...
self.addEventListener('push', function (event) {
    ...
    event.data && event.data.json && event.data.json();
    ...
    const promiseChain = clients
        ...
        .then((windowClients) => {
            ...
            for (let i = 0; i < windowClients.length; i++) {
                ...
                hasClient = hasClient || (windowClient && windowClient.visibilityState === 'visible');
                //console.log();
                // hasClient = true;
                // clientWindow = windowClient;
        ...
        .then(hasClient => {
            ...
            if ((!hasClient
                ...
                // in the background or not open show notification from within SW
