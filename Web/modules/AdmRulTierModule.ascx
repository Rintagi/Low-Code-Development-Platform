<%@ Control Language="c#" Inherits="RO.Web.AdmRulTierModule" CodeFile="AdmRulTierModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmRulTier106List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmRulTier106List_SelectedIndexChanged" OnTextChanged="cAdmRulTier106List_TextChanged" OnDDFindClick="cAdmRulTier106List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="RuleTierId196" DataTextField="RuleTierId196Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cRuleTierId196P1" class="r-td r-labelR" runat="server"><asp:Label id="cRuleTierId196Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRuleTierId196P2" class="r-td r-content" runat="server"><asp:TextBox id="cRuleTierId196" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cRuleTierName196P1" class="r-td r-labelR" runat="server"><asp:Label id="cRuleTierName196Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRuleTierName196P2" class="r-td r-content" runat="server"><asp:TextBox id="cRuleTierName196" CssClass="inp-txt" MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVRuleTierName196" ControlToValidate="cRuleTierName196" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cEntityId196P1" class="r-td r-labelR" runat="server"><asp:Label id="cEntityId196Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cEntityId196P2" class="r-td r-content" runat="server"><asp:DropDownList id="cEntityId196" CssClass="inp-ddl" DataValueField="EntityId196" DataTextField="EntityId196Text" runat="server" /><asp:RequiredFieldValidator id="cRFVEntityId196" ControlToValidate="cEntityId196" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cLanguageCd196P1" class="r-td r-labelR" runat="server"><asp:Label id="cLanguageCd196Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cLanguageCd196P2" class="r-td r-content" runat="server"><asp:DropDownList id="cLanguageCd196" CssClass="inp-ddl" DataValueField="LanguageCd196" DataTextField="LanguageCd196Text" runat="server" /><asp:RequiredFieldValidator id="cRFVLanguageCd196" ControlToValidate="cLanguageCd196" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cFrameworkCd196P1" class="r-td r-labelR" runat="server"><asp:Label id="cFrameworkCd196Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cFrameworkCd196P2" class="r-td r-content" runat="server"><asp:DropDownList id="cFrameworkCd196" CssClass="inp-ddl" DataValueField="FrameworkCd196" DataTextField="FrameworkCd196Text" runat="server" /><asp:RequiredFieldValidator id="cRFVFrameworkCd196" ControlToValidate="cFrameworkCd196" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cDevProgramPath196P1" class="r-td r-labelR" runat="server"><asp:Label id="cDevProgramPath196Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cDevProgramPath196P2" class="r-td r-content" runat="server"><asp:TextBox id="cDevProgramPath196" CssClass="inp-txt" MaxLength="100" runat="server" /><asp:RequiredFieldValidator id="cRFVDevProgramPath196" ControlToValidate="cDevProgramPath196" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cIsDefault196P1" class="r-td r-labelR" runat="server"><asp:Label id="cIsDefault196Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cIsDefault196P2" class="r-td r-content" runat="server"><asp:CheckBox id="cIsDefault196" CssClass="inp-chk" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
