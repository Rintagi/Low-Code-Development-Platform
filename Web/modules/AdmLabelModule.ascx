<%@ Control Language="c#" Inherits="RO.Web.AdmLabelModule" CodeFile="AdmLabelModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmLabel112List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmLabel112List_SelectedIndexChanged" OnTextChanged="cAdmLabel112List_TextChanged" OnDDFindClick="cAdmLabel112List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="LabelId215" DataTextField="LabelId215Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cLabelId215P1" class="r-td r-labelR" runat="server"><asp:Label id="cLabelId215Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cLabelId215P2" class="r-td r-content" runat="server"><asp:TextBox id="cLabelId215" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cCultureId215P1" class="r-td r-labelR" runat="server"><asp:Label id="cCultureId215Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCultureId215P2" class="r-td r-content" runat="server"><rcasp:ComboBox autocomplete="off" id="cCultureId215" CssClass="inp-ddl" Mode="A" OnPostBack="cbPostBack" OnSearch="cbCultureId215" DataValueField="CultureId215" DataTextField="CultureId215Text" AutoPostBack="true" OnSelectedIndexChanged="cCultureId215_SelectedIndexChanged" OnTextChanged="cCultureId215_TextChanged" OnDDFindClick="cCultureId215_DDFindClick" runat="server" /><asp:RequiredFieldValidator id="cRFVCultureId215" ControlToValidate="cCultureId215" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cLabelCat215P1" class="r-td r-labelR" runat="server"><asp:Label id="cLabelCat215Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cLabelCat215P2" class="r-td r-content" runat="server"><asp:TextBox id="cLabelCat215" CssClass="inp-txt" MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVLabelCat215" ControlToValidate="cLabelCat215" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cLabelKey215P1" class="r-td r-labelR" runat="server"><asp:Label id="cLabelKey215Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cLabelKey215P2" class="r-td r-content" runat="server"><asp:TextBox id="cLabelKey215" CssClass="inp-txt" MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVLabelKey215" ControlToValidate="cLabelKey215" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    	...
    	<div class="r-tr">
    		...
    		<div id="cCompanyId215P2" class="r-td r-content" runat="server"><asp:DropDownList id="cCompanyId215" CssClass="inp-ddl" DataValueField="CompanyId215" DataTextField="CompanyId215Text" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cSortOrder215P1" class="r-td r-labelR" runat="server"><asp:Label id="cSortOrder215Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cSortOrder215P2" class="r-td r-content" runat="server"><asp:TextBox id="cSortOrder215" CssClass="inp-num" runat="server" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-7-8"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cRemoveBtnP1" class="r-td r-labelR" runat="server"><asp:Label id="cRemoveBtnLabel" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRemoveBtnP2" class="r-td r-content" runat="server"><asp:Button id="cRemoveBtn" CssClass="small blue button" OnClick="cRemoveBtn_Click" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
