<%@ Control Language="c#" Inherits="RO.Web.AdmReportObjModule" CodeFile="AdmReportObjModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmReportObj13List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmReportObj13List_SelectedIndexChanged" OnTextChanged="cAdmReportObj13List_TextChanged" OnDDFindClick="cAdmReportObj13List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="ReportObjId23" DataTextField="ReportObjId23Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cReportObjId23P1" class="r-td r-labelR" runat="server"><asp:Label id="cReportObjId23Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cReportObjId23P2" class="r-td r-content" runat="server"><asp:TextBox id="cReportObjId23" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cReportId23P1" class="r-td r-labelR" runat="server"><asp:Label id="cReportId23Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cReportId23P2" class="r-td r-content" runat="server"><rcasp:ComboBox autocomplete="off" id="cReportId23" CssClass="inp-ddl" Mode="A" OnPostBack="cbPostBack" OnSearch="cbReportId23" DataValueField="ReportId23" DataTextField="ReportId23Text" AutoPostBack="true" OnSelectedIndexChanged="cReportId23_SelectedIndexChanged" OnTextChanged="cReportId23_TextChanged" OnDDFindClick="cReportId23_DDFindClick" runat="server" /><asp:RequiredFieldValidator id="cRFVReportId23" ControlToValidate="cReportId23" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cColumnName23P1" class="r-td r-labelR" runat="server"><asp:Label id="cColumnName23Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cColumnName23P2" class="r-td r-content" runat="server"><asp:TextBox id="cColumnName23" CssClass="inp-txt" MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVColumnName23" ControlToValidate="cColumnName23" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cRptObjTypeCd23P1" class="r-td r-labelR" runat="server"><asp:Label id="cRptObjTypeCd23Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRptObjTypeCd23P2" class="r-td r-content" runat="server"><asp:DropDownList id="cRptObjTypeCd23" CssClass="inp-ddl" DataValueField="RptObjTypeCd23" DataTextField="RptObjTypeCd23Text" runat="server" /><asp:RequiredFieldValidator id="cRFVRptObjTypeCd23" ControlToValidate="cRptObjTypeCd23" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cTabIndex23P1" class="r-td r-labelR" runat="server"><asp:Label id="cTabIndex23Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cTabIndex23P2" class="r-td r-content" runat="server"><asp:TextBox id="cTabIndex23" CssClass="inp-num" runat="server" /><asp:RequiredFieldValidator id="cRFVTabIndex23" ControlToValidate="cTabIndex23" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cColumnFormat23P1" class="r-td r-labelR" runat="server"><asp:Label id="cColumnFormat23Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cColumnFormat23P2" class="r-td r-content" runat="server"><asp:TextBox id="cColumnFormat23" CssClass="inp-txt" MaxLength="20" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cPaddSize23P1" class="r-td r-labelR" runat="server"><asp:Label id="cPaddSize23Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cPaddSize23P2" class="r-td r-content" runat="server"><asp:TextBox id="cPaddSize23" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cPaddChar23P1" class="r-td r-labelR" runat="server"><asp:Label id="cPaddChar23Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cPaddChar23P2" class="r-td r-content" runat="server"><asp:TextBox id="cPaddChar23" CssClass="inp-ctr" MaxLength="1" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cDataTypeId23P1" class="r-td r-labelR" runat="server"><asp:Label id="cDataTypeId23Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cDataTypeId23P2" class="r-td r-content" runat="server"><asp:DropDownList id="cDataTypeId23" CssClass="inp-ddl" DataValueField="DataTypeId23" DataTextField="DataTypeId23Text" runat="server" /><asp:RequiredFieldValidator id="cRFVDataTypeId23" ControlToValidate="cDataTypeId23" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cOperatorId23P1" class="r-td r-labelR" runat="server"><asp:Label id="cOperatorId23Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cOperatorId23P2" class="r-td r-content" runat="server"><asp:DropDownList id="cOperatorId23" CssClass="inp-ddl" DataValueField="OperatorId23" DataTextField="OperatorId23Text" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cReportCriId23P1" class="r-td r-labelR" runat="server"><asp:Label id="cReportCriId23Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cReportCriId23P2" class="r-td r-content" runat="server"><asp:DropDownList id="cReportCriId23" CssClass="inp-ddl" DataValueField="ReportCriId23" DataTextField="ReportCriId23Text" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
...
<div class="ListView">
	<asp:ListView id="cAdmReportObjGrid" DataKeyNames="ReportObjHlpId99" OnItemCommand="cAdmReportObjGrid_OnItemCommand" OnSorting="cAdmReportObjGrid_OnSorting" OnPreRender="cAdmReportObjGrid_OnPreRender" OnPagePropertiesChanging="cAdmReportObjGrid_OnPagePropertiesChanging" OnItemEditing="cAdmReportObjGrid_OnItemEditing" OnItemCanceling="cAdmReportObjGrid_OnItemCanceling" OnItemDeleting="cAdmReportObjGrid_OnItemDeleting" OnItemDataBound="cAdmReportObjGrid_OnItemDataBound" OnLayoutCreated="cAdmReportObjGrid_OnLayoutCreated" OnItemUpdating="cAdmReportObjGrid_OnItemUpdating" runat="server">
	<LayoutTemplate>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr id="cAdmReportObjGridHeader" class="GrdHead" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:40px;text-align:right;' runat="server">
			<asp:LinkButton id="cReportObjHlpId99hl" CssClass="GrdHead" onClick="cReportObjHlpId99hl_Click" runat="server" /><asp:Image id="cReportObjHlpId99hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' runat="server">
			<asp:LinkButton id="cCultureId99hl" CssClass="GrdHead" onClick="cCultureId99hl_Click" runat="server" /><asp:Image id="cCultureId99hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:400px;text-align:left;' runat="server">
			<asp:LinkButton id="cColumnHeader99hl" CssClass="GrdHead" onClick="cColumnHeader99hl_Click" runat="server" /><asp:Image id="cColumnHeader99hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:60px;text-align:right;' runat="server">
			<asp:LinkButton id="cHeaderWidth99hl" CssClass="GrdHead" onClick="cHeaderWidth99hl_Click" runat="server" /><asp:Image id="cHeaderWidth99hi" runat="server" />
		</div></div>
    </td>
	...
	<tr id="cAdmReportObjGridFooter" class="GrdFoot" visible="false" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:40px;text-align:right;' runat="server">
		    <asp:Label id="cReportObjHlpId99fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' runat="server">
		    <asp:Label id="cCultureId99fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:400px;text-align:left;' runat="server">
		    <asp:Label id="cColumnHeader99fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:60px;text-align:right;' runat="server">
		    <asp:Label id="cHeaderWidth99fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr></table></LayoutTemplate>
	<ItemTemplate>
	<tr id="cAdmReportObjGridRow" class='<%# Container.DisplayIndex % 2 == 0 ? "GrdItm" : "GrdAlt" %>' runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:40px;text-align:right;' visible="<%# GridColumnVisible(11) %>" onclick='GridEdit("ReportObjHlpId99")' runat="server">
			<asp:Label id="cReportObjHlpId99l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ReportObjHlpId99").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' visible="<%# GridColumnVisible(12) %>" onclick='GridEdit("CultureId99")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"CultureId99").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cCultureId99l" text='<%# DataBinder.Eval(Container.DataItem,"CultureId99Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:400px;text-align:left;' visible="<%# GridColumnVisible(13) %>" onclick='GridEdit("ColumnHeader99")' runat="server">
			<asp:Label id="cColumnHeader99l" Text='<%# DataBinder.Eval(Container.DataItem,"ColumnHeader99").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:60px;text-align:right;' visible="<%# GridColumnVisible(14) %>" onclick='GridEdit("HeaderWidth99")' runat="server">
			<asp:Label id="cHeaderWidth99l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"HeaderWidth99").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmReportObjGridEdit" style="display:none;" CausesValidation="true" CommandName="Edit" runat="server" />
       <asp:LinkButton ID="cAdmReportObjGridDelete" CssClass="GrdDel" tooltip="DELETE" CommandName="Delete" onclientclick='GridDelete()' runat="server" />
	</td>
	</tr>
	</ItemTemplate>
	<EditItemTemplate>
    ...
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:40px;text-align:right;' visible="<%# GridColumnVisible(11) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cReportObjHlpId99ml" runat="server" /></div>
		    <asp:TextBox id="cReportObjHlpId99" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ReportObjHlpId99").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' visible="<%# GridColumnVisible(12) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cCultureId99ml" runat="server" /></div>
		    <asp:DropDownList id="cCultureId99" CssClass="GrdDdl" DataValueField="CultureId99" DataTextField="CultureId99Text" runat="server" /><asp:RequiredFieldValidator id="cRFVCultureId99" ControlToValidate="cCultureId99" display="none" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:400px;text-align:left;' visible="<%# GridColumnVisible(13) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cColumnHeader99ml" runat="server" /></div>
		    <asp:TextBox id="cColumnHeader99" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"ColumnHeader99").ToString() %>' MaxLength="50" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:60px;text-align:right;' visible="<%# GridColumnVisible(14) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cHeaderWidth99ml" runat="server" /></div>
		    <asp:TextBox id="cHeaderWidth99" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"HeaderWidth99").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmReportObjGridCancel" CssClass="GrdCan" tooltip="CANCEL" OnClientClick="GridCancel();" CausesValidation="true" CommandName="Cancel" runat="server" />
       <asp:LinkButton ID="cAdmReportObjGridUpdate" style="display:none;" CommandName="Update" runat="server" />
	</td>
	</tr>
	</EditItemTemplate>
	...
	<asp:DataPager ID="cAdmReportObjGridDataPager" runat="server" Visible="false" PagedControlID="cAdmReportObjGrid"></asp:DataPager>
</div></div></div>
</asp:Panel>
