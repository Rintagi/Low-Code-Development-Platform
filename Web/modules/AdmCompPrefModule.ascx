<%@ Control Language="c#" Inherits="RO.Web.AdmCompPrefModule" CodeFile="AdmCompPrefModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
...
<asp:UpdatePanel ID="PanelUpd" runat="server"><Triggers><asp:PostBackTrigger ControlID="cCompanyLogo1329Upl" /></Triggers><ContentTemplate>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmCompPref1029List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmCompPref1029List_SelectedIndexChanged" OnTextChanged="cAdmCompPref1029List_TextChanged" OnDDFindClick="cAdmCompPref1029List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="CompPrefId1329" DataTextField="CompPrefId1329Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-7"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cCompPrefId1329P1" class="r-td r-labelR" runat="server"><asp:Label id="cCompPrefId1329Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCompPrefId1329P2" class="r-td r-content" runat="server"><asp:TextBox id="cCompPrefId1329" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cCompanyId1329P1" class="r-td r-labelR" runat="server"><asp:Label id="cCompanyId1329Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCompanyId1329P2" class="r-td r-content" runat="server"><asp:DropDownList id="cCompanyId1329" CssClass="inp-ddl" DataValueField="CompanyId1329" DataTextField="CompanyId1329Text" runat="server" /><asp:RequiredFieldValidator id="cRFVCompanyId1329" ControlToValidate="cCompanyId1329" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cCompanyLogo1329P1" class="r-td r-labelR" runat="server"><asp:Label id="cCompanyLogo1329Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCompanyLogo1329P2" class="r-td r-content" runat="server">
    			<asp:Panel id="cCompanyLogo1329Pan" CssClass="DocPanel" Visible="false" runat="server">
    			<table width="100%"><tr>
    			<td style="display:none;"><asp:Button id="cCompanyLogo1329Upl" CssClass="small blue button" OnClientClick='NoConfirm()' onclick="cCompanyLogo1329Upl_Click" text="Upload" runat="server" /></td>
    			<td><asp:FileUpload id="cCompanyLogo1329Fi" runat="server" onchange="AutoUpload(this,event);" /></td>
    			</tr></table>
    			</asp:Panel>
    			<asp:TextBox id="cCompanyLogo1329" CssClass="inp-txt" MaxLength="100" AutoPostBack="true" runat="server" />
    			<asp:ImageButton id="cCompanyLogo1329Tgo" CssClass="r-icon" OnClientClick='NoConfirm()' onclick="cCompanyLogo1329Tgo_Click" runat="server" ImageUrl="~/Images/UpLoad.png" CausesValidation="true" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cSystemLs1329P1" class="r-td r-labelR" runat="server"><asp:Label id="cSystemLs1329Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cSystemLs1329P2" class="r-td r-content" runat="server"><asp:ListBox SelectionMode="Multiple" id="cSystemLs1329" CssClass="inp-pic" DataValueField="SystemLs1329" DataTextField="SystemLs1329Text" runat="server" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-8-12"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cCompPrefDesc1329P1" class="r-td r-labelR" runat="server"><asp:Label id="cCompPrefDesc1329Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCompPrefDesc1329P2" class="r-td r-content" runat="server"><asp:TextBox id="cCompPrefDesc1329" CssClass="inp-txt" MaxLength="200" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
