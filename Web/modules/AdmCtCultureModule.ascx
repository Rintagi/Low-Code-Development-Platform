<%@ Control Language="c#" Inherits="RO.Web.AdmCtCultureModule" CodeFile="AdmCtCultureModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmCtCulture8List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmCtCulture8List_SelectedIndexChanged" OnTextChanged="cAdmCtCulture8List_TextChanged" OnDDFindClick="cAdmCtCulture8List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="CultureTypeId8" DataTextField="CultureTypeId8Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cCultureTypeId8P1" class="r-td r-labelR" runat="server"><asp:Label id="cCultureTypeId8Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCultureTypeId8P2" class="r-td r-content" runat="server"><asp:TextBox id="cCultureTypeId8" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cCultureTypeDesc8P1" class="r-td r-labelR" runat="server"><asp:Label id="cCultureTypeDesc8Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCultureTypeDesc8P2" class="r-td r-content" runat="server"><asp:TextBox id="cCultureTypeDesc8" CssClass="inp-txt" MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVCultureTypeDesc8" ControlToValidate="cCultureTypeDesc8" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cCultureTypeName8P1" class="r-td r-labelR" runat="server"><asp:Label id="cCultureTypeName8Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCultureTypeName8P2" class="r-td r-content" runat="server"><asp:TextBox id="cCultureTypeName8" CssClass="inp-txt" MaxLength="10" AutoPostBack="true" OnTextChanged="cCultureTypeName8_TextChanged" runat="server" /><asp:RequiredFieldValidator id="cRFVCultureTypeName8" ControlToValidate="cCultureTypeName8" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cCurrencyCd8P1" class="r-td r-labelR" runat="server"><asp:Label id="cCurrencyCd8Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCurrencyCd8P2" class="r-td r-content" runat="server"><asp:TextBox id="cCurrencyCd8" CssClass="inp-txt" MaxLength="3" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cCountryCd8P1" class="r-td r-labelR" runat="server"><asp:Label id="cCountryCd8Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCountryCd8P2" class="r-td r-content" runat="server"><rcasp:ComboBox autocomplete="off" id="cCountryCd8" CssClass="inp-ddl" Mode="A" OnPostBack="cbPostBack" OnSearch="cbCountryCd8" DataValueField="CountryCd8" DataTextField="CountryCd8Text" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cCultureDefault8P1" class="r-td r-labelR" runat="server"><asp:Label id="cCultureDefault8Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCultureDefault8P2" class="r-td r-content" runat="server"><asp:CheckBox id="cCultureDefault8" CssClass="inp-chk" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cEnNumberRule8P1" class="r-td r-labelR" runat="server"><asp:Label id="cEnNumberRule8Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cEnNumberRule8P2" class="r-td r-content" runat="server"><asp:CheckBox id="cEnNumberRule8" CssClass="inp-chk" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cToTranslate8P1" class="r-td r-labelR" runat="server"><asp:Label id="cToTranslate8Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cToTranslate8P2" class="r-td r-content" runat="server"><asp:CheckBox id="cToTranslate8" CssClass="inp-chk" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
...
<div class="ListView">
	<asp:ListView id="cAdmCtCultureGrid" DataKeyNames="CultureLblId242" OnItemCommand="cAdmCtCultureGrid_OnItemCommand" OnSorting="cAdmCtCultureGrid_OnSorting" OnPreRender="cAdmCtCultureGrid_OnPreRender" OnPagePropertiesChanging="cAdmCtCultureGrid_OnPagePropertiesChanging" OnItemEditing="cAdmCtCultureGrid_OnItemEditing" OnItemCanceling="cAdmCtCultureGrid_OnItemCanceling" OnItemDeleting="cAdmCtCultureGrid_OnItemDeleting" OnItemDataBound="cAdmCtCultureGrid_OnItemDataBound" OnLayoutCreated="cAdmCtCultureGrid_OnLayoutCreated" OnItemUpdating="cAdmCtCultureGrid_OnItemUpdating" runat="server">
	<LayoutTemplate>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr id="cAdmCtCultureGridHeader" class="GrdHead" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:100px;text-align:right;' runat="server">
			<asp:LinkButton id="cCultureLblId242hl" CssClass="GrdHead" onClick="cCultureLblId242hl_Click" runat="server" /><asp:Image id="cCultureLblId242hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' runat="server">
			<asp:LinkButton id="cCultureId242hl" CssClass="GrdHead" onClick="cCultureId242hl_Click" runat="server" /><asp:Image id="cCultureId242hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
			<asp:LinkButton id="cCultureTypeLabel242hl" CssClass="GrdHead" onClick="cCultureTypeLabel242hl_Click" runat="server" /><asp:Image id="cCultureTypeLabel242hi" runat="server" />
		</div></div>
    </td>
	...
	<tr id="cAdmCtCultureGridFooter" class="GrdFoot" visible="false" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:100px;text-align:right;' runat="server">
		    <asp:Label id="cCultureLblId242fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' runat="server">
		    <asp:Label id="cCultureId242fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
		    <asp:Label id="cCultureTypeLabel242fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr></table></LayoutTemplate>
	<ItemTemplate>
	<tr id="cAdmCtCultureGridRow" class='<%# Container.DisplayIndex % 2 == 0 ? "GrdItm" : "GrdAlt" %>' runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:100px;text-align:right;' visible="<%# GridColumnVisible(8) %>" onclick='GridEdit("CultureLblId242")' runat="server">
			<asp:Label id="cCultureLblId242l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"CultureLblId242").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' visible="<%# GridColumnVisible(9) %>" onclick='GridEdit("CultureId242")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"CultureId242").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cCultureId242l" text='<%# DataBinder.Eval(Container.DataItem,"CultureId242Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(10) %>" onclick='GridEdit("CultureTypeLabel242")' runat="server">
			<asp:Label id="cCultureTypeLabel242l" Text='<%# DataBinder.Eval(Container.DataItem,"CultureTypeLabel242").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmCtCultureGridEdit" style="display:none;" CausesValidation="true" CommandName="Edit" runat="server" />
       <asp:LinkButton ID="cAdmCtCultureGridDelete" CssClass="GrdDel" tooltip="DELETE" CommandName="Delete" onclientclick='GridDelete()' runat="server" />
	</td>
	</tr>
	</ItemTemplate>
	<EditItemTemplate>
    ...
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' visible="<%# GridColumnVisible(8) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cCultureLblId242ml" runat="server" /></div>
		    <asp:TextBox id="cCultureLblId242" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"CultureLblId242").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' visible="<%# GridColumnVisible(9) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cCultureId242ml" runat="server" /></div>
		    <rcasp:ComboBox autocomplete="off" id="cCultureId242" CssClass="GrdDdl" DataValueField="CultureId242" DataTextField="CultureId242Text" Mode="A" OnPostBack="cbPostBack" OnSearch="cbCultureId242" runat="server" /><asp:RequiredFieldValidator id="cRFVCultureId242" ControlToValidate="cCultureId242" display="none" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(10) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cCultureTypeLabel242ml" runat="server" /></div>
		    <asp:TextBox id="cCultureTypeLabel242" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"CultureTypeLabel242").ToString() %>' MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVCultureTypeLabel242" ControlToValidate="cCultureTypeLabel242" display="none" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmCtCultureGridCancel" CssClass="GrdCan" tooltip="CANCEL" OnClientClick="GridCancel();" CausesValidation="true" CommandName="Cancel" runat="server" />
       <asp:LinkButton ID="cAdmCtCultureGridUpdate" style="display:none;" CommandName="Update" runat="server" />
	</td>
	</tr>
	</EditItemTemplate>
	...
	<asp:DataPager ID="cAdmCtCultureGridDataPager" runat="server" Visible="false" PagedControlID="cAdmCtCultureGrid"></asp:DataPager>
</div></div></div>
</asp:Panel>
