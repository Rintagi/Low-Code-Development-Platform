		...
		private string SaveDb(object sender, System.EventArgs e)
		{
			...
			if (ValidPage() && !cRowAuthId238Pwd.Visible && (cAdmRowOvrdGrid.EditIndex < 0 || UpdateGridRow(cAdmRowOvrdGrid, new CommandEventArgs("Save", ""))))
			{
				...
				if (string.IsNullOrEmpty(cAdmRowOvrd17List.SelectedValue))	// Add
				{
					if (ds != null)
					{
						pid = (new AdminSystem()).AddData(17,false,base.LUser,base.LImpr,base.LCurr,ds,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),base.CPrj,base.CSrc);
					}
					...
					bool bValid7 = false;
					if (ds != null && (new AdminSystem()).UpdData(17,false,base.LUser,base.LImpr,base.LCurr,ds,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),base.CPrj,base.CSrc)) {bValid7 = true;}
					if (bValid7)
					{
						cAdmRowOvrd17List.ClearSearch(); Session.Remove(KEY_dtAdmRowOvrd17List);
