	...
	public partial class AdmRptElmModule : RO.Web.ModuleBase
	{
		...
		private void SetSystem(byte SystemId)
		{
			...
			try
			{
				...
				{
					(new GenScreensSystem()).CreateProgram(91, "Report Element ( -- no react gen -- )", row["dbAppDatabase"].ToString(), base.CPrj, base.CSrc, base.CTar, LcAppConnString, LcAppPw);
		...
		private void getReport(string eExport)
		{
			try
			{
				...
				if (eExport == "TXT")
				{
					...
					bExpNow.Value = "Y"; Session["ExportFnm"] = "AdmRptElm.xls"; Session["ExportStr"] = sb.Replace("\r\n","\n");
				}
				else if (eExport == "RTF")
				{
