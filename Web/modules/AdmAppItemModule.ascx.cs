...
namespace RO.Web
{
	public partial class AdmAppItemModule : RO.Web.ModuleBase
	{
		private const string KEY_dtScreenHlp = "Cache:dtScreenHlp3_83";
		private const string KEY_dtClientRule = "Cache:dtClientRule3_83";
		private const string KEY_dtAuthCol = "Cache:dtAuthCol3_83";
		private const string KEY_dtAuthRow = "Cache:dtAuthRow3_83";
		private const string KEY_dtLabel = "Cache:dtLabel3_83";
		private const string KEY_dtCriHlp = "Cache:dtCriHlp3_83";
		private const string KEY_dtScrCri = "Cache:dtScrCri3_83";
		private const string KEY_dsScrCriVal = "Cache:dsScrCriVal3_83";

		private const string KEY_dtAppInfoId136 = "Cache:dtAppInfoId136";
		private const string KEY_dtLanguageCd136 = "Cache:dtLanguageCd136";
		private const string KEY_dtFrameworkCd136 = "Cache:dtFrameworkCd136";
		private const string KEY_dtObjectTypeCd136 = "Cache:dtObjectTypeCd136";
		private const string KEY_dtDbProviderCd136 = "Cache:dtDbProviderCd136";
		private const string KEY_dtScreenId136 = "Cache:dtScreenId136";
		private const string KEY_dtReportId136 = "Cache:dtReportId136";
		private const string KEY_dtWizardId136 = "Cache:dtWizardId136";

		private const string KEY_dtSystems = "Cache:dtSystems3_83";
		private const string KEY_sysConnectionString = "Cache:sysConnectionString3_83";
		private const string KEY_dtAdmAppItem83List = "Cache:dtAdmAppItem83List";
		private const string KEY_bNewVisible = "Cache:bNewVisible3_83";
		private const string KEY_bNewSaveVisible = "Cache:bNewSaveVisible3_83";
		private const string KEY_bCopyVisible = "Cache:bCopyVisible3_83";
		private const string KEY_bCopySaveVisible = "Cache:bCopySaveVisible3_83";
		private const string KEY_bDeleteVisible = "Cache:bDeleteVisible3_83";
		private const string KEY_bUndoAllVisible = "Cache:bUndoAllVisible3_83";
		private const string KEY_bUpdateVisible = "Cache:bUpdateVisible3_83";

		private const string KEY_bClCriVisible = "Cache:bClCriVisible3_83";
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				DataTable dtMenuAccess = (new MenuSystem()).GetMenu(base.LUser.CultureId, 3, base.LImpr, LcSysConnString, LcAppPw,83, null, null);
				...
				Session.Remove(KEY_dtAdmAppItem83List);
				...
				Session.Remove(KEY_dtAppInfoId136);
				Session.Remove(KEY_dtLanguageCd136);
				Session.Remove(KEY_dtFrameworkCd136);
				Session.Remove(KEY_dtObjectTypeCd136);
				Session.Remove(KEY_dtDbProviderCd136);
				Session.Remove(KEY_dtScreenId136);
				Session.Remove(KEY_dtReportId136);
				Session.Remove(KEY_dtWizardId136);
				SetButtonHlp();
				GetSystems();
				SetColumnAuthority();
				GetGlobalFilter();
				...
				cTab42.InnerText = dt.Rows[0]["TabFolderName"].ToString();
				cTab43.InnerText = dt.Rows[1]["TabFolderName"].ToString();
				cTab44.InnerText = dt.Rows[2]["TabFolderName"].ToString();
				SetClientRule(null,false);
				IgnoreConfirm(); InitPreserve();
				try
				{
					(new AdminSystem()).LogUsage(base.LUser.UsrId, string.Empty, dtHlp.Rows[0]["ScreenTitle"].ToString(), 83, 0, 0, string.Empty, LcSysConnString, LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				// *** Criteria Trigger (before) Web Rule starts here *** //
				PopAdmAppItem83List(sender, e, true, null);
				if (cAuditButton.Attributes["OnClick"] == null || cAuditButton.Attributes["OnClick"].IndexOf("AdmScrAudit.aspx") < 0) { cAuditButton.Attributes["OnClick"] += "SearchLink('AdmScrAudit.aspx?cri0=83&typ=N&sys=3','','',''); return false;"; }
		...
		private void SetSystem(byte SystemId)
		{
			...
			try
			{
				...
				if ((Config.DeployType == "DEV" || row["dbAppDatabase"].ToString() == base.CPrj.EntityCode + "View") && !(base.CPrj.EntityCode != "RO" && row["SysProgram"].ToString() == "Y") && (new AdminSystem()).IsRegenNeeded(string.Empty,83,0,0,LcSysConnString,LcAppPw))
				{
					(new GenScreensSystem()).CreateProgram(83, "Release Content", row["dbAppDatabase"].ToString(), base.CPrj, base.CSrc, base.CTar, LcAppConnString, LcAppPw);
		...
		private void SetButtonHlp()
		{
			...
			{
				DataTable dt;
				dt = (new AdminSystem()).GetButtonHlp(83,0,0,base.LUser.CultureId,LcSysConnString,LcAppPw);
		...
		private DataTable GetClientRule()
		{
			...
			if (dtRul == null)
			{
				...
				try
				{
					dtRul = (new AdminSystem()).GetClientRule(83,0,base.LUser.CultureId,LcSysConnString,LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		...
		private DataTable GetScreenCriHlp()
		{
			...
			if (dtCriHlp == null)
			{
				...
				try
				{
					dtCriHlp = (new AdminSystem()).GetScreenCriHlp(83,base.LUser.CultureId,LcSysConnString,LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		...
		private DataTable GetScreenHlp()
		{
			...
			if (dtHlp == null)
			{
				...
				try
				{
					dtHlp = (new AdminSystem()).GetScreenHlp(83,base.LUser.CultureId,LcSysConnString,LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		...
		private void GetGlobalFilter()
		{
			...
			{
				DataTable dt;
				dt = (new AdminSystem()).GetGlobalFilter(base.LUser.UsrId,83,base.LUser.CultureId,LcSysConnString,LcAppPw);
				if (dt != null && dt.Rows.Count > 0)
				{
		...
		private void GetScreenFilter()
		{
			try
			{
				DataTable dt = (new AdminSystem()).GetScreenFilter(83,base.LUser.CultureId,LcSysConnString,LcAppPw);
				if (dt != null)
				{
		...
		private DataTable GetLabel()
		{
			...
			if (dt == null)
			{
				try
				{
					dt = (new AdminSystem()).GetScreenLabel(83,base.LUser.CultureId,base.LImpr,base.LCurr,LcSysConnString,LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		...
		private DataTable GetAuthCol()
		{
			...
			if (dt == null)
			{
				try
				{
					dt = (new AdminSystem()).GetAuthCol(83,base.LImpr,base.LCurr,LcSysConnString,LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		...
		protected DataTable GetAuthRow()
		{
			...
			if (dt == null)
			{
				try
				{
					dt = (new AdminSystem()).GetAuthRow(83,base.LImpr.RowAuthoritys,LcSysConnString,LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		...
		private void getReport(string eExport)
		{
			try
			{
				...
				try
				{
					try {dv = new DataView((new AdminSystem()).GetExp(83,"GetExpAdmAppItem83","Y",(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),filterId,GetScrCriteria(),base.LImpr,base.LCurr,UpdCriteria(false)));}
					catch {dv = new DataView((new AdminSystem()).GetExp(83,"GetExpAdmAppItem83","N",(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),filterId,GetScrCriteria(),base.LImpr,base.LCurr,UpdCriteria(false)));}
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				if (eExport == "TXT")
				{
					DataTable dtAu;
					dtAu = (new AdminSystem()).GetAuthExp(83,base.LUser.CultureId,base.LImpr,base.LCurr,LcSysConnString,LcAppPw);
					if (dtAu != null)
					{
					...
					{
						if (dtAu.Rows[0]["ColExport"].ToString() == "Y") {sb.Append(RO.Common3.Utils.fmNumeric("0",drv["AppItemId136"].ToString(),base.LUser.Culture) + (char)9);}
						if (dtAu.Rows[1]["ColExport"].ToString() == "Y") {sb.Append(drv["AppInfoId136"].ToString() + (char)9 + drv["AppInfoId136Text"].ToString() + (char)9);}
						if (dtAu.Rows[2]["ColExport"].ToString() == "Y") {sb.Append("\"" + drv["LanguageCd136"].ToString().Replace("\"","\"\"") + "\"" + (char)9 + "\"" + drv["LanguageCd136Text"].ToString().Replace("\"","\"\"") + "\"" + (char)9);}
						if (dtAu.Rows[3]["ColExport"].ToString() == "Y") {sb.Append(RO.Common3.Utils.fmNumeric("0",drv["ItemOrder136"].ToString(),base.LUser.Culture) + (char)9);}
						if (dtAu.Rows[4]["ColExport"].ToString() == "Y") {sb.Append("\"" + drv["FrameworkCd136"].ToString().Replace("\"","\"\"") + "\"" + (char)9 + "\"" + drv["FrameworkCd136Text"].ToString().Replace("\"","\"\"") + "\"" + (char)9);}
						if (dtAu.Rows[5]["ColExport"].ToString() == "Y") {sb.Append("\"" + drv["ObjectTypeCd136"].ToString().Replace("\"","\"\"") + "\"" + (char)9 + "\"" + drv["ObjectTypeCd136Text"].ToString().Replace("\"","\"\"") + "\"" + (char)9);}
						if (dtAu.Rows[6]["ColExport"].ToString() == "Y") {sb.Append("\"" + drv["DbProviderCd136"].ToString().Replace("\"","\"\"") + "\"" + (char)9 + "\"" + drv["DbProviderCd136Text"].ToString().Replace("\"","\"\"") + "\"" + (char)9);}
						if (dtAu.Rows[7]["ColExport"].ToString() == "Y") {sb.Append("\"" + drv["RelativePath136"].ToString().Replace("\"","\"\"") + "\"" + (char)9);}
						if (dtAu.Rows[8]["ColExport"].ToString() == "Y") {sb.Append("\"" + drv["AppItemName136"].ToString().Replace("\"","\"\"") + "\"" + (char)9);}
						if (dtAu.Rows[9]["ColExport"].ToString() == "Y") {sb.Append("\"" + drv["MultiDesignDb136"].ToString().Replace("\"","\"\"") + "\"" + (char)9);}
						if (dtAu.Rows[10]["ColExport"].ToString() == "Y") {sb.Append("\"" + drv["RemoveItem136"].ToString().Replace("\"","\"\"") + "\"" + (char)9);}
						if (dtAu.Rows[11]["ColExport"].ToString() == "Y") {sb.Append("\"" + drv["AppItemCode136"].ToString().Replace("\"","\"\"") + "\"" + (char)9);}
						if (dtAu.Rows[12]["ColExport"].ToString() == "Y") {sb.Append(drv["ScreenId136"].ToString() + (char)9 + drv["ScreenId136Text"].ToString() + (char)9);}
						if (dtAu.Rows[13]["ColExport"].ToString() == "Y") {sb.Append(drv["ReportId136"].ToString() + (char)9 + drv["ReportId136Text"].ToString() + (char)9);}
						if (dtAu.Rows[14]["ColExport"].ToString() == "Y") {sb.Append(drv["WizardId136"].ToString() + (char)9 + drv["WizardId136Text"].ToString() + (char)9);}
						if (dtAu.Rows[15]["ColExport"].ToString() == "Y") {sb.Append(RO.Common3.Utils.fmNumeric("0",drv["CustomId136"].ToString(),base.LUser.Culture) + (char)9);}
						sb.Append(Environment.NewLine);
					}
					bExpNow.Value = "Y"; Session["ExportFnm"] = "AdmAppItem.csv"; Session["ExportStr"] = (Config.ExportExcelCSV ? "sep=\t\n": "") + sb.Replace("\r\n","\n");
				}
				else if (eExport == "RTF")
				{
...
\par }}");
					...
					bExpNow.Value = "Y"; Session["ExportFnm"] = "AdmAppItem.rtf"; Session["ExportStr"] = sb;
				}
			}
			catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		}
		...
		private string GetRtfGrid(DataView dv)
		{
			...
			try
			{
				...
				foreach (DataRowView drv in dv)
				{
					...
					sb.Append("\r\n");
					sb.Append(@"{");
					if (dtAu.Rows[0]["ColExport"].ToString() == "Y") {sb.Append(RO.Common3.Utils.fmNumeric("0",drv["AppItemId136"].ToString(),base.LUser.Culture) + @"\cell ");}
					if (dtAu.Rows[1]["ColExport"].ToString() == "Y") {sb.Append(drv["AppInfoId136Text"].ToString() + @"\cell ");}
					if (dtAu.Rows[2]["ColExport"].ToString() == "Y") {sb.Append(drv["LanguageCd136Text"].ToString().Replace("\r\n",@"\par ") + @"\cell ");}
					if (dtAu.Rows[3]["ColExport"].ToString() == "Y") {sb.Append(RO.Common3.Utils.fmNumeric("0",drv["ItemOrder136"].ToString(),base.LUser.Culture) + @"\cell ");}
					if (dtAu.Rows[4]["ColExport"].ToString() == "Y") {sb.Append(drv["FrameworkCd136Text"].ToString().Replace("\r\n",@"\par ") + @"\cell ");}
					if (dtAu.Rows[5]["ColExport"].ToString() == "Y") {sb.Append(drv["ObjectTypeCd136Text"].ToString().Replace("\r\n",@"\par ") + @"\cell ");}
					if (dtAu.Rows[6]["ColExport"].ToString() == "Y") {sb.Append(drv["DbProviderCd136Text"].ToString().Replace("\r\n",@"\par ") + @"\cell ");}
					if (dtAu.Rows[7]["ColExport"].ToString() == "Y") {sb.Append(drv["RelativePath136"].ToString().Replace("\r\n",@"\par ") + @"\cell ");}
					if (dtAu.Rows[8]["ColExport"].ToString() == "Y") {sb.Append(drv["AppItemName136"].ToString().Replace("\r\n",@"\par ") + @"\cell ");}
					if (dtAu.Rows[9]["ColExport"].ToString() == "Y") {sb.Append(drv["MultiDesignDb136"].ToString().Replace("\r\n",@"\par ") + @"\cell ");}
					if (dtAu.Rows[10]["ColExport"].ToString() == "Y") {sb.Append(drv["RemoveItem136"].ToString().Replace("\r\n",@"\par ") + @"\cell ");}
					if (dtAu.Rows[11]["ColExport"].ToString() == "Y") {sb.Append(drv["AppItemCode136"].ToString().Replace("\r\n",@"\par ") + @"\cell ");}
					if (dtAu.Rows[12]["ColExport"].ToString() == "Y") {sb.Append(drv["ScreenId136Text"].ToString() + @"\cell ");}
					if (dtAu.Rows[13]["ColExport"].ToString() == "Y") {sb.Append(drv["ReportId136Text"].ToString() + @"\cell ");}
					if (dtAu.Rows[14]["ColExport"].ToString() == "Y") {sb.Append(drv["WizardId136Text"].ToString() + @"\cell ");}
					if (dtAu.Rows[15]["ColExport"].ToString() == "Y") {sb.Append(RO.Common3.Utils.fmNumeric("0",drv["CustomId136"].ToString(),base.LUser.Culture) + @"\cell ");}
					sb.Append(@"}");
					sb.Append("\r\n");
					sb.Append(@"\pard \ql \li0\ri0\widctlpar\intbl\aspalpha\aspnum\adjustright\rin0\lin0 {");
					sb.Append(@"\insrsid2981395 \trowd \irow0\irowband0\lastrow \ts15\trgaph108\trleft-108\trbrdrt\brdrs\brdrw10 \trbrdrl\brdrs\brdrw10 \trbrdrb\brdrs\brdrw10 \trbrdrr\brdrs\brdrw10 \trbrdrh\brdrs\brdrw10 \trbrdrv\brdrs\brdrw10 ");
		...
		private void GetCriteria(DataView dvCri)
		{
			...
			{
				DataTable dt;
				dt = (new AdminSystem()).GetLastCriteria(int.Parse(dvCri.Count.ToString()) + 1, 83, 0, base.LUser.UsrId, LcSysConnString, LcAppPw);
		...
		protected void cCriButton_Click(object sender, System.EventArgs e)
		{
			...
			UpdCriteria(true);
			cAdmAppItem83List.ClearSearch(); Session.Remove(KEY_dtAdmAppItem83List);
			PopAdmAppItem83List(sender, e, false, null);
		}
			...
			try
			{
				foreach (DataRowView drv in dvCri)
				{
					...
					if (drv["DisplayName"].ToString() == "ComboBox")
					{
						...
						(new AdminSystem()).MkGetScreenIn("83", drv["ScreenCriId"].ToString(), "GetDdl" + drv["ColumnName"].ToString() + LCurr.SystemId.ToString() + "C" + drv["ScreenCriId"].ToString(), LcAppDb, LcDesDb, drv["MultiDesignDb"].ToString(), LcSysConnString, LcAppPw);
						DataView dv = new DataView((new AdminSystem()).GetScreenIn("83", "GetDdl" + drv["ColumnName"].ToString() + LCurr.SystemId.ToString() + "C" + drv["ScreenCriId"].ToString(), (new AdminSystem()).CountScrCri(drv["ScreenCriId"].ToString(), drv["MultiDesignDb"].ToString(), drv["MultiDesignDb"].ToString() == "N" ? LcSysConnString : (string)Session[KEY_sysConnectionString], base.AppPwd(LCurr.DbId)), drv["RequiredValid"].ToString(), 0, string.Empty, drv["DisplayMode"].ToString() != "AutoListBox", val, base.LImpr, base.LCurr, drv["MultiDesignDb"].ToString() == "N" ? LcAppConnString : (string)Session[KEY_sysConnectionString], base.AppPwd(LCurr.DbId)));
		...
		private DataView GetScrCriteria()
		{
		    ...
		    if (dtScrCri == null)
		    {
				try
				{
					dtScrCri = (new AdminSystem()).GetScrCriteria("83", LcSysConnString, LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		...
		private void MakeScrGrpInp(DataRowView drv)
		{
		    ...
		    else if (drv["DisplayName"].ToString() == "ListBox")
		    {
		        ...
		        if (drv["DisplayMode"].ToString() == "AutoListBox")
		        {
		            ...
		            context["refCol"] = wcFtr != null ? drv["DdlFtrColumnName"].ToString() : null;
		            context["refColDataType"] = wcFtr != null ? drv["DdlFtrDataType"].ToString() : null;
		            Session["AdmAppItem83" + cListBox.ID] = context;
		            cListBox.Attributes["ac_context"] = "AdmAppItem83" + cListBox.ID;
		...
		private DataSet UpdCriteria(bool bUpdate)
		{
			...
			foreach (DataRowView drv in dvCri)
			{
			    if (drv["DisplayName"].ToString() == "ListBox")
			    {
					...
					if (cListBox != null)
					{
						...
						int TotalChoiceCnt = new DataView((new AdminSystem()).GetScreenIn("83", "GetDdl" + drv["ColumnName"].ToString() + LCurr.SystemId.ToString() + "C" + drv["ScreenCriId"].ToString(), CriCnt, drv["RequiredValid"].ToString(), 0, string.Empty, true, string.Empty, base.LImpr, base.LCurr, drv["MultiDesignDb"].ToString() == "N" ? LcAppConnString : (string)Session[KEY_sysConnectionString], base.AppPwd(LCurr.DbId))).Count;
						string selectedValues = string.Join(",", cListBox.Items.Cast<ListItem>().Where(x => x.Selected).Select(x => "'" + x.Value + "'").ToArray());
			...
			if (bUpdate) 
			{
				try
				{
					(new AdminSystem()).UpdScrCriteria("83", "AdmAppItem83", dvCri, base.LUser.UsrId, cCriteria.Visible, ds, LcAppConnString, LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
			}
		...
		private DataTable GetScreenTab()
		{
			...
			try
			{
				dtScreenTab = (new AdminSystem()).GetScreenTab(83,base.LUser.CultureId,LcSysConnString,LcAppPw);
			}
			catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
			return dtScreenTab;
		}

		protected void cbAppInfoId136(object sender, System.EventArgs e)
		{
			SetAppInfoId136((RoboCoder.WebControls.ComboBox)sender,string.Empty);
		}

		private void SetAppInfoId136(RoboCoder.WebControls.ComboBox ddl, string keyId)
		{
			System.Collections.Generic.Dictionary<string, string> context = new System.Collections.Generic.Dictionary<string, string>();
			context["method"] = "GetDdlAppInfoId3S1352";
			context["addnew"] = "Y";
			context["mKey"] = "AppInfoId136";
			context["mVal"] = "AppInfoId136Text";
			context["mTip"] = "AppInfoId136Text";
			context["mImg"] = "AppInfoId136Text";
			context["ssd"] = Request.QueryString["ssd"];
			context["scr"] = "83";
			context["csy"] = "3";
			context["filter"] = Utils.IsInt(cFilterId.SelectedValue)? cFilterId.SelectedValue : "0";
			...
			if (ddl != null)
			{
				...
				try
				{
					dv = new DataView((new AdminSystem()).GetDdl(83,"GetDdlAppInfoId3S1352",true,false,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				if (dv != null)
				{
					if (dv.Table.Columns.Contains("AppItemId"))
					{
						context["pMKeyColID"] = cAdmAppItem83List.ClientID;
						context["pMKeyCol"] = "AppItemId";
						string ss = "(AppItemId is null";
						if (string.IsNullOrEmpty(cAdmAppItem83List.SelectedValue)) {ss = ss + ")";} else {ss = ss + " OR AppItemId = " + cAdmAppItem83List.SelectedValue + ")";}
						dv.RowFilter = ss;
					}
					ddl.DataSource = dv; Session[KEY_dtAppInfoId136] = dv.Table;
				    try { ddl.SelectByValue(keyId,string.Empty,true); } catch { try { ddl.SelectedIndex = 0; } catch { } }
				}
			}
		}

		private void SetLanguageCd136(DropDownList ddl, string keyId)
		{
			DataTable dt = (DataTable)Session[KEY_dtLanguageCd136];
			...
			if (ddl != null)
			{
				...
				if (dv == null)
				{
					...
					try
					{
						dv = new DataView((new AdminSystem()).GetDdl(83,"GetDdlLanguageCd3S1355",true,bAll,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
					}
					catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				}
				if (dv != null)
				{
					if (dv.Table.Columns.Contains("AppItemId"))
					{
						ss = "(AppItemId is null";
						if (string.IsNullOrEmpty(cAdmAppItem83List.SelectedValue)) {ss = ss + ")";} else {ss = ss + " OR AppItemId = " + cAdmAppItem83List.SelectedValue + ")";}
					}
					if (!string.IsNullOrEmpty(keyId) && !ddl.Enabled) { ss = ss + (string.IsNullOrEmpty(ss) ? string.Empty : " AND ") + "LanguageCd136 is not NULL"; }
					dv.RowFilter = ss;
					...
					if (dv.Count <= 1 && keyId != string.Empty)	// In case invalid value casued by copy action.
					{
						try
						{
							dv = new DataView((new AdminSystem()).GetDdl(83,"GetDdlLanguageCd3S1355",true,true,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
						}
						catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
						dv.RowFilter = ss; ddl.DataSource = dv; ddl.DataBind();
						li = ddl.Items.FindByValue(keyId); if (li != null) {li.Selected = true;}
					}
					Session[KEY_dtLanguageCd136] = dv.Table;
				}
			}
		}

		private void SetFrameworkCd136(DropDownList ddl, string keyId)
		{
			DataTable dt = (DataTable)Session[KEY_dtFrameworkCd136];
			DataView dv = dt != null ? dt.DefaultView : null;
			if (ddl != null)
			{
				string ss = string.Empty;
				...
				if (dv == null)
				{
					...
					try
					{
						dv = new DataView((new AdminSystem()).GetDdl(83,"GetDdlFrameworkCd3S1356",true,bAll,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
					}
					catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				}
				if (dv != null)
				{
					...
					if (!string.IsNullOrEmpty(keyId) && !ddl.Enabled) { ss = ss + (string.IsNullOrEmpty(ss) ? string.Empty : " AND ") + "FrameworkCd136 is not NULL"; }
					dv.RowFilter = ss;
					ddl.DataSource = dv; ddl.DataBind();
					li = ddl.Items.FindByValue(keyId); if (li != null) {li.Selected = true;}
					else if (!bFirst)
					...
					if (dv.Count <= 1 && keyId != string.Empty)	// In case invalid value casued by copy action.
					{
						try
						{
							dv = new DataView((new AdminSystem()).GetDdl(83,"GetDdlFrameworkCd3S1356",true,true,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
						}
						catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
						dv.RowFilter = ss; ddl.DataSource = dv; ddl.DataBind();
						li = ddl.Items.FindByValue(keyId); if (li != null) {li.Selected = true;}
					}
					Session[KEY_dtFrameworkCd136] = dv.Table;
				}
			}
		}

		private void SetObjectTypeCd136(DropDownList ddl, string keyId)
		{
			DataTable dt = (DataTable)Session[KEY_dtObjectTypeCd136];
			DataView dv = dt != null ? dt.DefaultView : null;
			if (ddl != null)
			{
				string ss = string.Empty;
				...
				if (dv == null)
				{
					...
					try
					{
						dv = new DataView((new AdminSystem()).GetDdl(83,"GetDdlObjectTypeCd3S1354",true,bAll,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
					}
					catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				}
				if (dv != null)
				{
					...
					if (!string.IsNullOrEmpty(keyId) && !ddl.Enabled) { ss = ss + (string.IsNullOrEmpty(ss) ? string.Empty : " AND ") + "ObjectTypeCd136 is not NULL"; }
					dv.RowFilter = ss;
					ddl.DataSource = dv; ddl.DataBind();
					li = ddl.Items.FindByValue(keyId); if (li != null) {li.Selected = true;}
					else if (!bFirst)
					...
					if (dv.Count <= 1 && keyId != string.Empty)	// In case invalid value casued by copy action.
					{
						try
						{
							dv = new DataView((new AdminSystem()).GetDdl(83,"GetDdlObjectTypeCd3S1354",true,true,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
						}
						catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
						dv.RowFilter = ss; ddl.DataSource = dv; ddl.DataBind();
						li = ddl.Items.FindByValue(keyId); if (li != null) {li.Selected = true;}
					}
					Session[KEY_dtObjectTypeCd136] = dv.Table;
				}
			}
		}

		private void SetDbProviderCd136(DropDownList ddl, string keyId)
		{
			DataTable dt = (DataTable)Session[KEY_dtDbProviderCd136];
			DataView dv = dt != null ? dt.DefaultView : null;
			if (ddl != null)
			{
				string ss = string.Empty;
				...
				if (dv == null)
				{
					...
					try
					{
						dv = new DataView((new AdminSystem()).GetDdl(83,"GetDdlDbProviderCd3S1357",true,bAll,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
					}
					catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				}
				if (dv != null)
				{
					...
					if (!string.IsNullOrEmpty(keyId) && !ddl.Enabled) { ss = ss + (string.IsNullOrEmpty(ss) ? string.Empty : " AND ") + "DbProviderCd136 is not NULL"; }
					dv.RowFilter = ss;
					ddl.DataSource = dv; ddl.DataBind();
					li = ddl.Items.FindByValue(keyId); if (li != null) {li.Selected = true;}
					else if (!bFirst)
					...
					if (dv.Count <= 1 && keyId != string.Empty)	// In case invalid value casued by copy action.
					{
						try
						{
							dv = new DataView((new AdminSystem()).GetDdl(83,"GetDdlDbProviderCd3S1357",true,true,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
						}
						catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
						dv.RowFilter = ss; ddl.DataSource = dv; ddl.DataBind();
						li = ddl.Items.FindByValue(keyId); if (li != null) {li.Selected = true;}
					}
					Session[KEY_dtDbProviderCd136] = dv.Table;
				}
			}
		}

		protected void cbScreenId136(object sender, System.EventArgs e)
		{
			SetScreenId136((RoboCoder.WebControls.ComboBox)sender,string.Empty);
		}

		private void SetScreenId136(RoboCoder.WebControls.ComboBox ddl, string keyId)
		{
			System.Collections.Generic.Dictionary<string, string> context = new System.Collections.Generic.Dictionary<string, string>();
			context["method"] = "GetDdlScreenId3S1364";
			context["addnew"] = "Y";
			context["mKey"] = "ScreenId136";
			context["mVal"] = "ScreenId136Text";
			context["mTip"] = "ScreenId136Text";
			context["mImg"] = "ScreenId136Text";
			context["ssd"] = Request.QueryString["ssd"];
			context["scr"] = "83";
			context["csy"] = "3";
			context["filter"] = Utils.IsInt(cFilterId.SelectedValue)? cFilterId.SelectedValue : "0";
			...
			if (ddl != null)
			{
				...
				try
				{
					dv = new DataView((new AdminSystem()).GetDdl(83,"GetDdlScreenId3S1364",true,false,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				if (dv != null)
				{
					...
					ddl.DataSource = dv; Session[KEY_dtScreenId136] = dv.Table;
				    try { ddl.SelectByValue(keyId,string.Empty,true); } catch { try { ddl.SelectedIndex = 0; } catch { } }
				}
			}
		}

		protected void cbReportId136(object sender, System.EventArgs e)
		{
			SetReportId136((RoboCoder.WebControls.ComboBox)sender,string.Empty);
		}

		private void SetReportId136(RoboCoder.WebControls.ComboBox ddl, string keyId)
		{
			System.Collections.Generic.Dictionary<string, string> context = new System.Collections.Generic.Dictionary<string, string>();
			context["method"] = "GetDdlReportId3S1365";
			context["addnew"] = "Y";
			context["mKey"] = "ReportId136";
			context["mVal"] = "ReportId136Text";
			context["mTip"] = "ReportId136Text";
			context["mImg"] = "ReportId136Text";
			context["ssd"] = Request.QueryString["ssd"];
			context["scr"] = "83";
			context["csy"] = "3";
			context["filter"] = Utils.IsInt(cFilterId.SelectedValue)? cFilterId.SelectedValue : "0";
			...
			if (ddl != null)
			{
				...
				try
				{
					dv = new DataView((new AdminSystem()).GetDdl(83,"GetDdlReportId3S1365",true,false,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				if (dv != null)
				{
					...
					ddl.DataSource = dv; Session[KEY_dtReportId136] = dv.Table;
				    try { ddl.SelectByValue(keyId,string.Empty,true); } catch { try { ddl.SelectedIndex = 0; } catch { } }
				}
			}
		}

		protected void cbWizardId136(object sender, System.EventArgs e)
		{
			SetWizardId136((RoboCoder.WebControls.ComboBox)sender,string.Empty);
		}

		private void SetWizardId136(RoboCoder.WebControls.ComboBox ddl, string keyId)
		{
			System.Collections.Generic.Dictionary<string, string> context = new System.Collections.Generic.Dictionary<string, string>();
			context["method"] = "GetDdlWizardId3S1366";
			context["addnew"] = "Y";
			context["mKey"] = "WizardId136";
			context["mVal"] = "WizardId136Text";
			context["mTip"] = "WizardId136Text";
			context["mImg"] = "WizardId136Text";
			context["ssd"] = Request.QueryString["ssd"];
			context["scr"] = "83";
			context["csy"] = "3";
			context["filter"] = Utils.IsInt(cFilterId.SelectedValue)? cFilterId.SelectedValue : "0";
			...
			if (ddl != null)
			{
				...
				try
				{
					dv = new DataView((new AdminSystem()).GetDdl(83,"GetDdlWizardId3S1366",true,false,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				if (dv != null)
				{
					...
					ddl.DataSource = dv; Session[KEY_dtWizardId136] = dv.Table;
				    try { ddl.SelectByValue(keyId,string.Empty,true); } catch { try { ddl.SelectedIndex = 0; } catch { } }
				}
			}
		}

		private DataView GetAdmAppItem83List()
		{
			DataTable dt = (DataTable)Session[KEY_dtAdmAppItem83List];
			if (dt == null)
			{
				CheckAuthentication(false);
				int filterId = 0;
				...
				try
				{
					try {dt = (new AdminSystem()).GetLis(83,"GetLisAdmAppItem83",true,"Y",0,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),filterId,key,string.Empty,GetScrCriteria(),base.LImpr,base.LCurr,UpdCriteria(false));}
					catch {dt = (new AdminSystem()).GetLis(83,"GetLisAdmAppItem83",true,"N",0,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),filterId,key,string.Empty,GetScrCriteria(),base.LImpr,base.LCurr,UpdCriteria(false));}
				}
		...
		private void PopAdmAppItem83List(object sender, System.EventArgs e, bool bPageLoad, object ID)
		{
			DataView dv = GetAdmAppItem83List();
			System.Collections.Generic.Dictionary<string, string> context = new System.Collections.Generic.Dictionary<string, string>();
			...
			context["isSys"] = "N";
			context["conn"] = KEY_sysConnectionString;
			cAdmAppItem83List.AutoCompleteUrl = "AutoComplete.aspx/LisSuggests";
			cAdmAppItem83List.DataContext = context;
			if (dv.Table == null) return;
			cAdmAppItem83List.DataSource = dv;
			cAdmAppItem83List.Visible = true;
			if (cAdmAppItem83List.Items.Count <= 0) {cAdmAppItem83List.Visible = false; cAdmAppItem83List_SelectedIndexChanged(sender,e);}
			else
			{
				if (bPageLoad && !string.IsNullOrEmpty(Request.QueryString["key"]) && bUseCri.Value == string.Empty)
				{
					try {cAdmAppItem83List.SelectByValue(Request.QueryString["key"],string.Empty,true);} catch {cAdmAppItem83List.Items[0].Selected = true; cAdmAppItem83List_SelectedIndexChanged(sender, e);}
				    cScreenSearch.Visible = false; cSystem.Visible = false; cEditButton.Visible = true; cSaveCloseButton.Visible = cSaveButton.Visible;
				}
				else
				{
					if (ID != null) {if (!cAdmAppItem83List.SelectByValue(ID,string.Empty,true)) {ID = null;}}
					if (ID == null)
					{
						cAdmAppItem83List_SelectedIndexChanged(sender, e);
					}
				}
			}
		}
		...
		private void SetColumnAuthority()
		{
			...
			{
				base.SetFoldBehavior(cAppItemId136, dtAuth.Rows[0], cAppItemId136P1, cAppItemId136Label, cAppItemId136P2, null, dtLabel.Rows[0], null, null, null);
				base.SetFoldBehavior(cAppInfoId136, dtAuth.Rows[1], cAppInfoId136P1, cAppInfoId136Label, cAppInfoId136P2, null, dtLabel.Rows[1], cRFVAppInfoId136, null, null);
				SetAppInfoId136(cAppInfoId136,string.Empty);
				base.SetFoldBehavior(cLanguageCd136, dtAuth.Rows[2], cLanguageCd136P1, cLanguageCd136Label, cLanguageCd136P2, null, dtLabel.Rows[2], null, null, null);
				base.SetFoldBehavior(cItemOrder136, dtAuth.Rows[3], cItemOrder136P1, cItemOrder136Label, cItemOrder136P2, null, dtLabel.Rows[3], null, null, null);
				base.SetFoldBehavior(cFrameworkCd136, dtAuth.Rows[4], cFrameworkCd136P1, cFrameworkCd136Label, cFrameworkCd136P2, null, dtLabel.Rows[4], null, null, null);
				base.SetFoldBehavior(cObjectTypeCd136, dtAuth.Rows[5], cObjectTypeCd136P1, cObjectTypeCd136Label, cObjectTypeCd136P2, null, dtLabel.Rows[5], cRFVObjectTypeCd136, null, null);
				base.SetFoldBehavior(cDbProviderCd136, dtAuth.Rows[6], cDbProviderCd136P1, cDbProviderCd136Label, cDbProviderCd136P2, null, dtLabel.Rows[6], null, null, null);
				base.SetFoldBehavior(cRelativePath136, dtAuth.Rows[7], cRelativePath136P1, cRelativePath136Label, cRelativePath136P2, null, dtLabel.Rows[7], null, null, null);
				base.SetFoldBehavior(cAppItemName136, dtAuth.Rows[8], cAppItemName136P1, cAppItemName136Label, cAppItemName136P2, null, dtLabel.Rows[8], cRFVAppItemName136, null, null);
				base.SetFoldBehavior(cMultiDesignDb136, dtAuth.Rows[9], cMultiDesignDb136P1, cMultiDesignDb136Label, cMultiDesignDb136P2, null, dtLabel.Rows[9], null, null, null);
				base.SetFoldBehavior(cRemoveItem136, dtAuth.Rows[10], cRemoveItem136P1, cRemoveItem136Label, cRemoveItem136P2, null, dtLabel.Rows[10], null, null, null);
				base.SetFoldBehavior(cAppItemCode136, dtAuth.Rows[11], cAppItemCode136P1, cAppItemCode136Label, cAppItemCode136P2, cAppItemCode136E, null, dtLabel.Rows[11], null, null, null);
				cAppItemCode136E.Attributes["label_id"] = cAppItemCode136Label.ClientID; cAppItemCode136E.Attributes["target_id"] = cAppItemCode136.ClientID;
				base.SetFoldBehavior(cScreenId136, dtAuth.Rows[12], cScreenId136P1, cScreenId136Label, cScreenId136P2, null, dtLabel.Rows[12], null, null, null);
				SetScreenId136(cScreenId136,string.Empty);
				base.SetFoldBehavior(cReportId136, dtAuth.Rows[13], cReportId136P1, cReportId136Label, cReportId136P2, null, dtLabel.Rows[13], null, null, null);
				SetReportId136(cReportId136,string.Empty);
				base.SetFoldBehavior(cWizardId136, dtAuth.Rows[14], cWizardId136P1, cWizardId136Label, cWizardId136P2, null, dtLabel.Rows[14], null, null, null);
				SetWizardId136(cWizardId136,string.Empty);
				base.SetFoldBehavior(cCustomId136, dtAuth.Rows[15], cCustomId136P1, cCustomId136Label, cCustomId136P2, null, dtLabel.Rows[15], null, null, null);
			}
			if ((cAppInfoId136.Attributes["OnChange"] == null || cAppInfoId136.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cAppInfoId136.Visible && cAppInfoId136.Enabled) {cAppInfoId136.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cLanguageCd136.Attributes["OnChange"] == null || cLanguageCd136.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cLanguageCd136.Visible && cLanguageCd136.Enabled) {cLanguageCd136.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cItemOrder136.Attributes["OnChange"] == null || cItemOrder136.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cItemOrder136.Visible && !cItemOrder136.ReadOnly) {cItemOrder136.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cFrameworkCd136.Attributes["OnChange"] == null || cFrameworkCd136.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cFrameworkCd136.Visible && cFrameworkCd136.Enabled) {cFrameworkCd136.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cObjectTypeCd136.Attributes["OnChange"] == null || cObjectTypeCd136.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cObjectTypeCd136.Visible && cObjectTypeCd136.Enabled) {cObjectTypeCd136.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cDbProviderCd136.Attributes["OnChange"] == null || cDbProviderCd136.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cDbProviderCd136.Visible && cDbProviderCd136.Enabled) {cDbProviderCd136.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cRelativePath136.Attributes["OnChange"] == null || cRelativePath136.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cRelativePath136.Visible && !cRelativePath136.ReadOnly) {cRelativePath136.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cAppItemName136.Attributes["OnChange"] == null || cAppItemName136.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cAppItemName136.Visible && !cAppItemName136.ReadOnly) {cAppItemName136.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cMultiDesignDb136.Attributes["OnClick"] == null || cMultiDesignDb136.Attributes["OnClick"].IndexOf("ChkPgDirty") < 0) && cMultiDesignDb136.Visible && cMultiDesignDb136.Enabled) {cMultiDesignDb136.Attributes["OnClick"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty(); this.focus();";}
			if ((cRemoveItem136.Attributes["OnClick"] == null || cRemoveItem136.Attributes["OnClick"].IndexOf("ChkPgDirty") < 0) && cRemoveItem136.Visible && cRemoveItem136.Enabled) {cRemoveItem136.Attributes["OnClick"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty(); this.focus();";}
			if ((cAppItemCode136.Attributes["OnChange"] == null || cAppItemCode136.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cAppItemCode136.Visible && !cAppItemCode136.ReadOnly) {cAppItemCode136.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cScreenId136.Attributes["OnChange"] == null || cScreenId136.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cScreenId136.Visible && cScreenId136.Enabled) {cScreenId136.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cReportId136.Attributes["OnChange"] == null || cReportId136.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cReportId136.Visible && cReportId136.Enabled) {cReportId136.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cWizardId136.Attributes["OnChange"] == null || cWizardId136.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cWizardId136.Visible && cWizardId136.Enabled) {cWizardId136.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cCustomId136.Attributes["OnChange"] == null || cCustomId136.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cCustomId136.Visible && !cCustomId136.ReadOnly) {cCustomId136.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
		}
		...
		private void ClearMaster(object sender, System.EventArgs e)
		{
			...
			if (dt.Rows[1]["ColVisible"].ToString() == "Y" && dt.Rows[1]["ColReadOnly"].ToString() != "Y") {cAppInfoId136.ClearSearch();}
			if (dt.Rows[2]["ColVisible"].ToString() == "Y" && dt.Rows[2]["ColReadOnly"].ToString() != "Y") {SetLanguageCd136(cLanguageCd136,string.Empty);}
			if (dt.Rows[3]["ColVisible"].ToString() == "Y" && dt.Rows[3]["ColReadOnly"].ToString() != "Y") {cItemOrder136.Text = string.Empty;}
			if (dt.Rows[4]["ColVisible"].ToString() == "Y" && dt.Rows[4]["ColReadOnly"].ToString() != "Y") {SetFrameworkCd136(cFrameworkCd136,string.Empty);}
			if (dt.Rows[5]["ColVisible"].ToString() == "Y" && dt.Rows[5]["ColReadOnly"].ToString() != "Y") {SetObjectTypeCd136(cObjectTypeCd136,string.Empty);}
			if (dt.Rows[6]["ColVisible"].ToString() == "Y" && dt.Rows[6]["ColReadOnly"].ToString() != "Y") {SetDbProviderCd136(cDbProviderCd136,string.Empty);}
			if (dt.Rows[7]["ColVisible"].ToString() == "Y" && dt.Rows[7]["ColReadOnly"].ToString() != "Y") {cRelativePath136.Text = string.Empty;}
			if (dt.Rows[8]["ColVisible"].ToString() == "Y" && dt.Rows[8]["ColReadOnly"].ToString() != "Y") {cAppItemName136.Text = string.Empty;}
			if (dt.Rows[9]["ColVisible"].ToString() == "Y" && dt.Rows[9]["ColReadOnly"].ToString() != "Y") {cMultiDesignDb136.Checked = base.GetBool("N");}
			if (dt.Rows[10]["ColVisible"].ToString() == "Y" && dt.Rows[10]["ColReadOnly"].ToString() != "Y") {cRemoveItem136.Checked = base.GetBool("N");}
			if (dt.Rows[11]["ColVisible"].ToString() == "Y" && dt.Rows[11]["ColReadOnly"].ToString() != "Y") {cAppItemCode136.Text = string.Empty;}
			if (dt.Rows[12]["ColVisible"].ToString() == "Y" && dt.Rows[12]["ColReadOnly"].ToString() != "Y") {cScreenId136.ClearSearch();}
			if (dt.Rows[13]["ColVisible"].ToString() == "Y" && dt.Rows[13]["ColReadOnly"].ToString() != "Y") {cReportId136.ClearSearch();}
			if (dt.Rows[14]["ColVisible"].ToString() == "Y" && dt.Rows[14]["ColReadOnly"].ToString() != "Y") {cWizardId136.ClearSearch();}
			if (dt.Rows[15]["ColVisible"].ToString() == "Y" && dt.Rows[15]["ColReadOnly"].ToString() != "Y") {cCustomId136.Text = string.Empty;}
			// *** Default Value (Folder) Web Rule starts here *** //
		}

		private void InitMaster(object sender, System.EventArgs e)
		{
			cAppItemId136.Text = string.Empty;
			cAppInfoId136.ClearSearch();
			SetLanguageCd136(cLanguageCd136,string.Empty);
			cItemOrder136.Text = string.Empty;
			SetFrameworkCd136(cFrameworkCd136,string.Empty);
			SetObjectTypeCd136(cObjectTypeCd136,string.Empty);
			SetDbProviderCd136(cDbProviderCd136,string.Empty);
			cRelativePath136.Text = string.Empty;
			cAppItemName136.Text = string.Empty;
			cMultiDesignDb136.Checked = base.GetBool("N");
			cRemoveItem136.Checked = base.GetBool("N");
			cAppItemCode136.Text = string.Empty;
			cScreenId136.ClearSearch();
			cReportId136.ClearSearch();
			cWizardId136.ClearSearch();
			cCustomId136.Text = string.Empty;
			// *** Default Value (Folder) Web Rule starts here *** //
		}
		protected void cAdmAppItem83List_TextChanged(object sender, System.EventArgs e)
		{
			ScriptManager.GetCurrent(Parent.Page).SetFocus(((RoboCoder.WebControls.ComboBox)sender).FocusID);
		}

		protected void cAdmAppItem83List_DDFindClick(object sender, System.EventArgs e)
		{
			ScriptManager.GetCurrent(Parent.Page).SetFocus(((RoboCoder.WebControls.ComboBox)sender).FocusID);
		}

		protected void cAdmAppItem83List_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			InitMaster(sender, e);      // Do this first to enable defaults for non-database columns.
			DataTable dt = null;
			try
			{
				dt = (new AdminSystem()).GetMstById("GetAdmAppItem83ById",cAdmAppItem83List.SelectedValue,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId));
			}
			catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
			if (dt != null)
			{
				...
				if (dt.Rows.Count > 0)
				{
					cAdmAppItem83List.SetDdVisible();
					DataRow dr = dt.Rows[0];
					try {cAppItemId136.Text = RO.Common3.Utils.fmNumeric("0",dr["AppItemId136"].ToString(),base.LUser.Culture);} catch {cAppItemId136.Text = string.Empty;}
					SetAppInfoId136(cAppInfoId136,dr["AppInfoId136"].ToString());
					SetLanguageCd136(cLanguageCd136,dr["LanguageCd136"].ToString());
					try {cItemOrder136.Text = RO.Common3.Utils.fmNumeric("0",dr["ItemOrder136"].ToString(),base.LUser.Culture);} catch {cItemOrder136.Text = string.Empty;}
					SetFrameworkCd136(cFrameworkCd136,dr["FrameworkCd136"].ToString());
					SetObjectTypeCd136(cObjectTypeCd136,dr["ObjectTypeCd136"].ToString());
					SetDbProviderCd136(cDbProviderCd136,dr["DbProviderCd136"].ToString());
					try {cRelativePath136.Text = dr["RelativePath136"].ToString();} catch {cRelativePath136.Text = string.Empty;}
					try {cAppItemName136.Text = dr["AppItemName136"].ToString();} catch {cAppItemName136.Text = string.Empty;}
					try {cMultiDesignDb136.Checked = base.GetBool(dr["MultiDesignDb136"].ToString());} catch {cMultiDesignDb136.Checked = false;}
					try {cRemoveItem136.Checked = base.GetBool(dr["RemoveItem136"].ToString());} catch {cRemoveItem136.Checked = false;}
					try {cAppItemCode136.Text = dr["AppItemCode136"].ToString();} catch {cAppItemCode136.Text = string.Empty;}
					SetScreenId136(cScreenId136,dr["ScreenId136"].ToString());
					SetReportId136(cReportId136,dr["ReportId136"].ToString());
					SetWizardId136(cWizardId136,dr["WizardId136"].ToString());
					try {cCustomId136.Text = RO.Common3.Utils.fmNumeric("0",dr["CustomId136"].ToString(),base.LUser.Culture);} catch {cCustomId136.Text = string.Empty;}
				}
			}
			cButPanel.DataBind();
			ScriptManager.GetCurrent(Parent.Page).SetFocus(cAdmAppItem83List.FocusID);
		...
		{
			// *** System Button Click (Before) Web Rule starts here *** //
			if (cAppItemId136.Text == string.Empty) { cClearButton_Click(sender, new EventArgs()); ShowDirty(false); PanelTop.Update();}
			else { PopAdmAppItem83List(sender, e, false, cAppItemId136.Text); }
			// *** System Button Click (After) Web Rule starts here *** //
		}
		...
		public void cEditButton_Click(object sender, System.EventArgs e)
		{
			...
			Session.Remove(KEY_dtAdmAppItem83List); PopAdmAppItem83List(sender, e, false, null);
		...
		private string SaveDb(object sender, System.EventArgs e)
		{
			...
			if (ValidPage())
			{
				AdmAppItem83 ds = PrepAdmAppItemData(null,cAppItemId136.Text == string.Empty);
				if (!string.IsNullOrEmpty(cAdmAppItem83List.SelectedValue) && cAppItemId136.Text != cAdmAppItem83List.SelectedValue)
				{
					PreMsgPopup("Primary key cannot be changed");
					return rtn;
				}
				if (string.IsNullOrEmpty(cAdmAppItem83List.SelectedValue))	// Add
				{
					if (ds != null)
					{
						pid = (new AdminSystem()).AddData(83,false,base.LUser,base.LImpr,base.LCurr,ds,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),base.CPrj,base.CSrc,noTrans,commandTimeOut);
					}
					if (!string.IsNullOrEmpty(pid))
					{
						cAdmAppItem83List.ClearSearch(); Session.Remove(KEY_dtAdmAppItem83List);
						ShowDirty(false); bUseCri.Value = "Y"; PopAdmAppItem83List(sender, e, false, pid);
						rtn = GetScreenHlp().Rows[0]["AddMsg"].ToString();
					}
				}
				else {
					bool bValid7 = false;
					if (ds != null && (new AdminSystem()).UpdData(83,false,base.LUser,base.LImpr,base.LCurr,ds,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),base.CPrj,base.CSrc,noTrans,commandTimeOut)) {bValid7 = true;}
					if (bValid7)
					{
						cAdmAppItem83List.ClearSearch(); Session.Remove(KEY_dtAdmAppItem83List);
						ShowDirty(false); PopAdmAppItem83List(sender, e, false, ds.Tables["AdmAppItem"].Rows[0]["AppItemId136"]);
		...
		{
			// *** System Button Click (Before) Web Rule starts here *** //
			if (cAppItemId136.Text != string.Empty)
			{
				AdmAppItem83 ds = PrepAdmAppItemData(null,false);
				try
				{
					if (ds != null && (new AdminSystem()).DelData(83,false,base.LUser,base.LImpr,base.LCurr,ds,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),base.CPrj,base.CSrc))
					{
						cAdmAppItem83List.ClearSearch(); Session.Remove(KEY_dtAdmAppItem83List);
						ShowDirty(false); PopAdmAppItem83List(sender, e, false, null);
		...
		private AdmAppItem83 PrepAdmAppItemData(DataView dv, bool bAdd)
		{
			...
			if (bAdd) { dr["AppItemId136"] = string.Empty; } else { dr["AppItemId136"] = cAppItemId136.Text; }
			drType["AppItemId136"] = "Numeric"; drDisp["AppItemId136"] = "TextBox";
			try {dr["AppInfoId136"] = cAppInfoId136.SelectedValue;} catch {}
			drType["AppInfoId136"] = "Numeric"; drDisp["AppInfoId136"] = "AutoComplete";
			try {dr["LanguageCd136"] = cLanguageCd136.SelectedValue;} catch {}
			drType["LanguageCd136"] = "Char"; drDisp["LanguageCd136"] = "DropDownList";
			try {dr["ItemOrder136"] = cItemOrder136.Text.Trim();} catch {}
			drType["ItemOrder136"] = "Numeric"; drDisp["ItemOrder136"] = "TextBox";
			try {dr["FrameworkCd136"] = cFrameworkCd136.SelectedValue;} catch {}
			drType["FrameworkCd136"] = "Char"; drDisp["FrameworkCd136"] = "DropDownList";
			try {dr["ObjectTypeCd136"] = cObjectTypeCd136.SelectedValue;} catch {}
			drType["ObjectTypeCd136"] = "Char"; drDisp["ObjectTypeCd136"] = "DropDownList";
			try {dr["DbProviderCd136"] = cDbProviderCd136.SelectedValue;} catch {}
			drType["DbProviderCd136"] = "Char"; drDisp["DbProviderCd136"] = "DropDownList";
			try {dr["RelativePath136"] = cRelativePath136.Text.Trim();} catch {}
			drType["RelativePath136"] = "VarChar"; drDisp["RelativePath136"] = "TextBox";
			try {dr["AppItemName136"] = cAppItemName136.Text.Trim();} catch {}
			drType["AppItemName136"] = "VarChar"; drDisp["AppItemName136"] = "TextBox";
			try {dr["MultiDesignDb136"] = base.SetBool(cMultiDesignDb136.Checked);} catch {}
			drType["MultiDesignDb136"] = "Char"; drDisp["MultiDesignDb136"] = "CheckBox";
			try {dr["RemoveItem136"] = base.SetBool(cRemoveItem136.Checked);} catch {}
			drType["RemoveItem136"] = "Char"; drDisp["RemoveItem136"] = "CheckBox";
			try {dr["AppItemCode136"] = cAppItemCode136.Text;} catch {}
			drType["AppItemCode136"] = "VarWChar"; drDisp["AppItemCode136"] = "MultiLine";
			try {dr["ScreenId136"] = cScreenId136.SelectedValue;} catch {}
			drType["ScreenId136"] = "Numeric"; drDisp["ScreenId136"] = "AutoComplete";
			try {dr["ReportId136"] = cReportId136.SelectedValue;} catch {}
			drType["ReportId136"] = "Numeric"; drDisp["ReportId136"] = "AutoComplete";
			try {dr["WizardId136"] = cWizardId136.SelectedValue;} catch {}
			drType["WizardId136"] = "Numeric"; drDisp["WizardId136"] = "AutoComplete";
			try {dr["CustomId136"] = cCustomId136.Text.Trim();} catch {}
		...
		public bool CanAct(char typ) { return CanAct(typ, GetAuthRow(), cAdmAppItem83List.SelectedValue.ToString()); }
		...
		private bool ValidPage()
		{
			...
			DataTable dt = null;
			dt = (DataTable)Session[KEY_dtAppInfoId136];
			if (dt != null && dt.Rows.Count <= 0)
			{
				bErrNow.Value = "Y"; PreMsgPopup("Value is expected for 'AppInfoId', please investigate."); return false;
			}
			dt = (DataTable)Session[KEY_dtObjectTypeCd136];
			if (dt != null && dt.Rows.Count <= 0)
			{
				bErrNow.Value = "Y"; PreMsgPopup("Value is expected for 'ObjectTypeCd', please investigate."); return false;
			}
			return true;
		}
		...
		private void PreMsgPopup(string msg) { PreMsgPopup(msg,cAdmAppItem83List,null); }
