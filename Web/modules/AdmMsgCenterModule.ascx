<%@ Control Language="c#" Inherits="RO.Web.AdmMsgCenterModule" CodeFile="AdmMsgCenterModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmMsgCenter86List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmMsgCenter86List_SelectedIndexChanged" OnTextChanged="cAdmMsgCenter86List_TextChanged" OnDDFindClick="cAdmMsgCenter86List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="MsgId146" DataTextField="MsgId146Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-2"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cMsgId146P1" class="r-td r-labelR" runat="server"><asp:Label id="cMsgId146Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cMsgId146P2" class="r-td r-content" runat="server"><asp:TextBox id="cMsgId146" CssClass="inp-num" runat="server" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-3-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cMsgTypeCd146P1" class="r-td r-labelR" runat="server"><asp:Label id="cMsgTypeCd146Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cMsgTypeCd146P2" class="r-td r-content" runat="server"><asp:DropDownList id="cMsgTypeCd146" CssClass="inp-ddl" DataValueField="MsgTypeCd146" DataTextField="MsgTypeCd146Text" runat="server" /><asp:RequiredFieldValidator id="cRFVMsgTypeCd146" ControlToValidate="cMsgTypeCd146" display="none" runat="server" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-7-12"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cMsgSource146P1" class="r-td r-labelR" runat="server"><asp:Label id="cMsgSource146Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cMsgSource146P2" class="r-td r-content" runat="server"><asp:TextBox id="cMsgSource146" CssClass="inp-txt" MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVMsgSource146" ControlToValidate="cMsgSource146" display="none" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
...
<div class="ListView">
	<asp:ListView id="cAdmMsgCenterGrid" DataKeyNames="MsgCenterId147" OnItemCommand="cAdmMsgCenterGrid_OnItemCommand" OnSorting="cAdmMsgCenterGrid_OnSorting" OnPreRender="cAdmMsgCenterGrid_OnPreRender" OnPagePropertiesChanging="cAdmMsgCenterGrid_OnPagePropertiesChanging" OnItemEditing="cAdmMsgCenterGrid_OnItemEditing" OnItemCanceling="cAdmMsgCenterGrid_OnItemCanceling" OnItemDeleting="cAdmMsgCenterGrid_OnItemDeleting" OnItemDataBound="cAdmMsgCenterGrid_OnItemDataBound" OnLayoutCreated="cAdmMsgCenterGrid_OnLayoutCreated" OnItemUpdating="cAdmMsgCenterGrid_OnItemUpdating" runat="server">
	<LayoutTemplate>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr id="cAdmMsgCenterGridHeader" class="GrdHead" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:right;' runat="server">
			<asp:LinkButton id="cMsgCenterId147hl" CssClass="GrdHead" onClick="cMsgCenterId147hl_Click" runat="server" /><asp:Image id="cMsgCenterId147hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' runat="server">
			<asp:LinkButton id="cCultureId147hl" CssClass="GrdHead" onClick="cCultureId147hl_Click" runat="server" /><asp:Image id="cCultureId147hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:600px;text-align:left;' runat="server">
			<asp:LinkButton id="cMsg147hl" CssClass="GrdHead" onClick="cMsg147hl_Click" runat="server" /><asp:Image id="cMsg147hi" runat="server" />
		</div></div>
    </td>
	...
	<tr id="cAdmMsgCenterGridFooter" class="GrdFoot" visible="false" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:right;' runat="server">
		    <asp:Label id="cMsgCenterId147fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' runat="server">
		    <asp:Label id="cCultureId147fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:600px;text-align:left;' runat="server">
		    <asp:Label id="cMsg147fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr></table></LayoutTemplate>
	<ItemTemplate>
	<tr id="cAdmMsgCenterGridRow" class='<%# Container.DisplayIndex % 2 == 0 ? "GrdItm" : "GrdAlt" %>' runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:right;' visible="<%# GridColumnVisible(3) %>" onclick='GridEdit("MsgCenterId147")' runat="server">
			<asp:Label id="cMsgCenterId147l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"MsgCenterId147").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' visible="<%# GridColumnVisible(4) %>" onclick='GridEdit("CultureId147")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"CultureId147").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cCultureId147l" text='<%# DataBinder.Eval(Container.DataItem,"CultureId147Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:600px;text-align:left;' visible="<%# GridColumnVisible(5) %>" onclick='GridEdit("Msg147")' runat="server">
			<asp:Label id="cMsg147l" Text='<%# DataBinder.Eval(Container.DataItem,"Msg147").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmMsgCenterGridEdit" style="display:none;" CausesValidation="true" CommandName="Edit" runat="server" />
       <asp:LinkButton ID="cAdmMsgCenterGridDelete" CssClass="GrdDel" tooltip="DELETE" CommandName="Delete" onclientclick='GridDelete()' runat="server" />
	</td>
	</tr>
	</ItemTemplate>
	<EditItemTemplate>
    ...
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:right;' visible="<%# GridColumnVisible(3) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cMsgCenterId147ml" runat="server" /></div>
		    <asp:TextBox id="cMsgCenterId147" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"MsgCenterId147").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' visible="<%# GridColumnVisible(4) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cCultureId147ml" runat="server" /></div>
		    <rcasp:ComboBox autocomplete="off" id="cCultureId147" CssClass="GrdDdl" DataValueField="CultureId147" DataTextField="CultureId147Text" Mode="A" OnPostBack="cbPostBack" OnSearch="cbCultureId147" runat="server" /><asp:RequiredFieldValidator id="cRFVCultureId147" ControlToValidate="cCultureId147" display="none" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:600px;text-align:left;' visible="<%# GridColumnVisible(5) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cMsg147ml" runat="server" /></div>
		    <asp:TextBox id="cMsg147" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"Msg147").ToString() %>' MaxLength="800" runat="server" /><asp:RequiredFieldValidator id="cRFVMsg147" ControlToValidate="cMsg147" display="none" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmMsgCenterGridCancel" CssClass="GrdCan" tooltip="CANCEL" OnClientClick="GridCancel();" CausesValidation="true" CommandName="Cancel" runat="server" />
       <asp:LinkButton ID="cAdmMsgCenterGridUpdate" style="display:none;" CommandName="Update" runat="server" />
	</td>
	</tr>
	</EditItemTemplate>
	...
	<asp:DataPager ID="cAdmMsgCenterGridDataPager" runat="server" Visible="false" PagedControlID="cAdmMsgCenterGrid"></asp:DataPager>
</div></div></div>
</asp:Panel>
