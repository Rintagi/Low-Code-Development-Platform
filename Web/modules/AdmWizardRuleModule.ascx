<%@ Control Language="c#" Inherits="RO.Web.AdmWizardRuleModule" CodeFile="AdmWizardRuleModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmWizardRule50List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmWizardRule50List_SelectedIndexChanged" OnTextChanged="cAdmWizardRule50List_TextChanged" OnDDFindClick="cAdmWizardRule50List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="WizardRuleId73" DataTextField="WizardRuleId73Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cWizardRuleId73P1" class="r-td r-labelR" runat="server"><asp:Label id="cWizardRuleId73Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cWizardRuleId73P2" class="r-td r-content" runat="server"><asp:TextBox id="cWizardRuleId73" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cRuleName73P1" class="r-td r-labelR" runat="server"><asp:Label id="cRuleName73Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRuleName73P2" class="r-td r-content" runat="server"><asp:TextBox id="cRuleName73" CssClass="inp-txt" MaxLength="100" runat="server" /><asp:RequiredFieldValidator id="cRFVRuleName73" ControlToValidate="cRuleName73" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cRuleDescription73P1" class="r-td r-labelR" runat="server"><asp:Label id="cRuleDescription73Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRuleDescription73P2" class="r-td r-content" runat="server"><asp:TextBox TextMode="MultiLine" autocomplete="new-password" id="cRuleDescription73" CssClass="inp-txt" runat="server" /><asp:RegularExpressionValidator ControlToValidate="cRuleDescription73" display="none" ErrorMessage="RuleDescription <= 500 characters please." ValidationExpression="^[\s\S]{0,500}$" runat="server" /><asp:Image id="cRuleDescription73E" ImageUrl="~/images/Expand.gif" CssClass="r-icon show-expand-button" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cRuleTypeId73P1" class="r-td r-labelR" runat="server"><asp:Label id="cRuleTypeId73Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRuleTypeId73P2" class="r-td r-content" runat="server"><asp:DropDownList id="cRuleTypeId73" CssClass="inp-ddl" DataValueField="RuleTypeId73" DataTextField="RuleTypeId73Text" runat="server" /><asp:RequiredFieldValidator id="cRFVRuleTypeId73" ControlToValidate="cRuleTypeId73" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cWizardId73P1" class="r-td r-labelR" runat="server"><asp:Label id="cWizardId73Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cWizardId73P2" class="r-td r-content" runat="server"><asp:DropDownList id="cWizardId73" CssClass="inp-ddl" DataValueField="WizardId73" DataTextField="WizardId73Text" runat="server" /><asp:RequiredFieldValidator id="cRFVWizardId73" ControlToValidate="cWizardId73" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cRuleOrder73P1" class="r-td r-labelR" runat="server"><asp:Label id="cRuleOrder73Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRuleOrder73P2" class="r-td r-content" runat="server"><asp:TextBox id="cRuleOrder73" CssClass="inp-num" runat="server" /><asp:RequiredFieldValidator id="cRFVRuleOrder73" ControlToValidate="cRuleOrder73" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cProcedureName73P1" class="r-td r-labelR" runat="server"><asp:Label id="cProcedureName73Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cProcedureName73P2" class="r-td r-content" runat="server"><asp:TextBox id="cProcedureName73" CssClass="inp-txt" MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVProcedureName73" ControlToValidate="cProcedureName73" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cBeforeCRUD73P1" class="r-td r-labelR" runat="server"><asp:Label id="cBeforeCRUD73Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cBeforeCRUD73P2" class="r-td r-content" runat="server"><asp:CheckBox id="cBeforeCRUD73" CssClass="inp-chk" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
