<%@ Control Language="c#" Inherits="RO.Web.AdmRptwizTypModule" CodeFile="AdmRptwizTypModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
...
<div class="ListView">
	<asp:ListView id="cAdmRptwizTypGrid" DataKeyNames="RptwizTypId185" OnItemCommand="cAdmRptwizTypGrid_OnItemCommand" OnSorting="cAdmRptwizTypGrid_OnSorting" OnPreRender="cAdmRptwizTypGrid_OnPreRender" OnPagePropertiesChanging="cAdmRptwizTypGrid_OnPagePropertiesChanging" OnItemEditing="cAdmRptwizTypGrid_OnItemEditing" OnItemCanceling="cAdmRptwizTypGrid_OnItemCanceling" OnItemDeleting="cAdmRptwizTypGrid_OnItemDeleting" OnItemDataBound="cAdmRptwizTypGrid_OnItemDataBound" OnLayoutCreated="cAdmRptwizTypGrid_OnLayoutCreated" OnItemUpdating="cAdmRptwizTypGrid_OnItemUpdating" runat="server">
	<LayoutTemplate>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr id="cAdmRptwizTypGridHeader" class="GrdHead" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:90px;text-align:right;' runat="server">
			<asp:LinkButton id="cRptwizTypId185hl" CssClass="GrdHead" onClick="cRptwizTypId185hl_Click" runat="server" /><asp:Image id="cRptwizTypId185hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
			<asp:LinkButton id="cRptwizTypName185hl" CssClass="GrdHead" onClick="cRptwizTypName185hl_Click" runat="server" /><asp:Image id="cRptwizTypName185hi" runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr>
	<tr id="itemPlaceholder" runat="server"></tr>
	<tr id="cAdmRptwizTypGridFooter" class="GrdFoot" visible="false" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:90px;text-align:right;' runat="server">
		    <asp:Label id="cRptwizTypId185fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
		    <asp:Label id="cRptwizTypName185fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr></table></LayoutTemplate>
	<ItemTemplate>
	<tr id="cAdmRptwizTypGridRow" class='<%# Container.DisplayIndex % 2 == 0 ? "GrdItm" : "GrdAlt" %>' runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:90px;text-align:right;' visible="<%# GridColumnVisible(0) %>" onclick='GridEdit("RptwizTypId185")' runat="server">
			<asp:Label id="cRptwizTypId185l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"RptwizTypId185").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(1) %>" onclick='GridEdit("RptwizTypName185")' runat="server">
			<asp:Label id="cRptwizTypName185l" Text='<%# DataBinder.Eval(Container.DataItem,"RptwizTypName185").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmRptwizTypGridEdit" style="display:none;" CausesValidation="true" CommandName="Edit" runat="server" />
       <asp:LinkButton ID="cAdmRptwizTypGridDelete" CssClass="GrdDel" tooltip="DELETE" CommandName="Delete" onclientclick='GridDelete()' runat="server" />
	</td>
	</tr>
	</ItemTemplate>
	<EditItemTemplate>
    ...
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:90px;text-align:right;' visible="<%# GridColumnVisible(0) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cRptwizTypId185ml" runat="server" /></div>
		    <asp:TextBox id="cRptwizTypId185" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"RptwizTypId185").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(1) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cRptwizTypName185ml" runat="server" /></div>
		    <asp:TextBox id="cRptwizTypName185" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"RptwizTypName185").ToString() %>' MaxLength="100" runat="server" /><asp:RequiredFieldValidator id="cRFVRptwizTypName185" ControlToValidate="cRptwizTypName185" display="none" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmRptwizTypGridCancel" CssClass="GrdCan" tooltip="CANCEL" OnClientClick="GridCancel();" CausesValidation="true" CommandName="Cancel" runat="server" />
       <asp:LinkButton ID="cAdmRptwizTypGridUpdate" style="display:none;" CommandName="Update" runat="server" />
	</td>
	</tr>
	</EditItemTemplate>
	...
	<asp:DataPager ID="cAdmRptwizTypGridDataPager" runat="server" Visible="false" PagedControlID="cAdmRptwizTypGrid"></asp:DataPager>
</div></div></div>
