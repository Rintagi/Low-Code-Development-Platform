	...
	public partial class AdmScrAuditModule : RO.Web.ModuleBase
	{
		...
		private void SetSystem(byte SystemId)
		{
			...
			try
			{
				...
				{
					(new GenScreensSystem()).CreateProgram(1019, "Screen Audit Header ( -- no react gen -- )", row["dbAppDatabase"].ToString(), base.CPrj, base.CSrc, base.CTar, LcAppConnString, LcAppPw);
		...
		private void getReport(string eExport)
		{
			try
			{
				...
				if (eExport == "TXT")
				{
					...
					bExpNow.Value = "Y"; Session["ExportFnm"] = "AdmScrAudit.xls"; Session["ExportStr"] = sb.Replace("\r\n","\n");
				}
				else if (eExport == "RTF")
				{
