<%@ Control Language="c#" Inherits="RO.Web.AdmColDrgModule" CodeFile="AdmColDrgModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
...
<div class="ListView">
	<asp:ListView id="cAdmColDrgGrid" DataKeyNames="ScreenObjId14" OnItemCommand="cAdmColDrgGrid_OnItemCommand" OnSorting="cAdmColDrgGrid_OnSorting" OnPreRender="cAdmColDrgGrid_OnPreRender" OnPagePropertiesChanging="cAdmColDrgGrid_OnPagePropertiesChanging" OnItemEditing="cAdmColDrgGrid_OnItemEditing" OnItemCanceling="cAdmColDrgGrid_OnItemCanceling" OnItemDeleting="cAdmColDrgGrid_OnItemDeleting" OnItemDataBound="cAdmColDrgGrid_OnItemDataBound" OnLayoutCreated="cAdmColDrgGrid_OnLayoutCreated" OnItemUpdating="cAdmColDrgGrid_OnItemUpdating" runat="server">
	<LayoutTemplate>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr id="cAdmColDrgGridHeader" class="GrdHead" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
			<asp:LinkButton id="cScreenObjId14hl" CssClass="GrdHead" onClick="cScreenObjId14hl_Click" runat="server" /><asp:Image id="cScreenObjId14hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
			<asp:LinkButton id="cScreenId14hl" CssClass="GrdHead" onClick="cScreenId14hl_Click" runat="server" /><asp:Image id="cScreenId14hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
			<asp:LinkButton id="cGroupRowId14hl" CssClass="GrdHead" onClick="cGroupRowId14hl_Click" runat="server" /><asp:Image id="cGroupRowId14hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
			<asp:LinkButton id="cGroupColId14hl" CssClass="GrdHead" onClick="cGroupColId14hl_Click" runat="server" /><asp:Image id="cGroupColId14hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
			<asp:LinkButton id="cColumnName14hl" CssClass="GrdHead" onClick="cColumnName14hl_Click" runat="server" /><asp:Image id="cColumnName14hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
			<asp:LinkButton id="cTabFolderId14hl" CssClass="GrdHead" onClick="cTabFolderId14hl_Click" runat="server" /><asp:Image id="cTabFolderId14hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
			<asp:LinkButton id="cTabIndex14hl" CssClass="GrdHead" onClick="cTabIndex14hl_Click" runat="server" /><asp:Image id="cTabIndex14hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
			<asp:LinkButton id="cMasterTable14hl" CssClass="GrdHead" onClick="cMasterTable14hl_Click" runat="server" /><asp:Image id="cMasterTable14hi" runat="server" />
		</div></div>
    </td>
	...
	<tr id="cAdmColDrgGridFooter" class="GrdFoot" visible="false" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
		    <asp:Label id="cScreenObjId14fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
		    <asp:Label id="cScreenId14fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
		    <asp:Label id="cGroupRowId14fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
		    <asp:Label id="cGroupColId14fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
		    <asp:Label id="cColumnName14fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
		    <asp:Label id="cTabFolderId14fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
		    <asp:Label id="cTabIndex14fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
		    <asp:Label id="cMasterTable14fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr></table></LayoutTemplate>
	<ItemTemplate>
	<tr id="cAdmColDrgGridRow" class='<%# Container.DisplayIndex % 2 == 0 ? "GrdItm" : "GrdAlt" %>' runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(0) %>" onclick='GridEdit("ScreenObjId14")' runat="server">
			<asp:Label id="cScreenObjId14l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ScreenObjId14").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(1) %>" onclick='GridEdit("ScreenId14")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"ScreenId14").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cScreenId14l" text='<%# DataBinder.Eval(Container.DataItem,"ScreenId14Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(2) %>" onclick='GridEdit("GroupRowId14")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"GroupRowId14").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cGroupRowId14l" text='<%# DataBinder.Eval(Container.DataItem,"GroupRowId14Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(3) %>" onclick='GridEdit("GroupColId14")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"GroupColId14").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cGroupColId14l" text='<%# DataBinder.Eval(Container.DataItem,"GroupColId14Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(4) %>" onclick='GridEdit("ColumnName14")' runat="server">
			<asp:Label id="cColumnName14l" Text='<%# DataBinder.Eval(Container.DataItem,"ColumnName14").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(5) %>" onclick='GridEdit("TabFolderId14")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"TabFolderId14").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cTabFolderId14l" text='<%# DataBinder.Eval(Container.DataItem,"TabFolderId14Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(6) %>" onclick='GridEdit("TabIndex14")' runat="server">
			<asp:Label id="cTabIndex14l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"TabIndex14").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(7) %>" onclick='GridEdit("MasterTable14")' runat="server">
			<asp:Label id="cMasterTable14l" Text='<%# DataBinder.Eval(Container.DataItem,"MasterTable14").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdNwrLb" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmColDrgGridEdit" style="display:none;" CausesValidation="true" CommandName="Edit" runat="server" />
       <asp:LinkButton ID="cAdmColDrgGridDelete" CssClass="GrdDel" tooltip="DELETE" CommandName="Delete" onclientclick='GridDelete()' runat="server" />
	</td>
	</tr>
	</ItemTemplate>
	<EditItemTemplate>
    ...
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(0) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cScreenObjId14ml" runat="server" /></div>
		    <asp:TextBox id="cScreenObjId14" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ScreenObjId14").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(1) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cScreenId14ml" runat="server" /></div>
		    <rcasp:ComboBox autocomplete="off" id="cScreenId14" CssClass="GrdDdl" DataValueField="ScreenId14" DataTextField="ScreenId14Text" Mode="A" OnPostBack="cbPostBack" OnSearch="cbScreenId14" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(2) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cGroupRowId14ml" runat="server" /></div>
		    <asp:DropDownList id="cGroupRowId14" CssClass="GrdDdl" DataValueField="GroupRowId14" DataTextField="GroupRowId14Text" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(3) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cGroupColId14ml" runat="server" /></div>
		    <asp:DropDownList id="cGroupColId14" CssClass="GrdDdl" DataValueField="GroupColId14" DataTextField="GroupColId14Text" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(4) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cColumnName14ml" runat="server" /></div>
		    <asp:TextBox id="cColumnName14" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"ColumnName14").ToString() %>' MaxLength="50" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(5) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cTabFolderId14ml" runat="server" /></div>
		    <asp:DropDownList id="cTabFolderId14" CssClass="GrdDdl" DataValueField="TabFolderId14" DataTextField="TabFolderId14Text" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(6) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cTabIndex14ml" runat="server" /></div>
		    <asp:TextBox id="cTabIndex14" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"TabIndex14").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(7) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cMasterTable14ml" runat="server" /></div>
		    <asp:TextBox id="cMasterTable14" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"MasterTable14").ToString() %>' MaxLength="1" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmColDrgGridCancel" CssClass="GrdCan" tooltip="CANCEL" OnClientClick="GridCancel();" CausesValidation="true" CommandName="Cancel" runat="server" />
       <asp:LinkButton ID="cAdmColDrgGridUpdate" style="display:none;" CommandName="Update" runat="server" />
	</td>
	</tr>
	</EditItemTemplate>
	...
	<asp:DataPager ID="cAdmColDrgGridDataPager" runat="server" Visible="false" PagedControlID="cAdmColDrgGrid"></asp:DataPager>
</div></div></div>
