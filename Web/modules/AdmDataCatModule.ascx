<%@ Control Language="c#" Inherits="RO.Web.AdmDataCatModule" CodeFile="AdmDataCatModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmDataCat96List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmDataCat96List_SelectedIndexChanged" OnTextChanged="cAdmDataCat96List_TextChanged" OnDDFindClick="cAdmDataCat96List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="RptwizCatId181" DataTextField="RptwizCatId181Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cRptwizCatId181P1" class="r-td r-labelR" runat="server"><asp:Label id="cRptwizCatId181Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRptwizCatId181P2" class="r-td r-content" runat="server"><asp:TextBox id="cRptwizCatId181" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cRptwizTypId181P1" class="r-td r-labelR" runat="server"><asp:Label id="cRptwizTypId181Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRptwizTypId181P2" class="r-td r-content" runat="server"><rcasp:ComboBox autocomplete="off" id="cRptwizTypId181" CssClass="inp-ddl" Mode="A" OnPostBack="cbPostBack" OnSearch="cbRptwizTypId181" DataValueField="RptwizTypId181" DataTextField="RptwizTypId181Text" runat="server" /><asp:RequiredFieldValidator id="cRFVRptwizTypId181" ControlToValidate="cRptwizTypId181" display="none" runat="server" /><asp:ImageButton id="cRptwizTypId181Search" CssClass="r-icon" onclick="cRptwizTypId181Search_Click" runat="server" ImageUrl="~/Images/Link.gif" CausesValidation="true" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cRptwizCatName181P1" class="r-td r-labelR" runat="server"><asp:Label id="cRptwizCatName181Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRptwizCatName181P2" class="r-td r-content" runat="server"><asp:TextBox id="cRptwizCatName181" CssClass="inp-txt" MaxLength="100" runat="server" /><asp:RequiredFieldValidator id="cRFVRptwizCatName181" ControlToValidate="cRptwizCatName181" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    	...
    	<div class="r-tr">
    		...
    		<div id="cTableId181P2" class="r-td r-content" runat="server"><rcasp:ComboBox autocomplete="off" id="cTableId181" CssClass="inp-ddl" Mode="A" OnPostBack="cbPostBack" OnSearch="cbTableId181" DataValueField="TableId181" DataTextField="TableId181Text" AutoPostBack="true" OnSelectedIndexChanged="cTableId181_SelectedIndexChanged" OnTextChanged="cTableId181_TextChanged" OnDDFindClick="cTableId181_DDFindClick" runat="server" /><asp:RequiredFieldValidator id="cRFVTableId181" ControlToValidate="cTableId181" display="none" runat="server" /><asp:ImageButton id="cTableId181Search" CssClass="r-icon" onclick="cTableId181Search_Click" runat="server" ImageUrl="~/Images/Link.gif" CausesValidation="true" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-7-12"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cSampleImage181P1" class="r-td r-labelR" runat="server"><asp:Label id="cSampleImage181Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cSampleImage181P2" class="r-td r-content" runat="server">
    			<asp:Panel id="cSampleImage181Pan" CssClass="DocPanel" Style="display: none;" runat="server">
    			<table width="100%"><tr>
    			<td><asp:FileUpload id="cSampleImage181Fi" runat="server" /></td>
    			<td><asp:ImageButton ImageUrl="~/images/Btrash.gif" ID="cSampleImage181Del" CssClass="BtnImgDel" style="display:none; margin-left: 6px;" OnClientClick='NoConfirm();' Text="Delete" runat="server" /></td>
    			</tr></table>
    			</asp:Panel>
    			<asp:ImageButton id="cSampleImage181" CssClass="DocView" OnClientClick='NoConfirm(); return false;' OnClick="cSampleImage181_Click" runat="server" />
    			<asp:ImageButton id="cSampleImage181Tgo" OnClientClick='NoConfirm(); switchStatus($(this)); return false;' onclick="cSampleImage181Tgo_Click" runat="server" ImageUrl="~/Images/UpLoad.png" CausesValidation="false" /></div>
    	</div>
    </div></div></div>
    </div></div>
...
<div class="ListView">
	<asp:ListView id="cAdmDataCatGrid" DataKeyNames="RptwizCatDtlId182" OnItemCommand="cAdmDataCatGrid_OnItemCommand" OnSorting="cAdmDataCatGrid_OnSorting" OnPreRender="cAdmDataCatGrid_OnPreRender" OnPagePropertiesChanging="cAdmDataCatGrid_OnPagePropertiesChanging" OnItemEditing="cAdmDataCatGrid_OnItemEditing" OnItemCanceling="cAdmDataCatGrid_OnItemCanceling" OnItemDeleting="cAdmDataCatGrid_OnItemDeleting" OnItemDataBound="cAdmDataCatGrid_OnItemDataBound" OnLayoutCreated="cAdmDataCatGrid_OnLayoutCreated" OnItemUpdating="cAdmDataCatGrid_OnItemUpdating" runat="server">
	<LayoutTemplate>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr id="cAdmDataCatGridHeader" class="GrdHead" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
			<asp:LinkButton id="cRptwizCatDtlId182hl" CssClass="GrdHead" onClick="cRptwizCatDtlId182hl_Click" runat="server" /><asp:Image id="cRptwizCatDtlId182hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:160px;text-align:left;' runat="server">
			<asp:LinkButton id="cColumnId182hl" CssClass="GrdHead" onClick="cColumnId182hl_Click" runat="server" /><asp:Image id="cColumnId182hi" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:160px;text-align:left;' runat="server">
			<asp:LinkButton id="cDisplayModeId182hl" CssClass="GrdHead" onClick="cDisplayModeId182hl_Click" runat="server" /><asp:Image id="cDisplayModeId182hi" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:160px;text-align:left;' runat="server">
			<asp:LinkButton id="cColumnSize182hl" CssClass="GrdHead" onClick="cColumnSize182hl_Click" runat="server" /><asp:Image id="cColumnSize182hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:130px;text-align:left;' runat="server">
			<asp:LinkButton id="cRowSize182hl" CssClass="GrdHead" onClick="cRowSize182hl_Click" runat="server" /><asp:Image id="cRowSize182hi" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:130px;text-align:left;' runat="server">
			<asp:LinkButton id="cDdlKeyColNm182hl" CssClass="GrdHead" onClick="cDdlKeyColNm182hl_Click" runat="server" /><asp:Image id="cDdlKeyColNm182hi" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:130px;text-align:left;' runat="server">
			<asp:LinkButton id="cDdlRefColNm182hl" CssClass="GrdHead" onClick="cDdlRefColNm182hl_Click" runat="server" /><asp:Image id="cDdlRefColNm182hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:250px;text-align:left;' runat="server">
			<asp:LinkButton id="cRegClause182hl" CssClass="GrdHead" onClick="cRegClause182hl_Click" runat="server" /><asp:Image id="cRegClause182hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:350px;text-align:left;' runat="server">
			<asp:LinkButton id="cStoredProc182hl" CssClass="GrdHead" onClick="cStoredProc182hl_Click" runat="server" /><asp:Image id="cStoredProc182hi" runat="server" />
		</div></div>
    </td>
	...
	<tr id="cAdmDataCatGridFooter" class="GrdFoot" visible="false" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
		    <asp:Label id="cRptwizCatDtlId182fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:160px;text-align:left;' runat="server">
		    <asp:Label id="cColumnId182fl" class='GrdFoot' runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:160px;text-align:left;' runat="server">
		    <asp:Label id="cDisplayModeId182fl" class='GrdFoot' runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:160px;text-align:left;' runat="server">
		    <asp:Label id="cColumnSize182fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:130px;text-align:left;' runat="server">
		    <asp:Label id="cRowSize182fl" class='GrdFoot' runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:130px;text-align:left;' runat="server">
		    <asp:Label id="cDdlKeyColNm182fl" class='GrdFoot' runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:130px;text-align:left;' runat="server">
		    <asp:Label id="cDdlRefColNm182fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:250px;text-align:left;' runat="server">
		    <asp:Label id="cRegClause182fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:350px;text-align:left;' runat="server">
		    <asp:Label id="cStoredProc182fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr></table></LayoutTemplate>
	<ItemTemplate>
	<tr id="cAdmDataCatGridRow" class='<%# Container.DisplayIndex % 2 == 0 ? "GrdItm" : "GrdAlt" %>' runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(6) %>" onclick='GridEdit("RptwizCatDtlId182")' runat="server">
			<asp:Label id="cRptwizCatDtlId182l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"RptwizCatDtlId182").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:160px;text-align:left;' visible="<%# GridColumnVisible(7) %>" onclick='GridEdit("ColumnId182")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"ColumnId182").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cColumnId182l" text='<%# DataBinder.Eval(Container.DataItem,"ColumnId182Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:160px;text-align:left;' visible="<%# GridColumnVisible(8) %>" onclick='GridEdit("DisplayModeId182")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"DisplayModeId182").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cDisplayModeId182l" text='<%# DataBinder.Eval(Container.DataItem,"DisplayModeId182Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:160px;text-align:left;' visible="<%# GridColumnVisible(9) %>" onclick='GridEdit("ColumnSize182")' runat="server">
			<asp:Label id="cColumnSize182l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ColumnSize182").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:130px;text-align:left;' visible="<%# GridColumnVisible(10) %>" onclick='GridEdit("RowSize182")' runat="server">
			<asp:Label id="cRowSize182l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"RowSize182").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:130px;text-align:left;' visible="<%# GridColumnVisible(11) %>" onclick='GridEdit("DdlKeyColNm182")' runat="server">
			<asp:Label id="cDdlKeyColNm182l" Text='<%# DataBinder.Eval(Container.DataItem,"DdlKeyColNm182").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:130px;text-align:left;' visible="<%# GridColumnVisible(12) %>" onclick='GridEdit("DdlRefColNm182")' runat="server">
			<asp:Label id="cDdlRefColNm182l" Text='<%# DataBinder.Eval(Container.DataItem,"DdlRefColNm182").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:250px;text-align:left;' visible="<%# GridColumnVisible(13) %>" onclick='GridEdit("RegClause182")' runat="server">
			<asp:Label id="cRegClause182l" Text='<%# DataBinder.Eval(Container.DataItem,"RegClause182").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:350px;text-align:left;' visible="<%# GridColumnVisible(14) %>" onclick='GridEdit("StoredProc182")' runat="server">
			<asp:Label id="cStoredProc182l" Text='<%# DataBinder.Eval(Container.DataItem,"StoredProc182").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmDataCatGridEdit" style="display:none;" CausesValidation="true" CommandName="Edit" runat="server" />
       <asp:LinkButton ID="cAdmDataCatGridDelete" CssClass="GrdDel" tooltip="DELETE" CommandName="Delete" onclientclick='GridDelete()' runat="server" />
	</td>
	</tr>
	</ItemTemplate>
	<EditItemTemplate>
    ...
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(6) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cRptwizCatDtlId182ml" runat="server" /></div>
		    <asp:TextBox id="cRptwizCatDtlId182" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"RptwizCatDtlId182").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:160px;text-align:left;' visible="<%# GridColumnVisible(7) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cColumnId182ml" runat="server" /></div>
		    <rcasp:ComboBox autocomplete="off" id="cColumnId182" CssClass="GrdDdl" DataValueField="ColumnId182" DataTextField="ColumnId182Text" Mode="A" OnPostBack="cbPostBack" OnSearch="cbColumnId182" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:160px;text-align:left;' visible="<%# GridColumnVisible(8) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cDisplayModeId182ml" runat="server" /></div>
		    <asp:DropDownList id="cDisplayModeId182" CssClass="GrdDdl" DataValueField="DisplayModeId182" DataTextField="DisplayModeId182Text" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:160px;text-align:left;' visible="<%# GridColumnVisible(9) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cColumnSize182ml" runat="server" /></div>
		    <asp:TextBox id="cColumnSize182" CssClass="GrdTxt" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ColumnSize182").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:130px;text-align:left;' visible="<%# GridColumnVisible(10) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cRowSize182ml" runat="server" /></div>
		    <asp:TextBox id="cRowSize182" CssClass="GrdTxt" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"RowSize182").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:130px;text-align:left;' visible="<%# GridColumnVisible(11) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cDdlKeyColNm182ml" runat="server" /></div>
		    <asp:TextBox id="cDdlKeyColNm182" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"DdlKeyColNm182").ToString() %>' MaxLength="50" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:130px;text-align:left;' visible="<%# GridColumnVisible(12) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cDdlRefColNm182ml" runat="server" /></div>
		    <asp:TextBox id="cDdlRefColNm182" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"DdlRefColNm182").ToString() %>' MaxLength="50" runat="server" />
		</div></div>
    </td>
    <td>
	...
	<td>
       <asp:LinkButton ID="cAdmDataCatGridCancel" CssClass="GrdCan" tooltip="CANCEL" OnClientClick="GridCancel();" CausesValidation="true" CommandName="Cancel" runat="server" />
       <asp:LinkButton ID="cAdmDataCatGridUpdate" style="display:none;" CommandName="Update" runat="server" />
	</td>
	</tr>
	</EditItemTemplate>
	...
	<asp:DataPager ID="cAdmDataCatGridDataPager" runat="server" Visible="false" PagedControlID="cAdmDataCatGrid"></asp:DataPager>
</div></div></div>
</asp:Panel>
