<%@ Control Language="c#" Inherits="RO.Web.AdmMaintMsgModule" CodeFile="AdmMaintMsgModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmMaintMsg109List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmMaintMsg109List_SelectedIndexChanged" OnTextChanged="cAdmMaintMsg109List_TextChanged" OnDDFindClick="cAdmMaintMsg109List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="MaintMsgId233" DataTextField="MaintMsgId233Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cMaintMsgId233P1" class="r-td r-labelR" runat="server"><asp:Label id="cMaintMsgId233Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cMaintMsgId233P2" class="r-td r-content" runat="server"><asp:TextBox id="cMaintMsgId233" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cMaintMsgName233P1" class="r-td r-labelR" runat="server"><asp:Label id="cMaintMsgName233Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cMaintMsgName233P2" class="r-td r-content" runat="server"><asp:TextBox id="cMaintMsgName233" CssClass="inp-txt" MaxLength="200" runat="server" /><asp:RequiredFieldValidator id="cRFVMaintMsgName233" ControlToValidate="cMaintMsgName233" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cMaintMessage233P1" class="r-td r-labelR" runat="server"><asp:Label id="cMaintMessage233Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cMaintMessage233P2" class="r-td r-content" runat="server"><asp:TextBox TextMode="MultiLine" autocomplete="new-password" id="cMaintMessage233" CssClass="inp-txt" runat="server" /><asp:RegularExpressionValidator ControlToValidate="cMaintMessage233" display="none" ErrorMessage="MaintMessage <= 2000 characters please." ValidationExpression="^[\s\S]{0,2000}$" runat="server" /><asp:RequiredFieldValidator id="cRFVMaintMessage233" ControlToValidate="cMaintMessage233" display="none" runat="server" /><asp:Image id="cMaintMessage233E" ImageUrl="~/images/Expand.gif" CssClass="r-icon show-expand-button" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cShowOnLogin233P1" class="r-td r-labelR" runat="server"><asp:Label id="cShowOnLogin233Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cShowOnLogin233P2" class="r-td r-content" runat="server"><asp:CheckBox id="cShowOnLogin233" CssClass="inp-chk" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cLastEmailDt233P1" class="r-td r-labelR" runat="server"><asp:Label id="cLastEmailDt233Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cLastEmailDt233P2" class="r-td r-content" runat="server"><asp:TextBox id="cLastEmailDt233" CssClass="inp-txt" runat="server" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-7-8"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cEmailUsersP1" class="r-td r-labelR" runat="server"><asp:Label id="cEmailUsersLabel" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cEmailUsersP2" class="r-td r-content" runat="server"><asp:Button id="cEmailUsers" CssClass="small blue button" OnClick="cEmailUsers_Click" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
