<%@ Control Language="c#" Inherits="RO.Web.AdmTemplatePermModule" CodeFile="AdmTemplatePermModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmTemplatePerm1030List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmTemplatePerm1030List_SelectedIndexChanged" OnTextChanged="cAdmTemplatePerm1030List_TextChanged" OnDDFindClick="cAdmTemplatePerm1030List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="TemplateId79" DataTextField="TemplateId79Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-2"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cTemplateId79P1" class="r-td r-labelR" runat="server"><asp:Label id="cTemplateId79Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cTemplateId79P2" class="r-td r-content" runat="server"><asp:TextBox id="cTemplateId79" CssClass="inp-num" runat="server" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-3-5"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cTemplateName79P1" class="r-td r-labelR" runat="server"><asp:Label id="cTemplateName79Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cTemplateName79P2" class="r-td r-content" runat="server"><asp:TextBox id="cTemplateName79" CssClass="inp-txt" MaxLength="30" runat="server" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-6-7"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cTmplPrefix79P1" class="r-td r-labelR" runat="server"><asp:Label id="cTmplPrefix79Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cTmplPrefix79P2" class="r-td r-content" runat="server"><asp:TextBox id="cTmplPrefix79" CssClass="inp-txt" MaxLength="10" runat="server" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-8-9"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cTmplDefault79P1" class="r-td r-labelR" runat="server"><asp:Label id="cTmplDefault79Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cTmplDefault79P2" class="r-td r-content" runat="server"><asp:CheckBox id="cTmplDefault79" CssClass="inp-chk" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
...
<div class="ListView">
	<asp:ListView id="cAdmTemplatePermGrid" DataKeyNames="TemplatePrmId1331" OnItemCommand="cAdmTemplatePermGrid_OnItemCommand" OnSorting="cAdmTemplatePermGrid_OnSorting" OnPreRender="cAdmTemplatePermGrid_OnPreRender" OnPagePropertiesChanging="cAdmTemplatePermGrid_OnPagePropertiesChanging" OnItemEditing="cAdmTemplatePermGrid_OnItemEditing" OnItemCanceling="cAdmTemplatePermGrid_OnItemCanceling" OnItemDeleting="cAdmTemplatePermGrid_OnItemDeleting" OnItemDataBound="cAdmTemplatePermGrid_OnItemDataBound" OnLayoutCreated="cAdmTemplatePermGrid_OnLayoutCreated" OnItemUpdating="cAdmTemplatePermGrid_OnItemUpdating" runat="server">
	<LayoutTemplate>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr id="cAdmTemplatePermGridHeader" class="GrdHead" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
			<asp:LinkButton id="cTemplatePrmId1331hl" CssClass="GrdHead" onClick="cTemplatePrmId1331hl_Click" runat="server" /><asp:Image id="cTemplatePrmId1331hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
			<asp:LinkButton id="cGrantDeny1331hl" CssClass="GrdHead" onClick="cGrantDeny1331hl_Click" runat="server" /><asp:Image id="cGrantDeny1331hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
			<asp:LinkButton id="cPermKeyId1331hl" CssClass="GrdHead" onClick="cPermKeyId1331hl_Click" runat="server" /><asp:Image id="cPermKeyId1331hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
			<asp:LinkButton id="cPermId1331hl" CssClass="GrdHead" onClick="cPermId1331hl_Click" runat="server" /><asp:Image id="cPermId1331hi" runat="server" />
		</div></div>
    </td>
	...
	<tr id="cAdmTemplatePermGridFooter" class="GrdFoot" visible="false" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
		    <asp:Label id="cTemplatePrmId1331fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
		    <asp:Label id="cGrantDeny1331fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
		    <asp:Label id="cPermKeyId1331fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
		    <asp:Label id="cPermId1331fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr></table></LayoutTemplate>
	<ItemTemplate>
	<tr id="cAdmTemplatePermGridRow" class='<%# Container.DisplayIndex % 2 == 0 ? "GrdItm" : "GrdAlt" %>' runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(4) %>" onclick='GridEdit("TemplatePrmId1331")' runat="server">
			<asp:Label id="cTemplatePrmId1331l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"TemplatePrmId1331").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(5) %>" onclick='GridEdit("GrantDeny1331")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"GrantDeny1331").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' Visible="false" runat="server" />
			<asp:Label id="cGrantDeny1331l" text='<%# DataBinder.Eval(Container.DataItem,"GrantDeny1331Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(6) %>" onclick='GridEdit("PermKeyId1331")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"PermKeyId1331").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cPermKeyId1331l" text='<%# DataBinder.Eval(Container.DataItem,"PermKeyId1331Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(7) %>" onclick='GridEdit("PermId1331")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"PermId1331").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cPermId1331l" text='<%# DataBinder.Eval(Container.DataItem,"PermId1331Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmTemplatePermGridEdit" style="display:none;" CausesValidation="true" CommandName="Edit" runat="server" />
       <asp:LinkButton ID="cAdmTemplatePermGridDelete" CssClass="GrdDel" tooltip="DELETE" CommandName="Delete" onclientclick='GridDelete()' runat="server" />
	</td>
	</tr>
	</ItemTemplate>
	<EditItemTemplate>
    ...
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(4) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cTemplatePrmId1331ml" runat="server" /></div>
		    <asp:TextBox id="cTemplatePrmId1331" CssClass="GrdTxt" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"TemplatePrmId1331").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(5) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cGrantDeny1331ml" runat="server" /></div>
		    <asp:DropDownList id="cGrantDeny1331" CssClass="GrdDdl" DataValueField="GrantDeny1331" DataTextField="GrantDeny1331Text" runat="server" /><asp:RequiredFieldValidator id="cRFVGrantDeny1331" ControlToValidate="cGrantDeny1331" display="none" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(6) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cPermKeyId1331ml" runat="server" /></div>
		    <rcasp:ComboBox autocomplete="off" id="cPermKeyId1331" CssClass="GrdDdl" AutoPostBack="true" OnSelectedIndexChanged="cPermKeyId1331_SelectedIndexChanged" OnTextChanged="cPermKeyId1331_TextChanged" OnDDFindClick="cPermKeyId1331_DDFindClick" DataValueField="PermKeyId1331" DataTextField="PermKeyId1331Text" Mode="A" OnPostBack="cbPostBack" OnSearch="cbPermKeyId1331" runat="server" /><asp:RequiredFieldValidator id="cRFVPermKeyId1331" ControlToValidate="cPermKeyId1331" display="none" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(7) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cPermId1331ml" runat="server" /></div>
		    <rcasp:ComboBox autocomplete="off" id="cPermId1331" CssClass="GrdDdl" DataValueField="PermId1331" DataTextField="PermId1331Text" Mode="A" OnPostBack="cbPostBack" OnSearch="cbPermId1331" runat="server" /><asp:RequiredFieldValidator id="cRFVPermId1331" ControlToValidate="cPermId1331" display="none" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmTemplatePermGridCancel" CssClass="GrdCan" tooltip="CANCEL" OnClientClick="GridCancel();" CausesValidation="true" CommandName="Cancel" runat="server" />
       <asp:LinkButton ID="cAdmTemplatePermGridUpdate" style="display:none;" CommandName="Update" runat="server" />
	</td>
	</tr>
	</EditItemTemplate>
	...
	<asp:DataPager ID="cAdmTemplatePermGridDataPager" runat="server" Visible="false" PagedControlID="cAdmTemplatePermGrid"></asp:DataPager>
</div></div></div>
</asp:Panel>
