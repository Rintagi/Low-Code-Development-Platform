<%@ Control Language="c#" Inherits="RO.Web.AdmSredTimeModule" CodeFile="AdmSredTimeModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
...
<div class="ListView">
	<asp:ListView id="cAdmSredTimeGrid" DataKeyNames="SredTimeId272" OnItemCommand="cAdmSredTimeGrid_OnItemCommand" OnSorting="cAdmSredTimeGrid_OnSorting" OnPreRender="cAdmSredTimeGrid_OnPreRender" OnPagePropertiesChanging="cAdmSredTimeGrid_OnPagePropertiesChanging" OnItemEditing="cAdmSredTimeGrid_OnItemEditing" OnItemCanceling="cAdmSredTimeGrid_OnItemCanceling" OnItemDeleting="cAdmSredTimeGrid_OnItemDeleting" OnItemDataBound="cAdmSredTimeGrid_OnItemDataBound" OnLayoutCreated="cAdmSredTimeGrid_OnLayoutCreated" OnItemUpdating="cAdmSredTimeGrid_OnItemUpdating" runat="server">
	<LayoutTemplate>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr id="cAdmSredTimeGridHeader" class="GrdHead" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' runat="server">
			<asp:LinkButton id="cSredTimeId272hl" CssClass="GrdHead" onClick="cSredTimeId272hl_Click" runat="server" /><asp:Image id="cSredTimeId272hi" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' runat="server">
			<asp:LinkButton id="cMemberId272hl" CssClass="GrdHead" onClick="cMemberId272hl_Click" style="font-family:Georgia; color:#555555;" runat="server" /><asp:Image id="cMemberId272hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:180px;text-align:left;' runat="server">
			<asp:LinkButton id="cSredTimeDt272hl" CssClass="GrdHead" onClick="cSredTimeDt272hl_Click" runat="server" /><asp:Image id="cSredTimeDt272hi" runat="server" />
		</div><div class='GrdInner' style='max-width:80px;text-align:right;' runat="server">
			<asp:LinkButton id="cHourSpent272hl" CssClass="GrdHead" onClick="cHourSpent272hl_Click" runat="server" /><asp:Image id="cHourSpent272hi" runat="server" />
		</div><div class='GrdInner HideObjOnMobile' style='max-width:140px;text-align:left;' runat="server">
			<asp:LinkButton id="cEnteredBy272hl" CssClass="GrdHead" onClick="cEnteredBy272hl_Click" style="font-size:11px; color:#555555;" runat="server" /><asp:Image id="cEnteredBy272hi" runat="server" />
		</div><div class='GrdInner HideObjOnMobile' style='max-width:120px;text-align:left;' runat="server">
			<asp:LinkButton id="cEnteredOn272hl" CssClass="GrdHead" onClick="cEnteredOn272hl_Click" style="font-size:11px; color:#888888;" runat="server" /><asp:Image id="cEnteredOn272hi" runat="server" />
		</div><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:140px;text-align:left;' runat="server">
			<asp:LinkButton id="cModifiedBy272hl" CssClass="GrdHead" onClick="cModifiedBy272hl_Click" style="font-size:11px; color:#555555;" runat="server" /><asp:Image id="cModifiedBy272hi" runat="server" />
		</div><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:120px;text-align:left;' runat="server">
			<asp:LinkButton id="cModifiedOn272hl" CssClass="GrdHead" onClick="cModifiedOn272hl_Click" style="font-size:11px; color:#888888;" runat="server" /><asp:Image id="cModifiedOn272hi" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:780px;text-align:left;' runat="server">
			<asp:LinkButton id="cAccomplished272hl" CssClass="GrdHead" onClick="cAccomplished272hl_Click" style="font-family:Georgia; color:#555555;" runat="server" /><asp:Image id="cAccomplished272hi" runat="server" />
		</div></div>
    </td>
	...
	<tr id="cAdmSredTimeGridFooter" class="GrdFoot" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' runat="server">
		    <asp:Label id="cSredTimeId272fl" class='GrdFoot' runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' runat="server">
		    <asp:Label id="cMemberId272fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:180px;text-align:left;' runat="server">
		    <asp:Label id="cSredTimeDt272fl" class='GrdFoot' runat="server" />
		</div><div class='GrdInner' style='max-width:80px;text-align:right;' runat="server">
		    <asp:Label id="cHourSpent272fl" class='GrdFoot' runat="server" />
		</div><div class='GrdInner HideObjOnMobile' style='max-width:140px;text-align:left;' runat="server">
		    <asp:Label id="cEnteredBy272fl" class='GrdFoot' runat="server" />
		</div><div class='GrdInner HideObjOnMobile' style='max-width:120px;text-align:left;' runat="server">
		    <asp:Label id="cEnteredOn272fl" class='GrdFoot' runat="server" />
		</div><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:140px;text-align:left;' runat="server">
		    <asp:Label id="cModifiedBy272fl" class='GrdFoot' runat="server" />
		</div><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:120px;text-align:left;' runat="server">
		    <asp:Label id="cModifiedOn272fl" class='GrdFoot' runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:780px;text-align:left;' runat="server">
		    <asp:Label id="cAccomplished272fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr></table></LayoutTemplate>
	<ItemTemplate>
	<tr id="cAdmSredTimeGridRow" class='<%# Container.DisplayIndex % 2 == 0 ? "GrdItm" : "GrdAlt" %>' runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(0) %>" onclick='GridEdit("SredTimeId272")' runat="server">
			<asp:Label id="cSredTimeId272l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"SredTimeId272").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(1) %>" onclick='GridEdit("MemberId272")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"MemberId272").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cMemberId272l" text='<%# DataBinder.Eval(Container.DataItem,"MemberId272Text") %>' CssClass="GrdTxtLb" style="font-family:Georgia; color:#555555;" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:180px;text-align:left;' visible="<%# GridColumnVisible(2) %>" onclick='GridEdit("SredTimeDt272")' runat="server">
			<asp:Label id="cSredTimeDt272l" Text='<%# RO.Common3.Utils.fmLongDate(DataBinder.Eval(Container.DataItem,"SredTimeDt272").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div><div class='GrdInner' style='max-width:80px;text-align:right;' visible="<%# GridColumnVisible(3) %>" onclick='GridEdit("HourSpent272")' runat="server">
			<asp:Label id="cHourSpent272l" Text='<%# RO.Common3.Utils.fmMoney(DataBinder.Eval(Container.DataItem,"HourSpent272").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div><div class='GrdInner HideObjOnMobile' style='max-width:140px;text-align:left;' visible="<%# GridColumnVisible(4) %>" onclick='GridEdit("EnteredBy272")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"EnteredBy272").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cEnteredBy272l" text='<%# DataBinder.Eval(Container.DataItem,"EnteredBy272Text") %>' CssClass="GrdTxtLb" style="font-size:11px; color:#555555;" runat="server" />
		</div><div class='GrdInner HideObjOnMobile' style='max-width:120px;text-align:left;' visible="<%# GridColumnVisible(5) %>" onclick='GridEdit("EnteredOn272")' runat="server">
			<asp:Label id="cEnteredOn272l" Text='<%# RO.Common3.Utils.fmShortDateTimeUTC(DataBinder.Eval(Container.DataItem,"EnteredOn272").ToString(),base.LUser.Culture,CurrTimeZoneInfo()) %>' CssClass="GrdTxtLb" style="font-size:11px; color:#888888;" runat="server" />
		</div><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:140px;text-align:left;' visible="<%# GridColumnVisible(6) %>" onclick='GridEdit("ModifiedBy272")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"ModifiedBy272").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cModifiedBy272l" text='<%# DataBinder.Eval(Container.DataItem,"ModifiedBy272Text") %>' CssClass="GrdTxtLb" style="font-size:11px; color:#555555;" runat="server" />
		</div><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:120px;text-align:left;' visible="<%# GridColumnVisible(7) %>" onclick='GridEdit("ModifiedOn272")' runat="server">
			<asp:Label id="cModifiedOn272l" Text='<%# RO.Common3.Utils.fmShortDateTimeUTC(DataBinder.Eval(Container.DataItem,"ModifiedOn272").ToString(),base.LUser.Culture,CurrTimeZoneInfo()) %>' CssClass="GrdTxtLb" style="font-size:11px; color:#888888;" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:780px;text-align:left;' visible="<%# GridColumnVisible(8) %>" onclick='GridEdit("Accomplished272")' runat="server">
			<asp:Label id="cAccomplished272l" Text='<%# DataBinder.Eval(Container.DataItem,"Accomplished272").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" style="font-family:Georgia; color:#555555;" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmSredTimeGridEdit" style="display:none;" CausesValidation="true" CommandName="Edit" runat="server" />
       <asp:LinkButton ID="cAdmSredTimeGridDelete" CssClass="GrdDel" tooltip="DELETE" CommandName="Delete" onclientclick='GridDelete()' runat="server" />
	</td>
	</tr>
	</ItemTemplate>
	<EditItemTemplate>
    ...
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(0) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cSredTimeId272ml" runat="server" /></div>
		    <asp:TextBox id="cSredTimeId272" CssClass="GrdTxt" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"SredTimeId272").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(1) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cMemberId272ml" runat="server" /></div>
		    <rcasp:ComboBox autocomplete="off" id="cMemberId272" CssClass="GrdDdl" DataValueField="MemberId272" DataTextField="MemberId272Text" Mode="A" OnPostBack="cbPostBack" OnSearch="cbMemberId272" runat="server" /><asp:RequiredFieldValidator id="cRFVMemberId272" ControlToValidate="cMemberId272" display="none" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:180px;text-align:left;' visible="<%# GridColumnVisible(2) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cSredTimeDt272ml" runat="server" /></div>
		    <asp:TextBox id="cSredTimeDt272" CssClass="GrdTxt" Text='<%# RO.Common3.Utils.fmLongDate(DataBinder.Eval(Container.DataItem,"SredTimeDt272").ToString(),base.LUser.Culture) %>' runat="server" /><asp:RequiredFieldValidator id="cRFVSredTimeDt272" ControlToValidate="cSredTimeDt272" display="none" runat="server" />
		</div><div class='GrdInner' style='max-width:80px;text-align:right;' visible="<%# GridColumnVisible(3) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cHourSpent272ml" runat="server" /></div>
		    <asp:TextBox id="cHourSpent272" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmMoney(DataBinder.Eval(Container.DataItem,"HourSpent272").ToString(),base.LUser.Culture) %>' runat="server" /><asp:RequiredFieldValidator id="cRFVHourSpent272" ControlToValidate="cHourSpent272" display="none" runat="server" />
		</div><div class='GrdInner' style='max-width:140px;text-align:left;' visible="<%# GridColumnVisible(4) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cEnteredBy272ml" runat="server" /></div>
		    <asp:DropDownList id="cEnteredBy272" CssClass="GrdDdl" DataValueField="EnteredBy272" DataTextField="EnteredBy272Text" runat="server" />
		</div><div class='GrdInner' style='max-width:120px;text-align:left;' visible="<%# GridColumnVisible(5) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cEnteredOn272ml" runat="server" /></div>
		    <asp:TextBox id="cEnteredOn272" CssClass="GrdTxt" Text='<%# RO.Common3.Utils.fmShortDateTimeUTC(DataBinder.Eval(Container.DataItem,"EnteredOn272").ToString(),base.LUser.Culture,CurrTimeZoneInfo()) %>' runat="server" />
		</div><div class='GrdInner' style='max-width:140px;text-align:left;' visible="<%# GridColumnVisible(6) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cModifiedBy272ml" runat="server" /></div>
		    <asp:DropDownList id="cModifiedBy272" CssClass="GrdDdl" DataValueField="ModifiedBy272" DataTextField="ModifiedBy272Text" runat="server" />
		</div><div class='GrdInner' style='max-width:120px;text-align:left;' visible="<%# GridColumnVisible(7) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cModifiedOn272ml" runat="server" /></div>
		    <asp:TextBox id="cModifiedOn272" CssClass="GrdTxt" Text='<%# RO.Common3.Utils.fmShortDateTimeUTC(DataBinder.Eval(Container.DataItem,"ModifiedOn272").ToString(),base.LUser.Culture,CurrTimeZoneInfo()) %>' runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:780px;text-align:left;' visible="<%# GridColumnVisible(8) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cAccomplished272ml" runat="server" /></div>
		    <asp:TextBox id="cAccomplished272" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"Accomplished272").ToString() %>' MaxLength="1000" runat="server" /><asp:RequiredFieldValidator id="cRFVAccomplished272" ControlToValidate="cAccomplished272" display="none" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmSredTimeGridCancel" CssClass="GrdCan" tooltip="CANCEL" OnClientClick="GridCancel();" CausesValidation="true" CommandName="Cancel" runat="server" />
       <asp:LinkButton ID="cAdmSredTimeGridUpdate" style="display:none;" CommandName="Update" runat="server" />
	</td>
	</tr>
	</EditItemTemplate>
	...
	<asp:DataPager ID="cAdmSredTimeGridDataPager" runat="server" Visible="false" PagedControlID="cAdmSredTimeGrid"></asp:DataPager>
</div></div></div>
