	...
	public partial class AdmLabelVwModule : RO.Web.ModuleBase
	{
		...
		private void SetSystem(byte SystemId)
		{
			...
			try
			{
				...
				{
					(new GenScreensSystem()).CreateProgram(119, "Label View ( -- no react gen -- )", row["dbAppDatabase"].ToString(), base.CPrj, base.CSrc, base.CTar, LcAppConnString, LcAppPw);
		...
		private void getReport(string eExport)
		{
			try
			{
				...
				if (eExport == "TXT")
				{
					...
					bExpNow.Value = "Y"; Session["ExportFnm"] = "AdmLabelVw.xls"; Session["ExportStr"] = sb.Replace("\r\n","\n");
				}
				else if (eExport == "RTF")
				{
