<%@ Control Language="c#" Inherits="RO.Web.AdmStaticJsModule" CodeFile="AdmStaticJsModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmStaticJs116List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmStaticJs116List_SelectedIndexChanged" OnTextChanged="cAdmStaticJs116List_TextChanged" OnDDFindClick="cAdmStaticJs116List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="StaticJsId261" DataTextField="StaticJsId261Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-3"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cStaticJsId261P1" class="r-td r-labelR" runat="server"><asp:Label id="cStaticJsId261Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cStaticJsId261P2" class="r-td r-content" runat="server"><asp:TextBox id="cStaticJsId261" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cStaticJsNm261P1" class="r-td r-labelR" runat="server"><asp:Label id="cStaticJsNm261Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cStaticJsNm261P2" class="r-td r-content" runat="server"><asp:TextBox id="cStaticJsNm261" CssClass="inp-txt" MaxLength="200" runat="server" /><asp:RequiredFieldValidator id="cRFVStaticJsNm261" ControlToValidate="cStaticJsNm261" display="none" runat="server" /></div>
    	</div>
    </div></div></div>
