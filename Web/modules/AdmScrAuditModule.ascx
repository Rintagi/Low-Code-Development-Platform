<%@ Control Language="c#" Inherits="RO.Web.AdmScrAuditModule" CodeFile="AdmScrAuditModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
...
<div class="ListView">
	<asp:ListView id="cAdmScrAuditGrid" DataKeyNames="ScrAuditId1300" OnItemCommand="cAdmScrAuditGrid_OnItemCommand" OnSorting="cAdmScrAuditGrid_OnSorting" OnPreRender="cAdmScrAuditGrid_OnPreRender" OnPagePropertiesChanging="cAdmScrAuditGrid_OnPagePropertiesChanging" OnItemEditing="cAdmScrAuditGrid_OnItemEditing" OnItemCanceling="cAdmScrAuditGrid_OnItemCanceling" OnItemDeleting="cAdmScrAuditGrid_OnItemDeleting" OnItemDataBound="cAdmScrAuditGrid_OnItemDataBound" OnLayoutCreated="cAdmScrAuditGrid_OnLayoutCreated" OnItemUpdating="cAdmScrAuditGrid_OnItemUpdating" runat="server">
	<LayoutTemplate>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr id="cAdmScrAuditGridHeader" class="GrdHead" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' runat="server">
			<asp:LinkButton id="cScrAuditId1300hl" CssClass="GrdHead" onClick="cScrAuditId1300hl_Click" runat="server" /><asp:Image id="cScrAuditId1300hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:left;' runat="server">
			<asp:LinkButton id="cCudAction1300hl" CssClass="GrdHead" onClick="cCudAction1300hl_Click" runat="server" /><asp:Image id="cCudAction1300hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' runat="server">
			<asp:LinkButton id="cScreenId1300hl" CssClass="GrdHead" onClick="cScreenId1300hl_Click" runat="server" /><asp:Image id="cScreenId1300hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:60px;text-align:center;' runat="server">
			<asp:LinkButton id="cMasterTable1300hl" CssClass="GrdHead" onClick="cMasterTable1300hl_Click" runat="server" /><asp:Image id="cMasterTable1300hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:200px;text-align:left;' runat="server">
			<asp:LinkButton id="cTableId1300hl" CssClass="GrdHead" onClick="cTableId1300hl_Click" runat="server" /><asp:Image id="cTableId1300hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:60px;text-align:right;' runat="server">
			<asp:LinkButton id="cRowId1300hl" CssClass="GrdHead" onClick="cRowId1300hl_Click" runat="server" /><asp:Image id="cRowId1300hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
			<asp:LinkButton id="cRowDesc1300hl" CssClass="GrdHead" onClick="cRowDesc1300hl_Click" runat="server" /><asp:Image id="cRowDesc1300hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:120px;text-align:left;' runat="server">
			<asp:LinkButton id="cChangedBy1300hl" CssClass="GrdHead" onClick="cChangedBy1300hl_Click" runat="server" /><asp:Image id="cChangedBy1300hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:120px;text-align:left;' runat="server">
			<asp:LinkButton id="cChangedOn1300hl" CssClass="GrdHead" onClick="cChangedOn1300hl_Click" runat="server" /><asp:Image id="cChangedOn1300hi" runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr>
	<tr id="itemPlaceholder" runat="server"></tr>
	<tr id="cAdmScrAuditGridFooter" class="GrdFoot" visible="false" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' runat="server">
		    <asp:Label id="cScrAuditId1300fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:left;' runat="server">
		    <asp:Label id="cCudAction1300fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' runat="server">
		    <asp:Label id="cScreenId1300fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:60px;text-align:center;' runat="server">
		    <asp:Label id="cMasterTable1300fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:200px;text-align:left;' runat="server">
		    <asp:Label id="cTableId1300fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:60px;text-align:right;' runat="server">
		    <asp:Label id="cRowId1300fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
		    <asp:Label id="cRowDesc1300fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:120px;text-align:left;' runat="server">
		    <asp:Label id="cChangedBy1300fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:120px;text-align:left;' runat="server">
		    <asp:Label id="cChangedOn1300fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr></table></LayoutTemplate>
	<ItemTemplate>
	<tr id="cAdmScrAuditGridRow" class='<%# Container.DisplayIndex % 2 == 0 ? "GrdItm" : "GrdAlt" %>' runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' visible="<%# GridColumnVisible(0) %>" onclick='GridEdit("ScrAuditId1300")' runat="server">
			<asp:Label id="cScrAuditId1300l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ScrAuditId1300").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:left;' visible="<%# GridColumnVisible(1) %>" onclick='GridEdit("CudAction1300")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"CudAction1300").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' Visible="false" runat="server" />
			<asp:Label id="cCudAction1300l" text='<%# DataBinder.Eval(Container.DataItem,"CudAction1300Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' visible="<%# GridColumnVisible(2) %>" onclick='GridEdit("ScreenId1300")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"ScreenId1300").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cScreenId1300l" text='<%# DataBinder.Eval(Container.DataItem,"ScreenId1300Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:60px;text-align:center;' visible="<%# GridColumnVisible(3) %>" onclick='GridEdit("MasterTable1300")' runat="server">
			<asp:CheckBox id="cMasterTable1300l" Enabled='<%# AllowEdit(LcAuth,"MasterTable1300") && AllowRowEdit(GetAuthRow(),DataBinder.Eval(Container.DataItem,"ScrAuditId1300").ToString()) %>' checked='<%# base.GetBool(DataBinder.Eval(Container.DataItem,"MasterTable1300").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace())) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:200px;text-align:left;' visible="<%# GridColumnVisible(4) %>" onclick='GridEdit("TableId1300")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"TableId1300").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cTableId1300l" text='<%# DataBinder.Eval(Container.DataItem,"TableId1300Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:60px;text-align:right;' visible="<%# GridColumnVisible(5) %>" onclick='GridEdit("RowId1300")' runat="server">
			<asp:Label id="cRowId1300l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"RowId1300").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(6) %>" onclick='GridEdit("RowDesc1300")' runat="server">
			<asp:Label id="cRowDesc1300l" Text='<%# DataBinder.Eval(Container.DataItem,"RowDesc1300").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:120px;text-align:left;' visible="<%# GridColumnVisible(7) %>" onclick='GridEdit("ChangedBy1300")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"ChangedBy1300").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cChangedBy1300l" text='<%# DataBinder.Eval(Container.DataItem,"ChangedBy1300Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:120px;text-align:left;' visible="<%# GridColumnVisible(8) %>" onclick='GridEdit("ChangedOn1300")' runat="server">
			<asp:Label id="cChangedOn1300l" Text='<%# RO.Common3.Utils.fmShortDateTimeUTC(DataBinder.Eval(Container.DataItem,"ChangedOn1300").ToString(),base.LUser.Culture,CurrTimeZoneInfo()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmScrAuditGridEdit" style="display:none;" CausesValidation="true" CommandName="Edit" runat="server" />
       <asp:LinkButton ID="cAdmScrAuditGridDelete" CssClass="GrdDel" tooltip="DELETE" CommandName="Delete" onclientclick='GridDelete()' runat="server" />
	</td>
	</tr>
	</ItemTemplate>
	<EditItemTemplate>
    ...
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' visible="<%# GridColumnVisible(0) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cScrAuditId1300ml" runat="server" /></div>
		    <asp:TextBox id="cScrAuditId1300" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ScrAuditId1300").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:left;' visible="<%# GridColumnVisible(1) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cCudAction1300ml" runat="server" /></div>
		    <asp:DropDownList id="cCudAction1300" CssClass="GrdDdl" DataValueField="CudAction1300" DataTextField="CudAction1300Text" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' visible="<%# GridColumnVisible(2) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cScreenId1300ml" runat="server" /></div>
		    <rcasp:ComboBox autocomplete="off" id="cScreenId1300" CssClass="GrdDdl" DataValueField="ScreenId1300" DataTextField="ScreenId1300Text" Mode="A" OnPostBack="cbPostBack" OnSearch="cbScreenId1300" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:60px;text-align:center;' visible="<%# GridColumnVisible(3) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cMasterTable1300ml" runat="server" /></div>
		    <asp:CheckBox id="cMasterTable1300" CssClass="GrdBox" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' visible="<%# GridColumnVisible(4) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cTableId1300ml" runat="server" /></div>
		    <rcasp:ComboBox autocomplete="off" id="cTableId1300" CssClass="GrdDdl" DataValueField="TableId1300" DataTextField="TableId1300Text" Mode="A" OnPostBack="cbPostBack" OnSearch="cbTableId1300" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:60px;text-align:right;' visible="<%# GridColumnVisible(5) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cRowId1300ml" runat="server" /></div>
		    <asp:TextBox id="cRowId1300" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"RowId1300").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(6) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cRowDesc1300ml" runat="server" /></div>
		    <asp:TextBox id="cRowDesc1300" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"RowDesc1300").ToString() %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:120px;text-align:left;' visible="<%# GridColumnVisible(7) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cChangedBy1300ml" runat="server" /></div>
		    <rcasp:ComboBox autocomplete="off" id="cChangedBy1300" CssClass="GrdDdl" DataValueField="ChangedBy1300" DataTextField="ChangedBy1300Text" Mode="A" OnPostBack="cbPostBack" OnSearch="cbChangedBy1300" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:120px;text-align:left;' visible="<%# GridColumnVisible(8) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cChangedOn1300ml" runat="server" /></div>
		    <asp:TextBox id="cChangedOn1300" CssClass="GrdTxt" Text='<%# RO.Common3.Utils.fmShortDateTimeUTC(DataBinder.Eval(Container.DataItem,"ChangedOn1300").ToString(),base.LUser.Culture,CurrTimeZoneInfo()) %>' runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmScrAuditGridCancel" CssClass="GrdCan" tooltip="CANCEL" OnClientClick="GridCancel();" CausesValidation="true" CommandName="Cancel" runat="server" />
       <asp:LinkButton ID="cAdmScrAuditGridUpdate" style="display:none;" CommandName="Update" runat="server" />
	</td>
	</tr>
	</EditItemTemplate>
	...
	<asp:DataPager ID="cAdmScrAuditGridDataPager" runat="server" Visible="false" PagedControlID="cAdmScrAuditGrid"></asp:DataPager>
</div></div></div>
