...
<div class="r-tr">
    <div class="r-td rc-1-6">
        <div class="wizard-image">
            <div style="float:right;"><img src="./images/wizard/screen-dsk.jpg" class="wizard-image-dsk" style="max-width:200px" /></div>
            <div style="float:none;"><img src="./images/wizard/screen-mob.jpg" class="wizard-image-mob" style="max-width:500px" /></div>
    ...
    <div class="r-td rc-7-12">
        <div class="wizard-content">
		    ...
		    <tr>
			    <td><asp:Label cssclass="inp-lbl" runat="server" text="Client Tier:" /></td>
		    ...
		    <tr>
			    <td><asp:Label cssclass="inp-lbl" runat="server" text="Rule Tier:" /></td>
		    ...
		    <tr>
			    <td><asp:Label cssclass="inp-lbl" runat="server" text="Data Tier:" /></td>
		    ...
		    <tr>
			    <td><asp:Label cssclass="inp-lbl" runat="server" text="Database:" /></td>
			    ...
			    <td align="right"><asp:Label cssclass="inp-lbl" runat="server" text="All Screens:" /></td>
			    <td width="20px"><asp:CheckBox id="cAllScreen" cssclass="inp-chk" AutoPostBack="true" onCheckedChanged="cAllScreen_CheckedChanged" tooltip="Check here for all screens in the listbox below to be generated." Runat="server" /></td>
		    </tr>
		    <tr>
			    <td><asp:Label cssclass="inp-lbl" runat="server" text="Search:" /></td>
			    <td colspan="2"><asp:textbox id="cSearch" CssClass="inp-txt" runat="server" MaxLength="25" /></td>
			    <td><asp:ImageButton id="cSearchButton" ImageUrl="~/images/Search.gif" onClick="cSearchButton_Click" AlternateText="Click here to search for screens with specified text on the left." Runat="server" />
		    </tr>
		    <tr>
			    <td colspan="4">
    ...
    <div class="r-td rc-1-12">
        <div class="wizard-action">
		    <span style="text-align:right;">
			    ...
			    <asp:Button id="cGenButton" CssClass="small blue button" onClick="cGenButton_Click" runat="server" text="Create" tooltip="Click here to generate codes for selected screen(s)." />
		    </span>
        </div>
