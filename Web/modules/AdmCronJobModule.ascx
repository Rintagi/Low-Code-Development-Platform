<%@ Control Language="c#" Inherits="RO.Web.AdmCronJobModule" CodeFile="AdmCronJobModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmCronJob118List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmCronJob118List_SelectedIndexChanged" OnTextChanged="cAdmCronJob118List_TextChanged" OnDDFindClick="cAdmCronJob118List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="CronJobId264" DataTextField="CronJobId264Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-5"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cCronJobId264P1" class="r-td r-labelR" runat="server"><asp:Label id="cCronJobId264Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCronJobId264P2" class="r-td r-content" runat="server"><asp:TextBox id="cCronJobId264" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cCronJobName264P1" class="r-td r-labelR" runat="server"><asp:Label id="cCronJobName264Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCronJobName264P2" class="r-td r-content" runat="server"><asp:TextBox id="cCronJobName264" CssClass="inp-txt" MaxLength="200" runat="server" /><asp:RequiredFieldValidator id="cRFVCronJobName264" ControlToValidate="cCronJobName264" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cLastRun264P1" class="r-td r-labelR" runat="server"><asp:Label id="cLastRun264Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cLastRun264P2" class="r-td r-content" runat="server"><asp:TextBox id="cLastRun264" CssClass="inp-txt" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cNextRun264P1" class="r-td r-labelR" runat="server"><asp:Label id="cNextRun264Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cNextRun264P2" class="r-td r-content" runat="server"><asp:TextBox id="cNextRun264" CssClass="inp-txt" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cJobLink264P1" class="r-td r-labelR" runat="server"><asp:Label id="cJobLink264Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cJobLink264P2" class="r-td r-content" runat="server"><asp:TextBox id="cJobLink264" CssClass="inp-txt" MaxLength="200" runat="server" /><asp:RequiredFieldValidator id="cRFVJobLink264" ControlToValidate="cJobLink264" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    ...
    <div class="r-td rc-6-8"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cYear264P1" class="r-td r-labelR" runat="server"><asp:Label id="cYear264Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cYear264P2" class="r-td r-content" runat="server"><asp:TextBox id="cYear264" CssClass="inp-num" runat="server" /><asp:RangeValidator id="cRVYear264" ControlToValidate="cYear264" display="none" MaximumValue="9999" MinimumValue="2012" Type="Integer" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cMonth264P1" class="r-td r-labelR" runat="server"><asp:Label id="cMonth264Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cMonth264P2" class="r-td r-content" runat="server"><asp:TextBox id="cMonth264" CssClass="inp-num" runat="server" /><asp:RangeValidator id="cRVMonth264" ControlToValidate="cMonth264" display="none" MaximumValue="12" MinimumValue="1" Type="Integer" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cDay264P1" class="r-td r-labelR" runat="server"><asp:Label id="cDay264Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cDay264P2" class="r-td r-content" runat="server"><asp:TextBox id="cDay264" CssClass="inp-num" runat="server" /><asp:RangeValidator id="cRVDay264" ControlToValidate="cDay264" display="none" MaximumValue="31" MinimumValue="1" Type="Integer" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cHour264P1" class="r-td r-labelR" runat="server"><asp:Label id="cHour264Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cHour264P2" class="r-td r-content" runat="server"><asp:TextBox id="cHour264" CssClass="inp-num" runat="server" /><asp:RangeValidator id="cRVHour264" ControlToValidate="cHour264" display="none" MaximumValue="23" MinimumValue="0" Type="Integer" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cMinute264P1" class="r-td r-labelR" runat="server"><asp:Label id="cMinute264Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cMinute264P2" class="r-td r-content" runat="server"><asp:TextBox id="cMinute264" CssClass="inp-num" runat="server" /><asp:RangeValidator id="cRVMinute264" ControlToValidate="cMinute264" display="none" MaximumValue="59" MinimumValue="0" Type="Integer" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cDayOfWeek264P1" class="r-td r-labelR" runat="server"><asp:Label id="cDayOfWeek264Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cDayOfWeek264P2" class="r-td r-content" runat="server"><asp:TextBox id="cDayOfWeek264" CssClass="inp-num" runat="server" /><asp:RangeValidator id="cRVDayOfWeek264" ControlToValidate="cDayOfWeek264" display="none" MaximumValue="6" MinimumValue="0" Type="Integer" runat="server" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-9-12"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div class="r-td"></div>
    		<div id="cCronJobMsgP2" class="r-td r-content" style="color: #555; background:#abdbc3; font-size: 16px; padding:15px; line-height:1.5;" runat="server"><asp:Label id="cCronJobMsg" CssClass="inp-lab" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
