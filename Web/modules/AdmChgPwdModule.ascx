<%@ Control Language="c#" Inherits="RO.Web.AdmChgPwdModule" CodeFile="AdmChgPwdModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmChgPwd71List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmChgPwd71List_SelectedIndexChanged" OnTextChanged="cAdmChgPwd71List_TextChanged" OnDDFindClick="cAdmChgPwd71List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="UsrId1" DataTextField="UsrId1Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	...
    	<div class="r-tr">
    		...
    		<div id="cSendMailP2" class="r-td r-content" runat="server"><asp:CheckBox id="cSendMail" CssClass="inp-chk" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cForcePwdChgP1" class="r-td r-labelR" runat="server"><asp:Label id="cForcePwdChgLabel" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cForcePwdChgP2" class="r-td r-content" runat="server"><asp:CheckBox id="cForcePwdChg" CssClass="inp-chk" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
