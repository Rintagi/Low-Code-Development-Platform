		...
		private string SaveDb(object sender, System.EventArgs e)
		{
			...
			if (ValidPage() && (cAdmScreenTabGrid.EditIndex < 0 || UpdateGridRow(cAdmScreenTabGrid, new CommandEventArgs("Save", ""))))
			{
				...
				if (string.IsNullOrEmpty(cAdmScreenTab54List.SelectedValue))	// Add
				{
					if (ds != null)
					{
						pid = (new AdminSystem()).AddData(54,false,base.LUser,base.LImpr,base.LCurr,ds,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),base.CPrj,base.CSrc);
					}
					...
					bool bValid7 = false;
					if (ds != null && (new AdminSystem()).UpdData(54,false,base.LUser,base.LImpr,base.LCurr,ds,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),base.CPrj,base.CSrc)) {bValid7 = true;}
					if (bValid7)
					{
						cAdmScreenTab54List.ClearSearch(); Session.Remove(KEY_dtAdmScreenTab54List);
