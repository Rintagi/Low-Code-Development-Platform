<%@ Control Language="c#" Inherits="RO.Web.AdmDatTierModule" CodeFile="AdmDatTierModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmDatTier107List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmDatTier107List_SelectedIndexChanged" OnTextChanged="cAdmDatTier107List_TextChanged" OnDDFindClick="cAdmDatTier107List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="DataTierId195" DataTextField="DataTierId195Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cDataTierId195P1" class="r-td r-labelR" runat="server"><asp:Label id="cDataTierId195Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cDataTierId195P2" class="r-td r-content" runat="server"><asp:TextBox id="cDataTierId195" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cDataTierName195P1" class="r-td r-labelR" runat="server"><asp:Label id="cDataTierName195Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cDataTierName195P2" class="r-td r-content" runat="server"><asp:TextBox id="cDataTierName195" CssClass="inp-txt" MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVDataTierName195" ControlToValidate="cDataTierName195" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cEntityId195P1" class="r-td r-labelR" runat="server"><asp:Label id="cEntityId195Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cEntityId195P2" class="r-td r-content" runat="server"><asp:DropDownList id="cEntityId195" CssClass="inp-ddl" DataValueField="EntityId195" DataTextField="EntityId195Text" runat="server" /><asp:RequiredFieldValidator id="cRFVEntityId195" ControlToValidate="cEntityId195" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cDbProviderCd195P1" class="r-td r-labelR" runat="server"><asp:Label id="cDbProviderCd195Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cDbProviderCd195P2" class="r-td r-content" runat="server"><asp:DropDownList id="cDbProviderCd195" CssClass="inp-ddl" DataValueField="DbProviderCd195" DataTextField="DbProviderCd195Text" runat="server" /><asp:RequiredFieldValidator id="cRFVDbProviderCd195" ControlToValidate="cDbProviderCd195" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    	...
    	<div class="r-tr">
    		...
    		<div id="cDesServer195P2" class="r-td r-content" runat="server"><asp:TextBox id="cDesServer195" CssClass="inp-txt" MaxLength="20" runat="server" /><asp:RequiredFieldValidator id="cRFVDesServer195" ControlToValidate="cDesServer195" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cDesDatabase195P1" class="r-td r-labelR" runat="server"><asp:Label id="cDesDatabase195Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cDesDatabase195P2" class="r-td r-content" runat="server"><asp:TextBox id="cDesDatabase195" CssClass="inp-txt" MaxLength="20" runat="server" /><asp:RequiredFieldValidator id="cRFVDesDatabase195" ControlToValidate="cDesDatabase195" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cDesUserId195P1" class="r-td r-labelR" runat="server"><asp:Label id="cDesUserId195Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cDesUserId195P2" class="r-td r-content" runat="server"><asp:TextBox id="cDesUserId195" CssClass="inp-txt" MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVDesUserId195" ControlToValidate="cDesUserId195" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cDesPassword195P1" class="r-td r-labelR" runat="server"><asp:Label id="cDesPassword195Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cDesPassword195P2" class="r-td r-content" runat="server"><asp:TextBox id="cDesPassword195" CssClass="inp-txt" MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVDesPassword195" ControlToValidate="cDesPassword195" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cPortBinPath195P1" class="r-td r-labelR" runat="server"><asp:Label id="cPortBinPath195Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cPortBinPath195P2" class="r-td r-content" runat="server"><asp:TextBox id="cPortBinPath195" CssClass="inp-txt" MaxLength="100" runat="server" /><asp:RequiredFieldValidator id="cRFVPortBinPath195" ControlToValidate="cPortBinPath195" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cInstBinPath195P1" class="r-td r-labelR" runat="server"><asp:Label id="cInstBinPath195Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cInstBinPath195P2" class="r-td r-content" runat="server"><asp:TextBox id="cInstBinPath195" CssClass="inp-txt" MaxLength="100" runat="server" /><asp:RequiredFieldValidator id="cRFVInstBinPath195" ControlToValidate="cInstBinPath195" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cScriptPath195P1" class="r-td r-labelR" runat="server"><asp:Label id="cScriptPath195Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cScriptPath195P2" class="r-td r-content" runat="server"><asp:TextBox id="cScriptPath195" CssClass="inp-txt" MaxLength="100" runat="server" /><asp:RequiredFieldValidator id="cRFVScriptPath195" ControlToValidate="cScriptPath195" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cDbDataPath195P1" class="r-td r-labelR" runat="server"><asp:Label id="cDbDataPath195Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cDbDataPath195P2" class="r-td r-content" runat="server"><asp:TextBox id="cDbDataPath195" CssClass="inp-txt" MaxLength="100" runat="server" /><asp:RequiredFieldValidator id="cRFVDbDataPath195" ControlToValidate="cDbDataPath195" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cIsDevelopment195P1" class="r-td r-labelR" runat="server"><asp:Label id="cIsDevelopment195Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cIsDevelopment195P2" class="r-td r-content" runat="server"><asp:CheckBox id="cIsDevelopment195" CssClass="inp-chk" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cIsDefault195P1" class="r-td r-labelR" runat="server"><asp:Label id="cIsDefault195Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cIsDefault195P2" class="r-td r-content" runat="server"><asp:CheckBox id="cIsDefault195" CssClass="inp-chk" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
