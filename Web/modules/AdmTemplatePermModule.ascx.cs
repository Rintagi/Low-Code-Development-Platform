...
{
	public class AdmTemplatePerm1030 : DataSet
	{
		public AdmTemplatePerm1030()
		{
			this.Tables.Add(MakeColumns(new DataTable("AdmTemplatePerm")));
			this.Tables.Add(MakeDtlColumns(new DataTable("AdmTemplatePermDef")));
			this.Tables.Add(MakeDtlColumns(new DataTable("AdmTemplatePermAdd")));
			this.Tables.Add(MakeDtlColumns(new DataTable("AdmTemplatePermUpd")));
			this.Tables.Add(MakeDtlColumns(new DataTable("AdmTemplatePermDel")));
			this.DataSetName = "AdmTemplatePerm1030";
			this.Namespace = "http://Rintagi.com/DataSet/AdmTemplatePerm1030";
		}

		private DataTable MakeColumns(DataTable dt)
		{
			DataColumnCollection columns = dt.Columns;
			columns.Add("TemplateId79", typeof(string));
			columns.Add("TemplateName79", typeof(string));
			columns.Add("TmplPrefix79", typeof(string));
			columns.Add("TmplDefault79", typeof(string));
			return dt;
		}
		...
		private DataTable MakeDtlColumns(DataTable dt)
		{
			DataColumnCollection columns = dt.Columns;
			columns.Add("TemplateId79", typeof(string));
			columns.Add("TemplatePrmId1331", typeof(string));
			columns.Add("GrantDeny1331", typeof(string));
			columns.Add("PermKeyId1331", typeof(string));
			columns.Add("PermId1331", typeof(string));
			return dt;
		}
	}
}
...
namespace RO.Web
{
	public partial class AdmTemplatePermModule : RO.Web.ModuleBase
	{

		private const string KEY_lastAddedRow = "Cache:lastAddedRow3_1030";
		private const string KEY_lastSortOrd = "Cache:lastSortOrd3_1030";
		private const string KEY_lastSortImg = "Cache:lastSortImg3_1030";
		private const string KEY_lastSortCol = "Cache:lastSortCol3_1030";
		private const string KEY_lastSortExp = "Cache:lastSortExp3_1030";
		private const string KEY_lastSortUrl = "Cache:lastSortUrl3_1030";
		private const string KEY_lastSortTog = "Cache:lastSortTog3_1030";
		private const string KEY_lastImpPwdOvride = "Cache:lastImpPwdOvride3_1030";
		private const string KEY_cntImpPwdOvride = "Cache:cntImpPwdOvride3_1030";
		private const string KEY_currPageIndex = "Cache:currPageIndex3_1030";
		private const string KEY_bHiImpVisible = "Cache:bHiImpVisible3_1030";
		private const string KEY_bShImpVisible = "Cache:bShImpVisible3_1030";
		private const string KEY_dtAdmTemplatePermGrid = "Cache:dtAdmTemplatePermGrid";
		private const string KEY_scrImport = "Cache:scrImport3_1030";
		private const string KEY_dtScreenHlp = "Cache:dtScreenHlp3_1030";
		private const string KEY_dtClientRule = "Cache:dtClientRule3_1030";
		private const string KEY_dtAuthCol = "Cache:dtAuthCol3_1030";
		private const string KEY_dtAuthRow = "Cache:dtAuthRow3_1030";
		private const string KEY_dtLabel = "Cache:dtLabel3_1030";
		private const string KEY_dtCriHlp = "Cache:dtCriHlp3_1030";
		private const string KEY_dtScrCri = "Cache:dtScrCri3_1030";
		private const string KEY_dsScrCriVal = "Cache:dsScrCriVal3_1030";

		private const string KEY_dtGrantDeny1331 = "Cache:dtGrantDeny1331";
		private const string KEY_dtPermKeyId1331 = "Cache:dtPermKeyId1331";
		private const string KEY_dtPermId1331 = "Cache:dtPermId1331";

		private const string KEY_dtSystems = "Cache:dtSystems3_1030";
		private const string KEY_sysConnectionString = "Cache:sysConnectionString3_1030";
		private const string KEY_dtAdmTemplatePerm1030List = "Cache:dtAdmTemplatePerm1030List";
		private const string KEY_bNewVisible = "Cache:bNewVisible3_1030";
		private const string KEY_bNewSaveVisible = "Cache:bNewSaveVisible3_1030";
		private const string KEY_bCopyVisible = "Cache:bCopyVisible3_1030";
		private const string KEY_bCopySaveVisible = "Cache:bCopySaveVisible3_1030";
		private const string KEY_bDeleteVisible = "Cache:bDeleteVisible3_1030";
		private const string KEY_bUndoAllVisible = "Cache:bUndoAllVisible3_1030";
		private const string KEY_bUpdateVisible = "Cache:bUpdateVisible3_1030";

		private const string KEY_bClCriVisible = "Cache:bClCriVisible3_1030";
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				DataTable dtMenuAccess = (new MenuSystem()).GetMenu(base.LUser.CultureId, 3, base.LImpr, LcSysConnString, LcAppPw,1030, null, null);
				...
				Session.Remove(KEY_dtGrantDeny1331);
				Session.Remove(KEY_dtPermKeyId1331);
				Session.Remove(KEY_dtPermId1331);
				SetButtonHlp();
				GetSystems();
				SetColumnAuthority();
				GetGlobalFilter();
				...
				try
				{
					(new AdminSystem()).LogUsage(base.LUser.UsrId, string.Empty, dtHlp.Rows[0]["ScreenTitle"].ToString(), 1030, 0, 0, string.Empty, LcSysConnString, LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				// *** Criteria Trigger (before) Web Rule starts here *** //
				PopAdmTemplatePerm1030List(sender, e, true, null);
				if (cAuditButton.Attributes["OnClick"] == null || cAuditButton.Attributes["OnClick"].IndexOf("AdmScrAudit.aspx") < 0) { cAuditButton.Attributes["OnClick"] += "SearchLink('AdmScrAudit.aspx?cri0=1030&typ=N&sys=3','','',''); return false;"; }
			...
			{
				DataTable dt = (DataTable)Session[KEY_dtAdmTemplatePermGrid];
				if (dt != null)
				{
		...
		private void InitializeComponent()
		{
			...
			if (LcSysConnString == null)
			{
				...
				{
					DataTable dt;
					dt = (new AdminSystem()).GetAuthRow(1030,base.LImpr.RowAuthoritys,LcSysConnString,LcAppPw);
					...
					{
						cAdmTemplatePermGrid.PreRender += new EventHandler(cAdmTemplatePermGrid_OnPreRender);
					}
				}
		...
		private void SetSystem(byte SystemId)
		{
			...
			try
			{
				...
				if ((Config.DeployType == "DEV" || row["dbAppDatabase"].ToString() == base.CPrj.EntityCode + "View") && !(base.CPrj.EntityCode != "RO" && row["SysProgram"].ToString() == "Y") && (new AdminSystem()).IsRegenNeeded(string.Empty,1030,0,0,LcSysConnString,LcAppPw))
				{
					(new GenScreensSystem()).CreateProgram(1030, "Template Permission", row["dbAppDatabase"].ToString(), base.CPrj, base.CSrc, base.CTar, LcAppConnString, LcAppPw);
		...
		private void SetButtonHlp()
		{
			...
			{
				DataTable dt;
				dt = (new AdminSystem()).GetButtonHlp(1030,0,0,base.LUser.CultureId,LcSysConnString,LcAppPw);
		...
		private DataTable GetClientRule()
		{
			...
			if (dtRul == null)
			{
				...
				try
				{
					dtRul = (new AdminSystem()).GetClientRule(1030,0,base.LUser.CultureId,LcSysConnString,LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		...
		private void SetClientRule(ListViewDataItem ee, bool isEditItem)
		{
			...
			if (dvRul.Count > 0)
			{
				...
				{
					if (ee == null || drv["ScriptEvent"].ToString().Substring(0,2).ToLower() != "on" || (cAdmTemplatePermGrid.EditIndex > -1 && GetDataItemIndex(cAdmTemplatePermGrid.EditIndex) == ee.DataItemIndex))
					{
		...
		private DataTable GetScreenCriHlp()
		{
			...
			if (dtCriHlp == null)
			{
				...
				try
				{
					dtCriHlp = (new AdminSystem()).GetScreenCriHlp(1030,base.LUser.CultureId,LcSysConnString,LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		...
		private DataTable GetScreenHlp()
		{
			...
			if (dtHlp == null)
			{
				...
				try
				{
					dtHlp = (new AdminSystem()).GetScreenHlp(1030,base.LUser.CultureId,LcSysConnString,LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		...
		private void GetGlobalFilter()
		{
			...
			{
				DataTable dt;
				dt = (new AdminSystem()).GetGlobalFilter(base.LUser.UsrId,1030,base.LUser.CultureId,LcSysConnString,LcAppPw);
				if (dt != null && dt.Rows.Count > 0)
				{
		...
		private void GetScreenFilter()
		{
			try
			{
				DataTable dt = (new AdminSystem()).GetScreenFilter(1030,base.LUser.CultureId,LcSysConnString,LcAppPw);
				if (dt != null)
				{
		...
		private DataTable GetLabel()
		{
			...
			if (dt == null)
			{
				try
				{
					dt = (new AdminSystem()).GetScreenLabel(1030,base.LUser.CultureId,base.LImpr,base.LCurr,LcSysConnString,LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		...
		private DataTable GetAuthCol()
		{
			...
			if (dt == null)
			{
				try
				{
					dt = (new AdminSystem()).GetAuthCol(1030,base.LImpr,base.LCurr,LcSysConnString,LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		...
		private void getReport(string eExport)
		{
			try
			{
				...
				try
				{
					try {dv = new DataView((new AdminSystem()).GetExp(1030,"GetExpAdmTemplatePerm1030","Y",(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),filterId,GetScrCriteria(),base.LImpr,base.LCurr,UpdCriteria(false)));}
					catch {dv = new DataView((new AdminSystem()).GetExp(1030,"GetExpAdmTemplatePerm1030","N",(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),filterId,GetScrCriteria(),base.LImpr,base.LCurr,UpdCriteria(false)));}
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				if (eExport == "TXT")
				{
					DataTable dtAu;
					dtAu = (new AdminSystem()).GetAuthExp(1030,base.LUser.CultureId,base.LImpr,base.LCurr,LcSysConnString,LcAppPw);
					if (dtAu != null)
					{
					...
					{
						if (dtAu.Rows[0]["ColExport"].ToString() == "Y") {sb.Append(RO.Common3.Utils.fmNumeric("0",drv["TemplateId79"].ToString(),base.LUser.Culture) + (char)9);}
						if (dtAu.Rows[1]["ColExport"].ToString() == "Y") {sb.Append("\"" + drv["TemplateName79"].ToString().Replace("\"","\"\"") + "\"" + (char)9);}
						if (dtAu.Rows[2]["ColExport"].ToString() == "Y") {sb.Append("\"" + drv["TmplPrefix79"].ToString().Replace("\"","\"\"") + "\"" + (char)9);}
						if (dtAu.Rows[3]["ColExport"].ToString() == "Y") {sb.Append("\"" + drv["TmplDefault79"].ToString().Replace("\"","\"\"") + "\"" + (char)9);}
						if (dtAu.Rows[4]["ColExport"].ToString() == "Y") {sb.Append(RO.Common3.Utils.fmNumeric("0",drv["TemplatePrmId1331"].ToString(),base.LUser.Culture) + (char)9);}
						if (dtAu.Rows[5]["ColExport"].ToString() == "Y") {sb.Append("\"" + drv["GrantDeny1331"].ToString().Replace("\"","\"\"") + "\"" + (char)9 + "\"" + drv["GrantDeny1331Text"].ToString().Replace("\"","\"\"") + "\"" + (char)9);}
						if (dtAu.Rows[6]["ColExport"].ToString() == "Y") {sb.Append(drv["PermKeyId1331"].ToString() + (char)9 + drv["PermKeyId1331Text"].ToString() + (char)9);}
						if (dtAu.Rows[7]["ColExport"].ToString() == "Y") {sb.Append(drv["PermId1331"].ToString() + (char)9 + drv["PermId1331Text"].ToString() + (char)9);}
						sb.Append(Environment.NewLine);
					}
					bExpNow.Value = "Y"; Session["ExportFnm"] = "AdmTemplatePerm.csv"; Session["ExportStr"] = (Config.ExportExcelCSV ? "sep=\t\n": "") + sb.Replace("\r\n","\n");
				}
				else if (eExport == "RTF")
				{
...
\par }}");
					...
					bExpNow.Value = "Y"; Session["ExportFnm"] = "AdmTemplatePerm.rtf"; Session["ExportStr"] = sb;
				}
			}
			catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
		}
		...
		private string GetRtfGrid(DataView dv)
		{
			...
			try
			{
				...
				foreach (DataRowView drv in dv)
				{
					...
					sb.Append("\r\n");
					sb.Append(@"{");
					if (dtAu.Rows[0]["ColExport"].ToString() == "Y") {sb.Append(RO.Common3.Utils.fmNumeric("0",drv["TemplateId79"].ToString(),base.LUser.Culture) + @"\cell ");}
					if (dtAu.Rows[1]["ColExport"].ToString() == "Y") {sb.Append(drv["TemplateName79"].ToString().Replace("\r\n",@"\par ") + @"\cell ");}
					if (dtAu.Rows[2]["ColExport"].ToString() == "Y") {sb.Append(drv["TmplPrefix79"].ToString().Replace("\r\n",@"\par ") + @"\cell ");}
					if (dtAu.Rows[3]["ColExport"].ToString() == "Y") {sb.Append(drv["TmplDefault79"].ToString().Replace("\r\n",@"\par ") + @"\cell ");}
					if (dtAu.Rows[4]["ColExport"].ToString() == "Y") {sb.Append(RO.Common3.Utils.fmNumeric("0",drv["TemplatePrmId1331"].ToString(),base.LUser.Culture) + @"\cell ");}
					if (dtAu.Rows[5]["ColExport"].ToString() == "Y") {sb.Append(drv["GrantDeny1331Text"].ToString().Replace("\r\n",@"\par ") + @"\cell ");}
					if (dtAu.Rows[6]["ColExport"].ToString() == "Y") {sb.Append(drv["PermKeyId1331Text"].ToString() + @"\cell ");}
					if (dtAu.Rows[7]["ColExport"].ToString() == "Y") {sb.Append(drv["PermId1331Text"].ToString() + @"\cell ");}
					sb.Append(@"}");
					sb.Append("\r\n");
					sb.Append(@"\pard \ql \li0\ri0\widctlpar\intbl\aspalpha\aspnum\adjustright\rin0\lin0 {");
					sb.Append(@"\insrsid2981395 \trowd \irow0\irowband0\lastrow \ts15\trgaph108\trleft-108\trbrdrt\brdrs\brdrw10 \trbrdrl\brdrs\brdrw10 \trbrdrb\brdrs\brdrw10 \trbrdrr\brdrs\brdrw10 \trbrdrh\brdrs\brdrw10 \trbrdrv\brdrs\brdrw10 ");
		...
		private void GetPageInfo()
		{
			...
			{
				DataTable dt;
				dt = (new AdminSystem()).GetLastPageInfo(1030, base.LUser.UsrId, LcSysConnString, LcAppPw);
		...
		private void GetCriteria(DataView dvCri)
		{
			...
			{
				DataTable dt;
				dt = (new AdminSystem()).GetLastCriteria(int.Parse(dvCri.Count.ToString()) + 1, 1030, 0, base.LUser.UsrId, LcSysConnString, LcAppPw);
		...
		protected void cCriButton_Click(object sender, System.EventArgs e)
		{
			// *** Criteria Trigger (before) Web Rule starts here *** //
			DataTable dt = (DataTable)Session[KEY_dtAdmTemplatePermGrid];
			if (cAdmTemplatePermGrid.EditIndex < 0 || (dt != null && UpdateGridRow(sender, new CommandEventArgs("Save", ""))))
			{
			if (IsPostBack && cCriteria.Visible) ReBindCriteria(GetScrCriteria());
			UpdCriteria(true);
			cAdmTemplatePerm1030List.ClearSearch(); Session.Remove(KEY_dtAdmTemplatePerm1030List);
			PopAdmTemplatePerm1030List(sender, e, false, null);
			}
		}
			...
			try
			{
				foreach (DataRowView drv in dvCri)
				{
					...
					if (drv["DisplayName"].ToString() == "ComboBox")
					{
						...
						(new AdminSystem()).MkGetScreenIn("1030", drv["ScreenCriId"].ToString(), "GetDdl" + drv["ColumnName"].ToString() + LCurr.SystemId.ToString() + "C" + drv["ScreenCriId"].ToString(), LcAppDb, LcDesDb, drv["MultiDesignDb"].ToString(), LcSysConnString, LcAppPw);
						DataView dv = new DataView((new AdminSystem()).GetScreenIn("1030", "GetDdl" + drv["ColumnName"].ToString() + LCurr.SystemId.ToString() + "C" + drv["ScreenCriId"].ToString(), (new AdminSystem()).CountScrCri(drv["ScreenCriId"].ToString(), drv["MultiDesignDb"].ToString(), drv["MultiDesignDb"].ToString() == "N" ? LcSysConnString : (string)Session[KEY_sysConnectionString], base.AppPwd(LCurr.DbId)), drv["RequiredValid"].ToString(), 0, string.Empty, drv["DisplayMode"].ToString() != "AutoListBox", val, base.LImpr, base.LCurr, drv["MultiDesignDb"].ToString() == "N" ? LcAppConnString : (string)Session[KEY_sysConnectionString], base.AppPwd(LCurr.DbId)));
		...
		private DataView GetScrCriteria()
		{
		    ...
		    if (dtScrCri == null)
		    {
				try
				{
					dtScrCri = (new AdminSystem()).GetScrCriteria("1030", LcSysConnString, LcAppPw);
				}
		...
		private void MakeScrGrpInp(DataRowView drv)
		{
		    ...
		    else if (drv["DisplayName"].ToString() == "ListBox")
		    {
		        ...
		        if (drv["DisplayMode"].ToString() == "AutoListBox")
		        {
		            ...
		            context["refCol"] = wcFtr != null ? drv["DdlFtrColumnName"].ToString() : null;
		            context["refColDataType"] = wcFtr != null ? drv["DdlFtrDataType"].ToString() : null;
		            Session["AdmTemplatePerm1030" + cListBox.ID] = context;
		            cListBox.Attributes["ac_context"] = "AdmTemplatePerm1030" + cListBox.ID;
		...
		private DataSet UpdCriteria(bool bUpdate)
		{
			...
			foreach (DataRowView drv in dvCri)
			{
			    if (drv["DisplayName"].ToString() == "ListBox")
			    {
					...
					if (cListBox != null)
					{
						...
						int TotalChoiceCnt = new DataView((new AdminSystem()).GetScreenIn("1030", "GetDdl" + drv["ColumnName"].ToString() + LCurr.SystemId.ToString() + "C" + drv["ScreenCriId"].ToString(), CriCnt, drv["RequiredValid"].ToString(), 0, string.Empty, true, string.Empty, base.LImpr, base.LCurr, drv["MultiDesignDb"].ToString() == "N" ? LcAppConnString : (string)Session[KEY_sysConnectionString], base.AppPwd(LCurr.DbId))).Count;
						string selectedValues = string.Join(",", cListBox.Items.Cast<ListItem>().Where(x => x.Selected).Select(x => "'" + x.Value + "'").ToArray());
			...
			if (bUpdate) 
			{
				try
				{
					(new AdminSystem()).UpdScrCriteria("1030", "AdmTemplatePerm1030", dvCri, base.LUser.UsrId, cCriteria.Visible, ds, LcAppConnString, LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
			}
		...
		private void SetGrantDeny1331(DropDownList ddl, string keyId)
		{
			DataTable dt = (DataTable)Session[KEY_dtGrantDeny1331];
			...
			if (ddl != null)
			{
				...
				if (dv == null)
				{
					...
					try
					{
						dv = new DataView((new AdminSystem()).GetDdl(1030,"GetDdlGrantDeny3S4448",true,bAll,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
					}
					catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				}
				if (dv != null)
				{
					if (dv.Table.Columns.Contains("TemplateId"))
					{
						ss = "(TemplateId is null";
						if (string.IsNullOrEmpty(cAdmTemplatePerm1030List.SelectedValue)) {ss = ss + ")";} else {ss = ss + " OR TemplateId = " + cAdmTemplatePerm1030List.SelectedValue + ")";}
					}
					if (!string.IsNullOrEmpty(keyId) && !ddl.Enabled) { ss = ss + (string.IsNullOrEmpty(ss) ? string.Empty : " AND ") + "GrantDeny1331 is not NULL"; }
					dv.RowFilter = ss;
					...
					if (dv.Count <= 1 && keyId != string.Empty)	// In case invalid value casued by copy action.
					{
						try
						{
							dv = new DataView((new AdminSystem()).GetDdl(1030,"GetDdlGrantDeny3S4448",true,true,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
						}
						catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
						dv.RowFilter = ss; ddl.DataSource = dv; ddl.DataBind();
						li = ddl.Items.FindByValue(keyId); if (li != null) {li.Selected = true;}
					}
					Session[KEY_dtGrantDeny1331] = dv.Table;
				}
			}
		}

		protected void cbPermKeyId1331(object sender, System.EventArgs e)
		{
			SetPermKeyId1331((RoboCoder.WebControls.ComboBox)sender,string.Empty,cAdmTemplatePermGrid.EditItem);
		}

		private void SetPermKeyId1331(RoboCoder.WebControls.ComboBox ddl, string keyId, ListViewItem li)
		{
			System.Collections.Generic.Dictionary<string, string> context = new System.Collections.Generic.Dictionary<string, string>();
			context["method"] = "GetDdlPermKeyId3S4449";
			context["addnew"] = "Y";
			context["mKey"] = "PermKeyId1331";
			context["mVal"] = "PermKeyId1331Text";
			context["mTip"] = "PermKeyId1331Text";
			context["mImg"] = "PermKeyId1331Text";
			context["ssd"] = Request.QueryString["ssd"];
			context["scr"] = "1030";
			context["csy"] = "3";
			context["filter"] = Utils.IsInt(cFilterId.SelectedValue)? cFilterId.SelectedValue : "0";
			...
			if (ddl != null)
			{
				...
				try
				{
					dv = new DataView((new AdminSystem()).GetDdl(1030,"GetDdlPermKeyId3S4449",true,false,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				if (dv != null)
				{
					if (dv.Table.Columns.Contains("TemplateId"))
					{
						context["pMKeyColID"] = cAdmTemplatePerm1030List.ClientID;
						context["pMKeyCol"] = "TemplateId";
						string ss = "(TemplateId is null";
						if (string.IsNullOrEmpty(cAdmTemplatePerm1030List.SelectedValue)) {ss = ss + ")";} else {ss = ss + " OR TemplateId = " + cAdmTemplatePerm1030List.SelectedValue + ")";}
						dv.RowFilter = ss;
					}
					ddl.DataSource = dv; Session[KEY_dtPermKeyId1331] = dv.Table;
				    try { ddl.SelectByValue(keyId,string.Empty,true); } catch { try { ddl.SelectedIndex = 0; } catch { } }
				}
			}
		}

		protected void cbPermId1331(object sender, System.EventArgs e)
		{
			SetPermId1331((RoboCoder.WebControls.ComboBox)sender,string.Empty,((RoboCoder.WebControls.ComboBox)cAdmTemplatePermGrid.EditItem.FindControl("cPermKeyId1331")).SelectedValue,cAdmTemplatePermGrid.EditItem);
		}

		private void SetPermId1331(RoboCoder.WebControls.ComboBox ddl, string keyId, string filtr, ListViewItem li)
		{
			System.Collections.Generic.Dictionary<string, string> context = new System.Collections.Generic.Dictionary<string, string>();
			context["method"] = "GetDdlPermId3S4450";
			context["addnew"] = "Y";
			context["mKey"] = "PermId1331";
			context["mVal"] = "PermId1331Text";
			context["mTip"] = "PermId1331Text";
			context["mImg"] = "PermId1331Text";
			context["ssd"] = Request.QueryString["ssd"];
			context["scr"] = "1030";
			context["csy"] = "3";
			context["filter"] = Utils.IsInt(cFilterId.SelectedValue)? cFilterId.SelectedValue : "0";
			context["isSys"] = "N";
			context["conn"] = KEY_sysConnectionString;
			context["refColCID"] = li != null ? li.FindControl("cPermKeyId1331").ClientID : string.Empty;
			...
			if (ddl != null)
			{
				...
				try
				{
					dv = new DataView((new AdminSystem()).GetDdl(1030,"GetDdlPermId3S4450",true,false,0,keyId,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr));
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				if (dv != null)
				{
					...
					ddl.DataSource = dv; Session[KEY_dtPermId1331] = dv.Table;
		...
		private DataView GetAdmTemplatePerm1030List()
		{
			DataTable dt = (DataTable)Session[KEY_dtAdmTemplatePerm1030List];
			if (dt == null)
			{
				CheckAuthentication(false);
				int filterId = 0;
				...
				try
				{
					try {dt = (new AdminSystem()).GetLis(1030,"GetLisAdmTemplatePerm1030",true,"Y",0,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),filterId,key,string.Empty,GetScrCriteria(),base.LImpr,base.LCurr,UpdCriteria(false));}
					catch {dt = (new AdminSystem()).GetLis(1030,"GetLisAdmTemplatePerm1030",true,"N",0,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),filterId,key,string.Empty,GetScrCriteria(),base.LImpr,base.LCurr,UpdCriteria(false));}
				}
		...
		private void PopAdmTemplatePerm1030List(object sender, System.EventArgs e, bool bPageLoad, object ID)
		{
			DataView dv = GetAdmTemplatePerm1030List();
			System.Collections.Generic.Dictionary<string, string> context = new System.Collections.Generic.Dictionary<string, string>();
			context["method"] = "GetLisAdmTemplatePerm1030";
			context["mKey"] = "TemplateId79";
			context["mVal"] = "TemplateId79Text";
			context["mTip"] = "TemplateId79Text";
			context["mImg"] = "TemplateId79Text";
			context["ssd"] = Request.QueryString["ssd"];
			context["scr"] = "1030";
			context["csy"] = "3";
			...
			context["isSys"] = "N";
			context["conn"] = KEY_sysConnectionString;
			cAdmTemplatePerm1030List.AutoCompleteUrl = "AutoComplete.aspx/LisSuggests";
			cAdmTemplatePerm1030List.DataContext = context;
			if (dv.Table == null) return;
			cAdmTemplatePerm1030List.DataSource = dv;
			cAdmTemplatePerm1030List.Visible = true;
			if (cAdmTemplatePerm1030List.Items.Count <= 0) {cAdmTemplatePerm1030List.Visible = false; cAdmTemplatePerm1030List_SelectedIndexChanged(sender,e);}
			else
			{
				if (bPageLoad && !string.IsNullOrEmpty(Request.QueryString["key"]) && bUseCri.Value == string.Empty)
				{
					try {cAdmTemplatePerm1030List.SelectByValue(Request.QueryString["key"],string.Empty,true);} catch {cAdmTemplatePerm1030List.Items[0].Selected = true; cAdmTemplatePerm1030List_SelectedIndexChanged(sender, e);}
				    cScreenSearch.Visible = false; cSystem.Visible = false; cEditButton.Visible = true; cSaveCloseButton.Visible = cSaveButton.Visible;
				}
				else
				{
					if (ID != null) {if (!cAdmTemplatePerm1030List.SelectByValue(ID,string.Empty,true)) {ID = null;}}
					if (ID == null)
					{
						cAdmTemplatePerm1030List_SelectedIndexChanged(sender, e);
					}
				}
			}
		}
		...
		private void SetColumnAuthority()
		{
			...
			{
				base.SetFoldBehavior(cTemplateId79, dtAuth.Rows[0], cTemplateId79P1, cTemplateId79Label, cTemplateId79P2, null, dtLabel.Rows[0], null, null, null);
				base.SetFoldBehavior(cTemplateName79, dtAuth.Rows[1], cTemplateName79P1, cTemplateName79Label, cTemplateName79P2, null, dtLabel.Rows[1], null, null, null);
				base.SetFoldBehavior(cTmplPrefix79, dtAuth.Rows[2], cTmplPrefix79P1, cTmplPrefix79Label, cTmplPrefix79P2, null, dtLabel.Rows[2], null, null, null);
				base.SetFoldBehavior(cTmplDefault79, dtAuth.Rows[3], cTmplDefault79P1, cTmplDefault79Label, cTmplDefault79P2, null, dtLabel.Rows[3], null, null, null);
			}
			if ((cTemplateName79.Attributes["OnChange"] == null || cTemplateName79.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cTemplateName79.Visible && !cTemplateName79.ReadOnly) {cTemplateName79.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cTmplPrefix79.Attributes["OnChange"] == null || cTmplPrefix79.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cTmplPrefix79.Visible && !cTmplPrefix79.ReadOnly) {cTmplPrefix79.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
			if ((cTmplDefault79.Attributes["OnClick"] == null || cTmplDefault79.Attributes["OnClick"].IndexOf("ChkPgDirty") < 0) && cTmplDefault79.Visible && cTmplDefault79.Enabled) {cTmplDefault79.Attributes["OnClick"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty(); this.focus();";}
		}
		...
		private void ClearMaster(object sender, System.EventArgs e)
		{
			...
			if (dt.Rows[1]["ColVisible"].ToString() == "Y" && dt.Rows[1]["ColReadOnly"].ToString() != "Y") {cTemplateName79.Text = string.Empty;}
			if (dt.Rows[2]["ColVisible"].ToString() == "Y" && dt.Rows[2]["ColReadOnly"].ToString() != "Y") {cTmplPrefix79.Text = string.Empty;}
			if (dt.Rows[3]["ColVisible"].ToString() == "Y" && dt.Rows[3]["ColReadOnly"].ToString() != "Y") {cTmplDefault79.Checked = base.GetBool("N");}
			// *** Default Value (Folder) Web Rule starts here *** //
		}

		private void InitMaster(object sender, System.EventArgs e)
		{
			cTemplateId79.Text = string.Empty;
			cTemplateName79.Text = string.Empty;
			cTmplPrefix79.Text = string.Empty;
			cTmplDefault79.Checked = base.GetBool("N");
			// *** Default Value (Folder) Web Rule starts here *** //
		}
		protected void cAdmTemplatePerm1030List_TextChanged(object sender, System.EventArgs e)
		{
			ScriptManager.GetCurrent(Parent.Page).SetFocus(((RoboCoder.WebControls.ComboBox)sender).FocusID);
		}

		protected void cAdmTemplatePerm1030List_DDFindClick(object sender, System.EventArgs e)
		{
			ScriptManager.GetCurrent(Parent.Page).SetFocus(((RoboCoder.WebControls.ComboBox)sender).FocusID);
		}

		protected void cAdmTemplatePerm1030List_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			InitMaster(sender, e);      // Do this first to enable defaults for non-database columns.
			DataTable dt = null;
			try
			{
				dt = (new AdminSystem()).GetMstById("GetAdmTemplatePerm1030ById",cAdmTemplatePerm1030List.SelectedValue,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId));
			}
			catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
			if (dt != null)
			{
				...
				if (dt.Rows.Count > 0)
				{
					cAdmTemplatePerm1030List.SetDdVisible();
					DataRow dr = dt.Rows[0];
					try {cTemplateId79.Text = RO.Common3.Utils.fmNumeric("0",dr["TemplateId79"].ToString(),base.LUser.Culture);} catch {cTemplateId79.Text = string.Empty;}
					try {cTemplateName79.Text = dr["TemplateName79"].ToString();} catch {cTemplateName79.Text = string.Empty;}
					try {cTmplPrefix79.Text = dr["TmplPrefix79"].ToString();} catch {cTmplPrefix79.Text = string.Empty;}
					try {cTmplDefault79.Checked = base.GetBool(dr["TmplDefault79"].ToString());} catch {cTmplDefault79.Checked = false;}
				}
			}
			cButPanel.DataBind(); if (!cSaveButton.Visible) { cInsRowButton.Visible = false; }
			DataTable dtAdmTemplatePermGrid = null;
			int filterId = 0; if (Utils.IsInt(cFilterId.SelectedValue)) { filterId = int.Parse(cFilterId.SelectedValue); }
			try
			{
				dtAdmTemplatePermGrid = (new AdminSystem()).GetDtlById(1030,"GetAdmTemplatePerm1030DtlById",cAdmTemplatePerm1030List.SelectedValue,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),filterId,base.LImpr,base.LCurr);
			}
			catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
			if (!dtAdmTemplatePermGrid.Columns.Contains("_NewRow")) { dtAdmTemplatePermGrid.Columns.Add("_NewRow"); }
			Session[KEY_dtAdmTemplatePermGrid] = dtAdmTemplatePermGrid;
			cAdmTemplatePermGrid.EditIndex = -1;
			cAdmTemplatePermGridDataPager.PageSize = Int16.Parse(cPgSize.Text); GotoPage(0);
			if (Session[KEY_lastSortCol] != null)
			{
				cAdmTemplatePermGrid_OnSorting(sender, new ListViewSortEventArgs((string)Session[KEY_lastSortExp], SortDirection.Ascending));
			}
			else if (dtAdmTemplatePermGrid.Rows.Count <= 0 || (!((GetAuthRow().Rows[0]["AllowUpd"].ToString() == "N" || GetAuthRow().Rows[0]["ViewOnly"].ToString() == "G") && GetAuthRow().Rows[0]["AllowAdd"].ToString() == "N") && !(Request.QueryString["enb"] != null && Request.QueryString["enb"] == "N") && dtAdmTemplatePermGrid.Rows.Count == 1))
			{
				cAdmTemplatePermGrid_DataBind(dtAdmTemplatePermGrid.DefaultView);
			}
			cFindButton_Click(sender, e);
			cNaviPanel.Visible = true; cImportPwdPanel.Visible = false; Session.Remove(KEY_scrImport);
			ScriptManager.GetCurrent(Parent.Page).SetFocus(cAdmTemplatePerm1030List.FocusID);
			ShowDirty(false); PanelTop.Update();
			// *** List Selection (End of) Web Rule starts here *** //
		}

		protected void cPermKeyId1331_TextChanged(object sender, System.EventArgs e)
		{
			ScriptManager.GetCurrent(Parent.Page).SetFocus(((RoboCoder.WebControls.ComboBox)sender).FocusID);
		}

		protected void cPermKeyId1331_DDFindClick(object sender, System.EventArgs e)
		{
			ScriptManager.GetCurrent(Parent.Page).SetFocus(((RoboCoder.WebControls.ComboBox)sender).FocusID);
		}

		protected void cPermKeyId1331_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			TextBox pwd = null;
			if (cAdmTemplatePermGrid.EditIndex > -1 && cAdmTemplatePermGrid.Items.Count > cAdmTemplatePermGrid.EditIndex)
			{
				DataView dvAdmTemplatePermGrid = ((DataTable)Session[KEY_dtAdmTemplatePermGrid]).DefaultView;
				if (Session[KEY_dtPermKeyId1331] != null)
				{
					DataView dv3 = ((DataTable)Session[KEY_dtPermKeyId1331]).DefaultView;
				}
				Session[KEY_dtAdmTemplatePermGrid] = dvAdmTemplatePermGrid.Table;
				SetPermId1331((RoboCoder.WebControls.ComboBox)cAdmTemplatePermGrid.EditItem.FindControl("cPermId1331"),dvAdmTemplatePermGrid[cAdmTemplatePermGrid.EditItem.DataItemIndex]["PermId1331"].ToString(),((RoboCoder.WebControls.ComboBox)sender).SelectedValue, cAdmTemplatePermGrid.EditItem);
			}
		...
		public void cFindButton_Click(object sender, System.EventArgs e)
		{
			...
			if (dv != null)
			{
				...
				if ((cc != null && cc.ID.Equals("cAdmTemplatePerm1030List")) || cAdmTemplatePermGrid.EditIndex < 0 || UpdateGridRow(cAdmTemplatePermGrid, new CommandEventArgs("Save", "")))
				{
					...
					GotoPage(0); cAdmTemplatePermGrid_DataBind(dv);
					if (GetCurrPageIndex() != (int)Session[KEY_currPageIndex] && (int)Session[KEY_currPageIndex] < GetTotalPages()) { GotoPage((int)Session[KEY_currPageIndex]); cAdmTemplatePermGrid_DataBind(dv);}
		...
		public void cInsRowButton_Click(object sender, System.EventArgs e)
		{
			...
			if (dt != null && (ValidPage()) && UpdateGridRow(sender, new CommandEventArgs("Save", "")))
			{
				...
				Session[KEY_lastAddedRow] = 0; Session[KEY_dtAdmTemplatePermGrid] = dt; Session[KEY_currPageIndex] = 0; GotoPage(0);
				cAdmTemplatePermGrid_DataBind(dt.DefaultView);
				cAdmTemplatePermGrid_OnItemEditing(cAdmTemplatePermGrid, new ListViewEditEventArgs(0));
		...
		public void cPgSizeButton_Click(object sender, System.EventArgs e)
		{
			...
			if (cAdmTemplatePermGrid.EditIndex < 0 || (dt != null && UpdateGridRow(sender, new CommandEventArgs("Save", ""))))
			{
				...
				cAdmTemplatePermGridDataPager.PageSize = int.Parse(cPgSize.Text); GotoPage(0);
				if (dt.Rows.Count <= 0 || (!((GetAuthRow().Rows[0]["AllowUpd"].ToString() == "N" || GetAuthRow().Rows[0]["ViewOnly"].ToString() == "G") && GetAuthRow().Rows[0]["AllowAdd"].ToString() == "N") && !(Request.QueryString["enb"] != null && Request.QueryString["enb"] == "N") && dt.Rows.Count == 1)) {cAdmTemplatePermGrid_DataBind(dt.DefaultView);} else {cFindButton_Click(sender, e);}
				try
				{
					(new AdminSystem()).UpdLastPageInfo(1030, base.LUser.UsrId, cPgSize.Text, LcSysConnString, LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); }
			}
		}
		...
		public void cShowImpButton_Click(object sender, System.EventArgs e)
		{
			...
			if (cSchemaImage.Visible)
			{
				try
				{
					Session["ImportSchema"] = (new AdminSystem()).GetSchemaScrImp(1030,base.LUser.CultureId,LcSysConnString,LcAppPw);
				}
				catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
				if (cSchemaImage.Attributes["OnClick"] == null || cSchemaImage.Attributes["OnClick"].IndexOf("ImportSchema.aspx") < 0) {cSchemaImage.Attributes["OnClick"] += "SearchLink('ImportSchema.aspx?scm=S&key=1030&csy=3','','',''); return false;";}
			}
			// *** System Button Click (after) Web Rule starts here *** //
		}
		...
		private void ScrImportDdl(DataView dvd, DataRowView drv, bool bComboBox, string PKey, string CKey, string CNam, int MaxLen, string MatchCd, bool bAllowNulls)
		{
			if (dvd != null)
			{
				...
				{
					if (string.IsNullOrEmpty(cAdmTemplatePerm1030List.SelectedValue))
					{
						dvd.RowFilter = "(" + PKey + " is null)";
					}
					else
					{
						dvd.RowFilter = "(" + PKey + " is null OR " + PKey + " = " + cAdmTemplatePerm1030List.SelectedValue + ")";
					}
				}
		...
		protected void ScrImport(bool bClear)
		{
			...
			DataTable dtAdmTemplatePermGrid = (DataTable)Session[KEY_dtAdmTemplatePermGrid];
			if (dti != null && dtAdmTemplatePermGrid != null)
			{
				if (bClear)
				{
					dtAdmTemplatePermGrid.Rows.Clear();
				}
				cFind.Text = string.Empty;
				int iExist = dtAdmTemplatePermGrid.Rows.Count;
				...
				foreach (DataRowView drv in dti.DefaultView)
				{
					...
					{
						DataTable dtd;
						dtd = (DataTable)Session[KEY_dtGrantDeny1331];
						if (dtd == null)
						{
							try
							{
								dtd = (new AdminSystem()).GetDdl(1030,"GetDdlGrantDeny3S4448",true,true,0,string.Empty,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr);
							}
							catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
							Session[KEY_dtGrantDeny1331] = dtd;
						}
						ScrImportDdl(dtd.DefaultView, drv, false, "TemplateId", "GrantDeny1331", "GrantDeny1331Text", 20, "", false);
						dtd = jj==iExist ? null : (DataTable)Session[KEY_dtPermKeyId1331];
						if (dtd == null)
						{
							try
							{
								dtd = (new AdminSystem()).GetDdl(1030,"GetDdlPermKeyId3S4449",true,true,0,string.Empty,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr);
							}
							catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
							Session[KEY_dtPermKeyId1331] = dtd;
						}
						ScrImportDdl(dtd.DefaultView, drv, true, "TemplateId", "PermKeyId1331", "PermKeyId1331Text", 50, "", false);
						dtd = jj==iExist ? null : (DataTable)Session[KEY_dtPermId1331];
						if (dtd == null)
						{
							try
							{
								dtd = (new AdminSystem()).GetDdl(1030,"GetDdlPermId3S4450",true,true,0,string.Empty,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),string.Empty,base.LImpr,base.LCurr);
							}
							catch (Exception err) { bErrNow.Value = "Y"; PreMsgPopup(err.Message); return; }
							Session[KEY_dtPermId1331] = dtd;
						}
						ScrImportDdl(dtd.DefaultView, drv, true, "TemplateId", "PermId1331", "PermId1331Text", 105, "", false);
					}
					jj = jj + 1;
				}
				iRow = dti.DefaultView.Count - iExist;
				if (!dti.Columns.Contains("_NewRow")) { dti.Columns.Add("_NewRow"); }
				Session[KEY_dtAdmTemplatePermGrid] = dti;
				cAdmTemplatePermGrid_DataBind(dti.DefaultView);
		...
		public void cImportButton_Click(object sender, System.EventArgs e)
		{
			...
			if (cFNameO.Text != string.Empty && cWorkSheet.Items.Count > 0 && cWorkSheet.SelectedItem.Text != string.Empty && cStartRow.Text != string.Empty)
			{
				...
				try
				{
					if (cAdmTemplatePermGrid.EditIndex < 0 || UpdateGridRow(cAdmTemplatePermGrid, new CommandEventArgs("Save", "")))
					{
						Session[KEY_scrImport] = ImportFile(dtAdmTemplatePermGrid.Copy(),cFNameO.Text,cWorkSheet.SelectedItem.Text,cStartRow.Text,Config.PathTmpImport + cFName.Text);
					}
		...
		private void GotoPage(int pageNo)
		{
			if (pageNo >= 0 && pageNo < GetTotalPages())
			{
				if (cAdmTemplatePermGrid.EditIndex < 0 || UpdateGridRow(cAdmTemplatePermGrid, new CommandEventArgs("Save", "")))
				{
					try { cAdmTemplatePermGridDataPager.SetPageProperties(cAdmTemplatePermGridDataPager.PageSize * pageNo, cAdmTemplatePermGridDataPager.MaximumRows, false); cAdmTemplatePermGrid_DataBind(null); }
					catch
					{
						try { cAdmTemplatePermGridDataPager.SetPageProperties(0, cAdmTemplatePermGridDataPager.MaximumRows, false); cAdmTemplatePermGrid_DataBind(null); } catch {}
					}
				}
			}
		}

		protected void cAdmTemplatePermGrid_OnItemCommand(object sender, ListViewCommandEventArgs e)
		{
		}

		private void cAdmTemplatePermGrid_DataBind(DataView dvAdmTemplatePermGrid)
		{
			if (dvAdmTemplatePermGrid == null)
			{
				DataTable dt = (DataTable)Session[KEY_dtAdmTemplatePermGrid];
				dvAdmTemplatePermGrid = dt != null ? dt.DefaultView : null;
			}
			if (dvAdmTemplatePermGrid != null)
			{
				LcAuth = GetAuthCol().AsEnumerable().ToDictionary<DataRow,string>(dr=>dr["ColName"].ToString());
				cAdmTemplatePermGrid.DataSource = dvAdmTemplatePermGrid;
				cAdmTemplatePermGrid.DataBind();
		...
		protected void cAdmTemplatePermGrid_OnSorting(object sender, ListViewSortEventArgs e)
		{
			DataTable dt = (DataTable)Session[KEY_dtAdmTemplatePermGrid];
			DataView dv = dt != null ? dt.DefaultView : null;
			if (dv != null)
			{
				if (cAdmTemplatePermGrid.EditIndex < 0 || UpdateGridRow(cAdmTemplatePermGrid, new CommandEventArgs("Save", "")))
				{
					...
					Session[KEY_dtAdmTemplatePermGrid] = dt;
					cAdmTemplatePermGrid_DataBind(dv);
				}
			}
		}

		protected void cAdmTemplatePermGrid_OnPagePropertiesChanging(object sender, PagePropertiesChangingEventArgs e)
		{
		    cAdmTemplatePermGridDataPager.SetPageProperties(e.StartRowIndex, e.MaximumRows, false);
		    DataTable dt = (DataTable)Session[KEY_dtAdmTemplatePermGrid];
		    DataView dv = dt != null ? dt.DefaultView : null;
			cAdmTemplatePermGrid_DataBind(dv); cAdmTemplatePermGrid.EditIndex = -1;
		}

		private void GridChkPgDirty(ListViewItem lvi)
		{
				WebControl cc = null;
				cc = ((WebControl)lvi.FindControl("cGrantDeny1331"));
				...
				cc = ((WebControl)lvi.FindControl("cPermKeyId1331"));
				...
				cc = ((WebControl)lvi.FindControl("cPermId1331"));
				if ((cc.Attributes["OnChange"] == null || cc.Attributes["OnChange"].IndexOf("ChkPgDirty") < 0) && cc.Visible && cc.Enabled) {cc.Attributes["OnChange"] += "document.getElementById('" + bPgDirty.ClientID + "').value='Y'; ChkPgDirty();";}
		}

		protected void cAdmTemplatePermGrid_OnItemDataBound(object sender, ListViewItemEventArgs e)
		{
			// *** GridItemDataBound (before) Web Rule End *** //
			DataTable dt = (DataTable)Session[KEY_dtAdmTemplatePermGrid];
			bool isEditItem = false;
			DataView dvAdmTemplatePermGrid = dt != null ? dt.DefaultView : null;
			if (cAdmTemplatePermGrid.EditIndex > -1 && GetDataItemIndex(cAdmTemplatePermGrid.EditIndex) == e.Item.DataItemIndex)
			{
				isEditItem = true;
				base.SetGridEnabled(e.Item, GetAuthCol(), GetLabel(), 4);
				SetGrantDeny1331((DropDownList)e.Item.FindControl("cGrantDeny1331"),dvAdmTemplatePermGrid[e.Item.DataItemIndex]["GrantDeny1331"].ToString());
				SetPermKeyId1331((RoboCoder.WebControls.ComboBox)e.Item.FindControl("cPermKeyId1331"),dvAdmTemplatePermGrid[e.Item.DataItemIndex]["PermKeyId1331"].ToString(), e.Item);
				SetPermId1331((RoboCoder.WebControls.ComboBox)e.Item.FindControl("cPermId1331"),dvAdmTemplatePermGrid[e.Item.DataItemIndex]["PermId1331"].ToString(),dvAdmTemplatePermGrid[e.Item.DataItemIndex]["PermKeyId1331"].ToString(), e.Item);
			...
			if (dtAuthRow != null)
			{
				...
				{
					cc = e.Item.FindControl("cAdmTemplatePermGridDelete"); if (cc != null) { cc.Visible = false; }
					cc = e.Item.FindControl("cAdmTemplatePermGridEdit"); if (cc != null) { cc.Visible = false; }
				}
				else
				{
			        HtmlTableRow tr = e.Item.FindControl("cAdmTemplatePermGridRow") as HtmlTableRow;
			        LinkButton lb = e.Item.FindControl("cAdmTemplatePermGridEdit") as LinkButton;
		...
		protected void cTemplatePrmId1331hl_Click(object sender, System.EventArgs e)
		{
			if (Session[KEY_lastSortCol] == null || (string)Session[KEY_lastSortCol] != "0") { Session.Remove(KEY_lastSortUrl); }
			Session[KEY_lastSortTog] = "Y"; Session[KEY_lastSortCol] = "0"; Session[KEY_lastSortExp] = "TemplatePrmId1331";Session[KEY_lastSortImg] = "cTemplatePrmId1331hi";
			cAdmTemplatePermGrid_OnSorting(sender, new ListViewSortEventArgs("TemplatePrmId1331", SortDirection.Ascending));
		}

		protected void cGrantDeny1331hl_Click(object sender, System.EventArgs e)
		{
			if (Session[KEY_lastSortCol] == null || (string)Session[KEY_lastSortCol] != "1") { Session.Remove(KEY_lastSortUrl); }
			Session[KEY_lastSortTog] = "Y"; Session[KEY_lastSortCol] = "1"; Session[KEY_lastSortExp] = "GrantDeny1331Text";Session[KEY_lastSortImg] = "cGrantDeny1331hi";
			cAdmTemplatePermGrid_OnSorting(sender, new ListViewSortEventArgs("GrantDeny1331Text", SortDirection.Ascending));
		}

		protected void cPermKeyId1331hl_Click(object sender, System.EventArgs e)
		{
			if (Session[KEY_lastSortCol] == null || (string)Session[KEY_lastSortCol] != "2") { Session.Remove(KEY_lastSortUrl); }
			Session[KEY_lastSortTog] = "Y"; Session[KEY_lastSortCol] = "2"; Session[KEY_lastSortExp] = "PermKeyId1331Text";Session[KEY_lastSortImg] = "cPermKeyId1331hi";
			cAdmTemplatePermGrid_OnSorting(sender, new ListViewSortEventArgs("PermKeyId1331Text", SortDirection.Ascending));
		}

		protected void cPermId1331hl_Click(object sender, System.EventArgs e)
		{
			if (Session[KEY_lastSortCol] == null || (string)Session[KEY_lastSortCol] != "3") { Session.Remove(KEY_lastSortUrl); }
			Session[KEY_lastSortTog] = "Y"; Session[KEY_lastSortCol] = "3"; Session[KEY_lastSortExp] = "PermId1331Text";Session[KEY_lastSortImg] = "cPermId1331hi";
			cAdmTemplatePermGrid_OnSorting(sender, new ListViewSortEventArgs("PermId1331Text", SortDirection.Ascending));
		}

		protected void cAdmTemplatePermGrid_OnItemEditing(object sender, ListViewEditEventArgs e)
		{
			DataTable dt = (DataTable)Session[KEY_dtAdmTemplatePermGrid];
			if ((ValidPage()) && UpdateGridRow(sender, new CommandEventArgs("Save", "")) && dt != null && dt.DefaultView.Count > GetDataItemIndex(e.NewEditIndex))
			{
				cAdmTemplatePermGrid.EditIndex = e.NewEditIndex;
				cAdmTemplatePermGrid_DataBind(null);
				cPermKeyId1331_SelectedIndexChanged((object)cAdmTemplatePermGrid.EditItem.FindControl("cPermKeyId1331"), new EventArgs());
				Control wc = null;
				string idx = Page.Request["__EVENTARGUMENT"];
				if (!string.IsNullOrEmpty(idx))
				{
				    Control ctrlToFocus = cAdmTemplatePermGrid.EditItem.FindControl("c" + idx);
				    if (((WebControl)ctrlToFocus).Enabled) { wc = ctrlToFocus; }
				}
				if (wc == null) { wc = FindEditableControl(cAdmTemplatePermGrid.EditItem); }
				if (wc != null)
             {
             ...
             MkMobileLabel(cAdmTemplatePermGrid.EditItem);
		    }
		    else { e.Cancel = true; }
		}
		...
		{
		    Label ml = null;
		    ml = lvi.FindControl("cTemplatePrmId1331ml") as Label;
		    if (ml != null) { ml.Text = ColumnHeaderText(4); }
		    ml = lvi.FindControl("cGrantDeny1331ml") as Label;
		    if (ml != null) { ml.Text = ColumnHeaderText(5); }
		    ml = lvi.FindControl("cPermKeyId1331ml") as Label;
		    if (ml != null) { ml.Text = ColumnHeaderText(6); }
		    ml = lvi.FindControl("cPermId1331ml") as Label;
		...
		protected void GridFill(ListViewItem lvi, DataTable dt, DataRow dr, bool bInsert)
		{
			...
			ddl = (DropDownList)lvi.FindControl("cGrantDeny1331");
			if (ddl != null)
			{
				if (ddl.SelectedIndex >= 0 && ddl.SelectedValue.ToString() != string.Empty)
				{
					dr["GrantDeny1331"] = ddl.SelectedValue;
					dr["GrantDeny1331Text"] = ddl.SelectedItem.Text;
				}
				else
				{
					dr["GrantDeny1331"] = System.DBNull.Value;
					dr["GrantDeny1331Text"] = System.DBNull.Value;
				}
			}
			RoboCoder.WebControls.ComboBox cbb = null;
			cbb = (RoboCoder.WebControls.ComboBox)lvi.FindControl("cPermKeyId1331");
			if (cbb != null)
			{
				if (cbb.SelectedValue != string.Empty)
				{
					dr["PermKeyId1331"] = cbb.SelectedValue;
					dr["PermKeyId1331Text"] = cbb.SelectedText;
				}
				else
				{
					dr["PermKeyId1331"] = System.DBNull.Value;
					dr["PermKeyId1331Text"] = System.DBNull.Value;
				}
			}
			cbb = (RoboCoder.WebControls.ComboBox)lvi.FindControl("cPermId1331");
			if (cbb != null)
			{
				if (cbb.SelectedValue != string.Empty)
				{
					dr["PermId1331"] = cbb.SelectedValue;
					dr["PermId1331Text"] = cbb.SelectedText;
				}
				else
				{
					dr["PermId1331"] = System.DBNull.Value;
					dr["PermId1331Text"] = System.DBNull.Value;
				}
			}
		...
		protected void cAdmTemplatePermGrid_OnItemUpdating(object sender, ListViewUpdateEventArgs e)
		{
			DataTable dt = (DataTable)Session[KEY_dtAdmTemplatePermGrid];
			if (dt != null && dt.Rows.Count > 0)
			{
				DataRow dr = dt.DefaultView[GetDataItemIndex(e.ItemIndex)].Row;
			    GridFill(cAdmTemplatePermGrid.EditItem, dt, dr, false);
			    dr["_NewRow"] = "N";
			    if (dt.Columns.Contains("_SortOrder")) dr["_SortOrder"] = null;
			}
		}

		protected void cAdmTemplatePermGrid_OnItemCanceling(object sender, ListViewCancelEventArgs e)
		{
			PanelTop.Update();
			DataTable dt = (DataTable)Session[KEY_dtAdmTemplatePermGrid];
			DataView dv = dt != null ? dt.DefaultView : null;
			...
			{
				cAdmTemplatePermGrid_OnItemDeleting(sender, new ListViewDeleteEventArgs(e.ItemIndex));
			}
			if (dt.Columns.Contains("_SortOrder")) dt.DefaultView[GetDataItemIndex(e.ItemIndex)].Row["_SortOrder"] = null;
			cAdmTemplatePermGrid.EditIndex = -1; cAdmTemplatePermGrid_DataBind(null);
		}
		...
		protected void cDeleteAllButton_Click(object sender, System.EventArgs e)
		{
			DataTable dt = (DataTable)Session[KEY_dtAdmTemplatePermGrid];
			DataView dv = dt != null ? dt.DefaultView : null;
			if (dv != null && (cAdmTemplatePermGrid.EditIndex < 0 || UpdateGridRow(sender, new CommandEventArgs("Save", ""))))
			{
				GotoPage(0);
				while (dv.Count > 0) {dv.Delete(0);}
				Session[KEY_dtAdmTemplatePermGrid] = dt;
				cAdmTemplatePermGrid.EditIndex = -1; cAdmTemplatePermGrid_DataBind(dv);
			}
		}

		protected void cAdmTemplatePermGrid_OnItemDeleting(object sender, ListViewDeleteEventArgs e)
		{
			DataTable dt = (DataTable)Session[KEY_dtAdmTemplatePermGrid];
			DataView dv = dt != null ? dt.DefaultView : null;
			DataRow dr = dv != null ? dv[GetDataItemIndex(e.ItemIndex)].Row : null;
			if (dv != null && (cAdmTemplatePermGrid.EditIndex == e.ItemIndex || UpdateGridRow(sender, new CommandEventArgs("Save",""))))
			{
		...
		{
			// *** System Button Click (Before) Web Rule starts here *** //
			if (cTemplateId79.Text == string.Empty) { cClearButton_Click(sender, new EventArgs()); ShowDirty(false); PanelTop.Update();}
			else { PopAdmTemplatePerm1030List(sender, e, false, cTemplateId79.Text); }
			// *** System Button Click (After) Web Rule starts here *** //
		}
		...
		public void cEditButton_Click(object sender, System.EventArgs e)
		{
			...
			Session.Remove(KEY_dtAdmTemplatePerm1030List); PopAdmTemplatePerm1030List(sender, e, false, null);
		...
		private string SaveDb(object sender, System.EventArgs e)
		{
			...
			if (ValidPage() && (cAdmTemplatePermGrid.EditIndex < 0 || UpdateGridRow(cAdmTemplatePermGrid, new CommandEventArgs("Save", ""))))
			{
				DataTable dt = (DataTable)Session[KEY_dtAdmTemplatePermGrid];
				DataView dv = dt != null ? dt.DefaultView : null;
				string ftr = string.Empty;
				if (dv.RowFilter != string.Empty) { ftr = dv.RowFilter; dv.RowFilter = string.Empty; }
				AdmTemplatePerm1030 ds = PrepAdmTemplatePermData(dv,cTemplateId79.Text == string.Empty);
				if (ftr != string.Empty) {dv.RowFilter = ftr;}
				if (!string.IsNullOrEmpty(cAdmTemplatePerm1030List.SelectedValue) && cTemplateId79.Text != cAdmTemplatePerm1030List.SelectedValue)
				{
					PreMsgPopup("Primary key cannot be changed");
					return rtn;
				}
				if (string.IsNullOrEmpty(cAdmTemplatePerm1030List.SelectedValue))	// Add
				{
					if (ds != null)
					{
						pid = (new AdminSystem()).AddData(1030,false,base.LUser,base.LImpr,base.LCurr,ds,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),base.CPrj,base.CSrc,noTrans,commandTimeOut);
					}
					if (!string.IsNullOrEmpty(pid))
					{
						cAdmTemplatePerm1030List.ClearSearch(); Session.Remove(KEY_dtAdmTemplatePerm1030List);
						ShowDirty(false); bUseCri.Value = "Y"; PopAdmTemplatePerm1030List(sender, e, false, pid);
						rtn = GetScreenHlp().Rows[0]["AddMsg"].ToString();
					}
				}
				else {
					bool bValid7 = false;
					if (ds != null && (new AdminSystem()).UpdData(1030,false,base.LUser,base.LImpr,base.LCurr,ds,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),base.CPrj,base.CSrc,noTrans,commandTimeOut)) {bValid7 = true;}
					if (bValid7)
					{
						cAdmTemplatePerm1030List.ClearSearch(); Session.Remove(KEY_dtAdmTemplatePerm1030List);
						Session[KEY_currPageIndex] = GetCurrPageIndex();
						ShowDirty(false); PopAdmTemplatePerm1030List(sender, e, false, ds.Tables["AdmTemplatePerm"].Rows[0]["TemplateId79"]);
		...
		{
			// *** System Button Click (Before) Web Rule starts here *** //
			if (cTemplateId79.Text != string.Empty)
			{
				AdmTemplatePerm1030 ds = PrepAdmTemplatePermData(null,false);
				try
				{
					if (ds != null && (new AdminSystem()).DelData(1030,false,base.LUser,base.LImpr,base.LCurr,ds,(string)Session[KEY_sysConnectionString],base.AppPwd(base.LCurr.DbId),base.CPrj,base.CSrc))
					{
						cAdmTemplatePerm1030List.ClearSearch(); Session.Remove(KEY_dtAdmTemplatePerm1030List);
						ShowDirty(false); PopAdmTemplatePerm1030List(sender, e, false, null);
		...
		private AdmTemplatePerm1030 PrepAdmTemplatePermData(DataView dv, bool bAdd)
		{
			AdmTemplatePerm1030 ds = new AdmTemplatePerm1030();
			DataRow dr = ds.Tables["AdmTemplatePerm"].NewRow();
			DataRow drType = ds.Tables["AdmTemplatePerm"].NewRow();
			DataRow drDisp = ds.Tables["AdmTemplatePerm"].NewRow();
			if (bAdd) { dr["TemplateId79"] = string.Empty; } else { dr["TemplateId79"] = cTemplateId79.Text; }
			drType["TemplateId79"] = "Numeric"; drDisp["TemplateId79"] = "TextBox";
			try {dr["TemplateName79"] = cTemplateName79.Text.Trim();} catch {}
			drType["TemplateName79"] = "VarWChar"; drDisp["TemplateName79"] = "TextBox";
			try {dr["TmplPrefix79"] = cTmplPrefix79.Text.Trim();} catch {}
			drType["TmplPrefix79"] = "VarChar"; drDisp["TmplPrefix79"] = "TextBox";
			try {dr["TmplDefault79"] = base.SetBool(cTmplDefault79.Checked);} catch {}
			drType["TmplDefault79"] = "Char"; drDisp["TmplDefault79"] = "CheckBox";
			if (dv != null)
			{
				ds.Tables["AdmTemplatePermDef"].Rows.Add(MakeTypRow(ds.Tables["AdmTemplatePermDef"].NewRow()));
				ds.Tables["AdmTemplatePermDef"].Rows.Add(MakeDisRow(ds.Tables["AdmTemplatePermDef"].NewRow()));
				if (bAdd)
				{
					foreach (DataRowView drv in dv)
					{
						ds.Tables["AdmTemplatePermAdd"].Rows.Add(MakeColRow(ds.Tables["AdmTemplatePermAdd"].NewRow(), drv, true));
					}
				}
				else
				{
					...
					foreach (DataRowView drv in dv)
					{
						ds.Tables["AdmTemplatePermUpd"].Rows.Add(MakeColRow(ds.Tables["AdmTemplatePermUpd"].NewRow(), drv, false));
					}
					...
					foreach (DataRowView drv in dv)
					{
						ds.Tables["AdmTemplatePermDel"].Rows.Add(MakeColRow(ds.Tables["AdmTemplatePermDel"].NewRow(), drv, false));
					}
					dv.RowStateFilter = DataViewRowState.CurrentRows;
				}
			}
			ds.Tables["AdmTemplatePerm"].Rows.Add(dr); ds.Tables["AdmTemplatePerm"].Rows.Add(drType); ds.Tables["AdmTemplatePerm"].Rows.Add(drDisp);
			return ds;
		}

		public bool CanAct(char typ) { return CanAct(typ, GetAuthRow(), cAdmTemplatePerm1030List.SelectedValue.ToString()); }
		...
		private bool ValidPage()
		{
			...
			DataTable dt = null;
			dt = (DataTable)Session[KEY_dtGrantDeny1331];
			if (dt != null && dt.Rows.Count <= 0)
			{
				bErrNow.Value = "Y"; PreMsgPopup("Value is expected for 'GrantDeny', please investigate."); return false;
			}
			dt = (DataTable)Session[KEY_dtPermKeyId1331];
			if (dt != null && dt.Rows.Count <= 0)
			{
				bErrNow.Value = "Y"; PreMsgPopup("Value is expected for 'PermKeyId', please investigate."); return false;
			}
			dt = (DataTable)Session[KEY_dtPermId1331];
			if (dt != null && dt.Rows.Count <= 0)
			{
				bErrNow.Value = "Y"; PreMsgPopup("Value is expected for 'PermId', please investigate."); return false;
			}
			return true;
		}
		...
		{
			dr["TemplateId79"] = System.Data.OleDb.OleDbType.Numeric.ToString();
			dr["TemplatePrmId1331"] = System.Data.OleDb.OleDbType.Numeric.ToString();
			dr["GrantDeny1331"] = System.Data.OleDb.OleDbType.Char.ToString();
			dr["PermKeyId1331"] = System.Data.OleDb.OleDbType.Numeric.ToString();
			dr["PermId1331"] = System.Data.OleDb.OleDbType.Numeric.ToString();
			return dr;
		}

		private DataRow MakeDisRow(DataRow dr)
		{
			dr["TemplateId79"] = "TextBox";
			dr["TemplatePrmId1331"] = "TextBox";
			dr["GrantDeny1331"] = "DropDownList";
			dr["PermKeyId1331"] = "AutoComplete";
			dr["PermId1331"] = "AutoComplete";
			return dr;
		}

		private DataRow MakeColRow(DataRow dr, DataRowView drv, bool bAdd)
		{
			dr["TemplateId79"] = cTemplateId79.Text;
			DataTable dtAuth = GetAuthCol();
			if (dtAuth != null)
			{
				dr["TemplatePrmId1331"] = drv["TemplatePrmId1331"].ToString().Trim();
				dr["GrantDeny1331"] = drv["GrantDeny1331"];
				dr["PermKeyId1331"] = drv["PermKeyId1331"];
				dr["PermId1331"] = drv["PermId1331"];
			}
			return dr;
		}
		...
		{
			if (cAdmTemplatePermGrid.EditIndex > -1)
			{
				cAdmTemplatePermGrid_OnItemUpdating(sender, new ListViewUpdateEventArgs(cAdmTemplatePermGrid.EditIndex));
			}
			return true;
		}

		protected void cAdmTemplatePermGrid_OnPreRender(object sender, System.EventArgs e)
		{
			System.Web.UI.WebControls.Image hi = null;
			hi = (System.Web.UI.WebControls.Image)cAdmTemplatePermGrid.FindControl("cTemplatePrmId1331hi"); if (hi != null) { hi.Visible = false; }
			hi = (System.Web.UI.WebControls.Image)cAdmTemplatePermGrid.FindControl("cGrantDeny1331hi"); if (hi != null) { hi.Visible = false; }
			hi = (System.Web.UI.WebControls.Image)cAdmTemplatePermGrid.FindControl("cPermKeyId1331hi"); if (hi != null) { hi.Visible = false; }
			hi = (System.Web.UI.WebControls.Image)cAdmTemplatePermGrid.FindControl("cPermId1331hi"); if (hi != null) { hi.Visible = false; }
			if (Session[KEY_lastSortImg] != null)
			{
				hi = (System.Web.UI.WebControls.Image)cAdmTemplatePermGrid.FindControl((string)Session[KEY_lastSortImg]);
				if (hi != null) { hi.ImageUrl = Utils.AddTilde((string)Session[KEY_lastSortUrl]); hi.Visible = true; }
			}
			IgnoreHeaderConfirm((LinkButton)cAdmTemplatePermGrid.FindControl("cTemplatePrmId1331hl"));
			IgnoreHeaderConfirm((LinkButton)cAdmTemplatePermGrid.FindControl("cGrantDeny1331hl"));
			IgnoreHeaderConfirm((LinkButton)cAdmTemplatePermGrid.FindControl("cPermKeyId1331hl"));
			IgnoreHeaderConfirm((LinkButton)cAdmTemplatePermGrid.FindControl("cPermId1331hl"));
		}

		private string GetButtonId(ListViewItem lvi)
		{
			string ButtonID = String.Empty;
			Control c = lvi.FindControl("cAdmTemplatePermGridEdit");
		...
		{
		    return cAdmTemplatePermGridDataPager.StartRowIndex / cAdmTemplatePermGridDataPager.PageSize;
		}

		private int GetTotalPages()
		{
		    return (int)Math.Ceiling((double)cAdmTemplatePermGridDataPager.TotalRowCount / cAdmTemplatePermGridDataPager.PageSize);
		}

		private int GetDataItemIndex(int editIndex)
		{
		    return cAdmTemplatePermGridDataPager.StartRowIndex + editIndex;
		}

		protected void cAdmTemplatePermGrid_OnLayoutCreated(object sender, EventArgs e)
		{
		    // Header:
		    LinkButton lb = null;
		    lb = cAdmTemplatePermGrid.FindControl("cTemplatePrmId1331hl") as LinkButton;
		    if (lb != null) { lb.Text = ColumnHeaderText(4); lb.ToolTip = ColumnToolTip(4); lb.Parent.Visible = GridColumnVisible(4); }
		    lb = cAdmTemplatePermGrid.FindControl("cGrantDeny1331hl") as LinkButton;
		    if (lb != null) { lb.Text = ColumnHeaderText(5); lb.ToolTip = ColumnToolTip(5); lb.Parent.Visible = GridColumnVisible(5); }
		    lb = cAdmTemplatePermGrid.FindControl("cPermKeyId1331hl") as LinkButton;
		    if (lb != null) { lb.Text = ColumnHeaderText(6); lb.ToolTip = ColumnToolTip(6); lb.Parent.Visible = GridColumnVisible(6); }
		    lb = cAdmTemplatePermGrid.FindControl("cPermId1331hl") as LinkButton;
			...
			if (dtAuthRow != null)
			{
				...
				{
		            lb = cAdmTemplatePermGrid.FindControl("cDeleteAllButton") as LinkButton; if (lb != null) { lb.Visible = false; }
				}
			}
		    // footer:
		    Label gc = null;
		    gc = cAdmTemplatePermGrid.FindControl("cTemplatePrmId1331fl") as Label;
		    if (gc != null) { gc.Parent.Visible = GridColumnVisible(4); }
		    gc = cAdmTemplatePermGrid.FindControl("cGrantDeny1331fl") as Label;
		    if (gc != null) { gc.Parent.Visible = GridColumnVisible(5); }
		    gc = cAdmTemplatePermGrid.FindControl("cPermKeyId1331fl") as Label;
		    if (gc != null) { gc.Parent.Visible = GridColumnVisible(6); }
		    gc = cAdmTemplatePermGrid.FindControl("cPermId1331fl") as Label;
		...
		private void PreMsgPopup(string msg) { PreMsgPopup(msg,cAdmTemplatePerm1030List,null); }
