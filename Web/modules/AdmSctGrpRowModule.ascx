<%@ Control Language="c#" Inherits="RO.Web.AdmSctGrpRowModule" CodeFile="AdmSctGrpRowModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmSctGrpRow1004List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmSctGrpRow1004List_SelectedIndexChanged" OnTextChanged="cAdmSctGrpRow1004List_TextChanged" OnDDFindClick="cAdmSctGrpRow1004List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="SctGrpRowId1283" DataTextField="SctGrpRowId1283Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-4"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cSctGrpRowId1283P1" class="r-td r-labelR" runat="server"><asp:Label id="cSctGrpRowId1283Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cSctGrpRowId1283P2" class="r-td r-content" runat="server"><asp:TextBox id="cSctGrpRowId1283" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cSectionCd1283P1" class="r-td r-labelR" runat="server"><asp:Label id="cSectionCd1283Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cSectionCd1283P2" class="r-td r-content" runat="server"><asp:DropDownList id="cSectionCd1283" CssClass="inp-ddl" DataValueField="SectionCd1283" DataTextField="SectionCd1283Text" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cGroupRowId1283P1" class="r-td r-labelR" runat="server"><asp:Label id="cGroupRowId1283Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cGroupRowId1283P2" class="r-td r-content" runat="server"><asp:DropDownList id="cGroupRowId1283" CssClass="inp-ddl" DataValueField="GroupRowId1283" DataTextField="GroupRowId1283Text" runat="server" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-5-12"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div class="r-td"></div>
    		<div id="cSctGrpRowCss1283P1" class="r-td r-labelL r-labelT" runat="server"><asp:Label id="cSctGrpRowCss1283Label" CssClass="inp-lbl" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div class="r-td"></div>
