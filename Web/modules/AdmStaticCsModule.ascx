<%@ Control Language="c#" Inherits="RO.Web.AdmStaticCsModule" CodeFile="AdmStaticCsModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmStaticCs115List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmStaticCs115List_SelectedIndexChanged" OnTextChanged="cAdmStaticCs115List_TextChanged" OnDDFindClick="cAdmStaticCs115List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="StaticCsId260" DataTextField="StaticCsId260Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-3"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cStaticCsId260P1" class="r-td r-labelR" runat="server"><asp:Label id="cStaticCsId260Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cStaticCsId260P2" class="r-td r-content" runat="server"><asp:TextBox id="cStaticCsId260" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cStaticCsNm260P1" class="r-td r-labelR" runat="server"><asp:Label id="cStaticCsNm260Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cStaticCsNm260P2" class="r-td r-content" runat="server"><asp:TextBox id="cStaticCsNm260" CssClass="inp-txt" MaxLength="200" runat="server" /><asp:RequiredFieldValidator id="cRFVStaticCsNm260" ControlToValidate="cStaticCsNm260" display="none" runat="server" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-4-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cStyleDef260P1" class="r-td r-labelR" runat="server"><asp:Label id="cStyleDef260Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cStyleDef260P2" class="r-td r-content" runat="server"><asp:TextBox TextMode="MultiLine" id="cStyleDef260" CssClass="inp-txt" runat="server" /><asp:Image id="cStyleDef260E" ImageUrl="~/images/Expand.gif" CssClass="r-icon show-expand-button" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
