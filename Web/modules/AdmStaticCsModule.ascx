...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-4-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		...
    		<div id="cStyleDef260P2" class="r-td r-content" runat="server"><asp:TextBox TextMode="MultiLine" autocomplete="new-password" id="cStyleDef260" CssClass="inp-txt" runat="server" /><asp:Image id="cStyleDef260E" ImageUrl="~/images/Expand.gif" CssClass="r-icon show-expand-button" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
