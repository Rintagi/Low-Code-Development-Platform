<%@ Control Language="c#" Inherits="RO.Web.AdmReportGrpModule" CodeFile="AdmReportGrpModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
...
<div class="ListView">
	<asp:ListView id="cAdmReportGrpGrid" DataKeyNames="ReportGrpId94" OnItemCommand="cAdmReportGrpGrid_OnItemCommand" OnSorting="cAdmReportGrpGrid_OnSorting" OnPreRender="cAdmReportGrpGrid_OnPreRender" OnPagePropertiesChanging="cAdmReportGrpGrid_OnPagePropertiesChanging" OnItemEditing="cAdmReportGrpGrid_OnItemEditing" OnItemCanceling="cAdmReportGrpGrid_OnItemCanceling" OnItemDeleting="cAdmReportGrpGrid_OnItemDeleting" OnItemDataBound="cAdmReportGrpGrid_OnItemDataBound" OnLayoutCreated="cAdmReportGrpGrid_OnLayoutCreated" OnItemUpdating="cAdmReportGrpGrid_OnItemUpdating" runat="server">
	<LayoutTemplate>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr id="cAdmReportGrpGridHeader" class="GrdHead" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:right;' runat="server">
			<asp:LinkButton id="cReportGrpId94hl" CssClass="GrdHead" onClick="cReportGrpId94hl_Click" runat="server" /><asp:Image id="cReportGrpId94hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:150px;text-align:left;' runat="server">
			<asp:LinkButton id="cReportId94hl" CssClass="GrdHead" onClick="cReportId94hl_Click" runat="server" /><asp:Image id="cReportId94hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:80px;text-align:left;' runat="server">
			<asp:LinkButton id="cReportGrpIndex94hl" CssClass="GrdHead" onClick="cReportGrpIndex94hl_Click" runat="server" /><asp:Image id="cReportGrpIndex94hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' runat="server">
			<asp:LinkButton id="cParentGrpId94hl" CssClass="GrdHead" onClick="cParentGrpId94hl_Click" runat="server" /><asp:Image id="cParentGrpId94hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' runat="server">
			<asp:LinkButton id="cReportGrpName94hl" CssClass="GrdHead" onClick="cReportGrpName94hl_Click" runat="server" /><asp:Image id="cReportGrpName94hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:center;' runat="server">
			<asp:LinkButton id="cContentVertical94hl" CssClass="GrdHead" onClick="cContentVertical94hl_Click" runat="server" /><asp:Image id="cContentVertical94hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:center;' runat="server">
			<asp:LinkButton id="cLabelVertical94hl" CssClass="GrdHead" onClick="cLabelVertical94hl_Click" runat="server" /><asp:Image id="cLabelVertical94hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:50px;text-align:right;' runat="server">
			<asp:LinkButton id="cBorderWidth94hl" CssClass="GrdHead" onClick="cBorderWidth94hl_Click" runat="server" /><asp:Image id="cBorderWidth94hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:150px;text-align:left;' runat="server">
			<asp:LinkButton id="cGrpStyle94hl" CssClass="GrdHead" onClick="cGrpStyle94hl_Click" runat="server" /><asp:Image id="cGrpStyle94hi" runat="server" />
		</div></div>
    </td>
	...
	<tr id="cAdmReportGrpGridFooter" class="GrdFoot" visible="false" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:right;' runat="server">
		    <asp:Label id="cReportGrpId94fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:150px;text-align:left;' runat="server">
		    <asp:Label id="cReportId94fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:80px;text-align:left;' runat="server">
		    <asp:Label id="cReportGrpIndex94fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' runat="server">
		    <asp:Label id="cParentGrpId94fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' runat="server">
		    <asp:Label id="cReportGrpName94fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:center;' runat="server">
		    <asp:Label id="cContentVertical94fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:center;' runat="server">
		    <asp:Label id="cLabelVertical94fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:50px;text-align:right;' runat="server">
		    <asp:Label id="cBorderWidth94fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:150px;text-align:left;' runat="server">
		    <asp:Label id="cGrpStyle94fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr></table></LayoutTemplate>
	<ItemTemplate>
	<tr id="cAdmReportGrpGridRow" class='<%# Container.DisplayIndex % 2 == 0 ? "GrdItm" : "GrdAlt" %>' runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:right;' visible="<%# GridColumnVisible(0) %>" onclick='GridEdit("ReportGrpId94")' runat="server">
			<asp:Label id="cReportGrpId94l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ReportGrpId94").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(1) %>" onclick='GridEdit("ReportId94")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"ReportId94").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cReportId94l" text='<%# DataBinder.Eval(Container.DataItem,"ReportId94Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:80px;text-align:left;' visible="<%# GridColumnVisible(2) %>" onclick='GridEdit("ReportGrpIndex94")' runat="server">
			<asp:Label id="cReportGrpIndex94l" Text='<%# DataBinder.Eval(Container.DataItem,"ReportGrpIndex94").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(3) %>" onclick='GridEdit("ParentGrpId94")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"ParentGrpId94").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cParentGrpId94l" text='<%# DataBinder.Eval(Container.DataItem,"ParentGrpId94Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(4) %>" onclick='GridEdit("ReportGrpName94")' runat="server">
			<asp:Label id="cReportGrpName94l" Text='<%# DataBinder.Eval(Container.DataItem,"ReportGrpName94").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:center;' visible="<%# GridColumnVisible(5) %>" onclick='GridEdit("ContentVertical94")' runat="server">
			<asp:CheckBox id="cContentVertical94l" Enabled='<%# AllowEdit(LcAuth,"ContentVertical94") && AllowRowEdit(GetAuthRow(),DataBinder.Eval(Container.DataItem,"ReportGrpId94").ToString()) %>' checked='<%# base.GetBool(DataBinder.Eval(Container.DataItem,"ContentVertical94").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace())) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:center;' visible="<%# GridColumnVisible(6) %>" onclick='GridEdit("LabelVertical94")' runat="server">
			<asp:CheckBox id="cLabelVertical94l" Enabled='<%# AllowEdit(LcAuth,"LabelVertical94") && AllowRowEdit(GetAuthRow(),DataBinder.Eval(Container.DataItem,"ReportGrpId94").ToString()) %>' checked='<%# base.GetBool(DataBinder.Eval(Container.DataItem,"LabelVertical94").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace())) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:50px;text-align:right;' visible="<%# GridColumnVisible(7) %>" onclick='GridEdit("BorderWidth94")' runat="server">
			<asp:Label id="cBorderWidth94l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"BorderWidth94").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(8) %>" onclick='GridEdit("GrpStyle94")' runat="server">
			<asp:Label id="cGrpStyle94l" Text='<%# DataBinder.Eval(Container.DataItem,"GrpStyle94").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmReportGrpGridEdit" style="display:none;" CausesValidation="true" CommandName="Edit" runat="server" />
       <asp:LinkButton ID="cAdmReportGrpGridDelete" CssClass="GrdDel" tooltip="DELETE" CommandName="Delete" onclientclick='GridDelete()' runat="server" />
	</td>
	</tr>
	</ItemTemplate>
	<EditItemTemplate>
    ...
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:right;' visible="<%# GridColumnVisible(0) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cReportGrpId94ml" runat="server" /></div>
		    <asp:TextBox id="cReportGrpId94" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ReportGrpId94").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(1) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cReportId94ml" runat="server" /></div>
		    <rcasp:ComboBox autocomplete="off" id="cReportId94" CssClass="GrdDdl" DataValueField="ReportId94" DataTextField="ReportId94Text" Mode="A" OnPostBack="cbPostBack" OnSearch="cbReportId94" runat="server" /><asp:RequiredFieldValidator id="cRFVReportId94" ControlToValidate="cReportId94" display="none" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:80px;text-align:left;' visible="<%# GridColumnVisible(2) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cReportGrpIndex94ml" runat="server" /></div>
		    <asp:TextBox id="cReportGrpIndex94" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"ReportGrpIndex94").ToString() %>' MaxLength="20" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(3) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cParentGrpId94ml" runat="server" /></div>
		    <asp:DropDownList id="cParentGrpId94" CssClass="GrdDdl" DataValueField="ParentGrpId94" DataTextField="ParentGrpId94Text" runat="server" /><asp:RequiredFieldValidator id="cRFVParentGrpId94" ControlToValidate="cParentGrpId94" display="none" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(4) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cReportGrpName94ml" runat="server" /></div>
		    <asp:TextBox id="cReportGrpName94" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"ReportGrpName94").ToString() %>' MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVReportGrpName94" ControlToValidate="cReportGrpName94" display="none" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:center;' visible="<%# GridColumnVisible(5) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cContentVertical94ml" runat="server" /></div>
		    <asp:CheckBox id="cContentVertical94" CssClass="GrdBox" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:center;' visible="<%# GridColumnVisible(6) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cLabelVertical94ml" runat="server" /></div>
		    <asp:CheckBox id="cLabelVertical94" CssClass="GrdBox" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:right;' visible="<%# GridColumnVisible(7) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cBorderWidth94ml" runat="server" /></div>
		    <asp:TextBox id="cBorderWidth94" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"BorderWidth94").ToString(),base.LUser.Culture) %>' runat="server" /><asp:RequiredFieldValidator id="cRFVBorderWidth94" ControlToValidate="cBorderWidth94" display="none" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(8) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cGrpStyle94ml" runat="server" /></div>
		    <asp:TextBox id="cGrpStyle94" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"GrpStyle94").ToString() %>' MaxLength="200" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmReportGrpGridCancel" CssClass="GrdCan" tooltip="CANCEL" OnClientClick="GridCancel();" CausesValidation="true" CommandName="Cancel" runat="server" />
       <asp:LinkButton ID="cAdmReportGrpGridUpdate" style="display:none;" CommandName="Update" runat="server" />
	</td>
	</tr>
	</EditItemTemplate>
	...
	<asp:DataPager ID="cAdmReportGrpGridDataPager" runat="server" Visible="false" PagedControlID="cAdmReportGrpGrid"></asp:DataPager>
</div></div></div>
