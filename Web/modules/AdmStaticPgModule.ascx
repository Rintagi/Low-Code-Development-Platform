<%@ Control Language="c#" Inherits="RO.Web.AdmStaticPgModule" CodeFile="AdmStaticPgModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmStaticPg114List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmStaticPg114List_SelectedIndexChanged" OnTextChanged="cAdmStaticPg114List_TextChanged" OnDDFindClick="cAdmStaticPg114List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="StaticPgId259" DataTextField="StaticPgId259Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<input type="hidden" id="cCurrentTab" style="display:none" value="cTab78" runat="server"/>
<ul id="tabs">
    <li><a id="cTab78" href="#" class="current" name="Tab78" runat="server"></a></li>
    <li><a id="cTab79" href="#" name="Tab79" runat="server"></a></li>
    <li><a id="cTab80" href="#" name="Tab80" runat="server"></a></li>
    <li><a id="cTab81" href="#" name="Tab81" runat="server"></a></li>
    <li><a id="cTab82" href="#" name="Tab82" runat="server"></a></li>
</ul>
<div id="content">
<div id="Tab78" runat="server">
    <asp:UpdatePanel id="UpdPanel78" UpdateMode="Conditional" runat="server"><Triggers></Triggers><ContentTemplate>
    <div class="r-table rg-1-12"><div class="r-tr">
    <div class="r-td rc-1-3"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cStaticPgId259P1" class="r-td r-labelR" runat="server"><asp:Label id="cStaticPgId259Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cStaticPgId259P2" class="r-td r-content" runat="server"><asp:TextBox id="cStaticPgId259" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cStaticPgNm259P1" class="r-td r-labelR" runat="server"><asp:Label id="cStaticPgNm259Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cStaticPgNm259P2" class="r-td r-content" runat="server"><asp:TextBox id="cStaticPgNm259" CssClass="inp-txt" MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVStaticPgNm259" ControlToValidate="cStaticPgNm259" display="none" runat="server" /><asp:ImageButton id="cStaticPgNm259Search" CssClass="r-icon" onclick="cStaticPgNm259Search_Click" runat="server" ImageUrl="~/Images/Link.gif" CausesValidation="true" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cStaticPgTitle259P1" class="r-td r-labelR" runat="server"><asp:Label id="cStaticPgTitle259Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cStaticPgTitle259P2" class="r-td r-content" runat="server"><asp:TextBox id="cStaticPgTitle259" CssClass="inp-txt" MaxLength="100" runat="server" /><asp:RequiredFieldValidator id="cRFVStaticPgTitle259" ControlToValidate="cStaticPgTitle259" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cMasterPgFile259P1" class="r-td r-labelR" runat="server"><asp:Label id="cMasterPgFile259Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cMasterPgFile259P2" class="r-td r-content" runat="server"><asp:TextBox id="cMasterPgFile259" CssClass="inp-txt" MaxLength="100" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cStaticCsId259P1" class="r-td r-labelR" runat="server"><asp:Label id="cStaticCsId259Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cStaticCsId259P2" class="r-td r-content" runat="server"><asp:DropDownList id="cStaticCsId259" CssClass="inp-ddl" DataValueField="StaticCsId259" DataTextField="StaticCsId259Text" runat="server" /><asp:ImageButton id="cStaticCsId259Search" CssClass="r-icon" onclick="cStaticCsId259Search_Click" runat="server" ImageUrl="~/Images/Link.gif" CausesValidation="true" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cStaticJsId259P1" class="r-td r-labelR" runat="server"><asp:Label id="cStaticJsId259Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cStaticJsId259P2" class="r-td r-content" runat="server"><asp:DropDownList id="cStaticJsId259" CssClass="inp-ddl" DataValueField="StaticJsId259" DataTextField="StaticJsId259Text" runat="server" /><asp:ImageButton id="cStaticJsId259Search" CssClass="r-icon" onclick="cStaticJsId259Search_Click" runat="server" ImageUrl="~/Images/Link.gif" CausesValidation="true" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-4-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cStaticPgUrl259P1" class="r-td r-labelR" runat="server"><asp:Label id="cStaticPgUrl259Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cStaticPgUrl259P2" class="r-td r-content" runat="server"><asp:HyperLink id="cStaticPgUrl259" CssClass="inp-txtln" runat="server" /></div>
    	</div>
    	<div class="r-tr">
...
<div id="Tab79" style="display:none;" runat="server">
    <asp:UpdatePanel id="UpdPanel79" UpdateMode="Conditional" runat="server"><Triggers></Triggers><ContentTemplate>
    <div class="r-table rg-1-12"><div class="r-tr">
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cStaticPgHtm259P1" class="r-td r-labelR" runat="server"><asp:Label id="cStaticPgHtm259Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cStaticPgHtm259P2" class="r-td r-content" runat="server"><ajwced:Editor NoScript="true" ActiveMode="Html" id="cStaticPgHtm259" CssClass="inp-txt" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
    </ContentTemplate></asp:UpdatePanel>
</div>
<div id="Tab80" style="display:none;" runat="server">
    <asp:UpdatePanel id="UpdPanel80" UpdateMode="Conditional" runat="server"><Triggers></Triggers><ContentTemplate>
    <div class="r-table rg-1-12"><div class="r-tr">
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
...
<div id="Tab81" style="display:none;" runat="server">
    <asp:UpdatePanel id="UpdPanel81" UpdateMode="Conditional" runat="server"><Triggers></Triggers><ContentTemplate>
    <div class="r-table rg-1-12"><div class="r-tr">
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
...
<div id="Tab82" style="display:none;" runat="server">
    <asp:UpdatePanel id="UpdPanel82" UpdateMode="Conditional" runat="server"><Triggers></Triggers><ContentTemplate>
    <div class="r-table rg-1-12"><div class="r-tr">
    <div class="r-td rc-1-12"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<asp:PlaceHolder id="cStaticPHolder" runat="server" />
    	</div>
    </div></div></div>
    </div></div>
    </ContentTemplate></asp:UpdatePanel>
