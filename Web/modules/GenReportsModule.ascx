<%@ Control Language="c#" Inherits="RO.Web.GenReportsModule" CodeFile="GenReportsModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
    ...
    <div class="r-td rc-7-12">
        <div class="wizard-content">
		    ...
		    <tr>
			    ...
			    <td align="right"><asp:Label ID="Label6" cssclass="inp-lbl" runat="server" text="All Reports:" /></td>
			    <td width="20px"><asp:CheckBox id="cAllReport" cssclass="inp-chk" AutoPostBack="true" onCheckedChanged="cAllReport_CheckedChanged" tooltip="Check here for all reports in the listbox below to be generated." Runat="server" /></td>
		    </tr>
		    <tr>
			    ...
			    <td><asp:ImageButton id="cSearchButton" ImageUrl="~/images/Search.gif" onClick="cSearchButton_Click" AlternateText="Click here to search for reports with specified text on the left." Runat="server" />
		    </tr>
		    <tr>
			    <td colspan="4">
				    <asp:listbox id="cReportList" runat="server" CssClass="inp-pic" SelectionMode="Multiple" AutoPostBack="false" rows="6" DataValueField="ReportId" DataTextField="ReportTitle" />
			    </td>
		    </tr>
		    </table>
        </div>
