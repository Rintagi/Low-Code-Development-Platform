<%@ Control Language="c#" Inherits="RO.Web.AdmTbdRuleModule" CodeFile="AdmTbdRuleModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmTbdRule113List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmTbdRule113List_SelectedIndexChanged" OnTextChanged="cAdmTbdRule113List_TextChanged" OnDDFindClick="cAdmTbdRule113List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="TbdRuleId254" DataTextField="TbdRuleId254Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-8"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cTbdRuleId254P1" class="r-td r-labelR" runat="server"><asp:Label id="cTbdRuleId254Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cTbdRuleId254P2" class="r-td r-content" runat="server"><asp:TextBox id="cTbdRuleId254" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cScreenId254P1" class="r-td r-labelR" runat="server"><asp:Label id="cScreenId254Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cScreenId254P2" class="r-td r-content" runat="server"><rcasp:ComboBox autocomplete="off" id="cScreenId254" CssClass="inp-ddl" Mode="A" OnPostBack="cbPostBack" OnSearch="cbScreenId254" DataValueField="ScreenId254" DataTextField="ScreenId254Text" runat="server" /><asp:RequiredFieldValidator id="cRFVScreenId254" ControlToValidate="cScreenId254" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cTbdRuleName254P1" class="r-td r-labelR" runat="server"><asp:Label id="cTbdRuleName254Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cTbdRuleName254P2" class="r-td r-content" runat="server"><asp:TextBox id="cTbdRuleName254" CssClass="inp-txt" MaxLength="100" runat="server" /><asp:RequiredFieldValidator id="cRFVTbdRuleName254" ControlToValidate="cTbdRuleName254" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cTbdRuleDesc254P1" class="r-td r-labelR" runat="server"><asp:Label id="cTbdRuleDesc254Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cTbdRuleDesc254P2" class="r-td r-content" runat="server"><asp:TextBox TextMode="MultiLine" autocomplete="new-password" id="cTbdRuleDesc254" CssClass="inp-txt" runat="server" /><asp:Image id="cTbdRuleDesc254E" ImageUrl="~/images/Expand.gif" CssClass="r-icon show-expand-button" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
