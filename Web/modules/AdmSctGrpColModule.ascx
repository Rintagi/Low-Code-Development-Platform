<%@ Control Language="c#" Inherits="RO.Web.AdmSctGrpColModule" CodeFile="AdmSctGrpColModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmSctGrpCol1003List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmSctGrpCol1003List_SelectedIndexChanged" OnTextChanged="cAdmSctGrpCol1003List_TextChanged" OnDDFindClick="cAdmSctGrpCol1003List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="SctGrpColId1284" DataTextField="SctGrpColId1284Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-4"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cSctGrpColId1284P1" class="r-td r-labelR" runat="server"><asp:Label id="cSctGrpColId1284Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cSctGrpColId1284P2" class="r-td r-content" runat="server"><asp:TextBox id="cSctGrpColId1284" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cSectionCd1284P1" class="r-td r-labelR" runat="server"><asp:Label id="cSectionCd1284Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cSectionCd1284P2" class="r-td r-content" runat="server"><asp:DropDownList id="cSectionCd1284" CssClass="inp-ddl" DataValueField="SectionCd1284" DataTextField="SectionCd1284Text" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cGroupColId1284P1" class="r-td r-labelR" runat="server"><asp:Label id="cGroupColId1284Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cGroupColId1284P2" class="r-td r-content" runat="server"><asp:DropDownList id="cGroupColId1284" CssClass="inp-ddl" DataValueField="GroupColId1284" DataTextField="GroupColId1284Text" runat="server" /></div>
    	</div>
    </div></div></div>
    <div class="r-td rc-5-12"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div class="r-td"></div>
    		<div id="cSctGrpColCss1284P1" class="r-td r-labelL r-labelT" runat="server"><asp:Label id="cSctGrpColCss1284Label" CssClass="inp-lbl" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div class="r-td"></div>
    	...
    	<div class="r-tr">
    		<div class="r-td"></div>
    		<div id="cSctGrpColDiv1284P1" class="r-td r-labelL r-labelT" runat="server"><asp:Label id="cSctGrpColDiv1284Label" CssClass="inp-lbl" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div class="r-td"></div>
