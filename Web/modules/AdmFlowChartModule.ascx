<%@ Control Language="c#" Inherits="RO.Web.AdmFlowchartModule" CodeFile="AdmFlowchartModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmFlowchart1027List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmFlowchart1027List_SelectedIndexChanged" OnTextChanged="cAdmFlowchart1027List_TextChanged" OnDDFindClick="cAdmFlowchart1027List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="ChartId1325" DataTextField="ChartId1325Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-4"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cChartId1325P1" class="r-td r-labelR" runat="server"><asp:Label id="cChartId1325Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cChartId1325P2" class="r-td r-content" runat="server"><asp:TextBox id="cChartId1325" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cChartName1325P1" class="r-td r-labelR" runat="server"><asp:Label id="cChartName1325Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cChartName1325P2" class="r-td r-content" runat="server"><asp:TextBox id="cChartName1325" CssClass="inp-txt" MaxLength="500" runat="server" /><asp:RequiredFieldValidator id="cRFVChartName1325" ControlToValidate="cChartName1325" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    ...
    <div class="r-td rc-11-12"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="claunchP1" class="r-td r-labelR" runat="server"><asp:Label id="claunchLabel" CssClass="inp-lbl" runat="server" /></div>
    		<div id="claunchP2" class="r-td r-content" runat="server"><asp:Button id="claunch" CssClass="small blue button" OnClick="claunch_Click" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cViewP1" class="r-td r-labelR" runat="server"><asp:Label id="cViewLabel" CssClass="inp-lbl" runat="server" /></div>
