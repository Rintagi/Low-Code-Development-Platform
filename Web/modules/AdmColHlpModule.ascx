<%@ Control Language="c#" Inherits="RO.Web.AdmColHlpModule" CodeFile="AdmColHlpModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmColHlp1006List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmColHlp1006List_SelectedIndexChanged" OnTextChanged="cAdmColHlp1006List_TextChanged" OnDDFindClick="cAdmColHlp1006List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="ScreenObjId14" DataTextField="ScreenObjId14Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="ListView">
	<asp:ListView id="cAdmColHlpGrid" DataKeyNames="ScreenObjHlpId21" OnItemCommand="cAdmColHlpGrid_OnItemCommand" OnSorting="cAdmColHlpGrid_OnSorting" OnPreRender="cAdmColHlpGrid_OnPreRender" OnPagePropertiesChanging="cAdmColHlpGrid_OnPagePropertiesChanging" OnItemEditing="cAdmColHlpGrid_OnItemEditing" OnItemCanceling="cAdmColHlpGrid_OnItemCanceling" OnItemDeleting="cAdmColHlpGrid_OnItemDeleting" OnItemDataBound="cAdmColHlpGrid_OnItemDataBound" OnLayoutCreated="cAdmColHlpGrid_OnLayoutCreated" OnItemUpdating="cAdmColHlpGrid_OnItemUpdating" runat="server">
	<LayoutTemplate>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr id="cAdmColHlpGridHeader" class="GrdHead" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:right;' runat="server">
			<asp:LinkButton id="cScreenObjHlpId21hl" CssClass="GrdHead" onClick="cScreenObjHlpId21hl_Click" runat="server" /><asp:Image id="cScreenObjHlpId21hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
			<asp:LinkButton id="cCultureId21hl" CssClass="GrdHead" onClick="cCultureId21hl_Click" style="font-weight:bold; color:black;" runat="server" /><asp:Image id="cCultureId21hi" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
			<asp:LinkButton id="cColumnHeader21hl" CssClass="GrdHead" onClick="cColumnHeader21hl_Click" style="font-weight:bold; color:#555555;" runat="server" /><asp:Image id="cColumnHeader21hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:400px;text-align:left;' runat="server">
			<asp:LinkButton id="cToolTip21hl" CssClass="GrdHead" onClick="cToolTip21hl_Click" style="font-weight:bold; color:#00468C;" runat="server" /><asp:Image id="cToolTip21hi" runat="server" />
		</div><div class='GrdInner' style='max-width:350px;text-align:left;' runat="server">
			<asp:LinkButton id="cErrMessage21hl" CssClass="GrdHead" onClick="cErrMessage21hl_Click" style="color:#50852C;" runat="server" /><asp:Image id="cErrMessage21hi" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:750px;text-align:left;' runat="server">
			<asp:LinkButton id="cTbHint21hl" CssClass="GrdHead" onClick="cTbHint21hl_Click" style="color:#50852C;" runat="server" /><asp:Image id="cTbHint21hi" runat="server" />
		</div></div>
    </td>
	...
	<tr id="cAdmColHlpGridFooter" class="GrdFoot" visible="false" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:right;' runat="server">
		    <asp:Label id="cScreenObjHlpId21fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
		    <asp:Label id="cCultureId21fl" class='GrdFoot' runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
		    <asp:Label id="cColumnHeader21fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:400px;text-align:left;' runat="server">
		    <asp:Label id="cToolTip21fl" class='GrdFoot' runat="server" />
		</div><div class='GrdInner' style='max-width:350px;text-align:left;' runat="server">
		    <asp:Label id="cErrMessage21fl" class='GrdFoot' runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:750px;text-align:left;' runat="server">
		    <asp:Label id="cTbHint21fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr></table></LayoutTemplate>
	<ItemTemplate>
	<tr id="cAdmColHlpGridRow" class='<%# Container.DisplayIndex % 2 == 0 ? "GrdItm" : "GrdAlt" %>' runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:right;' visible="<%# GridColumnVisible(1) %>" onclick='GridEdit("ScreenObjHlpId21")' runat="server">
			<asp:Label id="cScreenObjHlpId21l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ScreenObjHlpId21").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(2) %>" onclick='GridEdit("CultureId21")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"CultureId21").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cCultureId21l" text='<%# DataBinder.Eval(Container.DataItem,"CultureId21Text") %>' CssClass="GrdTxtLb" style="font-weight:bold; color:black;" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(3) %>" onclick='GridEdit("ColumnHeader21")' runat="server">
			<asp:Label id="cColumnHeader21l" Text='<%# DataBinder.Eval(Container.DataItem,"ColumnHeader21").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" style="font-weight:bold; color:#555555;" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:400px;text-align:left;' visible="<%# GridColumnVisible(4) %>" onclick='GridEdit("ToolTip21")' runat="server">
			<asp:Label id="cToolTip21l" Text='<%# DataBinder.Eval(Container.DataItem,"ToolTip21").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" style="font-weight:bold; color:#00468C;" runat="server" />
		</div><div class='GrdInner' style='max-width:350px;text-align:left;' visible="<%# GridColumnVisible(5) %>" onclick='GridEdit("ErrMessage21")' runat="server">
			<asp:Label id="cErrMessage21l" Text='<%# DataBinder.Eval(Container.DataItem,"ErrMessage21").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" style="color:#50852C;" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:750px;text-align:left;' visible="<%# GridColumnVisible(6) %>" onclick='GridEdit("TbHint21")' runat="server">
			<asp:Label id="cTbHint21l" Text='<%# DataBinder.Eval(Container.DataItem,"TbHint21").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" style="color:#50852C;" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmColHlpGridEdit" style="display:none;" CausesValidation="true" CommandName="Edit" runat="server" />
       <asp:LinkButton ID="cAdmColHlpGridDelete" CssClass="GrdDel" tooltip="DELETE" CommandName="Delete" onclientclick='GridDelete()' runat="server" />
	</td>
	</tr>
	</ItemTemplate>
	<EditItemTemplate>
    ...
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:50px;text-align:right;' visible="<%# GridColumnVisible(1) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cScreenObjHlpId21ml" runat="server" /></div>
		    <asp:TextBox id="cScreenObjHlpId21" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ScreenObjHlpId21").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(2) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cCultureId21ml" runat="server" /></div>
		    <rcasp:ComboBox autocomplete="off" id="cCultureId21" CssClass="GrdDdl" DataValueField="CultureId21" DataTextField="CultureId21Text" Mode="A" OnPostBack="cbPostBack" OnSearch="cbCultureId21" runat="server" /><asp:RequiredFieldValidator id="cRFVCultureId21" ControlToValidate="cCultureId21" display="none" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(3) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cColumnHeader21ml" runat="server" /></div>
		<table cellspacing="0" cellpadding="0"><tr><td>
		    <asp:TextBox TextMode="MultiLine" autocomplete="new-password" id="cColumnHeader21" CssClass="GrdTxt" height="52px" Text='<%# DataBinder.Eval(Container.DataItem,"ColumnHeader21").ToString() %>' runat="server" /></td><td><asp:Image id="cColumnHeader21E" ImageUrl="~/images/Expand.gif" CssClass="show-expand-button" runat="server" />
		</td></tr></table>
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:400px;text-align:left;' visible="<%# GridColumnVisible(4) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cToolTip21ml" runat="server" /></div>
		    <asp:TextBox id="cToolTip21" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"ToolTip21").ToString() %>' MaxLength="1000" runat="server" />
		</div><div class='GrdInner' style='max-width:350px;text-align:left;' visible="<%# GridColumnVisible(5) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cErrMessage21ml" runat="server" /></div>
		    <asp:TextBox id="cErrMessage21" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"ErrMessage21").ToString() %>' MaxLength="1000" runat="server" />
		</div></div>
		<div></div>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:750px;text-align:left;' visible="<%# GridColumnVisible(6) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cTbHint21ml" runat="server" /></div>
		<table cellspacing="0" cellpadding="0"><tr><td>
		    <asp:TextBox TextMode="MultiLine" autocomplete="new-password" id="cTbHint21" CssClass="GrdTxt" height="52px" Text='<%# DataBinder.Eval(Container.DataItem,"TbHint21").ToString() %>' runat="server" /><asp:RegularExpressionValidator ControlToValidate="cTbHint21" display="none" ErrorMessage="TbHint <= 1000 characters please." ValidationExpression="^[\s\S]{0,1000}$" runat="server" /></td><td><asp:Image id="cTbHint21E" ImageUrl="~/images/Expand.gif" CssClass="show-expand-button" runat="server" />
		</td></tr></table>
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmColHlpGridCancel" CssClass="GrdCan" tooltip="CANCEL" OnClientClick="GridCancel();" CausesValidation="true" CommandName="Cancel" runat="server" />
       <asp:LinkButton ID="cAdmColHlpGridUpdate" style="display:none;" CommandName="Update" runat="server" />
	</td>
	</tr>
	</EditItemTemplate>
	...
	<asp:DataPager ID="cAdmColHlpGridDataPager" runat="server" Visible="false" PagedControlID="cAdmColHlpGrid"></asp:DataPager>
</div></div></div>
</asp:Panel>
