<%@ Control Language="c#" Inherits="RO.Web.AdmScrAuditDtlModule" CodeFile="AdmScrAuditDtlModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
...
<div class="ListView">
	<asp:ListView id="cAdmScrAuditDtlGrid" DataKeyNames="ScrAuditDtlId1301" OnItemCommand="cAdmScrAuditDtlGrid_OnItemCommand" OnSorting="cAdmScrAuditDtlGrid_OnSorting" OnPreRender="cAdmScrAuditDtlGrid_OnPreRender" OnPagePropertiesChanging="cAdmScrAuditDtlGrid_OnPagePropertiesChanging" OnItemEditing="cAdmScrAuditDtlGrid_OnItemEditing" OnItemCanceling="cAdmScrAuditDtlGrid_OnItemCanceling" OnItemDeleting="cAdmScrAuditDtlGrid_OnItemDeleting" OnItemDataBound="cAdmScrAuditDtlGrid_OnItemDataBound" OnLayoutCreated="cAdmScrAuditDtlGrid_OnLayoutCreated" OnItemUpdating="cAdmScrAuditDtlGrid_OnItemUpdating" runat="server">
	<LayoutTemplate>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr id="cAdmScrAuditDtlGridHeader" class="GrdHead" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' runat="server">
			<asp:LinkButton id="cScrAuditDtlId1301hl" CssClass="GrdHead" onClick="cScrAuditDtlId1301hl_Click" runat="server" /><asp:Image id="cScrAuditDtlId1301hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' runat="server">
			<asp:LinkButton id="cScrAuditId1301hl" CssClass="GrdHead" onClick="cScrAuditId1301hl_Click" runat="server" /><asp:Image id="cScrAuditId1301hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:100px;text-align:right;' runat="server">
			<asp:LinkButton id="cScreenObjId1301hl" CssClass="GrdHead" onClick="cScreenObjId1301hl_Click" runat="server" /><asp:Image id="cScreenObjId1301hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' runat="server">
			<asp:LinkButton id="cScreenObjDesc1301hl" CssClass="GrdHead" onClick="cScreenObjDesc1301hl_Click" runat="server" /><asp:Image id="cScreenObjDesc1301hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:100px;text-align:right;' runat="server">
			<asp:LinkButton id="cColumnId1301hl" CssClass="GrdHead" onClick="cColumnId1301hl_Click" runat="server" /><asp:Image id="cColumnId1301hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:150px;text-align:left;' runat="server">
			<asp:LinkButton id="cColumnDesc1301hl" CssClass="GrdHead" onClick="cColumnDesc1301hl_Click" runat="server" /><asp:Image id="cColumnDesc1301hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
			<asp:LinkButton id="cChangedFr1301hl" CssClass="GrdHead" onClick="cChangedFr1301hl_Click" runat="server" /><asp:Image id="cChangedFr1301hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
			<asp:LinkButton id="cChangedTo1301hl" CssClass="GrdHead" onClick="cChangedTo1301hl_Click" runat="server" /><asp:Image id="cChangedTo1301hi" runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr>
	<tr id="itemPlaceholder" runat="server"></tr>
	<tr id="cAdmScrAuditDtlGridFooter" class="GrdFoot" visible="false" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' runat="server">
		    <asp:Label id="cScrAuditDtlId1301fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' runat="server">
		    <asp:Label id="cScrAuditId1301fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:100px;text-align:right;' runat="server">
		    <asp:Label id="cScreenObjId1301fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' runat="server">
		    <asp:Label id="cScreenObjDesc1301fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:100px;text-align:right;' runat="server">
		    <asp:Label id="cColumnId1301fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:150px;text-align:left;' runat="server">
		    <asp:Label id="cColumnDesc1301fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
		    <asp:Label id="cChangedFr1301fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' runat="server">
		    <asp:Label id="cChangedTo1301fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr></table></LayoutTemplate>
	<ItemTemplate>
	<tr id="cAdmScrAuditDtlGridRow" class='<%# Container.DisplayIndex % 2 == 0 ? "GrdItm" : "GrdAlt" %>' runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' visible="<%# GridColumnVisible(0) %>" onclick='GridEdit("ScrAuditDtlId1301")' runat="server">
			<asp:Label id="cScrAuditDtlId1301l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ScrAuditDtlId1301").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' visible="<%# GridColumnVisible(1) %>" onclick='GridEdit("ScrAuditId1301")' runat="server">
			<asp:Label id="cScrAuditId1301l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ScrAuditId1301").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:100px;text-align:right;' visible="<%# GridColumnVisible(2) %>" onclick='GridEdit("ScreenObjId1301")' runat="server">
			<asp:Label id="cScreenObjId1301l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ScreenObjId1301").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' visible="<%# GridColumnVisible(3) %>" onclick='GridEdit("ScreenObjDesc1301")' runat="server">
			<asp:Label id="cScreenObjDesc1301l" Text='<%# DataBinder.Eval(Container.DataItem,"ScreenObjDesc1301").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnTablet HideObjOnMobile' style='max-width:100px;text-align:right;' visible="<%# GridColumnVisible(4) %>" onclick='GridEdit("ColumnId1301")' runat="server">
			<asp:Label id="cColumnId1301l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ColumnId1301").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner HideObjOnMobile' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(5) %>" onclick='GridEdit("ColumnDesc1301")' runat="server">
			<asp:Label id="cColumnDesc1301l" Text='<%# DataBinder.Eval(Container.DataItem,"ColumnDesc1301").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(6) %>" onclick='GridEdit("ChangedFr1301")' runat="server">
			<asp:Label id="cChangedFr1301l" Text='<%# DataBinder.Eval(Container.DataItem,"ChangedFr1301").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(7) %>" onclick='GridEdit("ChangedTo1301")' runat="server">
			<asp:Label id="cChangedTo1301l" Text='<%# DataBinder.Eval(Container.DataItem,"ChangedTo1301").ToString().Replace("\r\n","<br />").Replace("\r","<br />").Replace("\n","<br />").Replace("  ",HtmlSpace()) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmScrAuditDtlGridEdit" style="display:none;" CausesValidation="true" CommandName="Edit" runat="server" />
       <asp:LinkButton ID="cAdmScrAuditDtlGridDelete" CssClass="GrdDel" tooltip="DELETE" CommandName="Delete" onclientclick='GridDelete()' runat="server" />
	</td>
	</tr>
	</ItemTemplate>
	<EditItemTemplate>
    ...
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' visible="<%# GridColumnVisible(0) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cScrAuditDtlId1301ml" runat="server" /></div>
		    <asp:TextBox id="cScrAuditDtlId1301" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ScrAuditDtlId1301").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' visible="<%# GridColumnVisible(1) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cScrAuditId1301ml" runat="server" /></div>
		    <asp:TextBox id="cScrAuditId1301" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ScrAuditId1301").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' visible="<%# GridColumnVisible(2) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cScreenObjId1301ml" runat="server" /></div>
		    <asp:TextBox id="cScreenObjId1301" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ScreenObjId1301").ToString(),base.LUser.Culture) %>' runat="server" /><asp:RequiredFieldValidator id="cRFVScreenObjId1301" ControlToValidate="cScreenObjId1301" display="none" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:200px;text-align:left;' visible="<%# GridColumnVisible(3) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cScreenObjDesc1301ml" runat="server" /></div>
		    <asp:TextBox id="cScreenObjDesc1301" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"ScreenObjDesc1301").ToString() %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:100px;text-align:right;' visible="<%# GridColumnVisible(4) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cColumnId1301ml" runat="server" /></div>
		    <asp:TextBox id="cColumnId1301" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"ColumnId1301").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:150px;text-align:left;' visible="<%# GridColumnVisible(5) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cColumnDesc1301ml" runat="server" /></div>
		    <asp:TextBox id="cColumnDesc1301" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"ColumnDesc1301").ToString() %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(6) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cChangedFr1301ml" runat="server" /></div>
		    <asp:TextBox id="cChangedFr1301" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"ChangedFr1301").ToString() %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='max-width:300px;text-align:left;' visible="<%# GridColumnVisible(7) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cChangedTo1301ml" runat="server" /></div>
		    <asp:TextBox id="cChangedTo1301" CssClass="GrdTxt" Text='<%# DataBinder.Eval(Container.DataItem,"ChangedTo1301").ToString() %>' runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmScrAuditDtlGridCancel" CssClass="GrdCan" tooltip="CANCEL" OnClientClick="GridCancel();" CausesValidation="true" CommandName="Cancel" runat="server" />
       <asp:LinkButton ID="cAdmScrAuditDtlGridUpdate" style="display:none;" CommandName="Update" runat="server" />
	</td>
	</tr>
	</EditItemTemplate>
	...
	<asp:DataPager ID="cAdmScrAuditDtlGridDataPager" runat="server" Visible="false" PagedControlID="cAdmScrAuditDtlGrid"></asp:DataPager>
</div></div></div>
