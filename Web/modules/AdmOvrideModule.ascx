<%@ Control Language="c#" Inherits="RO.Web.AdmOvrideModule" CodeFile="AdmOvrideModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmOvride78List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmOvride78List_SelectedIndexChanged" OnTextChanged="cAdmOvride78List_TextChanged" OnDDFindClick="cAdmOvride78List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="OvrideId122" DataTextField="OvrideId122Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cOvrideId122P1" class="r-td r-labelR" runat="server"><asp:Label id="cOvrideId122Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cOvrideId122P2" class="r-td r-content" runat="server"><asp:TextBox id="cOvrideId122" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cOvrideName122P1" class="r-td r-labelR" runat="server"><asp:Label id="cOvrideName122Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cOvrideName122P2" class="r-td r-content" runat="server"><asp:TextBox id="cOvrideName122" CssClass="inp-txt" MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVOvrideName122" ControlToValidate="cOvrideName122" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cPromptAlways122P1" class="r-td r-labelR" runat="server"><asp:Label id="cPromptAlways122Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cPromptAlways122P2" class="r-td r-content" runat="server"><asp:CheckBox id="cPromptAlways122" CssClass="inp-chk" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cPromptModal122P1" class="r-td r-labelR" runat="server"><asp:Label id="cPromptModal122Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cPromptModal122P2" class="r-td r-content" runat="server"><asp:CheckBox id="cPromptModal122" CssClass="inp-chk" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
...
<div class="ListView">
	<asp:ListView id="cAdmOvrideGrid" DataKeyNames="OvrideGrpId123" OnItemCommand="cAdmOvrideGrid_OnItemCommand" OnSorting="cAdmOvrideGrid_OnSorting" OnPreRender="cAdmOvrideGrid_OnPreRender" OnPagePropertiesChanging="cAdmOvrideGrid_OnPagePropertiesChanging" OnItemEditing="cAdmOvrideGrid_OnItemEditing" OnItemCanceling="cAdmOvrideGrid_OnItemCanceling" OnItemDeleting="cAdmOvrideGrid_OnItemDeleting" OnItemDataBound="cAdmOvrideGrid_OnItemDataBound" OnLayoutCreated="cAdmOvrideGrid_OnLayoutCreated" OnItemUpdating="cAdmOvrideGrid_OnItemUpdating" runat="server">
	<LayoutTemplate>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr id="cAdmOvrideGridHeader" class="GrdHead" visible="true" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
			<asp:LinkButton id="cOvrideGrpId123hl" CssClass="GrdHead" onClick="cOvrideGrpId123hl_Click" runat="server" /><asp:Image id="cOvrideGrpId123hi" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
			<asp:LinkButton id="cUsrGroupId123hl" CssClass="GrdHead" onClick="cUsrGroupId123hl_Click" runat="server" /><asp:Image id="cUsrGroupId123hi" runat="server" />
		</div></div>
    </td>
	...
	<tr id="cAdmOvrideGridFooter" class="GrdFoot" visible="false" runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' runat="server">
		    <asp:Label id="cOvrideGrpId123fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' runat="server">
		    <asp:Label id="cUsrGroupId123fl" class='GrdFoot' runat="server" />
		</div></div>
    </td>
    <td>&nbsp;</td>
	</tr></table></LayoutTemplate>
	<ItemTemplate>
	<tr id="cAdmOvrideGridRow" class='<%# Container.DisplayIndex % 2 == 0 ? "GrdItm" : "GrdAlt" %>' runat="server">
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(4) %>" onclick='GridEdit("OvrideGrpId123")' runat="server">
			<asp:Label id="cOvrideGrpId123l" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"OvrideGrpId123").ToString(),base.LUser.Culture) %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(5) %>" onclick='GridEdit("UsrGroupId123")' runat="server">
			<asp:Label Text='<%# DataBinder.Eval(Container.DataItem,"UsrGroupId123").ToString() %>' Visible="false" runat="server" />
			<asp:Label id="cUsrGroupId123l" text='<%# DataBinder.Eval(Container.DataItem,"UsrGroupId123Text") %>' CssClass="GrdTxtLb" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmOvrideGridEdit" style="display:none;" CausesValidation="true" CommandName="Edit" runat="server" />
       <asp:LinkButton ID="cAdmOvrideGridDelete" CssClass="GrdDel" tooltip="DELETE" CommandName="Delete" onclientclick='GridDelete()' runat="server" />
	</td>
	</tr>
	</ItemTemplate>
	<EditItemTemplate>
    ...
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:right;' visible="<%# GridColumnVisible(4) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cOvrideGrpId123ml" runat="server" /></div>
		    <asp:TextBox id="cOvrideGrpId123" CssClass="GrdNum" Text='<%# RO.Common3.Utils.fmNumeric("0",DataBinder.Eval(Container.DataItem,"OvrideGrpId123").ToString(),base.LUser.Culture) %>' runat="server" />
		</div></div>
    </td>
    <td>
		<div class='GrdOuter' runat="server"><div class='GrdInner' style='text-align:left;' visible="<%# GridColumnVisible(5) %>" runat="server"><div class="GrdEdtLabelText"><asp:label id="cUsrGroupId123ml" runat="server" /></div>
		    <asp:DropDownList id="cUsrGroupId123" CssClass="GrdDdl" DataValueField="UsrGroupId123" DataTextField="UsrGroupId123Text" runat="server" /><asp:RequiredFieldValidator id="cRFVUsrGroupId123" ControlToValidate="cUsrGroupId123" display="none" runat="server" />
		</div></div>
    </td>
	<td>
       <asp:LinkButton ID="cAdmOvrideGridCancel" CssClass="GrdCan" tooltip="CANCEL" OnClientClick="GridCancel();" CausesValidation="true" CommandName="Cancel" runat="server" />
       <asp:LinkButton ID="cAdmOvrideGridUpdate" style="display:none;" CommandName="Update" runat="server" />
	</td>
	</tr>
	</EditItemTemplate>
	...
	<asp:DataPager ID="cAdmOvrideGridDataPager" runat="server" Visible="false" PagedControlID="cAdmOvrideGrid"></asp:DataPager>
</div></div></div>
</asp:Panel>
