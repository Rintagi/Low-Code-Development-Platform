<%@ Control Language="c#" Inherits="RO.Web.AdmDbKeyModule" CodeFile="AdmDbKeyModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmDbKey15List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmDbKey15List_SelectedIndexChanged" OnTextChanged="cAdmDbKey15List_TextChanged" OnDDFindClick="cAdmDbKey15List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="KeyId20" DataTextField="KeyId20Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cKeyId20P1" class="r-td r-labelR" runat="server"><asp:Label id="cKeyId20Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cKeyId20P2" class="r-td r-content" runat="server"><asp:TextBox id="cKeyId20" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cKeyName20P1" class="r-td r-labelR" runat="server"><asp:Label id="cKeyName20Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cKeyName20P2" class="r-td r-content" runat="server"><asp:TextBox id="cKeyName20" CssClass="inp-txt" MaxLength="50" runat="server" /><asp:RequiredFieldValidator id="cRFVKeyName20" ControlToValidate="cKeyName20" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cTableId20P1" class="r-td r-labelR" runat="server"><asp:Label id="cTableId20Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cTableId20P2" class="r-td r-content" runat="server"><rcasp:ComboBox autocomplete="off" id="cTableId20" CssClass="inp-ddl" Mode="A" OnPostBack="cbPostBack" OnSearch="cbTableId20" DataValueField="TableId20" DataTextField="TableId20Text" AutoPostBack="true" OnSelectedIndexChanged="cTableId20_SelectedIndexChanged" OnTextChanged="cTableId20_TextChanged" OnDDFindClick="cTableId20_DDFindClick" runat="server" /><asp:RequiredFieldValidator id="cRFVTableId20" ControlToValidate="cTableId20" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cColumnId20P1" class="r-td r-labelR" runat="server"><asp:Label id="cColumnId20Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cColumnId20P2" class="r-td r-content" runat="server"><rcasp:ComboBox autocomplete="off" id="cColumnId20" CssClass="inp-ddl" Mode="A" OnPostBack="cbPostBack" OnSearch="cbColumnId20" DataValueField="ColumnId20" DataTextField="ColumnId20Text" runat="server" /><asp:RequiredFieldValidator id="cRFVColumnId20" ControlToValidate="cColumnId20" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cRefTableId20P1" class="r-td r-labelR" runat="server"><asp:Label id="cRefTableId20Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRefTableId20P2" class="r-td r-content" runat="server"><rcasp:ComboBox autocomplete="off" id="cRefTableId20" CssClass="inp-ddl" Mode="A" OnPostBack="cbPostBack" OnSearch="cbRefTableId20" DataValueField="RefTableId20" DataTextField="RefTableId20Text" AutoPostBack="true" OnSelectedIndexChanged="cRefTableId20_SelectedIndexChanged" OnTextChanged="cRefTableId20_TextChanged" OnDDFindClick="cRefTableId20_DDFindClick" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cRefColumnId20P1" class="r-td r-labelR" runat="server"><asp:Label id="cRefColumnId20Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRefColumnId20P2" class="r-td r-content" runat="server"><rcasp:ComboBox autocomplete="off" id="cRefColumnId20" CssClass="inp-ddl" Mode="A" OnPostBack="cbPostBack" OnSearch="cbRefColumnId20" DataValueField="RefColumnId20" DataTextField="RefColumnId20Text" runat="server" /><asp:RequiredFieldValidator id="cRFVRefColumnId20" ControlToValidate="cRefColumnId20" display="none" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
