<%@ Control Language="c#" Inherits="RO.Web.AdmRptChaModule" CodeFile="AdmRptChaModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmRptCha100List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmRptCha100List_SelectedIndexChanged" OnTextChanged="cAdmRptCha100List_TextChanged" OnDDFindClick="cAdmRptCha100List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="RptChaId206" DataTextField="RptChaId206Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-6"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	<div class="r-tr">
    		<div id="cRptChaId206P1" class="r-td r-labelR" runat="server"><asp:Label id="cRptChaId206Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRptChaId206P2" class="r-td r-content" runat="server"><asp:TextBox id="cRptChaId206" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cRptCtrId206P1" class="r-td r-labelR" runat="server"><asp:Label id="cRptCtrId206Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRptCtrId206P2" class="r-td r-content" runat="server"><rcasp:ComboBox autocomplete="off" id="cRptCtrId206" CssClass="inp-ddl" Mode="A" OnPostBack="cbPostBack" OnSearch="cbRptCtrId206" DataValueField="RptCtrId206" DataTextField="RptCtrId206Text" runat="server" /><asp:RequiredFieldValidator id="cRFVRptCtrId206" ControlToValidate="cRptCtrId206" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cReportId206P1" class="r-td r-labelR" runat="server"><asp:Label id="cReportId206Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cReportId206P2" class="r-td r-content" runat="server"><rcasp:ComboBox autocomplete="off" id="cReportId206" CssClass="inp-ddl" Mode="A" OnPostBack="cbPostBack" OnSearch="cbReportId206" DataValueField="ReportId206" DataTextField="ReportId206Text" AutoPostBack="true" OnSelectedIndexChanged="cReportId206_SelectedIndexChanged" OnTextChanged="cReportId206_TextChanged" OnDDFindClick="cReportId206_DDFindClick" runat="server" /><asp:RequiredFieldValidator id="cRFVReportId206" ControlToValidate="cReportId206" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cRptChaTypeCd206P1" class="r-td r-labelR" runat="server"><asp:Label id="cRptChaTypeCd206Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cRptChaTypeCd206P2" class="r-td r-content" runat="server"><asp:DropDownList id="cRptChaTypeCd206" CssClass="inp-ddl" DataValueField="RptChaTypeCd206" DataTextField="RptChaTypeCd206Text" runat="server" /><asp:RequiredFieldValidator id="cRFVRptChaTypeCd206" ControlToValidate="cRptChaTypeCd206" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cThreeD206P1" class="r-td r-labelR" runat="server"><asp:Label id="cThreeD206Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cThreeD206P2" class="r-td r-content" runat="server"><asp:CheckBox id="cThreeD206" CssClass="inp-chk" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cCategoryGrp206P1" class="r-td r-labelR" runat="server"><asp:Label id="cCategoryGrp206Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCategoryGrp206P2" class="r-td r-content" runat="server"><asp:DropDownList id="cCategoryGrp206" CssClass="inp-ddl" DataValueField="CategoryGrp206" DataTextField="CategoryGrp206Text" runat="server" /><asp:RequiredFieldValidator id="cRFVCategoryGrp206" ControlToValidate="cCategoryGrp206" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cChartData206P1" class="r-td r-labelR" runat="server"><asp:Label id="cChartData206Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cChartData206P2" class="r-td r-content" runat="server"><asp:TextBox id="cChartData206" CssClass="inp-txt" MaxLength="1000" runat="server" /><asp:RequiredFieldValidator id="cRFVChartData206" ControlToValidate="cChartData206" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cSeriesGrp206P1" class="r-td r-labelR" runat="server"><asp:Label id="cSeriesGrp206Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cSeriesGrp206P2" class="r-td r-content" runat="server"><asp:DropDownList id="cSeriesGrp206" CssClass="inp-ddl" DataValueField="SeriesGrp206" DataTextField="SeriesGrp206Text" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
