<%@ Control Language="c#" Inherits="RO.Web.AdmMenuDrgModule" CodeFile="AdmMenuDrgModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
        ...
        <div id="cScreenSearch" class="screen-search" runat="server">
            <div class="r-table">
                <div class="r-tr">
                    ...
                    <div class="r-td r-content"><rcasp:ComboBox autocomplete="off" id="cAdmMenuDrg121List" CssClass="inp-ddl" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cAdmMenuDrg121List_SelectedIndexChanged" OnTextChanged="cAdmMenuDrg121List_TextChanged" OnDDFindClick="cAdmMenuDrg121List_DDFindClick" Mode="A" OnPostBack="cbPostBack" DataValueField="MenuId39" DataTextField="MenuId39Text" /></div>
                </div>
            </div>
        </div>
    </div>
...
<asp:Panel id="cTabFolder" runat="server">
    ...
    <div class="r-td rc-1-3"><div class="screen-tabfolder" runat="server"><div class="r-table">
    	...
    	<div class="r-tr">
    		...
    		<div id="cParentId39P2" class="r-td r-content" runat="server"><asp:TextBox id="cParentId39" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cMenuIndex39P1" class="r-td r-labelR" runat="server"><asp:Label id="cMenuIndex39Label" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cMenuIndex39P2" class="r-td r-content" runat="server"><asp:TextBox id="cMenuIndex39" CssClass="inp-num" runat="server" /><asp:RequiredFieldValidator id="cRFVMenuIndex39" ControlToValidate="cMenuIndex39" display="none" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cMenuListP1" class="r-td r-labelR" runat="server"><asp:Label id="cMenuListLabel" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cMenuListP2" class="r-td r-content" runat="server"><asp:TextBox id="cMenuList" CssClass="inp-num" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cNewMenuListP1" class="r-td r-labelR" runat="server"><asp:Label id="cNewMenuListLabel" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cNewMenuListP2" class="r-td r-content" runat="server"><asp:TextBox id="cNewMenuList" CssClass="inp-txt" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cCurrParentIdP1" class="r-td r-labelR" runat="server"><asp:Label id="cCurrParentIdLabel" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cCurrParentIdP2" class="r-td r-content pMenuId" runat="server"><asp:TextBox id="cCurrParentId" CssClass="inp-txt" runat="server" /></div>
    	</div>
    	<div class="r-tr">
    		<div id="cDelItemIdP1" class="r-td r-labelR" runat="server"><asp:Label id="cDelItemIdLabel" CssClass="inp-lbl" runat="server" /></div>
    		<div id="cDelItemIdP2" class="r-td r-content pDeleteId" runat="server"><asp:TextBox id="cDelItemId" CssClass="inp-txt" runat="server" /></div>
    	</div>
    </div></div></div>
    </div></div>
</asp:Panel>
