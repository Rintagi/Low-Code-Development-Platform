<%@ WebService Language="C#" Class="RO.Web.AdmLabelWs" %>
namespace RO.Web
{
    using System;
    using System.Data;
    ...
    public class AdmLabel112 : DataSet
    {
        public AdmLabel112()
        {
            ...
            this.Tables.Add(MakeDtlColumns(new DataTable("AdmLabelDef")));
            this.Tables.Add(MakeDtlColumns(new DataTable("AdmLabelAdd")));
            this.Tables.Add(MakeDtlColumns(new DataTable("AdmLabelUpd")));
            this.Tables.Add(MakeDtlColumns(new DataTable("AdmLabelDel")));
    ...
    public partial class AdmLabelWs : RO.Web.AsmxBase
    {
        const int screenId = 112;
        const byte systemId = 3;
        const string programName = "AdmLabel112";

        protected override byte GetSystemId() { return systemId; }
        protected override int GetScreenId() { return screenId; }
        protected override string GetProgramName() { return programName; }
        protected override string GetValidateMstIdSPName() { return "GetLisAdmLabel112"; }
        protected override string GetMstTableName(bool underlying = true) { return "Label"; }
        protected override string GetDtlTableName(bool underlying = true) { return ""; }
        protected override string GetMstKeyColumnName(bool underlying = false) { return underlying ? "LabelId" : "LabelId215"; }
        protected override string GetDtlKeyColumnName(bool underlying = false) { return underlying ? "" : ""; }
            
        Dictionary<string, SerializableDictionary<string, string>> ddlContext = new Dictionary<string, SerializableDictionary<string, string>>() {
            {"CultureId215", new SerializableDictionary<string,string>() {{"scr",screenId.ToString()},{"csy",systemId.ToString()},{"conn",""},{"addnew","N"},{"isSys","N"}, {"method","GetDdlCultureId3S1967"},{"mKey","CultureId215"},{"mVal","CultureId215Text"}, }},
            {"CompanyId215", new SerializableDictionary<string,string>() {{"scr",screenId.ToString()},{"csy",systemId.ToString()},{"conn",""},{"addnew","N"},{"isSys","N"}, {"method","GetDdlCompanyId3S1971"},{"mKey","CompanyId215"},{"mVal","CompanyId215Text"}, }},
        };

        private DataRow MakeTypRow(DataRow dr)
        {
            dr["LabelId215"] = System.Data.OleDb.OleDbType.Numeric.ToString();
        ...
        private AdmLabel112 PrepAdmLabelData(SerializableDictionary<string, string> mst, List<SerializableDictionary<string, string>> dtl, bool bAdd)
        {
            ...
            if (bAdd) { dr["LabelId215"] = string.Empty; } else { dr["LabelId215"] = mst["LabelId215"]; }
            drType["LabelId215"] = "Numeric"; drDisp["LabelId215"] = "TextBox";
            try { dr["CultureId215"] = mst["CultureId215"]; } catch { }
            drType["CultureId215"] = "Numeric"; drDisp["CultureId215"] = "AutoComplete";
            try { dr["LabelCat215"] = (mst["LabelCat215"] ?? "").Trim().Left(50); } catch { }
            drType["LabelCat215"] = "VarChar"; drDisp["LabelCat215"] = "TextBox";
            try { dr["LabelKey215"] = (mst["LabelKey215"] ?? "").Trim().Left(50); } catch { }
            drType["LabelKey215"] = "VarChar"; drDisp["LabelKey215"] = "TextBox";
            try { dr["LabelText215"] = mst["LabelText215"]; } catch { }
            drType["LabelText215"] = "VarWChar"; drDisp["LabelText215"] = "MultiLine";
            try { dr["CompanyId215"] = mst["CompanyId215"]; } catch { }
            ...
            if (dtl != null)
            {
                ds.Tables["AdmLabelDef"].Rows.Add(MakeTypRow(ds.Tables["AdmLabelDef"].NewRow()));
                ds.Tables["AdmLabelDef"].Rows.Add(MakeDisRow(ds.Tables["AdmLabelDef"].NewRow()));
                if (bAdd)
                {
                    foreach (var drv in dtl)
                    {
                        ds.Tables["AdmLabelAdd"].Rows.Add(MakeColRow(ds.Tables["AdmLabelAdd"].NewRow(), drv, mst["LabelId215"], true));
                    }
                }
                else
                {
                    ...
                    {
                        ds.Tables["AdmLabelUpd"].Rows.Add(MakeColRow(ds.Tables["AdmLabelUpd"].NewRow(), drv, mst["LabelId215"], false));
                    }
                    ...
                    {
                        ds.Tables["AdmLabelDel"].Rows.Add(MakeColRow(ds.Tables["AdmLabelDel"].NewRow(), drv, mst["LabelId215"], false));
                    }
                }
            }
        ...
        public ApiResponse<AutoCompleteResponse, SerializableDictionary<string, AutoCompleteResponse>> GetAdmLabel112List(string searchStr, int topN, string filterId)
        {
        ...
        public override ApiResponse<AutoCompleteResponse, SerializableDictionary<string, AutoCompleteResponse>> GetSearchList(string searchStr, int topN, string filterId, SerializableDictionary<string, string> desiredScreenCriteria)
        {
            ...
            return GetAdmLabel112List(searchStr, topN, filterId);
        }

        [WebMethod(EnableSession = false)]
        public ApiResponse<List<SerializableDictionary<string, string>>, SerializableDictionary<string, AutoCompleteResponse>> GetAdmLabel112ById(string keyId, SerializableDictionary<string, string> options)
        {
            ...
            Func<ApiResponse<List<SerializableDictionary<string, string>>, SerializableDictionary<string, AutoCompleteResponse>>> fn = () =>
            {
                ...
                ValidatedMstId("GetLisAdmLabel112", systemId, screenId, "**" + keyId, MatchScreenCriteria(_GetScrCriteria(screenId).DefaultView, jsonCri));
        ...
        {
            return GetAdmLabel112ById(keyId, options);
        }
        [WebMethod(EnableSession = false)]
        public ApiResponse<List<SerializableDictionary<string, string>>, SerializableDictionary<string, AutoCompleteResponse>> GetAdmLabel112DtlById(string keyId, SerializableDictionary<string, string> options, int filterId)
        {
            bool refreshUsrImpr = options.ContainsKey("ReAuth") && options["ReAuth"] == "Y" ;
        ...
        {
            return GetAdmLabel112DtlById(keyId, options, filterId);
        }
        [WebMethod(EnableSession = false)]
        ...
        {
            return (new RO.Access3.AdminAccess()).GetMstById("GetAdmLabel112ById", string.IsNullOrEmpty(mstId) ? "-1" : mstId, LcAppConnString, LcAppPw);

        }
        protected override DataTable _GetDtlById(string mstId, int screenFilterId)
        {
            return (new RO.Access3.AdminAccess()).GetDtlById(screenId, "GetAdmLabel112DtlById", string.IsNullOrEmpty(mstId) ? "-1" : mstId, LcAppConnString, LcAppPw, GetEffectiveScreenFilterId(screenFilterId.ToString(), false), LImpr, LCurr);
        ...
        public ApiResponse<SaveDataResponse, SerializableDictionary<string, AutoCompleteResponse>> DelMst(SerializableDictionary<string, string> mst, SerializableDictionary<string, string> options)
        {
            ...
            {
                SwitchContext(systemId, LCurr.CompanyId, LCurr.ProjectId, true, true, refreshUsrImpr);
                var pid = mst["LabelId215"];
                var ds = PrepAdmLabelData(mst, new List<SerializableDictionary<string, string>>(), string.IsNullOrEmpty(mst["LabelId215"]));
        ...
        public ApiResponse<SaveDataResponse, SerializableDictionary<string, AutoCompleteResponse>> SaveData(SerializableDictionary<string, string> mst, List<SerializableDictionary<string, string>> dtl, SerializableDictionary<string, string> options)
        {
            ...
            Func<ApiResponse<SaveDataResponse, SerializableDictionary<string, AutoCompleteResponse>>> fn = () =>
            {
                ...
                {
                    string jsonCri = options.ContainsKey("CurrentScreenCriteria") ? options["CurrentScreenCriteria"] : null;
                    ValidatedMstId("GetLisAdmLabel112", systemId, screenId, "**" + pid, MatchScreenCriteria(_GetScrCriteria(screenId).DefaultView, jsonCri));
                }
                else
                {
                ...
                var validationResult = ValidateInput(ref mst, ref dtl, dtMst, dtDtl, "LabelId215", "", skipValidation);
                ...
                var ds = PrepAdmLabelData(mst, dtl, string.IsNullOrEmpty(mst["LabelId215"]));
        ...
        [WebMethod(EnableSession = false)]
        public ApiResponse<AutoCompleteResponse, SerializableDictionary<string, AutoCompleteResponse>> GetCultureId215List(string query, int topN, string filterBy)
        {
        Func<ApiResponse<AutoCompleteResponse, SerializableDictionary<string, AutoCompleteResponse>>> fn = () =>
        {
            SwitchContext(systemId, LCurr.CompanyId, LCurr.ProjectId);
            ...
            var ret = ProtectedCall(RestrictedApiCall(fn, systemId, screenId, "R", "CultureId215", emptyAutoCompleteResponse));
            return ret;
        }
                        
        [WebMethod(EnableSession = false)]
        public ApiResponse<AutoCompleteResponse, SerializableDictionary<string, AutoCompleteResponse>> GetCompanyId215List(string query, int topN, string filterBy)
        {
            Func<ApiResponse<AutoCompleteResponse, SerializableDictionary<string, AutoCompleteResponse>>> fn = () =>
            {
                SwitchContext(systemId, LCurr.CompanyId, LCurr.ProjectId);
                ...
                DataTable dt = (new RO.Access3.AdminAccess()).GetDdl(screenId, "GetDdlCompanyId3S1971", bAddNew, bAll, 0, keyId, LcAppConnString, LcAppPw, string.Empty, base.LImpr, base.LCurr);
                return DataTableToApiResponse(dt, "", 0);
            };
            var ret = ProtectedCall(RestrictedApiCall(fn, systemId, screenId, "R", "CompanyId215", emptyAutoCompleteResponse));
            return ret;
        }
        public ApiResponse<LoadScreenPageResponse, SerializableDictionary<string, AutoCompleteResponse>> _LoadInitPage(SerializableDictionary<string, string> options)
        {
            Func<ApiResponse<LoadScreenPageResponse, SerializableDictionary<string, AutoCompleteResponse>>> fn = () =>
            {
                ...
                var dtLabel = _GetLabels("AdmLabel");
                var SearchList = GetAdmLabel112List("", 0, "");
                var CultureId215List = GetCultureId215List("", 0, "");
                var CompanyId215List = GetCompanyId215List("", 0, "");
