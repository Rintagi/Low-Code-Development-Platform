...
namespace RO.Web
{
    ...
    public partial class AdmMenuWs : RO.Web.AsmxBase
    {
        ...
        {
            return (new RO.Access3.AdminAccess()).GetDtlById(screenId, "GetAdmMenu35DtlById", string.IsNullOrEmpty(mstId) ? "-1" : mstId, LcAppConnString, LcAppPw, GetEffectiveScreenFilterId(screenFilterId.ToString(), false), LImpr, LCurr);
