<%@ WebService Language="C#" Class="RO.Web.AdmTemplateWs" %>
namespace RO.Web
{
    using System;
    using System.Data;
    ...
    public partial class AdmTemplateWs : RO.Web.AsmxBase
    {
        const int screenId = 53;
        const byte systemId = 3;
        const string programName = "AdmTemplate53";

        protected override byte GetSystemId() { return systemId; }
        protected override int GetScreenId() { return screenId; }
        protected override string GetProgramName() { return programName; }
        protected override string GetValidateMstIdSPName() { return "GetLisAdmTemplate53"; }
        protected override string GetMstTableName(bool underlying = true) { return "Template"; }
        protected override string GetDtlTableName(bool underlying = true) { return "Template"; }
        protected override string GetMstKeyColumnName(bool underlying = false) { return underlying ? "TemplateId" : "TemplateId79"; }
        protected override string GetDtlKeyColumnName(bool underlying = false) { return underlying ? "TemplateId" : "TemplateId79"; }
        ...
        private DataRow MakeColRow(DataRow dr, SerializableDictionary<string, string> drv, string keyId, bool bAdd)
        {
            ...
            if (dtAuth != null)
            {
                dr["TemplateId79"] = (drv["TemplateId79"] ?? "").ToString().Trim().Left(9999999);
                dr["TemplateName79"] = (drv["TemplateName79"] ?? "").ToString().Trim().Left(30);
                dr["TmplPrefix79"] = (drv["TmplPrefix79"] ?? "").ToString().Trim().Left(10);
        ...
        private AdmTemplate53 PrepAdmTemplateData(SerializableDictionary<string, string> mst, List<SerializableDictionary<string, string>> dtl, bool bAdd)
        {
            ...
            if (dtl != null)
            {
                ...
                if (bAdd)
                {
                    ...
                    {
                        ds.Tables["AdmTemplateAdd"].Rows.Add(MakeColRow(ds.Tables["AdmTemplateAdd"].NewRow(), drv, mst["TemplateId79"], true));
                    }
                }
                else
                {
                    var dtlUpd = from r in dtl where !string.IsNullOrEmpty((r["TemplateId79"] ?? "").ToString()) && (r.ContainsKey("_mode") ? r["_mode"] : "") != "delete" select r;
                    foreach (var drv in dtlUpd)
                    {
                        ds.Tables["AdmTemplateUpd"].Rows.Add(MakeColRow(ds.Tables["AdmTemplateUpd"].NewRow(), drv, mst["TemplateId79"], false));
                    }
                    var dtlAdd = from r in dtl.AsEnumerable() where string.IsNullOrEmpty(r["TemplateId79"]) select r;
                    foreach (var drv in dtlAdd)
                    {
                        ds.Tables["AdmTemplateAdd"].Rows.Add(MakeColRow(ds.Tables["AdmTemplateAdd"].NewRow(), drv, mst["TemplateId79"], true));
                    }
                    var dtlDel = from r in dtl.AsEnumerable() where !string.IsNullOrEmpty((r["TemplateId79"] ?? "").ToString()) && (r.ContainsKey("_mode") ? r["_mode"] : "") == "delete" select r;
                    foreach (var drv in dtlDel)
                    {
                        ds.Tables["AdmTemplateDel"].Rows.Add(MakeColRow(ds.Tables["AdmTemplateDel"].NewRow(), drv, mst["TemplateId79"], false));
                    }
                }
            }
            return ds;
        ...
        public ApiResponse<AutoCompleteResponse, SerializableDictionary<string, AutoCompleteResponse>> GetAdmTemplate53List(string searchStr, int topN, string filterId)
        {
            Func<ApiResponse<AutoCompleteResponse, SerializableDictionary<string, AutoCompleteResponse>>> fn = () =>
            {
                SwitchContext(systemId, LCurr.CompanyId, LCurr.ProjectId);
                DataTable dtSuggest = GetLis("GetLisAdmTemplate53", GetSystemId(), GetScreenId(), "", _CurrentScreenCriteria ?? new List<string>(), filterId, "", "N", 0, false);
        ...
        public override ApiResponse<AutoCompleteResponse, SerializableDictionary<string, AutoCompleteResponse>> GetSearchList(string searchStr, int topN, string filterId, SerializableDictionary<string, string> desiredScreenCriteria)
        {
            ...
            return GetAdmTemplate53List(searchStr, topN, filterId);
        }

        [WebMethod(EnableSession = false)]
        public ApiResponse<List<SerializableDictionary<string, string>>, SerializableDictionary<string, AutoCompleteResponse>> GetAdmTemplate53ById(string keyId, SerializableDictionary<string, string> options)
        {
            ...
            Func<ApiResponse<List<SerializableDictionary<string, string>>, SerializableDictionary<string, AutoCompleteResponse>>> fn = () =>
            {
                ...
                ValidatedMstId("GetLisAdmTemplate53", systemId, screenId, "**" + keyId, MatchScreenCriteria(_GetScrCriteria(screenId).DefaultView, jsonCri));
        ...
        {
            return GetAdmTemplate53ById(keyId, options);
        }
        [WebMethod(EnableSession = false)]
        public ApiResponse<List<SerializableDictionary<string, string>>, SerializableDictionary<string, AutoCompleteResponse>> GetAdmTemplate53DtlById(string keyId, SerializableDictionary<string, string> options, int filterId)
        {
            bool refreshUsrImpr = options.ContainsKey("ReAuth") && options["ReAuth"] == "Y" ;
        ...
        {
            return GetAdmTemplate53DtlById(keyId, options, filterId);
        }
        [WebMethod(EnableSession = false)]
        ...
        public override ApiResponse<SaveDataResponse, SerializableDictionary<string, AutoCompleteResponse>> DelMst(SerializableDictionary<string, string> mst, SerializableDictionary<string, string> options)
        {
            ...
            Func<ApiResponse<SaveDataResponse, SerializableDictionary<string, AutoCompleteResponse>>> fn = () =>
            {
                ...
                var ds = PrepAdmTemplateData(mst, dtl, IsGridOnlyScreen() ? false : string.IsNullOrEmpty(mst["TemplateId79"]));
        ...
        public override ApiResponse<SaveDataResponse, SerializableDictionary<string, AutoCompleteResponse>> SaveData(SerializableDictionary<string, string> mst, List<SerializableDictionary<string, string>> dtl, SerializableDictionary<string, string> options)
        {
            ...
            Func<ApiResponse<SaveDataResponse, SerializableDictionary<string, AutoCompleteResponse>>> fn = () =>
            {
                ...
                {
                    string jsonCri = options.ContainsKey("CurrentScreenCriteria") ? options["CurrentScreenCriteria"] : null;
                    ValidatedMstId("GetLisAdmTemplate53", systemId, screenId, "**" + pid, MatchScreenCriteria(_GetScrCriteria(screenId).DefaultView, jsonCri));
                }
                else
                {
                ...
                int maxDtlId = dtDtl == null ? -1 : dtDtl.AsEnumerable().Select(dr => dr["TemplateId79"].ToString()).Where((s) => !string.IsNullOrEmpty(s)).Select(id => int.Parse(id)).DefaultIfEmpty(-1).Max();
                var validationResult = ValidateInput(ref mst, ref dtl, dtMst, dtDtl, "TemplateId79", "TemplateId79", skipValidation);
                ...
                var ds = PrepAdmTemplateData(mst, dtl, string.IsNullOrEmpty(mst["TemplateId79"]));
