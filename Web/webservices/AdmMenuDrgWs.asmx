...
namespace RO.Web
{
    ...
    public partial class AdmMenuDrgWs : RO.Web.AsmxBase
    {
        ...
        {
            return (new RO.Access3.AdminAccess()).GetDtlById(screenId, "GetAdmMenuDrg121DtlById", string.IsNullOrEmpty(mstId) ? "-1" : mstId, LcAppConnString, LcAppPw, screenFilterId, LImpr, LCurr);
