...
namespace RO.Web
{
    ...
    public partial class AdmChgPwdWs : RO.Web.AsmxBase
    {
        ...
        {
            return (new RO.Facade3.AdminSystem()).GetMstById("GetAdmChgPwd71ById", string.IsNullOrEmpty(mstId) ? "-1" : mstId, LcAppConnString, LcAppPw);

        }
        protected override DataTable _GetDtlById(string mstId, int screenFilterId)
        {
            return (new RO.Facade3.AdminSystem()).GetDtlById(screenId, "GetAdmChgPwd71DtlById", string.IsNullOrEmpty(mstId) ? "-1" : mstId, LcAppConnString, LcAppPw, GetEffectiveScreenFilterId(screenFilterId.ToString(), false), LImpr, LCurr);
