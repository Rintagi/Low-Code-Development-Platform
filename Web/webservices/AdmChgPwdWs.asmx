<%@ WebService Language="C#" Class="RO.Web.AdmChgPwdWs" %>
namespace RO.Web
{
    using System;
    using System.Data;
    ...
    public class AdmChgPwd71 : DataSet
    {
        public AdmChgPwd71()
        {
            ...
            this.Tables.Add(MakeDtlColumns(new DataTable("AdmChgPwdDef")));
            this.Tables.Add(MakeDtlColumns(new DataTable("AdmChgPwdAdd")));
            this.Tables.Add(MakeDtlColumns(new DataTable("AdmChgPwdUpd")));
            this.Tables.Add(MakeDtlColumns(new DataTable("AdmChgPwdDel")));
    ...
    public partial class AdmChgPwdWs : RO.Web.AsmxBase
    {
        const int screenId = 71;
        const byte systemId = 3;
        const string programName = "AdmChgPwd71";

        protected override byte GetSystemId() { return systemId; }
        protected override int GetScreenId() { return screenId; }
        protected override string GetProgramName() { return programName; }
        protected override string GetValidateMstIdSPName() { return "GetLisAdmChgPwd71"; }
        ...
        private AdmChgPwd71 PrepAdmChgPwdData(SerializableDictionary<string, string> mst, List<SerializableDictionary<string, string>> dtl, bool bAdd)
        {
            ...
            try { dr["UsrPassword1"] = mst["UsrPassword1"]; } catch { }
            drType["UsrPassword1"] = "VarBinary"; drDisp["UsrPassword1"] = "Password";
            try { dr["ConfirmPwd1"] = mst["ConfirmPwd1"]; } catch { }
            drType["ConfirmPwd1"] = "VarBinary"; drDisp["ConfirmPwd1"] = "Password";
            try { dr["SendMail"] = (mst["SendMail"] ?? "").Trim().Left(9999999); } catch { }
            drType["SendMail"] = string.Empty; drDisp["SendMail"] = "CheckBox";
            try { dr["ForcePwdChg"] = (mst["ForcePwdChg"] ?? "").Trim().Left(9999999); } catch { }
            drType["ForcePwdChg"] = string.Empty; drDisp["ForcePwdChg"] = "CheckBox";

            if (dtl != null)
            {
                ds.Tables["AdmChgPwdDef"].Rows.Add(MakeTypRow(ds.Tables["AdmChgPwdDef"].NewRow()));
                ds.Tables["AdmChgPwdDef"].Rows.Add(MakeDisRow(ds.Tables["AdmChgPwdDef"].NewRow()));
                if (bAdd)
                {
                    foreach (var drv in dtl)
                    {
                        ds.Tables["AdmChgPwdAdd"].Rows.Add(MakeColRow(ds.Tables["AdmChgPwdAdd"].NewRow(), drv, mst["UsrId1"], true));
                    }
                }
                else
                {
                    ...
                    {
                        ds.Tables["AdmChgPwdUpd"].Rows.Add(MakeColRow(ds.Tables["AdmChgPwdUpd"].NewRow(), drv, mst["UsrId1"], false));
                    }
                    ...
                    {
                        ds.Tables["AdmChgPwdDel"].Rows.Add(MakeColRow(ds.Tables["AdmChgPwdDel"].NewRow(), drv, mst["UsrId1"], false));
                    }
                }
            }
        ...
        public ApiResponse<AutoCompleteResponse, SerializableDictionary<string, AutoCompleteResponse>> GetAdmChgPwd71List(string searchStr, int topN, string filterId)
        {
        ...
        public override ApiResponse<AutoCompleteResponse, SerializableDictionary<string, AutoCompleteResponse>> GetSearchList(string searchStr, int topN, string filterId, SerializableDictionary<string, string> desiredScreenCriteria)
        {
            ...
            return GetAdmChgPwd71List(searchStr, topN, filterId);
        }

        [WebMethod(EnableSession = false)]
        public ApiResponse<List<SerializableDictionary<string, string>>, SerializableDictionary<string, AutoCompleteResponse>> GetAdmChgPwd71ById(string keyId, SerializableDictionary<string, string> options)
        {
            ...
            Func<ApiResponse<List<SerializableDictionary<string, string>>, SerializableDictionary<string, AutoCompleteResponse>>> fn = () =>
            {
                ...
                ValidatedMstId("GetLisAdmChgPwd71", systemId, screenId, "**" + keyId, MatchScreenCriteria(_GetScrCriteria(screenId).DefaultView, jsonCri));
        ...
        {
            return GetAdmChgPwd71ById(keyId, options);
        }
        [WebMethod(EnableSession = false)]
        public ApiResponse<List<SerializableDictionary<string, string>>, SerializableDictionary<string, AutoCompleteResponse>> GetAdmChgPwd71DtlById(string keyId, SerializableDictionary<string, string> options, int filterId)
        {
            bool refreshUsrImpr = options.ContainsKey("ReAuth") && options["ReAuth"] == "Y" ;
        ...
        {
            return GetAdmChgPwd71DtlById(keyId, options, filterId);
        }
        [WebMethod(EnableSession = false)]
        ...
        {
            return (new RO.Access3.AdminAccess()).GetMstById("GetAdmChgPwd71ById", string.IsNullOrEmpty(mstId) ? "-1" : mstId, LcAppConnString, LcAppPw);

        }
        protected override DataTable _GetDtlById(string mstId, int screenFilterId)
        {
            return (new RO.Access3.AdminAccess()).GetDtlById(screenId, "GetAdmChgPwd71DtlById", string.IsNullOrEmpty(mstId) ? "-1" : mstId, LcAppConnString, LcAppPw, GetEffectiveScreenFilterId(screenFilterId.ToString(), false), LImpr, LCurr);
        ...
        public ApiResponse<SaveDataResponse, SerializableDictionary<string, AutoCompleteResponse>> DelMst(SerializableDictionary<string, string> mst, SerializableDictionary<string, string> options)
        {
            ...
            Func<ApiResponse<SaveDataResponse, SerializableDictionary<string, AutoCompleteResponse>>> fn = () =>
            {
                SwitchContext(systemId, LCurr.CompanyId, LCurr.ProjectId, true, true, refreshUsrImpr);
                var pid = mst["UsrId1"];
                var ds = PrepAdmChgPwdData(mst, new List<SerializableDictionary<string, string>>(), string.IsNullOrEmpty(mst["UsrId1"]));
        ...
        public ApiResponse<SaveDataResponse, SerializableDictionary<string, AutoCompleteResponse>> SaveData(SerializableDictionary<string, string> mst, List<SerializableDictionary<string, string>> dtl, SerializableDictionary<string, string> options)
        {
            ...
            Func<ApiResponse<SaveDataResponse, SerializableDictionary<string, AutoCompleteResponse>>> fn = () =>
            {
                ...
                {
                    string jsonCri = options.ContainsKey("CurrentScreenCriteria") ? options["CurrentScreenCriteria"] : null;
                    ValidatedMstId("GetLisAdmChgPwd71", systemId, screenId, "**" + pid, MatchScreenCriteria(_GetScrCriteria(screenId).DefaultView, jsonCri));
                }
                else
                {
                ...
                var ds = PrepAdmChgPwdData(mst, dtl, string.IsNullOrEmpty(mst["UsrId1"]));
        ...
        public ApiResponse<LoadScreenPageResponse, SerializableDictionary<string, AutoCompleteResponse>> _LoadInitPage(SerializableDictionary<string, string> options)
        {
            Func<ApiResponse<LoadScreenPageResponse, SerializableDictionary<string, AutoCompleteResponse>>> fn = () =>
            {
                ...
                var dtLabel = _GetLabels("AdmChgPwd");
                var SearchList = GetAdmChgPwd71List("", 0, "");
