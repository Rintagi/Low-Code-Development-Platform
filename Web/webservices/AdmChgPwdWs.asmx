...
namespace RO.Web
{
    ...
    public partial class AdmChgPwdWs : RO.Web.AsmxBase
    {
        ...
        {
            return (new RO.Access3.AdminAccess()).GetDtlById(screenId, "GetAdmChgPwd71DtlById", string.IsNullOrEmpty(mstId) ? "-1" : mstId, LcAppConnString, LcAppPw, screenFilterId, LImpr, LCurr);
