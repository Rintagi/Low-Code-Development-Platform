<%@ Control Language="c#" Inherits="RO.Web.AdmRptDbTableModule" CodeFile="AdmRptDbTableModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
	...
	<tr>
		<td>
			...
			<asp:TableRow VerticalAlign="top">
				<asp:TableCell id="cIdP1" CssClass="GrpContent" runat="server"><div><asp:Label id="cIdLabel" CssClass="inp-lbl" runat="server" /></div></asp:TableCell>
				<asp:TableCell id="cModifiedAfterP1" CssClass="GrpContent" runat="server"><div><asp:Label id="cModifiedAfterLabel" CssClass="inp-lbl" runat="server" /></div></asp:TableCell>
			</asp:TableRow>
			<asp:TableRow VerticalAlign="top">
				<asp:TableCell CssClass="GrpContent"><rcasp:ComboBox id="cId" CssClass="inp-ddl" DataValueField="Id" DataTextField="TableDesc" AutoPostBack="true" OnSelectedIndexChanged="cId_SelectedIndexChanged" runat="server" /></asp:TableCell>
				<asp:TableCell CssClass="GrpContent"><asp:TextBox id="cModifiedAfter" CssClass="inp-txt" AutoPostBack="true" OnTextChanged="cModifiedAfter_TextChanged" runat="server" /></asp:TableCell>
			</asp:TableRow>
			</asp:Table>
			</fieldset>
			</asp:Panel>
