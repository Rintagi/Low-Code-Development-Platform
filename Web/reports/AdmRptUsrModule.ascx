<%@ Control Language="c#" Inherits="RO.Web.AdmRptUsrModule" CodeFile="AdmRptUsrModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
	...
	<tr>
		<td>
			...
			<asp:TableRow VerticalAlign="top">
				<asp:TableCell id="cActiveP1" CssClass="GrpContent" runat="server"><div><asp:Label id="cActiveLabel" CssClass="inp-lbl" runat="server" /></div></asp:TableCell>
				<asp:TableCell id="cUsrGroupIdP1" CssClass="GrpContent" runat="server"><div><asp:Label id="cUsrGroupIdLabel" CssClass="inp-lbl" runat="server" /></div></asp:TableCell>
				<asp:TableCell id="cCompanyIdP1" CssClass="GrpContent" runat="server"><div><asp:Label id="cCompanyIdLabel" CssClass="inp-lbl" runat="server" /></div></asp:TableCell>
			</asp:TableRow>
			<asp:TableRow VerticalAlign="top">
				<asp:TableCell CssClass="GrpContent"><asp:DropDownList id="cActive" CssClass="inp-ddl" DataValueField="CheckBoxCd" DataTextField="CheckBoxName" AutoPostBack="true" OnSelectedIndexChanged="cActive_SelectedIndexChanged" runat="server" /></asp:TableCell>
				<asp:TableCell CssClass="GrpContent"><rcasp:ComboBox id="cUsrGroupId" CssClass="inp-ddl" DataValueField="UsrGroupId" DataTextField="UsrGroupName" AutoPostBack="true" OnSelectedIndexChanged="cUsrGroupId_SelectedIndexChanged" runat="server" /></asp:TableCell>
