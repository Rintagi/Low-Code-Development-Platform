<%@ Control Language="c#" Inherits="RO.Web.AdmRptSredModule" CodeFile="AdmRptSredModule.ascx.cs" CodeFileBaseClass="RO.Web.ModuleBase" %>
	...
	<tr>
		<td>
			...
			<asp:TableRow VerticalAlign="top">
				<asp:TableCell id="cMonthEndingP1" CssClass="GrpContent" runat="server"><div><asp:Label id="cMonthEndingLabel" CssClass="inp-lbl" runat="server" /></div></asp:TableCell>
				<asp:TableCell id="cNumMonthsP1" CssClass="GrpContent" runat="server"><div><asp:Label id="cNumMonthsLabel" CssClass="inp-lbl" runat="server" /></div></asp:TableCell>
			</asp:TableRow>
			<asp:TableRow VerticalAlign="top">
				<asp:TableCell CssClass="GrpContent"><asp:TextBox id="cMonthEnding" CssClass="inp-txt" AutoPostBack="true" OnTextChanged="cMonthEnding_TextChanged" runat="server" /></asp:TableCell>
				<asp:TableCell CssClass="GrpContent"><asp:TextBox id="cNumMonths" CssClass="inp-txt" AutoPostBack="true" OnTextChanged="cNumMonths_TextChanged" runat="server" /></asp:TableCell>
			</asp:TableRow>
			</asp:Table>
			</fieldset>
			</asp:Panel>
