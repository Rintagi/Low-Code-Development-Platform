...
namespace RO.Web
{
	public partial class AdmRptUsageModule : RO.Web.ModuleBase
	{
		...
		private void getReport(bool sendToPrinter, exportTo eExport)
		{
			...
			DataTable dt = (new AdminSystem()).GetRptDt(54,"GetAdmRptUsage",base.LImpr,base.LCurr,UpdCriteria(false),GetRptCriteria(),LcAppConnString,LcAppPw,false,false,false,CommandTimeOut);
			CovertRptUTC(dt);
