...
namespace RO.Web
{
	public partial class AdmRptBizRuleModule : RO.Web.ModuleBase
	{
		...
		private void getReport(bool sendToPrinter, exportTo eExport)
		{
			...
			DataTable dt = (new AdminSystem()).GetRptDt(55,"GetAdmRptBizRule",base.LImpr,base.LCurr,UpdCriteria(false),GetRptCriteria(),LcAppConnString,LcAppPw,false,false,false);
			CovertRptUTC(dt);
