...
function SaveSignature(id) {
    ...
    if (signaturePads[id].isEmpty()) {
        ...
        var text = document.getElementById(id);
        text.value = signaturePad.toDataURL();
        result = true;
    }
...
function ActivateSignature(data, canv, json) {
    ...
    var signaturePad = new SignaturePad(canvas, {
        ...
        penColor: properties.penColor,
        minWidth: properties.minWidth,
        maxWidth: properties.maxWidth,
        onEnd: function () {
            dt.value = signaturePad.toDataURL();
            dt.onchange();
        },
    });
    ...
    if (dt.value != "") {
        signaturePad.fromDataURL(dt.value);
    }

    signaturePads[data] = signaturePad;
}