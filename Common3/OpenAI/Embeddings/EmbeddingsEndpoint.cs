...
namespace OpenAI.Embeddings
{
    ...
    public sealed class EmbeddingsEndpoint : BaseEndPoint
    {
        ...
        /// <inheritdoc />
        protected override string Root { get { return "embeddings"; } }
        ...
        { return await CreateEmbeddingAsync(new EmbeddingsRequest(input, model, user)).ConfigureAwait(false); }
        ...
        /// <returns><see cref="EmbeddingsResponse"/></returns>
        public async Task<EmbeddingsResponse> CreateEmbeddingAsync(IEnumerable<string> input, string model = null, string user = null, CancellationToken cancellationToken = default(CancellationToken))
        { return await CreateEmbeddingAsync(new EmbeddingsRequest(input, model, user), cancellationToken).ConfigureAwait(false); }
        ...
        /// <param name="cancellationToken">Optional, <see cref="CancellationToken"/>.</param>
        /// <returns><see cref="EmbeddingsResponse"/></returns>
        public async Task<EmbeddingsResponse> CreateEmbeddingAsync(EmbeddingsRequest request, CancellationToken cancellationToken = default(CancellationToken))
        {
