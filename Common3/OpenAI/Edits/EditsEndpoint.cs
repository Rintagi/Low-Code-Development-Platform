...
namespace OpenAI.Edits
{
    ...
    public sealed class EditsEndpoint : BaseEndPoint
    {
        ...
        /// <inheritdoc />
        protected override string Root { get { return "edits"; } }
        ...
        public async Task<EditResponse> CreateEditAsync(EditRequest request, CancellationToken cancellationToken = default(CancellationToken))
        {
