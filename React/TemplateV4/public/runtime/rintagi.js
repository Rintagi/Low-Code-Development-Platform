...
document.Rintagi = {
  localDev:{
    ...
    apiBasename: 'http://localhost/RO', // webservice url for local development via npm start, i.e. localhost:3000 etc. must be full url in the form of http:// pointing to the site serving , no ending slash
  },
