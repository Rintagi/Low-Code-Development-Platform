...
export const GetSearchList = GetAdmReportObj13List;
export function GetAdmReportObj13ById(keyId, accessScope) {
...
export function GetAdmReportObj13DtlById(keyId, filterId, accessScope) {
