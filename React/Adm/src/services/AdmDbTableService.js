...
export const GetSearchList = GetAdmDbTable2List;
export function GetAdmDbTable2ById(keyId, accessScope) {
...
export function GetAdmDbTable2DtlById(keyId, filterId, accessScope) {
