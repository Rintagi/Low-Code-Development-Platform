...
export function GetAuthCol(accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/GetAuthCol'
        , {
            requestOptions: {
                body: JSON.stringify({
                }),
...
export function GetAuthRow(accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/GetAuthRow'
        , {
            requestOptions: {
                body: JSON.stringify({
                }),
...
export function GetScreenLabel(accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/GetScreenLabel'
        , {
            requestOptions: {
                body: JSON.stringify({
                }),
...
export function GetLabels(labelCat, accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/GetLabels'
        , {
            requestOptions: {
                body: JSON.stringify({
                    labelCat: labelCat
...
export function GetSystemLabels(labelCat, accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/GetSystemLabels'
        , {
            requestOptions: {
                body: JSON.stringify({
                    labelCat: labelCat
...
export function GetScreenButtonHlp(labelCat, accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/GetScreenButtonHlp'
        , {
            requestOptions: {
                body: JSON.stringify({
                }),
...
export function GetScreenHlp(labelCat, accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/GetScreenHlp'
        , {
            requestOptions: {
                body: JSON.stringify({
                }),
...
export function GetScreenCriteria(accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/GetScreenCriteria'
        , {
            requestOptions: {
                body: JSON.stringify({
                }),
...
export function GetNewMst(accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/GetNewMst'
        , {
            requestOptions: {
                body: JSON.stringify({
                }),
...
export function GetNewDtl(accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/GetNewDtl'
        , {
            requestOptions: {
                body: JSON.stringify({
                }),
...
export function GetScreenFilter(accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/GetScreenFilter'
        , {
            requestOptions: {
                body: JSON.stringify({
                }),
...
export const GetDtlById = GetAdmPayment1021DtlById;
export function LoadInitPage(options, accessScope) {
    const reqJson = JSON.stringify({
        options: options
    });
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/LoadInitPage'
        , {
            requestOptions: {
                body: reqJson,
            },
...
export function SaveData(mst, dtl, options, accessScope) {
    ...
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/SaveData'
        , {
            requestOptions: {
                body: reqJson,
            },
...
export function DelMst(mst, options, accessScope) {
    ...
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/DelMst'
        , {
            requestOptions: {
                body: reqJson,
            },
...
export function SetScreenCriteria(criteriaValues, accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/SetScreenCriteria'
        , {
            requestOptions: {
                body: JSON.stringify({
...
export function GetRefColumnContent(mstId, dtlId, refKeyId, isMaster, refScreenColumnName, options, accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/GetRefColumnContent'
        , {
            requestOptions: {
                body: JSON.stringify({
                    mstId: mstId || null,
...
export function GetColumnContent(mstId, dtlId, columnName, isMaster, screenColumnName, accessScope) {
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/GetColumnContent'
        , {
            requestOptions: {
                body: JSON.stringify({
                    mstId: mstId || '',
...
export function SaveEmbeddedImage(mstId, dtlId, isMaster, screenColumnName, docJson, options, accessScope) {
    ...
    return fetchData(baseUrl + '/AdmPaymentWs.asmx/AddDocColumnContent'
        , {
            requestOptions: {
                body: reqJson,
            },
