...
export function GetSearchList(searchStr, topN, filterId, desiredScreenCriteria, accessScope) {
    return fetchData(baseUrl + '/AdmWizardObjWs.asmx/GetSearchList'
        , {
            requestOptions: {
                body: JSON.stringify({
                    searchStr: searchStr || '',
...
export function GetAdmWizardObj49ById(keyId, options, accessScope) {
...
export const GetMstById = GetAdmWizardObj49ById;
export function GetAdmWizardObj49DtlById(keyId, filterId, options, accessScope) {
...
export const GetDtlById = GetAdmWizardObj49DtlById;
...
export function GetRefColumnContent(mstId, dtlId, refKeyId, isMaster, refScreenColumnName, options, accessScope) {
    return fetchData(baseUrl + '/AdmWizardObjWs.asmx/GetRefColumnContent'
        , {
            requestOptions: {
                body: JSON.stringify({
                    mstId: mstId || null,
