...
export const GetSearchList = GetAdmScreenObj10List;
export function GetAdmScreenObj10ById(keyId, accessScope) {
...
export function GetAdmScreenObj10DtlById(keyId, filterId, accessScope) {
