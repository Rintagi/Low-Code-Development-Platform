...
export const GetSearchList = GetAdmCronJob118List;
export function GetAdmCronJob118ById(keyId, accessScope) {
...
export function GetAdmCronJob118DtlById(keyId, filterId, accessScope) {
