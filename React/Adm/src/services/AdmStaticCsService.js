...
export function GetSearchList(searchStr, topN, filterId, desiredScreenCriteria, accessScope) {
    return fetchData(baseUrl + '/AdmStaticCsWs.asmx/GetSearchList'
        , {
            requestOptions: {
                body: JSON.stringify({
                    searchStr: searchStr || '',
...
export function GetAdmStaticCs115ById(keyId, options, accessScope) {
...
export function GetAdmStaticCs115DtlById(keyId, filterId, options, accessScope) {
