...
export const GetSearchList = GetAdmServerRule14List;
export function GetAdmServerRule14ById(keyId, accessScope) {
...
export function GetAdmServerRule14DtlById(keyId, filterId, accessScope) {
