...
class MstRecord extends RintagiScreen {
  ...
  DdlFtrColumnId104InputChange() { const _this = this; return function (name, v) { const filterBy = ((_this.props.AdmScreenCri || {}).Mst || {}).ScreenId104; _this.props.SearchDdlFtrColumnId104(v, filterBy); } }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmScreenCri.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.ScreenCriId104));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cScreenCriId104: formatContent(ScreenCriId104 || '', 'TextBox'),
                    cScreenId104: ScreenId104List.filter(obj => { return obj.key === ScreenId104 })[0],
                    cLabelCss104: formatContent(LabelCss104 || '', 'TextBox'),
                    cContentCss104: formatContent(ContentCss104 || '', 'TextBox'),
                    ...
                    cTabIndex104: formatContent(TabIndex104 || '', 'TextBox'),
                    cRequiredValid104: RequiredValid104 === 'Y',
                    cColumnJustify104: ColumnJustify104List.filter(obj => { return obj.key === ColumnJustify104 })[0],
                    cColumnSize104: formatContent(ColumnSize104 || '', 'TextBox'),
                    cRowSize104: formatContent(RowSize104 || '', 'TextBox'),
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenCriState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cScreenId104'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cScreenId104', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenCriState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cColumnId104'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cColumnId104', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenCriState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cOperatorId104'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cOperatorId104')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenCriState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cDisplayModeId104')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenCriState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cColumnJustify104')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenCriState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          ...
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cDdlKeyColumnId104', false, values)}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenCriState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          ...
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cDdlRefColumnId104', false, values)}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenCriState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          ...
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cDdlSrtColumnId104', false, values)}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenCriState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          ...
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cDdlFtrColumnId104', false, values)}
