...
class MstRecord extends RintagiScreen {
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmAppInfo.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.AppInfoId135));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cAppInfoId135: formatContent(AppInfoId135 || '', 'TextBox'),
                    cVersionMa135: formatContent(VersionMa135 || '', 'TextBox'),
                    cVersionMi135: formatContent(VersionMi135 || '', 'TextBox'),
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmAppInfoState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cAppItemLink135')}
