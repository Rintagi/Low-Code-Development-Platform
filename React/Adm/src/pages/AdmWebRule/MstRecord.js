...
class MstRecord extends RintagiScreen {
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmWebRule.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.WebRuleId128));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cWebRuleId128: formatContent(WebRuleId128 || '', 'TextBox'),
                    cRuleName128: formatContent(RuleName128 || '', 'TextBox'),
                    cRuleDescription128: formatContent(RuleDescription128 || '', 'MultiLine'),
                    ...
                    cReduxRuleProg128: formatContent(ReduxRuleProg128 || '', 'MultiLine'),
                    cServiceEventId128: ServiceEventId128List.filter(obj => { return obj.key === ServiceEventId128 })[0],
                    cServiceRuleProg128: formatContent(ServiceRuleProg128 || '', 'MultiLine'),
                    cAsmxEventId128: AsmxEventId128List.filter(obj => { return obj.key === AsmxEventId128 })[0],
                    cAsmxRuleProg128: formatContent(AsmxRuleProg128 || '', 'MultiLine'),
                  }}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmWebRuleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cRuleTypeId128'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cRuleTypeId128')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmWebRuleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cButtonTypeId128')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmWebRuleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cEventId128'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cEventId128')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmWebRuleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cReactEventId128')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmWebRuleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cReduxEventId128')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmWebRuleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cServiceEventId128')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmWebRuleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cAsmxEventId128')}
