...
export const pagesRoutes = [
  {
    ...
    screenId : 54
                    ...
                    {
                        path: '/AdmScreenTab/:mstId?/DtlList/:dtlId?',
                        name: 'Detail List',
                        short: 'DetailList',
                        component: DtlList,
                        icon: 'list-ul',
                      ...
                      {
                        path: '/AdmScreenTab/:mstId?/Dtl/:dtlId?',
                        name: 'Detail Record',
                        short: 'DetailRecord',
                        component: DtlRecord,
                        icon: 'picture-o',
...
export function getNaviBar(type, mst, dtl, label) {
  return pagesRoutes
    ...
    .map((v, i) => {
      return {
        path: naviPath(v.type === 'MstList' ? '_' : mst.ScreenTabId19, v.type === 'DtlList' ? '_' : dtl.ScreenTabHlpId80, v.path),
