...
class MstList extends RintagiScreen {
  constructor(props) {
    ...
    if (lastAppUrl && !(this.props.AdmButtonHlp || {}).initialized) {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    const buttons = (nextProps.AdmButtonHlp || {}).Buttons || {};
  ...
  componentDidUpdate(prevProps, prevStates) {
    ...
    if (prevStates.key !== (currReduxScreenState.Mst || {}).ButtonHlpId116) {
      const isMobileView = this.state.isMobile;
      const useMobileView = (isMobileView && !(this.props.user || {}).desktopView);
  ...
  render() {
    ...
    // if (!AdmButtonHlpState.initialized || AdmButtonHlpState.page_loading) return null;
    ...
    const screenDdlSelectors = AdmButtonHlpReduxObj.ScreenDdlSelectors;
    const screenCriDdlSelectors = AdmButtonHlpReduxObj.ScreenCriDdlSelectors;
    const screenCriteria = AdmButtonHlpState.ScreenCriteria || {}
    ...
    const currMst = AdmButtonHlpState.Mst;
    const currDtl = AdmButtonHlpState.EditDtl;
    const naviBar = getNaviBar('MstList', currMst, {}, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.ButtonHlpId116));
    const naviSelectBar = getNaviBar('MstList', {}, {}, screenButtons);
    const screenFilterList = AdmButtonHlpReduxObj.QuickFilterDdlToSelectList(AdmButtonHlpState);
    ...
    const CriCultureId10List = screenCriDdlSelectors.CultureId10(AdmButtonHlpState);
              ...
              <div className='account'>
                <div className='account__wrapper account-col'>
                  <div className='account__card rad-4'>
                    {/* {this.constructor.ShowSpinner(AdmButtonHlpState,'MstList') && siteSpinner} */}
                            ...
                            <UncontrolledDropdown>
                              <ButtonGroup className='btn-group--icons'>
                                <Button className={`mw-50 ${filterBtnStyle}`} onClick={this.props.changeMstListFilterVisibility} outline>
                                  <i className={`fa fa-filter icon-holder ${filterActive}`}></i>{ShowMstFilterApplied(AdmButtonHlpState) && <i className='filter-applied'></i>}
                                  ...
                                  dropdownMenuButtonList.filter(v => v.expose).map(v => {
                                    return (
                                      <Button
                                        ...
                                        // disabled={!activeSelectionVisible || this.ActionSuppressed(authRow, v.buttonType, (currMst || {}).ButtonHlpId116)}
                    ...
                    <Formik
                      ...
                      key={AdmButtonHlpState.searchListVersion}
                        ...
                        setFieldTouched
                          ...
                          <div>
                            <Form className='form'>
                              ...
                              {this.constructor.ShowMoreMstBtn(AdmButtonHlpState) && <Button className={`btn btn-view-more-blue account__btn ${noMargin}`} onClick={this.ShowMoreSearchList} type='button'>{strFormat(IncrementMsg, AdmButtonHlpState.ScreenCriteria.Increment)}<br /><i className='fa fa-arrow-down'></i></Button>}
...
const mapDispatchToProps = (dispatch) => (
  bindActionCreators(Object.assign({},
    ...
    { LoadInitPage: AdmButtonHlpReduxObj.LoadInitPage.bind(AdmButtonHlpReduxObj) },
    { LoadSearchList: AdmButtonHlpReduxObj.LoadSearchList.bind(AdmButtonHlpReduxObj) },
    { SelectMst: AdmButtonHlpReduxObj.SelectMst.bind(AdmButtonHlpReduxObj) },
    { DelMst: AdmButtonHlpReduxObj.DelMst.bind(AdmButtonHlpReduxObj) },
    { AddMst: AdmButtonHlpReduxObj.AddMst.bind(AdmButtonHlpReduxObj) },
    { AddDtl: AdmButtonHlpReduxObj.AddDtl.bind(AdmButtonHlpReduxObj) },
    { changeMstListFilterVisibility: AdmButtonHlpReduxObj.ChangeMstListFilterVisibility.bind(AdmButtonHlpReduxObj) },
    { SetScreenCriteria: AdmButtonHlpReduxObj.SetScreenCriteria.bind(AdmButtonHlpReduxObj) },
    { SearchCriCultureId10: AdmButtonHlpReduxObj.SearchActions.SearchCriCultureId10.bind(AdmButtonHlpReduxObj) },
