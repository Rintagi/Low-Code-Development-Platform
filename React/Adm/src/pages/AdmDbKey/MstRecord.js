...
class MstRecord extends RintagiScreen {
  ...
  RefColumnId20InputChange() { const _this = this; return function (name, v) { const filterBy = ((_this.props.AdmDbKey || {}).Mst || {}).RefTableId20; _this.props.SearchRefColumnId20(v, filterBy); } }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmDbKey.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.KeyId20));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cKeyId20: formatContent(KeyId20 || '', 'TextBox'),
                    cKeyName20: formatContent(KeyName20 || '', 'TextBox'),
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmDbKeyState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cTableId20'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cTableId20', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmDbKeyState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cColumnId20'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cColumnId20', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmDbKeyState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cRefTableId20'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cRefTableId20', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmDbKeyState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cRefColumnId20'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cRefColumnId20', false, values)}
