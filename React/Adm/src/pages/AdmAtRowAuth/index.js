...
export const pagesRoutes = [
  {
    ...
    screenId : 22
                    ...
                    {
                        path: '/AdmAtRowAuth/:mstId?/DtlList/:dtlId?',
                        name: 'Detail List',
                        short: 'DetailList',
                        component: DtlList,
                        icon: 'list-ul',
                      ...
                      {
                        path: '/AdmAtRowAuth/:mstId?/Dtl/:dtlId?',
                        name: 'Detail Record',
                        short: 'DetailRecord',
                        component: DtlRecord,
                        icon: 'picture-o',
...
export function getNaviBar(type, mst, dtl, label) {
  return pagesRoutes
    ...
    .map((v, i) => {
      return {
        path: naviPath(v.type === 'MstList' ? '_' : mst.RowAuthId236, v.type === 'DtlList' ? '_' : dtl.RowAuthPrmId237, v.path),
