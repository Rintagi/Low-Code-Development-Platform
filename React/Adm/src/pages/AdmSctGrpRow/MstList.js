...
class MstList extends RintagiScreen {
  constructor(props) {
    ...
    if (lastAppUrl && !(this.props.AdmSctGrpRow || {}).initialized) {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    const buttons = (nextProps.AdmSctGrpRow || {}).Buttons || {};
  ...
  componentDidUpdate(prevProps, prevStates) {
    ...
    if (prevStates.key !== (currReduxScreenState.Mst || {}).SctGrpRowId1283) {
      const isMobileView = this.state.isMobile;
      const useMobileView = (isMobileView && !(this.props.user || {}).desktopView);
  ...
  render() {
    ...
    // if (!AdmSctGrpRowState.initialized || AdmSctGrpRowState.page_loading) return null;
    ...
    const screenDdlSelectors = AdmSctGrpRowReduxObj.ScreenDdlSelectors;
    const screenCriDdlSelectors = AdmSctGrpRowReduxObj.ScreenCriDdlSelectors;
    const screenCriteria = AdmSctGrpRowState.ScreenCriteria || {}
    ...
    const currMst = AdmSctGrpRowState.Mst;
    const currDtl = AdmSctGrpRowState.EditDtl;
    const naviBar = getNaviBar('MstList', currMst, {}, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.SctGrpRowId1283));
    const naviSelectBar = getNaviBar('MstList', {}, {}, screenButtons);
    const screenFilterList = AdmSctGrpRowReduxObj.QuickFilterDdlToSelectList(AdmSctGrpRowState);
              ...
              <div className='account'>
                <div className='account__wrapper account-col'>
                  <div className='account__card rad-4'>
                    {/* {this.constructor.ShowSpinner(AdmSctGrpRowState,'MstList') && siteSpinner} */}
                            ...
                            <UncontrolledDropdown>
                              <ButtonGroup className='btn-group--icons'>
                                <Button className={`mw-50 ${filterBtnStyle}`} onClick={this.props.changeMstListFilterVisibility} outline>
                                  <i className={`fa fa-filter icon-holder ${filterActive}`}></i>{ShowMstFilterApplied(AdmSctGrpRowState) && <i className='filter-applied'></i>}
                                  ...
                                  dropdownMenuButtonList.filter(v => v.expose).map(v => {
                                    return (
                                      <Button
                                        ...
                                        // disabled={!activeSelectionVisible || this.ActionSuppressed(authRow, v.buttonType, (currMst || {}).SctGrpRowId1283)}
                    ...
                    <Formik
                      ...
                      key={AdmSctGrpRowState.searchListVersion}
                        ...
                        setFieldTouched
                          ...
                          <div>
                            <Form className='form'>
                              ...
                              {this.constructor.ShowMoreMstBtn(AdmSctGrpRowState) && <Button className={`btn btn-view-more-blue account__btn ${noMargin}`} onClick={this.ShowMoreSearchList} type='button'>{strFormat(IncrementMsg, AdmSctGrpRowState.ScreenCriteria.Increment)}<br /><i className='fa fa-arrow-down'></i></Button>}
...
const mapDispatchToProps = (dispatch) => (
  bindActionCreators(Object.assign({},
    ...
    { LoadInitPage: AdmSctGrpRowReduxObj.LoadInitPage.bind(AdmSctGrpRowReduxObj) },
    { LoadSearchList: AdmSctGrpRowReduxObj.LoadSearchList.bind(AdmSctGrpRowReduxObj) },
    { SelectMst: AdmSctGrpRowReduxObj.SelectMst.bind(AdmSctGrpRowReduxObj) },
    { DelMst: AdmSctGrpRowReduxObj.DelMst.bind(AdmSctGrpRowReduxObj) },
    { AddMst: AdmSctGrpRowReduxObj.AddMst.bind(AdmSctGrpRowReduxObj) },
    { AddDtl: AdmSctGrpRowReduxObj.AddDtl.bind(AdmSctGrpRowReduxObj) },
    { changeMstListFilterVisibility: AdmSctGrpRowReduxObj.ChangeMstListFilterVisibility.bind(AdmSctGrpRowReduxObj) },
    { SetScreenCriteria: AdmSctGrpRowReduxObj.SetScreenCriteria.bind(AdmSctGrpRowReduxObj) },
