...
class MstList extends RintagiScreen {
  constructor(props) {
    ...
    if (lastAppUrl && !(this.props.AdmTbdRule || {}).initialized) {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    const buttons = (nextProps.AdmTbdRule || {}).Buttons || {};
  ...
  componentDidUpdate(prevProps, prevStates) {
    ...
    if (prevStates.key !== (currReduxScreenState.Mst || {}).TbdRuleId254) {
      const isMobileView = this.state.isMobile;
      const useMobileView = (isMobileView && !(this.props.user || {}).desktopView);
  ...
  render() {
    ...
    // if (!AdmTbdRuleState.initialized || AdmTbdRuleState.page_loading) return null;
    ...
    const screenDdlSelectors = AdmTbdRuleReduxObj.ScreenDdlSelectors;
    const screenCriDdlSelectors = AdmTbdRuleReduxObj.ScreenCriDdlSelectors;
    const screenCriteria = AdmTbdRuleState.ScreenCriteria || {}
    ...
    const currMst = AdmTbdRuleState.Mst;
    const currDtl = AdmTbdRuleState.EditDtl;
    const naviBar = getNaviBar('MstList', currMst, {}, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.TbdRuleId254));
    const naviSelectBar = getNaviBar('MstList', {}, {}, screenButtons);
    const screenFilterList = AdmTbdRuleReduxObj.QuickFilterDdlToSelectList(AdmTbdRuleState);
    ...
    const CriScreenId10List = screenCriDdlSelectors.ScreenId10(AdmTbdRuleState);
              ...
              <div className='account'>
                <div className='account__wrapper account-col'>
                  <div className='account__card rad-4'>
                    {/* {this.constructor.ShowSpinner(AdmTbdRuleState,'MstList') && siteSpinner} */}
                            ...
                            <UncontrolledDropdown>
                              <ButtonGroup className='btn-group--icons'>
                                <Button className={`mw-50 ${filterBtnStyle}`} onClick={this.props.changeMstListFilterVisibility} outline>
                                  <i className={`fa fa-filter icon-holder ${filterActive}`}></i>{ShowMstFilterApplied(AdmTbdRuleState) && <i className='filter-applied'></i>}
                                  ...
                                  dropdownMenuButtonList.filter(v => v.expose).map(v => {
                                    return (
                                      <Button
                                        ...
                                        // disabled={!activeSelectionVisible || this.ActionSuppressed(authRow, v.buttonType, (currMst || {}).TbdRuleId254)}
                    ...
                    <Formik
                      ...
                      key={AdmTbdRuleState.searchListVersion}
                        ...
                        setFieldTouched
                          ...
                          <div>
                            <Form className='form'>
                              ...
                              {this.constructor.ShowMoreMstBtn(AdmTbdRuleState) && <Button className={`btn btn-view-more-blue account__btn ${noMargin}`} onClick={this.ShowMoreSearchList} type='button'>{strFormat(IncrementMsg, AdmTbdRuleState.ScreenCriteria.Increment)}<br /><i className='fa fa-arrow-down'></i></Button>}
...
const mapDispatchToProps = (dispatch) => (
  bindActionCreators(Object.assign({},
    ...
    { LoadInitPage: AdmTbdRuleReduxObj.LoadInitPage.bind(AdmTbdRuleReduxObj) },
    { LoadSearchList: AdmTbdRuleReduxObj.LoadSearchList.bind(AdmTbdRuleReduxObj) },
    { SelectMst: AdmTbdRuleReduxObj.SelectMst.bind(AdmTbdRuleReduxObj) },
    { DelMst: AdmTbdRuleReduxObj.DelMst.bind(AdmTbdRuleReduxObj) },
    { AddMst: AdmTbdRuleReduxObj.AddMst.bind(AdmTbdRuleReduxObj) },
    { AddDtl: AdmTbdRuleReduxObj.AddDtl.bind(AdmTbdRuleReduxObj) },
    { changeMstListFilterVisibility: AdmTbdRuleReduxObj.ChangeMstListFilterVisibility.bind(AdmTbdRuleReduxObj) },
    { SetScreenCriteria: AdmTbdRuleReduxObj.SetScreenCriteria.bind(AdmTbdRuleReduxObj) },
    { SearchCriScreenId10: AdmTbdRuleReduxObj.SearchActions.SearchCriScreenId10.bind(AdmTbdRuleReduxObj) },
