...
class MstRecord extends RintagiScreen {
  ...
  DetailTableId15InputChange() { const _this = this; return function (name, v) { const filterBy = ''; _this.props.SearchDetailTableId15(v, filterBy); } }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmScreen.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.ScreenId15));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cScreenId15: formatContent(ScreenId15 || '', 'TextBox'),
                    cProgramName15: formatContent(ProgramName15 || '', 'TextBox'),
                    ...
                    cGridRows15: formatContent(GridRows15 || '', 'TextBox'),
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cScreenTypeId15')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cViewOnly15'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cViewOnly15')}
