...
class DtlRecord extends RintagiScreen {
  ...
  CultureId16InputChange() {
    const _this = this; 
    return function (name, v) { 
      const filterBy = ''; 
      _this.props.SearchCultureId16(v, filterBy);
    } 
  }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (currDtlId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', mst, {}, this.props.AdmScreen.Label);
              ...
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    ...
                    cScreenTitle16: formatContent(currDtl.ScreenTitle16 || '', 'TextBox'),
                    cDefaultHlpMsg16: formatContent(currDtl.DefaultHlpMsg16 || '', 'TextBox'),
                    cFootNote16: formatContent(currDtl.FootNote16 || '', 'TextBox'),
                    cAddMsg16: formatContent(currDtl.AddMsg16 || '', 'TextBox'),
                    cUpdMsg16: formatContent(currDtl.UpdMsg16 || '', 'TextBox'),
                    cDelMsg16: formatContent(currDtl.DelMsg16 || '', 'TextBox'),
                    cIncrementMsg16: formatContent(currDtl.IncrementMsg16 || '', 'TextBox'),
                    cNoMasterMsg16: formatContent(currDtl.NoMasterMsg16 || '', 'TextBox'),
                    cNoDetailMsg16: formatContent(currDtl.NoDetailMsg16 || '', 'TextBox'),
                    cAddMasterMsg16: formatContent(currDtl.AddMasterMsg16 || '', 'TextBox'),
                    cAddDetailMsg16: formatContent(currDtl.AddDetailMsg16 || '', 'TextBox'),
                    cMasterLstTitle16: formatContent(currDtl.MasterLstTitle16 || '', 'TextBox'),
                    cMasterLstSubtitle16: formatContent(currDtl.MasterLstSubtitle16 || '', 'TextBox'),
                    cMasterRecTitle16: formatContent(currDtl.MasterRecTitle16 || '', 'TextBox'),
                    cMasterRecSubtitle16: formatContent(currDtl.MasterRecSubtitle16 || '', 'TextBox'),
                    cMasterFoundMsg16: formatContent(currDtl.MasterFoundMsg16 || '', 'TextBox'),
                    cDetailLstTitle16: formatContent(currDtl.DetailLstTitle16 || '', 'TextBox'),
                    cDetailLstSubtitle16: formatContent(currDtl.DetailLstSubtitle16 || '', 'TextBox'),
                    cDetailRecTitle16: formatContent(currDtl.DetailRecTitle16 || '', 'TextBox'),
                    cDetailRecSubtitle16: formatContent(currDtl.DetailRecSubtitle16 || '', 'TextBox'),
                    cDetailFoundMsg16: formatContent(currDtl.DetailFoundMsg16 || '', 'TextBox'),
                  }}
