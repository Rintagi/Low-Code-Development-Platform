...
export const pagesRoutes = [
  {
    ...
    screenId : 67
                    ...
                    {
                        path: '/AdmReport/:mstId?/DtlList/:dtlId?',
                        name: 'Detail List',
                        short: 'DetailList',
                        component: DtlList,
                        icon: 'list-ul',
                      ...
                      {
                        path: '/AdmReport/:mstId?/Dtl/:dtlId?',
                        name: 'Detail Record',
                        short: 'DetailRecord',
                        component: DtlRecord,
                        icon: 'picture-o',
...
export function getNaviBar(type, mst, dtl, label) {
  return pagesRoutes
    ...
    .map((v, i) => {
      return {
        path: naviPath(v.type === 'MstList' ? '_' : mst.ReportId22, v.type === 'DtlList' ? '_' : dtl.ReportHlpId96, v.path),
