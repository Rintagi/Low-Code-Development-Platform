...
class MstRecord extends RintagiScreen {
  ...
  TblGrouping162InputChange() { const _this = this; return function (name, v) { const filterBy = ((_this.props.AdmRptTbl || {}).Mst || {}).ReportId162; _this.props.SearchTblGrouping162(v, filterBy); } }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmRptTbl.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.RptTblId162));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cRptTblId162: formatContent(RptTblId162 || '', 'TextBox'),
                    ...
                    cTblOrder162: formatContent(TblOrder162 || '', 'TextBox'),
                    cColWidth162: formatContent(ColWidth162 || '', 'TextBox'),
                  }}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptTblState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cRptCtrId162'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cRptCtrId162', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptTblState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cParentId162'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cParentId162', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptTblState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cReportId162'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cReportId162', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptTblState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cTblToggle162'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cTblToggle162', false, values)}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptTblState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          ...
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cTblGrouping162', false, values)}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptTblState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cRptTblTypeCd162')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptTblState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cTblVisibility162')}
