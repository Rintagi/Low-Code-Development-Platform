...
//  }
  ...
  SavePage(values, { setSubmitting, setErrors, resetForm, setFieldValue, setValues }) {
    const errors = [];
    const currMst = (this.props.AdmMenuPerm || {}).Mst || {};
...
//    }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          this.props.AdmMenuPerm.Mst.Posted64 = 'N';
          if (useMobileView) {
            const naviBar = getNaviBar('Mst', {}, {}, this.props.AdmMenuPerm.Label);
  ...
  render() {
    ...
    const currMst = ((this.props.AdmMenuPerm || {}).Mst || {});
    const currDtl = ((this.props.AdmMenuPerm || {}).EditDtl || {});
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                {/* {!useMobileView && this.constructor.ShowSpinner(AdmMenuPermState) && <div className='panel__refresh'></div>} */}
                          ...
                          <Row>
                            ...
                            <Col xs={useMobileView ? 3 : 4}>
                              <ButtonToolbar className='f-right'>
                                {(this.constructor.ShowSpinner(AdmMenuPermState) && <Skeleton height='40px' />) ||
                                      ...
                                      .map((v, i, a) => {
                                        ...
                                        return (
                                          <Col key={v.tid || v.order} xs={colWidth} sm={colWidth} className='btn-bottom-column' >
                                            {(this.constructor.ShowSpinner(AdmMenuPermState) && <Skeleton height='43px' />) ||
...
//    { SearchMemberId64: AdmMenuPermReduxObj.SearchActions.SearchMemberId64.bind(AdmMenuPermReduxObj) },
//    { SearchCurrencyId64: AdmMenuPermReduxObj.SearchActions.SearchCurrencyId64.bind(AdmMenuPermReduxObj) },
//    { SearchCustomerJobId64: AdmMenuPermReduxObj.SearchActions.SearchCustomerJobId64.bind(AdmMenuPermReduxObj) },
