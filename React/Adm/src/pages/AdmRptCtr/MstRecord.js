...
class MstRecord extends RintagiScreen {
  ...
  CtrGrouping161InputChange() { const _this = this; return function (name, v) { const filterBy = ((_this.props.AdmRptCtr || {}).Mst || {}).ReportId161; _this.props.SearchCtrGrouping161(v, filterBy); } }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmRptCtr.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.RptCtrId161));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cRptCtrId161: formatContent(RptCtrId161 || '', 'TextBox'),
                    cReportId161: ReportId161List.filter(obj => { return obj.key === ReportId161 })[0],
                    cRptCtrName161: formatContent(RptCtrName161 || '', 'TextBox'),
                    ...
                    cCtrTop161: formatContent(CtrTop161 || '', 'TextBox'),
                    cCtrLeft161: formatContent(CtrLeft161 || '', 'TextBox'),
                    cCtrHeight161: formatContent(CtrHeight161 || '', 'TextBox'),
                    cCtrWidth161: formatContent(CtrWidth161 || '', 'TextBox'),
                    cCtrZIndex161: formatContent(CtrZIndex161 || '', 'TextBox'),
                    ...
                    cCtrValue161: formatContent(CtrValue161 || '', 'TextBox'),
                    cCtrAction161: formatContent(CtrAction161 || '', 'TextBox'),
                    ...
                    cCtrToolTip161: formatContent(CtrToolTip161 || '', 'TextBox'),
                  }}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptCtrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cRptCtrTypeCd161')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptCtrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cCtrVisibility161')}
