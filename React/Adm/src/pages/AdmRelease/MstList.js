...
class MstList extends RintagiScreen {
  ...
  RefreshSearchList(values, { setErrors, resetForm, setValues /* setValues and other goodies */ }) {
    ...
    const refreshFn = (() => {
      this.props.SetScreenCriteria(values.search,
        {
          ReleaseDate10: (values.cCriReleaseDate10) ? values.cCriReleaseDate10 : '',
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstList', currMst, {}, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.ReleaseId191));
              ...
              <div className='account'>
                <div className='account__wrapper account-col'>
                  <div className='account__card rad-4'>
                    ...
                    <Formik
                      initialValues={{
                        cCriReleaseDate10: ((screenCriteria || {}).ReleaseDate10 || {}).LastCriteria,
                            ...
                            <Form className='form'>
                              <div className='form__form-group'>
                                <div className={`form__form-group filter-padding ${filterVisibility}`} key={screenCriteria.key}>
                                  <Row className='mb-5'>
                                    <Col xs={12} md={12}>
                                      <label className='form__form-group-label filter-label'>{(screenCriteria.ReleaseDate10 || {}).ColumnHeader}</label>
                                      <div className='form__form-group-field filter-form-border'>
                                        <Field
                                          type='text'
                                          name='cCriReleaseDate10'
                                          value={values.cCriReleaseDate10}
                                          onBlur={this.SearchFilterTextValueChange(handleSubmit, setFieldValue, 'text', 'cCriReleaseDate10')}
                                        />
                                      </div>
                                    </Col>
                                    <Col xs={12} md={12}>
