...
class MstRecord extends RintagiScreen {
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmRelease.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.ReleaseId191));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cReleaseId191: formatContent(ReleaseId191 || '', 'TextBox'),
                    cReleaseName191: formatContent(ReleaseName191 || '', 'TextBox'),
                    cReleaseBuild191: formatContent(ReleaseBuild191 || '', 'TextBox'),
                    ...
                    cTarScriptAft191: formatContent(TarScriptAft191 || '', 'MultiLine'),
                    cReadMe191: formatContent(ReadMe191 || '', 'MultiLine'),
                  }}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmReleaseState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cReleaseOs191'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cReleaseOs191')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmReleaseState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cEntityId191'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cEntityId191')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmReleaseState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cReleaseTypeId191')}
