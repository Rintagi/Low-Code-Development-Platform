...
class MstList extends RintagiScreen {
  constructor(props) {
    ...
    if (lastAppUrl && !(this.props.AdmSctGrpCol || {}).initialized) {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    const buttons = (nextProps.AdmSctGrpCol || {}).Buttons || {};
  ...
  componentDidUpdate(prevProps, prevStates) {
    ...
    if (prevStates.key !== (currReduxScreenState.Mst || {}).SctGrpColId1284) {
      const isMobileView = this.state.isMobile;
      const useMobileView = (isMobileView && !(this.props.user || {}).desktopView);
  ...
  render() {
    ...
    // if (!AdmSctGrpColState.initialized || AdmSctGrpColState.page_loading) return null;
    ...
    const screenDdlSelectors = AdmSctGrpColReduxObj.ScreenDdlSelectors;
    const screenCriDdlSelectors = AdmSctGrpColReduxObj.ScreenCriDdlSelectors;
    const screenCriteria = AdmSctGrpColState.ScreenCriteria || {}
    ...
    const currMst = AdmSctGrpColState.Mst;
    const currDtl = AdmSctGrpColState.EditDtl;
    const naviBar = getNaviBar('MstList', currMst, {}, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.SctGrpColId1284));
    const naviSelectBar = getNaviBar('MstList', {}, {}, screenButtons);
    const screenFilterList = AdmSctGrpColReduxObj.QuickFilterDdlToSelectList(AdmSctGrpColState);
              ...
              <div className='account'>
                <div className='account__wrapper account-col'>
                  <div className='account__card rad-4'>
                    {/* {this.constructor.ShowSpinner(AdmSctGrpColState,'MstList') && siteSpinner} */}
                            ...
                            <UncontrolledDropdown>
                              <ButtonGroup className='btn-group--icons'>
                                <Button className={`mw-50 ${filterBtnStyle}`} onClick={this.props.changeMstListFilterVisibility} outline>
                                  <i className={`fa fa-filter icon-holder ${filterActive}`}></i>{ShowMstFilterApplied(AdmSctGrpColState) && <i className='filter-applied'></i>}
                                  ...
                                  dropdownMenuButtonList.filter(v => v.expose).map(v => {
                                    return (
                                      <Button
                                        ...
                                        // disabled={!activeSelectionVisible || this.ActionSuppressed(authRow, v.buttonType, (currMst || {}).SctGrpColId1284)}
                    ...
                    <Formik
                      ...
                      key={AdmSctGrpColState.searchListVersion}
                        ...
                        setFieldTouched
                          ...
                          <div>
                            <Form className='form'>
                              ...
                              {this.constructor.ShowMoreMstBtn(AdmSctGrpColState) && <Button className={`btn btn-view-more-blue account__btn ${noMargin}`} onClick={this.ShowMoreSearchList} type='button'>{strFormat(IncrementMsg, AdmSctGrpColState.ScreenCriteria.Increment)}<br /><i className='fa fa-arrow-down'></i></Button>}
...
const mapDispatchToProps = (dispatch) => (
  bindActionCreators(Object.assign({},
    ...
    { LoadInitPage: AdmSctGrpColReduxObj.LoadInitPage.bind(AdmSctGrpColReduxObj) },
    { LoadSearchList: AdmSctGrpColReduxObj.LoadSearchList.bind(AdmSctGrpColReduxObj) },
    { SelectMst: AdmSctGrpColReduxObj.SelectMst.bind(AdmSctGrpColReduxObj) },
    { DelMst: AdmSctGrpColReduxObj.DelMst.bind(AdmSctGrpColReduxObj) },
    { AddMst: AdmSctGrpColReduxObj.AddMst.bind(AdmSctGrpColReduxObj) },
    { AddDtl: AdmSctGrpColReduxObj.AddDtl.bind(AdmSctGrpColReduxObj) },
    { changeMstListFilterVisibility: AdmSctGrpColReduxObj.ChangeMstListFilterVisibility.bind(AdmSctGrpColReduxObj) },
    { SetScreenCriteria: AdmSctGrpColReduxObj.SetScreenCriteria.bind(AdmSctGrpColReduxObj) },
