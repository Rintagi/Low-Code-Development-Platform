...
//  }
  ...
  SavePage(values, { setSubmitting, setErrors, resetForm, setFieldValue, setValues }) {
    const errors = [];
    const currMst = (this.props.AdmMenuHlp || {}).Mst || {};
...
//    }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          this.props.AdmMenuHlp.Mst.Posted64 = 'N';
          if (useMobileView) {
            const naviBar = getNaviBar('Mst', {}, {}, this.props.AdmMenuHlp.Label);
  ...
  render() {
    ...
    const currMst = ((this.props.AdmMenuHlp || {}).Mst || {});
    const currDtl = ((this.props.AdmMenuHlp || {}).EditDtl || {});
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                {/* {!useMobileView && this.constructor.ShowSpinner(AdmMenuHlpState) && <div className='panel__refresh'></div>} */}
                          ...
                          <Row>
                            ...
                            <Col xs={useMobileView ? 3 : 4}>
                              <ButtonToolbar className='f-right'>
                                {(this.constructor.ShowSpinner(AdmMenuHlpState) && <Skeleton height='40px' />) ||
                                      ...
                                      .map((v, i, a) => {
                                        ...
                                        return (
                                          <Col key={v.tid || v.order} xs={colWidth} sm={colWidth} className='btn-bottom-column' >
                                            {(this.constructor.ShowSpinner(AdmMenuHlpState) && <Skeleton height='43px' />) ||
...
//    { SearchMemberId64: AdmMenuHlpReduxObj.SearchActions.SearchMemberId64.bind(AdmMenuHlpReduxObj) },
//    { SearchCurrencyId64: AdmMenuHlpReduxObj.SearchActions.SearchCurrencyId64.bind(AdmMenuHlpReduxObj) },
//    { SearchCustomerJobId64: AdmMenuHlpReduxObj.SearchActions.SearchCustomerJobId64.bind(AdmMenuHlpReduxObj) },
