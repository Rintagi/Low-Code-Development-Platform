...
class DtlRecord extends RintagiScreen {
  ...
  CultureId40InputChange() {
    const _this = this; 
    return function (name, v) { 
      const filterBy = ''; 
      _this.props.SearchCultureId40(v, filterBy);
    } 
  }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (currDtlId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', mst, {}, this.props.AdmMenuHlp.Label);
              ...
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    ...
                    cMenuText40: formatContent(currDtl.MenuText40 || '', 'TextBox'),
                  }}
