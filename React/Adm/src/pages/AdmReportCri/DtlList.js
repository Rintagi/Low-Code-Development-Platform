...
import AdmReportCriReduxObj from '../../redux/AdmReportCri';
...
class DtlList extends RintagiScreen {
  ...
  render() {
    ...
    const filterList = AdmReportCriState.DtlFilter.FilterColumnDdl.map((v, i) => ({ key: v.ColName, label: v.ColumnHeader, value: v.ColName, pos: i }))
                        ...
                        resetForm
                          ...
                          <div>
                                      ...
                                      <ButtonGroup className='btn-group--icons'>
                                        ...
                                        </Button>
                                        {
                                          dropdownMenuButtonList.filter(v => v.expose).map(v => {
                                            if ((!activeSelectionVisible && v.buttonType !== 'InsRow') || this.ActionSuppressed(authRow, v.buttonType, (currMst || {}).ReportCriId97)) return null;
                                            return (
                                              <Button
                                                key={v.tid}
                            ...
                            <Form className='form'>
                                ...
                                </div>
                                {
                                  itemList.slice(0, dtlFilter.Limit).map(
                                    (obj, i) => {
                                      ...
                                      return (
                                        <div className='form__form-group-narrow list-divider' key={obj.ReportCriHlpId98 || ('_' + i)}>
                                          <div className='form__form-group-field'>
                                            <label className='radio-btn radio-btn--button margin-narrow'>
                                              <Field
                                                key={obj.ReportCriHlpId98 || ('_' + i)}
                                                className='radio-btn__radio'
                                                name='expenseItem'
                                                type='radio'
                                                value={values.name}
                                                onClick={this.SelectDtlListRow(naviSelectBar, currMst, obj, i, 'ReportCriId97', 'ReportCriHlpId98')}
                                              ...
                                              </span>
                                              {
                                                rowMenuButtonList
                                                  ...
                                                  .map((v, i) => {
                                                    return (
                                                      <button type='button' onClick={this.ScreenButtonAction[v.buttonType]({ naviBar: naviSelectBar, mst: currMst, useMobileView, dtlId: obj.ReportCriHlpId98 })} className={`${v.exposedClassName}`}><i className={`${v.iconClassName}`}></i></button>
                                                    )
                                                  })
                                              }
                                              {
                              ...
                              <Button onClick={this.props.ViewMoreDtl} className={`${viewMoreClass} btn btn-view-more-blue account__btn`} type='button'>{strFormat(IncrementMsg, this.props.AdmReportCri.DtlFilter.PageSize)}<br /><i className='fa fa-arrow-down'></i></Button>
...
const mapDispatchToProps = (dispatch) => (
  bindActionCreators(Object.assign({},
    ...
    { SelectDtl: AdmReportCriReduxObj.SelectDtl.bind(AdmReportCriReduxObj) },
    ...
    { ChangeDtlListFilterVisibility: AdmReportCriReduxObj.ChangeDtlListFilterVisibility.bind(AdmReportCriReduxObj) },
    { ChangeDtlListFilter: AdmReportCriReduxObj.ChangeDtlListFilter.bind(AdmReportCriReduxObj) },
    { ViewMoreDtl: AdmReportCriReduxObj.ViewMoreDtl.bind(AdmReportCriReduxObj) },
    { setTitle: setTitle },
