...
class MstRecord extends RintagiScreen {
  ...
  DdlFtrColumnId97InputChange() { const _this = this; return function (name, v) { const filterBy = ((_this.props.AdmReportCri || {}).Mst || {}).ReportId97; _this.props.SearchDdlFtrColumnId97(v, filterBy); } }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmReportCri.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.ReportCriId97));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cReportCriId97: formatContent(ReportCriId97 || '', 'TextBox'),
                    cReportId97: ReportId97List.filter(obj => { return obj.key === ReportId97 })[0],
                    cTabIndex97: formatContent(TabIndex97 || '', 'TextBox'),
                    cColumnName97: formatContent(ColumnName97 || '', 'TextBox'),
                    cReportGrpId97: ReportGrpId97List.filter(obj => { return obj.key === ReportGrpId97 })[0],
                    cLabelCss97: formatContent(LabelCss97 || '', 'TextBox'),
                    cContentCss97: formatContent(ContentCss97 || '', 'TextBox'),
                    cDefaultValue97: formatContent(DefaultValue97 || '', 'TextBox'),
                    cTableId97: TableId97List.filter(obj => { return obj.key === TableId97 })[0],
                    cTableAbbr97: formatContent(TableAbbr97 || '', 'TextBox'),
                    cRequiredValid97: RequiredValid97 === 'Y',
                    cDataTypeId97: DataTypeId97List.filter(obj => { return obj.key === DataTypeId97 })[0],
                    cDataTypeSize97: formatContent(DataTypeSize97 || '', 'TextBox'),
                    cDisplayModeId97: DisplayModeId97List.filter(obj => { return obj.key === DisplayModeId97 })[0],
                    cColumnSize97: formatContent(ColumnSize97 || '', 'TextBox'),
                    cRowSize97: formatContent(RowSize97 || '', 'TextBox'),
                    cDdlKeyColumnName97: formatContent(DdlKeyColumnName97 || '', 'TextBox'),
                    cDdlRefColumnName97: formatContent(DdlRefColumnName97 || '', 'TextBox'),
                    cDdlSrtColumnName97: formatContent(DdlSrtColumnName97 || '', 'TextBox'),
                    cDdlFtrColumnId97: DdlFtrColumnId97List.filter(obj => { return obj.key === DdlFtrColumnId97 })[0],
                    cWhereClause97: formatContent(WhereClause97 || '', 'MultiLine'),
                    cRegClause97: formatContent(RegClause97 || '', 'MultiLine'),
                  }}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmReportCriState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cReportGrpId97'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cReportGrpId97')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmReportCriState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cTableId97'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cTableId97')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmReportCriState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cDataTypeId97'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cDataTypeId97')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmReportCriState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cDisplayModeId97')}
