...
class MstRecord extends RintagiScreen {
    ...
    if (errors.length > 0) {
      ...
      this.props.SavePage(
        this.props.AdmDataCat,
        {
          ...
          SampleImage181: values.cSampleImage181 && values.cSampleImage181.ts ?
            JSON.stringify({
              ...values.cSampleImage181,
              ts: undefined,
              lastTS: values.cSampleImage181.ts,
  ...
  render() {
    ...
    const SampleImage181 = currMst.SampleImage181 ? decodeEmbeddedFileObjectFromServer(currMst.SampleImage181) : null;
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmDataCatState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          ...
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cRptwizTypId181', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmDataCatState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cTableId181'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cTableId181', false, values)}
