...
class DtlRecord extends RintagiScreen {
  ...
  PermKeyRowId241InputChange() {
    const _this = this; 
    return function (name, v) { 
      const filterBy = ((_this.props.AdmAuthCol || {}).Dtl || {}).PermKeyId241; 
      _this.props.SearchPermKeyRowId241(v, filterBy);
    } 
  }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (currDtlId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', mst, {}, this.props.AdmAuthCol.Label);
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cColOvrdId241: currDtl.ColOvrdId241 || '',
                    ...
                    cPriority241: formatContent(currDtl.Priority241 || '', 'TextBox'),
                    cToolTip241: formatContent(currDtl.ToolTip241 || '', 'TextBox'),
                    cColumnHeader241: formatContent(currDtl.ColumnHeader241 || '', 'TextBox'),
                    cErrMessage241: formatContent(currDtl.ErrMessage241 || '', 'TextBox'),
                  }}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmAuthColState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cPermKeyId241'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cPermKeyId241')}
