...
//  }
  ...
  SavePage(values, { setSubmitting, setErrors, resetForm, setFieldValue, setValues }) {
    const errors = [];
    const currMst = (this.props.AdmAuthCol || {}).Mst || {};
...
//    }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          this.props.AdmAuthCol.Mst.Posted64 = 'N';
          if (useMobileView) {
            const naviBar = getNaviBar('Mst', {}, {}, this.props.AdmAuthCol.Label);
  ...
  render() {
    ...
    const currMst = ((this.props.AdmAuthCol || {}).Mst || {});
    const currDtl = ((this.props.AdmAuthCol || {}).EditDtl || {});
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                {/* {!useMobileView && this.constructor.ShowSpinner(AdmAuthColState) && <div className='panel__refresh'></div>} */}
                          ...
                          <Row>
                            ...
                            <Col xs={useMobileView ? 3 : 4}>
                              <ButtonToolbar className='f-right'>
                                {(this.constructor.ShowSpinner(AdmAuthColState) && <Skeleton height='40px' />) ||
                                      ...
                                      .map((v, i, a) => {
                                        ...
                                        return (
                                          <Col key={v.tid || v.order} xs={colWidth} sm={colWidth} className='btn-bottom-column' >
                                            {(this.constructor.ShowSpinner(AdmAuthColState) && <Skeleton height='43px' />) ||
...
//    { SearchMemberId64: AdmAuthColReduxObj.SearchActions.SearchMemberId64.bind(AdmAuthColReduxObj) },
//    { SearchCurrencyId64: AdmAuthColReduxObj.SearchActions.SearchCurrencyId64.bind(AdmAuthColReduxObj) },
//    { SearchCustomerJobId64: AdmAuthColReduxObj.SearchActions.SearchCustomerJobId64.bind(AdmAuthColReduxObj) },
