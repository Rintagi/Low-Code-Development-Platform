...
import * as AdmPaymentService from '../../services/AdmPaymentService';
...
class MstList extends RintagiScreen {
  constructor(props) {
    ...
    if (lastAppUrl && !(this.props.AdmPayment || {}).initialized) {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    const buttons = (nextProps.AdmPayment || {}).Buttons || {};
  ...
  render() {
    ...
    // if (!AdmPaymentState.initialized || AdmPaymentState.page_loading) return null;
    ...
    const screenDdlSelectors = AdmPaymentReduxObj.ScreenDdlSelectors;
    const screenCriDdlSelectors = AdmPaymentReduxObj.ScreenCriDdlSelectors;
    const screenCriteria = AdmPaymentState.ScreenCriteria || {}
    ...
    const currMst = AdmPaymentState.Mst;
    const currDtl = AdmPaymentState.EditDtl;
    ...
    const screenFilterList = AdmPaymentReduxObj.QuickFilterDdlToSelectList(AdmPaymentState);
              ...
              <div className='account'>
                <div className='account__wrapper account-col'>
                  <div className='account__card rad-4'>
                    {/* {this.constructor.ShowSpinner(AdmPaymentState,'MstList') && siteSpinner} */}
                            ...
                            <UncontrolledDropdown>
                              <ButtonGroup className='btn-group--icons'>
                                <Button className={`mw-50 ${filterBtnStyle}`} onClick={this.props.changeMstListFilterVisibility} outline>
                                  <i className={`fa fa-filter icon-holder ${filterActive}`}></i>{ShowMstFilterApplied(AdmPaymentState) && <i className='filter-applied'></i>}
                    ...
                    <Formik
                      ...
                      key={AdmPaymentState.searchListVersion}
                        ...
                        setFieldTouched
                          ...
                          <div>
                            <Form className='form'>
                              ...
                              {this.constructor.ShowMoreMstBtn(AdmPaymentState) && <Button className={`btn btn-view-more-blue account__btn ${noMargin}`} onClick={this.ShowMoreSearchList} type='button'>{strFormat(IncrementMsg, AdmPaymentState.ScreenCriteria.Increment)}<br /><i className='fa fa-arrow-down'></i></Button>}
...
const mapDispatchToProps = (dispatch) => (
  bindActionCreators(Object.assign({},
    ...
    { LoadInitPage: AdmPaymentReduxObj.LoadInitPage.bind(AdmPaymentReduxObj) },
    { LoadSearchList: AdmPaymentReduxObj.LoadSearchList.bind(AdmPaymentReduxObj) },
    { SelectMst: AdmPaymentReduxObj.SelectMst.bind(AdmPaymentReduxObj) },
    { DelMst: AdmPaymentReduxObj.DelMst.bind(AdmPaymentReduxObj) },
    { AddMst: AdmPaymentReduxObj.AddMst.bind(AdmPaymentReduxObj) },
    { AddDtl: AdmPaymentReduxObj.AddDtl.bind(AdmPaymentReduxObj) },
    { changeMstListFilterVisibility: AdmPaymentReduxObj.ChangeMstListFilterVisibility.bind(AdmPaymentReduxObj) },
    { SetScreenCriteria: AdmPaymentReduxObj.SetScreenCriteria.bind(AdmPaymentReduxObj) },
