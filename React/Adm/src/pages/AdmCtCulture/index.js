...
export const pagesRoutes = [
  {
    ...
    screenId : 8
                    ...
                    {
                        path: '/AdmCtCulture/:mstId?/DtlList/:dtlId?',
                        name: 'Detail List',
                        short: 'DetailList',
                        component: DtlList,
                        icon: 'list-ul',
                      ...
                      {
                        path: '/AdmCtCulture/:mstId?/Dtl/:dtlId?',
                        name: 'Detail Record',
                        short: 'DetailRecord',
                        component: DtlRecord,
                        icon: 'picture-o',
...
export function getNaviBar(type, mst, dtl, label) {
  return pagesRoutes
    ...
    .map((v, i) => {
      return {
        path: naviPath(v.type === 'MstList' ? '_' : mst.CultureTypeId8, v.type === 'DtlList' ? '_' : dtl.CultureLblId242, v.path),
