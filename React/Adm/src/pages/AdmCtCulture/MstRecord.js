...
class MstRecord extends RintagiScreen {
  ...
  CountryCd8InputChange() { const _this = this; return function (name, v) { const filterBy = ''; _this.props.SearchCountryCd8(v, filterBy); } }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmCtCulture.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.CultureTypeId8));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cCultureTypeId8: formatContent(CultureTypeId8 || '', 'TextBox'),
                    cCultureTypeDesc8: formatContent(CultureTypeDesc8 || '', 'TextBox'),
                    cCultureTypeName8: formatContent(CultureTypeName8 || '', 'TextBox'),
                    cCurrencyCd8: formatContent(CurrencyCd8 || '', 'TextBox'),
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmCtCultureState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cCountryCd8'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cCountryCd8', false, values)}
