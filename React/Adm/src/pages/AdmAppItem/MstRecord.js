...
class MstRecord extends RintagiScreen {
  ...
  WizardId136InputChange() { const _this = this; return function (name, v) { const filterBy = ''; _this.props.SearchWizardId136(v, filterBy); } }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmAppItem.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.AppItemId136));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cAppItemId136: formatContent(AppItemId136 || '', 'TextBox'),
                    ...
                    cItemOrder136: formatContent(ItemOrder136 || '', 'TextBox'),
                    ...
                    cRelativePath136: formatContent(RelativePath136 || '', 'TextBox'),
                    cAppItemName136: formatContent(AppItemName136 || '', 'TextBox'),
                    cMultiDesignDb136: MultiDesignDb136 === 'Y',
                    cRemoveItem136: RemoveItem136 === 'Y',
                    cAppItemCode136: formatContent(AppItemCode136 || '', 'MultiLine'),
                    ...
                    cCustomId136: formatContent(CustomId136 || '', 'TextBox'),
                  }}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmAppItemState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cLanguageCd136'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cLanguageCd136')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmAppItemState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cFrameworkCd136')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmAppItemState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cObjectTypeCd136')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmAppItemState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cDbProviderCd136')}
