...
class MstRecord extends RintagiScreen {
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmRptStyle.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.RptStyleId167));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cRptStyleId167: formatContent(RptStyleId167 || '', 'TextBox'),
                    cDefaultCd167: DefaultCd167List.filter(obj => { return obj.key === DefaultCd167 })[0],
                    cRptStyleDesc167: formatContent(RptStyleDesc167 || '', 'TextBox'),
                    cBorderColorD167: formatContent(BorderColorD167 || '', 'TextBox'),
                    cBorderColorL167: formatContent(BorderColorL167 || '', 'TextBox'),
                    cBorderColorR167: formatContent(BorderColorR167 || '', 'TextBox'),
                    cBorderColorT167: formatContent(BorderColorT167 || '', 'TextBox'),
                    cBorderColorB167: formatContent(BorderColorB167 || '', 'TextBox'),
                    cColor167: formatContent(Color167 || '', 'TextBox'),
                    cBgColor167: formatContent(BgColor167 || '', 'TextBox'),
                    cBgGradType167: BgGradType167List.filter(obj => { return obj.key === BgGradType167 })[0],
                    cBgGradColor167: formatContent(BgGradColor167 || '', 'TextBox'),
                    cBgImage167: formatContent(BgImage167 || '', 'TextBox'),
                    ...
                    cLineHeight167: formatContent(LineHeight167 || '', 'TextBox'),
                    cFormat167: formatContent(Format167 || '', 'TextBox'),
                    ...
                    cFontFamily167: formatContent(FontFamily167 || '', 'TextBox'),
                    cFontSize167: formatContent(FontSize167 || '', 'TextBox'),
                    ...
                    cBorderWidthD167: formatContent(BorderWidthD167 || '', 'TextBox'),
                    cBorderWidthL167: formatContent(BorderWidthL167 || '', 'TextBox'),
                    cBorderWidthR167: formatContent(BorderWidthR167 || '', 'TextBox'),
                    cBorderWidthT167: formatContent(BorderWidthT167 || '', 'TextBox'),
                    cBorderWidthB167: formatContent(BorderWidthB167 || '', 'TextBox'),
                    cPadLeft167: formatContent(PadLeft167 || '', 'TextBox'),
                    cPadRight167: formatContent(PadRight167 || '', 'TextBox'),
                    cPadTop167: formatContent(PadTop167 || '', 'TextBox'),
                    cPadBottom167: formatContent(PadBottom167 || '', 'TextBox'),
                  }}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cDefaultCd167'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cDefaultCd167')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cBgGradType167'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cBgGradType167')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cDirection167'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cDirection167')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cWritingMode167')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cBorderStyleD167')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cBorderStyleL167')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cBorderStyleR167')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cBorderStyleT167')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cBorderStyleB167')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cFontStyle167'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cFontStyle167')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cFontWeight167'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cFontWeight167')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cTextDecor167'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cTextDecor167')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cTextAlign167'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cTextAlign167')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmRptStyleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cVerticalAlign167')}
