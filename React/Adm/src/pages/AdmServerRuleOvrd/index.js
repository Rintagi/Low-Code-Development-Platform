...
export const pagesRoutes = [
  {
    path: '/AdmServerRuleOvrd/Mst/:mstId?',
    name: 'Master Record',
    short: 'MasterRecord',
    component: MstRecord,
    icon: 'briefcase',
  ...
  {
    path: '/AdmServerRuleOvrd/:mstId?/DtlList/:dtlId?',
    name: 'Detail List',
    short: 'DetailList',
    component: DtlList,
    icon: 'list-ul',
  ...
  {
    path: '/AdmServerRuleOvrd/:mstId?/Dtl/:dtlId?',
    name: 'Detail Record',
    short: 'DetailRecord',
    component: DtlRecord,
    icon: 'picture-o',
...
export function getNaviBar(type, mst, dtl, label) {
  return pagesRoutes
    ...
    .map((v, i) => {
      return {
        path: naviPath(v.type === 'MstList' ? '_' : mst.AtServerRuleOvrdId1322, v.type === 'DtlList' ? '_' : dtl.ServerRuledOvrdPrmId1321, v.path),
