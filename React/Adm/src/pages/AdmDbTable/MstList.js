...
TableDesc20: (values.cCriTableDesc20) ? values.cCriTableDesc20 : '',
  ...
  render() {
    ...
    const screenDdlSelectors = AdmDbTableReduxObj.ScreenDdlSelectors;
    const screenCriDdlSelectors = AdmDbTableReduxObj.ScreenCriDdlSelectors;
    const screenCriteria = AdmDbTableState.ScreenCriteria || {}
...
const mapDispatchToProps = (dispatch) => (
  bindActionCreators(Object.assign({},
    ...
    { LoadInitPage: AdmDbTableReduxObj.LoadInitPage.bind(AdmDbTableReduxObj) },
    { LoadSearchList: AdmDbTableReduxObj.LoadSearchList.bind(AdmDbTableReduxObj) },
