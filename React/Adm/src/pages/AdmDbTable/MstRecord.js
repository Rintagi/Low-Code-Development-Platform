...
class MstRecord extends RintagiScreen {
  ...
  BtnScan({ submitForm, ScreenButton, naviBar, redirectTo, onSuccess }) {
    return function (evt) {
      this.OnClickColumeName = 'BtnScan';
      //Enter Custom Code here, eg: submitForm();
      evt.preventDefault();
    }.bind(this);
  }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmDbTable.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.TableId3));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cTableId3: formatContent(TableId3 || '', 'TextBox'),
                    cSystemId3: SystemId3List.filter(obj => { return obj.key === SystemId3 })[0],
                    cTableName3: formatContent(TableName3 || '', 'TextBox'),
                    cTableDesc3: formatContent(TableDesc3 || '', 'TextBox'),
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmDbTableState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cSystemId3'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cSystemId3')}
                                  ...
                                  <div className='d-block'>
                                    {(authCol.ModelSample || {}).visible &&
                                      <Button color='secondary' size='sm' className='admin-ap-post-btn mb-10'
                                        ...
                                        {auxLabels.ModelSample || (columnLabel.ModelSample || {}).ColumnName}
                                      </Button>}
                                  </div>
                                </div>
                              </Col>
                                  ...
                                  <div className='d-block'>
                                    {(authCol.AnalToDb || {}).visible &&
                                      <Button color='secondary' size='sm' className='admin-ap-post-btn mb-10'
                                        ...
                                        {auxLabels.AnalToDb || (columnLabel.AnalToDb || {}).ColumnName}
                                      </Button>}
                                  </div>
                                </div>
                              </Col>
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmDbTableState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cSheetNameList'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cSheetNameList')}
                                  ...
                                  <div className='d-block'>
                                    {(authCol.BtnScan || {}).visible &&
                                      <Button color='secondary' size='sm' className='admin-ap-post-btn mb-10'
                                        ...
                                        {auxLabels.BtnScan || (columnLabel.BtnScan || {}).ColumnName}
                                      </Button>}
                                  </div>
                                </div>
                              </Col>
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmDbTableState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cModifiedBy3'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cModifiedBy3')}
