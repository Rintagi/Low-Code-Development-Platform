...
class MstRecord extends RintagiScreen {
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmUsr.Label);
  ...
  render() {
    ...
    const PicMed1 = currMst.PicMed1 ? decodeEmbeddedFileObjectFromServer(currMst.PicMed1) : null;
    const PicMed1FileUploadOptions = {
      CancelFileButton: auxSystemLabels.CancelFileBtnLabel,
      DeleteFileButton: auxSystemLabels.DeleteFileBtnLabel,
      MaxImageSize: {
        Width: (columnLabel.PicMed1 || {}).ResizeWidth,
        Height: (columnLabel.PicMed1 || {}).ResizeHeight,
      },
      MinImageSize: {
        Width: (columnLabel.PicMed1 || {}).ColumnSize,
        Height: (columnLabel.PicMed1 || {}).ColumnHeight,
      },
    }
              ...
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    ...
                    cLoginName1: formatContent(LoginName1 || '', 'TextBox'),
                    cUsrName1: formatContent(UsrName1 || '', 'TextBox'),
                    ...
                    cPwdNoRepeat1: formatContent(PwdNoRepeat1 || '', 'TextBox'),
                    cPwdDuration1: formatContent(PwdDuration1 || '', 'TextBox'),
                    cPwdWarn1: formatContent(PwdWarn1 || '', 'TextBox'),
                    cActive1: Active1 === 'Y',
                        ...
                        <Form className='form'> {/* this line equals to <form className='form' onSubmit={handleSubmit} */}
                          ...
                          <div className='w-100'>
                            <Row>
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cCultureId1'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cCultureId1', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cDefCompanyId1'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cDefCompanyId1')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cDefProjectId1'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cDefProjectId1')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cDefSystemId1'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cDefSystemId1')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cUsrImprLink1'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cUsrImprLink1')}
                              ...
                              {(authCol.PicMed1 || {}).visible &&
                                <Col lg={6} xl={6}>
                                  <div className='form__form-group'>
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='20px' />) ||
                                      <label className='form__form-group-label'>{(columnLabel.PicMed1 || {}).ColumnHeader} {(columnLabel.PicMed1 || {}).ToolTip &&
                                        (<ControlledPopover id={(columnLabel.PicMed1 || {}).ColumnName} className='sticky-icon pt-0 lh-23' message={(columnLabel.PicMed1 || {}).ToolTip} />
                                        )}
                                      </label>
                                    }
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <FileInputFieldV1
                                          name='cPicMed1'
                                          onChange={this.FileUploadChangeV1(setFieldValue, setFieldTouched, 'cPicMed1')}
                                          fileInfo={{ filename: this.state.filename }}
                                          options={PicMed1FileUploadOptions}
                                          value={values.cPicMed1 || PicMed1}
                                    ...
                                    {errors.cPicMed1 && touched.cPicMed1 && <span className='form__form-group-error'>{errors.cPicMed1}</span>}
                                  </div>
                                </Col>
                              }
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cHintQuestionId1')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cInvestorId1'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cInvestorId1', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cCustomerId1'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cCustomerId1', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cVendorId1'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cVendorId1', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cAgentId1'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cAgentId1', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cBrokerId1'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cBrokerId1', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cMemberId1'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cMemberId1', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cLenderId1'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cLenderId1', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cBorrowerId1'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cBorrowerId1', false, values)}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmUsrState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <AutoCompleteField
                                          name='cGuarantorId1'
                                          onChange={this.FieldChange(setFieldValue, setFieldTouched, 'cGuarantorId1', false, values)}
