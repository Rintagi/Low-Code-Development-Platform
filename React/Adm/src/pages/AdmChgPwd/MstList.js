...
class MstList extends RintagiScreen {
  constructor(props) {
    ...
    if (lastAppUrl && !(this.props.AdmChgPwd || {}).initialized) {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    const buttons = (nextProps.AdmChgPwd || {}).Buttons || {};
  ...
  render() {
    ...
    // if (!AdmChgPwdState.initialized || AdmChgPwdState.page_loading) return null;
    ...
    const screenDdlSelectors = AdmChgPwdReduxObj.ScreenDdlSelectors;
    const screenCriDdlSelectors = AdmChgPwdReduxObj.ScreenCriDdlSelectors;
    const screenCriteria = AdmChgPwdState.ScreenCriteria || {}
    ...
    const currMst = AdmChgPwdState.Mst;
    const currDtl = AdmChgPwdState.EditDtl;
    ...
    const screenFilterList = AdmChgPwdReduxObj.QuickFilterDdlToSelectList(AdmChgPwdState);
              ...
              <div className='account'>
                <div className='account__wrapper account-col'>
                  <div className='account__card rad-4'>
                    {/* {this.constructor.ShowSpinner(AdmChgPwdState,'MstList') && siteSpinner} */}
                            ...
                            <UncontrolledDropdown>
                              <ButtonGroup className='btn-group--icons'>
                                <Button className={`mw-50 ${filterBtnStyle}`} onClick={this.props.changeMstListFilterVisibility} outline>
                                  <i className={`fa fa-filter icon-holder ${filterActive}`}></i>{ShowMstFilterApplied(AdmChgPwdState) && <i className='filter-applied'></i>}
                    ...
                    <Formik
                      ...
                      key={AdmChgPwdState.searchListVersion}
                        ...
                        setFieldTouched
                          ...
                          <div>
                            <Form className='form'>
                              ...
                              {this.constructor.ShowMoreMstBtn(AdmChgPwdState) && <Button className={`btn btn-view-more-blue account__btn ${noMargin}`} onClick={this.ShowMoreSearchList} type='button'>{strFormat(IncrementMsg, AdmChgPwdState.ScreenCriteria.Increment)}<br /><i className='fa fa-arrow-down'></i></Button>}
...
const mapDispatchToProps = (dispatch) => (
  bindActionCreators(Object.assign({},
    ...
    { LoadInitPage: AdmChgPwdReduxObj.LoadInitPage.bind(AdmChgPwdReduxObj) },
    { LoadSearchList: AdmChgPwdReduxObj.LoadSearchList.bind(AdmChgPwdReduxObj) },
    { SelectMst: AdmChgPwdReduxObj.SelectMst.bind(AdmChgPwdReduxObj) },
    { DelMst: AdmChgPwdReduxObj.DelMst.bind(AdmChgPwdReduxObj) },
    { AddMst: AdmChgPwdReduxObj.AddMst.bind(AdmChgPwdReduxObj) },
    { AddDtl: AdmChgPwdReduxObj.AddDtl.bind(AdmChgPwdReduxObj) },
    { changeMstListFilterVisibility: AdmChgPwdReduxObj.ChangeMstListFilterVisibility.bind(AdmChgPwdReduxObj) },
    { SetScreenCriteria: AdmChgPwdReduxObj.SetScreenCriteria.bind(AdmChgPwdReduxObj) },
