    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('Mst', {}, {}, this.props.AdmChgPwd.Label);
...
//    { SearchMemberId64: AdmChgPwdReduxObj.SearchActions.SearchMemberId64.bind(AdmChgPwdReduxObj) },
//    { SearchCurrencyId64: AdmChgPwdReduxObj.SearchActions.SearchCurrencyId64.bind(AdmChgPwdReduxObj) },
//    { SearchCustomerJobId64: AdmChgPwdReduxObj.SearchActions.SearchCustomerJobId64.bind(AdmChgPwdReduxObj) },
