...
class MstRecord extends RintagiScreen {
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmStaticPg.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.StaticPgId259));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cStaticPgId259: formatContent(StaticPgId259 || '', 'TextBox'),
                    cStaticPgNm259: formatContent(StaticPgNm259 || '', 'TextBox'),
                    cStaticPgTitle259: formatContent(StaticPgTitle259 || '', 'TextBox'),
                    cMasterPgFile259: formatContent(MasterPgFile259 || '', 'TextBox'),
                    ...
                    cStaticPgJs259: formatContent(StaticPgJs259 || '', 'MultiLine'),
                  }}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmStaticPgState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cStaticCsId259'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cStaticCsId259')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmStaticPgState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cStaticJsId259'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cStaticJsId259')}
