...
//  }
  ...
  SavePage(values, { setSubmitting, setErrors, resetForm, setFieldValue, setValues }) {
    const errors = [];
    const currMst = (this.props.AdmColHlp || {}).Mst || {};
...
ScreenObjId14: values.cScreenObjId14|| '',
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          this.props.AdmColHlp.Mst.Posted64 = 'N';
          if (useMobileView) {
            const naviBar = getNaviBar('Mst', {}, {}, this.props.AdmColHlp.Label);
  ...
  render() {
    ...
    const currMst = ((this.props.AdmColHlp || {}).Mst || {});
    const currDtl = ((this.props.AdmColHlp || {}).EditDtl || {});
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                {/* {!useMobileView && this.constructor.ShowSpinner(AdmColHlpState) && <div className='panel__refresh'></div>} */}
...
//    { SearchMemberId64: AdmColHlpReduxObj.SearchActions.SearchMemberId64.bind(AdmColHlpReduxObj) },
//    { SearchCurrencyId64: AdmColHlpReduxObj.SearchActions.SearchCurrencyId64.bind(AdmColHlpReduxObj) },
//    { SearchCustomerJobId64: AdmColHlpReduxObj.SearchActions.SearchCustomerJobId64.bind(AdmColHlpReduxObj) },
