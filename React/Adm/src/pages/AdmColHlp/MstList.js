...
class MstList extends RintagiScreen {
  constructor(props) {
    ...
    if (lastAppUrl && !(this.props.AdmColHlp || {}).initialized) {
  ...
  DelMst({ naviBar, ScreenButton, mst, mstId }) {
    ...
    return this.Prompt({
      okFn: function (evt) {
        const fromMstId = mstId || mst.ScreenObjId14;
        this.props.DelMst(this.props.AdmColHlp, fromMstId);
      }.bind(this),
  ...
  render() {
    ...
    const screenDdlSelectors = AdmColHlpReduxObj.ScreenDdlSelectors;
    const screenCriDdlSelectors = AdmColHlpReduxObj.ScreenCriDdlSelectors;
    const screenCriteria = AdmColHlpState.ScreenCriteria || {}
    const selectList = AdmColHlpReduxObj.SearchListToSelectList(AdmColHlpState);
    const itemList = AdmColHlpState.Dtl || [];
    ...
    const screenFilterList = AdmColHlpReduxObj.QuickFilterDdlToSelectList(AdmColHlpState);
              ...
              <div className='account'>
                <div className='account__wrapper account-col'>
                  <div className='account__card rad-4'>
                    {/* {this.constructor.ShowSpinner(AdmColHlpState,'MstList') && siteSpinner} */}
                            ...
                            <UncontrolledDropdown>
                              <ButtonGroup className='btn-group--icons'>
                                <Button className={`mw-50 ${filterBtnStyle}`} onClick={this.props.changeMstListFilterVisibility} outline>
                                  <i className={`fa fa-filter icon-holder ${filterActive}`}></i>{ShowMstFilterApplied(AdmColHlpState) && <i className='filter-applied'></i>}
                    ...
                    <Formik
                      ...
                      key={AdmColHlpState.searchListVersion}
                        ...
                        setFieldTouched
                          ...
                          <div>
                            <Form className='form'>
                              ...
                              {this.constructor.ShowMoreMstBtn(AdmColHlpState) && <Button className={`btn btn-view-more-blue account__btn ${noMargin}`} onClick={this.ShowMoreSearchList} type='button'>{strFormat(IncrementMsg, AdmColHlpState.ScreenCriteria.Increment)}<br /><i className='fa fa-arrow-down'></i></Button>}
...
const mapDispatchToProps = (dispatch) => (
  bindActionCreators(Object.assign({},
    ...
    { LoadInitPage: AdmColHlpReduxObj.LoadInitPage.bind(AdmColHlpReduxObj) },
    { LoadSearchList: AdmColHlpReduxObj.LoadSearchList.bind(AdmColHlpReduxObj) },
    { SelectMst: AdmColHlpReduxObj.SelectMst.bind(AdmColHlpReduxObj) },
    { DelMst: AdmColHlpReduxObj.DelMst.bind(AdmColHlpReduxObj) },
    { AddMst: AdmColHlpReduxObj.AddMst.bind(AdmColHlpReduxObj) },
    { AddDtl: AdmColHlpReduxObj.AddDtl.bind(AdmColHlpReduxObj) },
    { changeMstListFilterVisibility: AdmColHlpReduxObj.ChangeMstListFilterVisibility.bind(AdmColHlpReduxObj) },
    { SetScreenCriteria: AdmColHlpReduxObj.SetScreenCriteria.bind(AdmColHlpReduxObj) },
