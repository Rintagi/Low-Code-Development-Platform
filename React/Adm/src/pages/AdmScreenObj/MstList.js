...
class MstList extends RintagiScreen {
  constructor(props) {
    ...
    if (lastAppUrl && !(this.props.AdmScreenObj || {}).initialized) {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    const buttons = (nextProps.AdmScreenObj || {}).Buttons || {};
  ...
  render() {
    ...
    // if (!AdmScreenObjState.initialized || AdmScreenObjState.page_loading) return null;
    ...
    const screenDdlSelectors = AdmScreenObjReduxObj.ScreenDdlSelectors;
    const screenCriDdlSelectors = AdmScreenObjReduxObj.ScreenCriDdlSelectors;
    const screenCriteria = AdmScreenObjState.ScreenCriteria || {}
    ...
    const currMst = AdmScreenObjState.Mst;
    const currDtl = AdmScreenObjState.EditDtl;
    ...
    const screenFilterList = AdmScreenObjReduxObj.QuickFilterDdlToSelectList(AdmScreenObjState);
              ...
              <div className='account'>
                <div className='account__wrapper account-col'>
                  <div className='account__card rad-4'>
                    {/* {this.constructor.ShowSpinner(AdmScreenObjState,'MstList') && siteSpinner} */}
                            ...
                            <UncontrolledDropdown>
                              <ButtonGroup className='btn-group--icons'>
                                <Button className={`mw-50 ${filterBtnStyle}`} onClick={this.props.changeMstListFilterVisibility} outline>
                                  <i className={`fa fa-filter icon-holder ${filterActive}`}></i>{ShowMstFilterApplied(AdmScreenObjState) && <i className='filter-applied'></i>}
                    ...
                    <Formik
                      ...
                      key={AdmScreenObjState.searchListVersion}
                        ...
                        setFieldTouched
                          ...
                          <div>
                            <Form className='form'>
                              ...
                              {this.constructor.ShowMoreMstBtn(AdmScreenObjState) && <Button className={`btn btn-view-more-blue account__btn ${noMargin}`} onClick={this.ShowMoreSearchList} type='button'>{strFormat(IncrementMsg, AdmScreenObjState.ScreenCriteria.Increment)}<br /><i className='fa fa-arrow-down'></i></Button>}
...
const mapDispatchToProps = (dispatch) => (
  bindActionCreators(Object.assign({},
    ...
    { LoadInitPage: AdmScreenObjReduxObj.LoadInitPage.bind(AdmScreenObjReduxObj) },
    { LoadSearchList: AdmScreenObjReduxObj.LoadSearchList.bind(AdmScreenObjReduxObj) },
    { SelectMst: AdmScreenObjReduxObj.SelectMst.bind(AdmScreenObjReduxObj) },
