...
class MstRecord extends RintagiScreen {
  ...
  DdlFtrColumnId14InputChange() { const _this = this; return function (name, v) { const filterBy = ''; _this.props.SearchDdlFtrColumnId14(v, filterBy); } }
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmScreenObj.Label);
              ...
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    ...
                    cColumnSize14: formatContent(ColumnSize14 || '', 'TextBox'),
                    cColumnHeight14: formatContent(ColumnHeight14 || '', 'TextBox'),
                    cResizeWidth14: formatContent(ResizeWidth14 || '', 'TextBox'),
                    cResizeHeight14: formatContent(ResizeHeight14 || '', 'TextBox'),
                    cSortOrder14: formatContent(SortOrder14 || '', 'TextBox'),
                    ...
                    cDisplayDesc18: formatContent(DisplayDesc18 || '', 'MultiLine'),
                    ...
                    cColumnLink14: formatContent(ColumnLink14 || '', 'TextBox'),
                    cDtlLstPosId14: DtlLstPosId14List.filter(obj => { return obj.key === DtlLstPosId14 })[0],
                    cLabelVertical14: LabelVertical14 === 'Y',
                    cLabelCss14: formatContent(LabelCss14 || '', 'TextBox'),
                    cContentCss14: formatContent(ContentCss14 || '', 'TextBox'),
                    cDefaultValue14: formatContent(DefaultValue14 || '', 'TextBox'),
                    cHyperLinkUrl14: formatContent(HyperLinkUrl14 || '', 'TextBox'),
                    cDefAfter14: DefAfter14 === 'Y',
                    cSystemValue14: formatContent(SystemValue14 || '', 'TextBox'),
                    ...
                    cMaskValid14: formatContent(MaskValid14 || '', 'TextBox'),
                    cRangeValidType14: formatContent(RangeValidType14 || '', 'TextBox'),
                    cRangeValidMax14: formatContent(RangeValidMax14 || '', 'TextBox'),
                    cRangeValidMin14: formatContent(RangeValidMin14 || '', 'TextBox'),
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenObjState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cGridGrpCd14'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cGridGrpCd14')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenObjState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cColumnJustify14')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenObjState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cDisplayModeId14')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenObjState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cDtlLstPosId14'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cDtlLstPosId14')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenObjState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cAggregateCd14'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cAggregateCd14')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmScreenObjState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cMatchCd14'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cMatchCd14')}
