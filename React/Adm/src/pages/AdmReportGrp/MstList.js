...
class MstList extends RintagiScreen {
  constructor(props) {
    ...
    if (lastAppUrl && !(this.props.AdmReportGrp || {}).initialized) {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    const buttons = (nextProps.AdmReportGrp || {}).Buttons || {};
  ...
  componentDidUpdate(prevProps, prevStates) {
    ...
    if (prevStates.key !== (currReduxScreenState.Mst || {}).ReportGrpId94) {
      const isMobileView = this.state.isMobile;
      const useMobileView = (isMobileView && !(this.props.user || {}).desktopView);
  ...
  render() {
    ...
    // if (!AdmReportGrpState.initialized || AdmReportGrpState.page_loading) return null;
    ...
    const screenDdlSelectors = AdmReportGrpReduxObj.ScreenDdlSelectors;
    const screenCriDdlSelectors = AdmReportGrpReduxObj.ScreenCriDdlSelectors;
    const screenCriteria = AdmReportGrpState.ScreenCriteria || {}
    ...
    const currMst = AdmReportGrpState.Mst;
    const currDtl = AdmReportGrpState.EditDtl;
    const naviBar = getNaviBar('MstList', currMst, {}, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.ReportGrpId94));
    const naviSelectBar = getNaviBar('MstList', {}, {}, screenButtons);
    const screenFilterList = AdmReportGrpReduxObj.QuickFilterDdlToSelectList(AdmReportGrpState);
    ...
    const CriReportId10List = screenCriDdlSelectors.ReportId10(AdmReportGrpState);
              ...
              <div className='account'>
                <div className='account__wrapper account-col'>
                  <div className='account__card rad-4'>
                    {/* {this.constructor.ShowSpinner(AdmReportGrpState,'MstList') && siteSpinner} */}
                            ...
                            <UncontrolledDropdown>
                              <ButtonGroup className='btn-group--icons'>
                                <Button className={`mw-50 ${filterBtnStyle}`} onClick={this.props.changeMstListFilterVisibility} outline>
                                  <i className={`fa fa-filter icon-holder ${filterActive}`}></i>{ShowMstFilterApplied(AdmReportGrpState) && <i className='filter-applied'></i>}
                                  ...
                                  dropdownMenuButtonList.filter(v => v.expose).map(v => {
                                    return (
                                      <Button
                                        ...
                                        // disabled={!activeSelectionVisible || this.ActionSuppressed(authRow, v.buttonType, (currMst || {}).ReportGrpId94)}
                    ...
                    <Formik
                      ...
                      key={AdmReportGrpState.searchListVersion}
                        ...
                        setFieldTouched
                          ...
                          <div>
                            <Form className='form'>
                                  ...
                                  <Row className='mb-5'>
                                    <Col xs={12} md={12}>
                                      ...
                                      <div className='form__form-group-field filter-form-border'>
                                        <DropdownField
                                          name='cCriReportId10'
                                          onChange={this.SearchFilterValueChange(handleSubmit, setFieldValue, 'ddl', 'cCriReportId10')}
                              ...
                              {this.constructor.ShowMoreMstBtn(AdmReportGrpState) && <Button className={`btn btn-view-more-blue account__btn ${noMargin}`} onClick={this.ShowMoreSearchList} type='button'>{strFormat(IncrementMsg, AdmReportGrpState.ScreenCriteria.Increment)}<br /><i className='fa fa-arrow-down'></i></Button>}
...
const mapDispatchToProps = (dispatch) => (
  bindActionCreators(Object.assign({},
    ...
    { LoadInitPage: AdmReportGrpReduxObj.LoadInitPage.bind(AdmReportGrpReduxObj) },
    { LoadSearchList: AdmReportGrpReduxObj.LoadSearchList.bind(AdmReportGrpReduxObj) },
    { SelectMst: AdmReportGrpReduxObj.SelectMst.bind(AdmReportGrpReduxObj) },
    { DelMst: AdmReportGrpReduxObj.DelMst.bind(AdmReportGrpReduxObj) },
    { AddMst: AdmReportGrpReduxObj.AddMst.bind(AdmReportGrpReduxObj) },
    { AddDtl: AdmReportGrpReduxObj.AddDtl.bind(AdmReportGrpReduxObj) },
    { changeMstListFilterVisibility: AdmReportGrpReduxObj.ChangeMstListFilterVisibility.bind(AdmReportGrpReduxObj) },
    { SetScreenCriteria: AdmReportGrpReduxObj.SetScreenCriteria.bind(AdmReportGrpReduxObj) },
