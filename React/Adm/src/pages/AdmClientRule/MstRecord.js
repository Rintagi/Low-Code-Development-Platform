...
class MstRecord extends RintagiScreen {
    ...
    return function (evt) {
      ...
      const copyFn = () => {
        if (fromMstId) {
          ...
          if (useMobileView) {
            const naviBar = getNaviBar('MstRecord', {}, {}, this.props.AdmClientRule.Label);
  ...
  render() {
    ...
    const naviBar = getNaviBar('MstRecord', currMst, currDtl, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.ClientRuleId127));
          ...
          <div className='account'>
            <div className='account__wrapper account-col'>
              <div className='account__card shadow-box rad-4'>
                ...
                <Formik
                  initialValues={{
                    cClientRuleId127: formatContent(ClientRuleId127 || '', 'TextBox'),
                    cRuleMethodId127: RuleMethodId127List.filter(obj => { return obj.key === RuleMethodId127 })[0],
                    cRuleMethodDesc1295: formatContent(RuleMethodDesc1295 || '', 'MultiLine'),
                    cRuleName127: formatContent(RuleName127 || '', 'TextBox'),
                    cRuleDescription127: formatContent(RuleDescription127 || '', 'MultiLine'),
                    ...
                    cRuleCntTypeDesc1294: formatContent(RuleCntTypeDesc1294 || '', 'TextBox'),
                    cClientRuleProg127: formatContent(ClientRuleProg127 || '', 'MultiLine'),
                    cClientScript127: ClientScript127List.filter(obj => { return obj.key === ClientScript127 })[0],
                    cClientScriptHelp126: formatContent(ClientScriptHelp126 || '', 'MultiLine'),
                    cUserScriptEvent127: formatContent(UserScriptEvent127 || '', 'TextBox'),
                    cUserScriptName127: formatContent(UserScriptName127 || '', 'MultiLine'),
                    cScriptParam127: formatContent(ScriptParam127 || '', 'TextBox'),
                  }}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmClientRuleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cRuleMethodId127')}
                                  ...
                                  <div className='form__form-group'>
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmClientRuleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          name='cRuleTypeId127'
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cRuleTypeId127')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmClientRuleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cRuleCntTypeId127')}
                                    ...
                                    {((true && this.constructor.ShowSpinner(AdmClientRuleState)) && <Skeleton height='36px' />) ||
                                      <div className='form__form-group-field'>
                                        <DropdownField
                                          ...
                                          onChange={this.DropdownChangeV1(setFieldValue, setFieldTouched, 'cClientScript127')}
