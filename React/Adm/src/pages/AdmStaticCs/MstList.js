...
class MstList extends RintagiScreen {
  constructor(props) {
    ...
    if (lastAppUrl && !(this.props.AdmStaticCs || {}).initialized) {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    const buttons = (nextProps.AdmStaticCs || {}).Buttons || {};
  ...
  componentDidUpdate(prevProps, prevStates) {
    ...
    if (prevStates.key !== (currReduxScreenState.Mst || {}).StaticCsId260) {
      const isMobileView = this.state.isMobile;
      const useMobileView = (isMobileView && !(this.props.user || {}).desktopView);
  ...
  render() {
    ...
    // if (!AdmStaticCsState.initialized || AdmStaticCsState.page_loading) return null;
    ...
    const screenDdlSelectors = AdmStaticCsReduxObj.ScreenDdlSelectors;
    const screenCriDdlSelectors = AdmStaticCsReduxObj.ScreenCriDdlSelectors;
    const screenCriteria = AdmStaticCsState.ScreenCriteria || {}
    ...
    const currMst = AdmStaticCsState.Mst;
    const currDtl = AdmStaticCsState.EditDtl;
    const naviBar = getNaviBar('MstList', currMst, {}, screenButtons).filter(v => ((v.type !== 'DtlRecord' && v.type !== 'DtlList') || currMst.StaticCsId260));
    const naviSelectBar = getNaviBar('MstList', {}, {}, screenButtons);
    const screenFilterList = AdmStaticCsReduxObj.QuickFilterDdlToSelectList(AdmStaticCsState);
              ...
              <div className='account'>
                <div className='account__wrapper account-col'>
                  <div className='account__card rad-4'>
                    {/* {this.constructor.ShowSpinner(AdmStaticCsState,'MstList') && siteSpinner} */}
                            ...
                            <UncontrolledDropdown>
                              <ButtonGroup className='btn-group--icons'>
                                <Button className={`mw-50 ${filterBtnStyle}`} onClick={this.props.changeMstListFilterVisibility} outline>
                                  <i className={`fa fa-filter icon-holder ${filterActive}`}></i>{ShowMstFilterApplied(AdmStaticCsState) && <i className='filter-applied'></i>}
                                  ...
                                  dropdownMenuButtonList.filter(v => v.expose).map(v => {
                                    return (
                                      <Button
                                        ...
                                        // disabled={!activeSelectionVisible || this.ActionSuppressed(authRow, v.buttonType, (currMst || {}).StaticCsId260)}
                    ...
                    <Formik
                      ...
                      key={AdmStaticCsState.searchListVersion}
                        ...
                        setFieldTouched
                          ...
                          <div>
                            <Form className='form'>
                              ...
                              {this.constructor.ShowMoreMstBtn(AdmStaticCsState) && <Button className={`btn btn-view-more-blue account__btn ${noMargin}`} onClick={this.ShowMoreSearchList} type='button'>{strFormat(IncrementMsg, AdmStaticCsState.ScreenCriteria.Increment)}<br /><i className='fa fa-arrow-down'></i></Button>}
...
const mapDispatchToProps = (dispatch) => (
  bindActionCreators(Object.assign({},
    ...
    { LoadInitPage: AdmStaticCsReduxObj.LoadInitPage.bind(AdmStaticCsReduxObj) },
    { LoadSearchList: AdmStaticCsReduxObj.LoadSearchList.bind(AdmStaticCsReduxObj) },
    { SelectMst: AdmStaticCsReduxObj.SelectMst.bind(AdmStaticCsReduxObj) },
    { DelMst: AdmStaticCsReduxObj.DelMst.bind(AdmStaticCsReduxObj) },
    { AddMst: AdmStaticCsReduxObj.AddMst.bind(AdmStaticCsReduxObj) },
    { AddDtl: AdmStaticCsReduxObj.AddDtl.bind(AdmStaticCsReduxObj) },
    { changeMstListFilterVisibility: AdmStaticCsReduxObj.ChangeMstListFilterVisibility.bind(AdmStaticCsReduxObj) },
    { SetScreenCriteria: AdmStaticCsReduxObj.SetScreenCriteria.bind(AdmStaticCsReduxObj) },
