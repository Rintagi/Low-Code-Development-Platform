...
export const pagesRoutes = [
  {
    ...
    screenId : 5
                    ...
                    {
                        path: '/AdmUsrGroup/:mstId?/DtlList/:dtlId?',
                        name: 'Detail List',
                        short: 'DetailList',
                        component: DtlList,
                        icon: 'list-ul',
                      ...
                      {
                        path: '/AdmUsrGroup/:mstId?/Dtl/:dtlId?',
                        name: 'Detail Record',
                        short: 'DetailRecord',
                        component: DtlRecord,
                        icon: 'picture-o',
...
export function getNaviBar(type, mst, dtl, label) {
  return pagesRoutes
    ...
    .map((v, i) => {
      return {
        path: naviPath(v.type === 'MstList' ? '_' : mst.UsrGroupId7, v.type === 'DtlList' ? '_' : dtl.UsrGroupAuthId58, v.path),
