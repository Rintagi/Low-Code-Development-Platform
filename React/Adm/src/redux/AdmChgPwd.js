...
class AdmChgPwdRedux extends RintagiScreenRedux {
    allowTmpDtl = false;
    constructor() {
      super();
      this.ActionApiNameMapper = {
        'GET_SEARCH_LIST' : 'GetAdmChgPwd71List',
        'GET_MST' : 'GetAdmChgPwd71ById',
        'GET_DTL_LIST' : 'GetAdmChgPwd71DtlById',
      }
      this.ScreenDdlDef = [
...
//        { columnName: 'TrxDetImg65', tableColumnName: 'TrxDetImg', forMst: false, apiServiceName: 'GetColumnContent', actionTypeName: 'GET_COLUMN_TRXDETIMG65' },
    ...
    GetScreenName(){return 'AdmChgPwd'}
    ...
    GetWebService() {return AdmChgPwdService}
...
//      || (state.ScreenCriteria.Posted30 ||{}).LastCriteria
  ...
  export default new AdmChgPwdRedux()
