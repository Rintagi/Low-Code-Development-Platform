...
class AdmUsrPrefRedux extends RintagiScreenRedux {
  ...
  constructor() {
    ...
    this.ScreenOnDemandDef = [
      { columnName: 'SampleImage93', isFileObject: true, tableColumnName: 'SampleImage', forMst: true, apiServiceName: 'GetColumnContent', actionTypeName: 'GET_COLUMN_SampleImage93' },
    ]
