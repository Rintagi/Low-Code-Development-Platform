...
class AdmTemplateRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmTemplate53List',
      'GET_MST': 'GetAdmTemplate53ById',
      'GET_DTL_LIST': 'GetAdmTemplate53DtlById',
    }
    this.ScreenDdlDef = [
  ...
  GetScreenName() { return 'AdmTemplate' }
  GetMstKeyColumnName(isUnderlining = false) { return isUnderlining ? 'TemplateId' : 'TemplateId79'; }
  GetDtlKeyColumnName(isUnderlining = false) { return isUnderlining ? '' : ''; }
  GetPersistDtlName() { return this.GetScreenName() + '_Dtl'; }
  GetPersistMstName() { return this.GetScreenName() + '_Mst'; }
  GetWebService() { return AdmTemplateService; }
  ...
  ExpandMst(mst, state, copy) {
    return {
      ...mst,
      key: Date.now(),
      TemplateId79: copy ? null : mst.TemplateId79,
    }
  }
...
export default new AdmTemplateRedux()
