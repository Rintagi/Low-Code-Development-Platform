...
class AdmSignupRedux extends RintagiScreenRedux {
    allowTmpDtl = false;
    constructor() {
      super();
      this.ActionApiNameMapper = {
        'GET_SEARCH_LIST' : 'GetAdmSignup1018List',
        'GET_MST' : 'GetAdmSignup1018ById',
        'GET_DTL_LIST' : 'GetAdmSignup1018DtlById',
      }
      this.ScreenDdlDef = [
...
//        { columnName: 'TrxDetImg65', tableColumnName: 'TrxDetImg', forMst: false, apiServiceName: 'GetColumnContent', actionTypeName: 'GET_COLUMN_TRXDETIMG65' },
    ...
    GetScreenName(){return 'AdmSignup'}
    GetMstKeyColumnName(isUnderlining = false) {return isUnderlining ? 'UsrId' :  'UsrId270'}
    GetDtlKeyColumnName(isUnderlining = false) {return isUnderlining ? ''  :''}
    GetPersistDtlName() {return this.GetScreenName() + '_Dtl'}
    GetPersistMstName() {return this.GetScreenName() + '_Mst'}
    GetWebService() {return AdmSignupService}
    ...
    ExpandMst(mst, state, copy) {
      return {
        ...mst,
		 key: Date.now(),
        UsrId270: copy ? null : mst.UsrId270,
...
//      || (state.ScreenCriteria.Posted30 ||{}).LastCriteria
  ...
  export default new AdmSignupRedux()
