...
class AdmColHlpRedux extends RintagiScreenRedux {
    ...
    constructor() {
      ...
      this.ScreenDdlDef = [
{ columnName: 'CultureId21', payloadDdlName:'CultureId21List', keyName:'CultureId21',labelName:'CultureId21Text', forMst: true, isAutoComplete:true, apiServiceName: 'GetCultureId21List', actionTypeName: 'GET_DDL_CultureId21' },
      ]
