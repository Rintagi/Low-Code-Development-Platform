...
class AdmColHlpRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmColHlp1006List',
      'GET_MST': 'GetAdmColHlp1006ById',
      'GET_DTL_LIST': 'GetAdmColHlp1006DtlById',
    }
    this.ScreenDdlDef = [
      { columnName: 'CultureId21', payloadDdlName: 'CultureId21List', keyName: 'CultureId21', labelName: 'CultureId21Text', forMst: false, isAutoComplete: true, apiServiceName: 'GetCultureId21List', actionTypeName: 'GET_DDL_CultureId21' },
    ]
  ...
  GetScreenName() { return 'AdmColHlp' }
  GetMstKeyColumnName(isUnderlining = false) { return isUnderlining ? 'ScreenObjId' : 'ScreenObjId14'; }
  GetDtlKeyColumnName(isUnderlining = false) { return isUnderlining ? 'ScreenObjHlpId' : 'ScreenObjHlpId21'; }
  GetPersistDtlName() { return this.GetScreenName() + '_Dtl'; }
  GetPersistMstName() { return this.GetScreenName() + '_Mst'; }
  GetWebService() { return AdmColHlpService; }
...
export default new AdmColHlpRedux()
