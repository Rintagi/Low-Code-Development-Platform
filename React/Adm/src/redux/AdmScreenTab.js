...
class AdmScreenTabRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmScreenTab54List',
      'GET_MST': 'GetAdmScreenTab54ById',
      'GET_DTL_LIST': 'GetAdmScreenTab54DtlById',
    }
    this.ScreenDdlDef = [
      { columnName: 'ScreenId19', payloadDdlName: 'ScreenId19List', keyName: 'ScreenId19', labelName: 'ScreenId19Text', forMst: true, isAutoComplete: true, apiServiceName: 'GetScreenId19List', actionTypeName: 'GET_DDL_ScreenId19' },
      { columnName: 'CultureId80', payloadDdlName: 'CultureId80List', keyName: 'CultureId80', labelName: 'CultureId80Text', forMst: false, isAutoComplete: true, apiServiceName: 'GetCultureId80List', actionTypeName: 'GET_DDL_CultureId80' },
    ]
  ...
  GetScreenName() { return 'AdmScreenTab' }
  GetMstKeyColumnName(isUnderlining = false) { return isUnderlining ? 'ScreenTabId' : 'ScreenTabId19'; }
  GetDtlKeyColumnName(isUnderlining = false) { return isUnderlining ? 'ScreenTabHlpId' : 'ScreenTabHlpId80'; }
  GetPersistDtlName() { return this.GetScreenName() + '_Dtl'; }
  GetPersistMstName() { return this.GetScreenName() + '_Mst'; }
  GetWebService() { return AdmScreenTabService; }
  ...
  GetDefaultDtl(state) {
    return (state || {}).NewDtl ||
    {
      ScreenTabHlpId80: null,
      CultureId80: null,
      TabFolderName80: null,
    }
  }
  ExpandMst(mst, state, copy) {
    return {
      ...mst,
      key: Date.now(),
      ScreenTabId19: copy ? null : mst.ScreenTabId19,
    }
  }
...
export default new AdmScreenTabRedux()
