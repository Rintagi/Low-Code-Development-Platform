...
class AdmLabelVwRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmLabelVw119List',
      'GET_MST': 'GetAdmLabelVw119ById',
      'GET_DTL_LIST': 'GetAdmLabelVw119DtlById',
    }
    this.ScreenDdlDef = [
  ...
  GetScreenName() { return 'AdmLabelVw' }
  GetMstKeyColumnName(isUnderlining = false) { return isUnderlining ? 'LabelId' : 'LabelId265'; }
  GetDtlKeyColumnName(isUnderlining = false) { return isUnderlining ? '' : ''; }
  GetPersistDtlName() { return this.GetScreenName() + '_Dtl'; }
  GetPersistMstName() { return this.GetScreenName() + '_Mst'; }
  GetWebService() { return AdmLabelVwService; }
  ...
  ExpandMst(mst, state, copy) {
    return {
      ...mst,
      key: Date.now(),
      LabelId265: copy ? null : mst.LabelId265,
    }
  }
...
export default new AdmLabelVwRedux()
