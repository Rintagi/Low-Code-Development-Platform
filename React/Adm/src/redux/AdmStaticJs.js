...
class AdmStaticJsRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmStaticJs116List',
      'GET_MST': 'GetAdmStaticJs116ById',
      'GET_DTL_LIST': 'GetAdmStaticJs116DtlById',
    }
    this.ScreenDdlDef = [
  ...
  GetScreenName() { return 'AdmStaticJs' }
  GetMstKeyColumnName(isUnderlining = false) { return isUnderlining ? 'StaticJsId' : 'StaticJsId261'; }
  GetDtlKeyColumnName(isUnderlining = false) { return isUnderlining ? '' : ''; }
  GetPersistDtlName() { return this.GetScreenName() + '_Dtl'; }
  GetPersistMstName() { return this.GetScreenName() + '_Mst'; }
  GetWebService() { return AdmStaticJsService; }
  ...
  ExpandMst(mst, state, copy) {
    return {
      ...mst,
      key: Date.now(),
      StaticJsId261: copy ? null : mst.StaticJsId261,
    }
  }
...
export default new AdmStaticJsRedux()
