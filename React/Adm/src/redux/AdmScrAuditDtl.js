...
class AdmScrAuditDtlRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmScrAuditDtl1020List',
      'GET_MST': 'GetAdmScrAuditDtl1020ById',
      'GET_DTL_LIST': 'GetAdmScrAuditDtl1020DtlById',
    }
    this.ScreenDdlDef = [
    ...
    this.ScreenCriDdlDef = [
      { columnName: 'ScrAuditId10', payloadDdlName: '', keyName: '', labelName: '', isCheckBox:false, isAutoComplete: false, apiServiceName: '', actionTypeName: 'GET_ScrAuditId10' },
    ]
    this.SearchActions = {
  ...
  GetScreenName() { return 'AdmScrAuditDtl' }
  GetMstKeyColumnName(isUnderlining = false) { return isUnderlining ? 'ScrAuditDtlId' : 'ScrAuditDtlId1301'; }
  GetDtlKeyColumnName(isUnderlining = false) { return isUnderlining ? '' : ''; }
  GetPersistDtlName() { return this.GetScreenName() + '_Dtl'; }
  GetPersistMstName() { return this.GetScreenName() + '_Mst'; }
  GetWebService() { return AdmScrAuditDtlService; }
  ...
  ExpandMst(mst, state, copy) {
    return {
      ...mst,
      key: Date.now(),
      ScrAuditDtlId1301: copy ? null : mst.ScrAuditDtlId1301,
    }
  }
...
export function ShowMstFilterApplied(state) {
  return !state
    ...
    || (state.ScreenCriteria.ScrAuditId10 || {}).LastCriteria
    || state.ScreenCriteria.SearchStr;
}

export default new AdmScrAuditDtlRedux()
