...
class AdmPostmanRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmPostman1028List',
      'GET_MST': 'GetAdmPostman1028ById',
      'GET_DTL_LIST': 'GetAdmPostman1028DtlById',
    }
    this.ScreenDdlDef = [
      { columnName: 'PostContentType', payloadDdlName: 'PostContentTypeList', keyName: 'PostContentType', labelName: 'PostContentTypeText', forMst: true, isAutoComplete: false, apiServiceName: 'GetPostContentTypeList', actionTypeName: 'GET_DDL_PostContentType' },
    ]
  ...
  GetScreenName() { return 'AdmPostman' }
  GetMstKeyColumnName(isUnderlining = false) { return isUnderlining ? 'SystemId' : 'SystemId1317'; }
  GetDtlKeyColumnName(isUnderlining = false) { return isUnderlining ? '' : ''; }
  GetPersistDtlName() { return this.GetScreenName() + '_Dtl'; }
  GetPersistMstName() { return this.GetScreenName() + '_Mst'; }
  GetWebService() { return AdmPostmanService; }
  ...
  ExpandMst(mst, state, copy) {
    return {
      ...mst,
      key: Date.now(),
      SystemId1317: copy ? null : mst.SystemId1317,
    }
  }
...
export default new AdmPostmanRedux()
