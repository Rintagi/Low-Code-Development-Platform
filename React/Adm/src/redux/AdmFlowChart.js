...
class AdmFlowchartRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmFlowchart1027List',
      'GET_MST': 'GetAdmFlowchart1027ById',
  ...
  GetScreenName() { return 'AdmFlowchart' }
  GetMstKeyColumnName(isUnderlining = false) { return isUnderlining ? 'ChartId' : 'ChartId1325'; }
  GetDtlKeyColumnName(isUnderlining = false) { return isUnderlining ? '' : ''; }
  GetPersistDtlName() { return this.GetScreenName() + '_Dtl'; }
  GetPersistMstName() { return this.GetScreenName() + '_Mst'; }
  GetWebService() { return AdmFlowchartService; }
  ...
  ExpandMst(mst, state, copy) {
    return {
      ...mst,
      key: Date.now(),
      ChartId1325: copy ? null : mst.ChartId1325,
    }
  }
...
export default new AdmFlowchartRedux()
