...
class AdmLicenseRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmLicense1022List',
      'GET_MST': 'GetAdmLicense1022ById',
      'GET_DTL_LIST': 'GetAdmLicense1022DtlById',
    }
    this.ScreenDdlDef = [
  ...
  GetScreenName() { return 'AdmLicense' }
  ...
  GetWebService() { return AdmLicenseService; }
...
export default new AdmLicenseRedux()
