...
class AdmPaymentRedux extends RintagiScreenRedux {
    allowTmpDtl = false;
    constructor() {
      super();
      this.ActionApiNameMapper = {
        'GET_SEARCH_LIST' : 'GetAdmPayment1021List',
        'GET_MST' : 'GetAdmPayment1021ById',
        'GET_DTL_LIST' : 'GetAdmPayment1021DtlById',
      }
      this.ScreenDdlDef = [

      ]
      this.ScreenOnDemandDef = [
{ columnName: 'PaypalBtn', tableColumnName: 'PaypalBtn', forMst: false, apiServiceName: 'GetColumnContent', actionTypeName: 'GET_COLUMN_PaypalBtn' },
//        { columnName: 'TrxDetImg65', tableColumnName: 'TrxDetImg', forMst: false, apiServiceName: 'GetColumnContent', actionTypeName: 'GET_COLUMN_TRXDETIMG65' },
    ...
    GetScreenName(){return 'AdmPayment'}
    ...
    GetWebService() {return AdmPaymentService}
...
//      || (state.ScreenCriteria.Posted30 ||{}).LastCriteria
  ...
  export default new AdmPaymentRedux()
