...
class AdmRptwizTypRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmRptwizTyp97List',
      'GET_MST': 'GetAdmRptwizTyp97ById',
      'GET_DTL_LIST': 'GetAdmRptwizTyp97DtlById',
    }
    this.ScreenDdlDef = [
  ...
  GetScreenName() { return 'AdmRptwizTyp' }
  GetMstKeyColumnName(isUnderlining = false) { return isUnderlining ? 'RptwizTypId' : 'RptwizTypId185'; }
  GetDtlKeyColumnName(isUnderlining = false) { return isUnderlining ? '' : ''; }
  GetPersistDtlName() { return this.GetScreenName() + '_Dtl'; }
  GetPersistMstName() { return this.GetScreenName() + '_Mst'; }
  GetWebService() { return AdmRptwizTypService; }
  ...
  ExpandMst(mst, state, copy) {
    return {
      ...mst,
      key: Date.now(),
      RptwizTypId185: copy ? null : mst.RptwizTypId185,
    }
  }
...
export default new AdmRptwizTypRedux()
