...
class AdmCtButtonHlpRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmCtButtonHlp81List',
      'GET_MST': 'GetAdmCtButtonHlp81ById',
      'GET_DTL_LIST': 'GetAdmCtButtonHlp81DtlById',
    }
    this.ScreenDdlDef = [
      { columnName: 'CultureId131', payloadDdlName: 'CultureId131List', keyName: 'CultureId131', labelName: 'CultureId131Text', forMst: true, isAutoComplete: true, apiServiceName: 'GetCultureId131List', actionTypeName: 'GET_DDL_CultureId131' },
      { columnName: 'ButtonTypeId131', payloadDdlName: 'ButtonTypeId131List', keyName: 'ButtonTypeId131', labelName: 'ButtonTypeId131Text', forMst: true, isAutoComplete: true, apiServiceName: 'GetButtonTypeId131List', actionTypeName: 'GET_DDL_ButtonTypeId131' },
    ]
  ...
  GetScreenName() { return 'AdmCtButtonHlp' }
  GetMstKeyColumnName(isUnderlining = false) { return isUnderlining ? 'ButtonHlpId' : 'ButtonHlpId131'; }
  GetDtlKeyColumnName(isUnderlining = false) { return isUnderlining ? '' : ''; }
  GetPersistDtlName() { return this.GetScreenName() + '_Dtl'; }
  GetPersistMstName() { return this.GetScreenName() + '_Mst'; }
  GetWebService() { return AdmCtButtonHlpService; }
  ...
  ExpandMst(mst, state, copy) {
    return {
      ...mst,
      key: Date.now(),
      ButtonHlpId131: copy ? null : mst.ButtonHlpId131,
    }
  }
...
export default new AdmCtButtonHlpRedux()
