...
class AdmCompPrefRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmCompPref1029List',
      'GET_MST': 'GetAdmCompPref1029ById',
      'GET_DTL_LIST': 'GetAdmCompPref1029DtlById',
    }
    this.ScreenDdlDef = [
      { columnName: 'CompanyId1329', payloadDdlName: 'CompanyId1329List', keyName: 'CompanyId1329', labelName: 'CompanyId1329Text', forMst: true, isAutoComplete: false, apiServiceName: 'GetCompanyId1329List', actionTypeName: 'GET_DDL_CompanyId1329' },
      { columnName: 'SystemLs1329', payloadDdlName: 'SystemLs1329List', keyName: 'SystemLs1329', labelName: 'SystemLs1329Text', forMst: true, isAutoComplete: false, apiServiceName: 'GetSystemLs1329List', actionTypeName: 'GET_DDL_SystemLs1329' },
    ]
  ...
  GetScreenName() { return 'AdmCompPref' }
  GetMstKeyColumnName(isUnderlining = false) { return isUnderlining ? 'CompPrefId' : 'CompPrefId1329'; }
  GetDtlKeyColumnName(isUnderlining = false) { return isUnderlining ? '' : ''; }
  GetPersistDtlName() { return this.GetScreenName() + '_Dtl'; }
  GetPersistMstName() { return this.GetScreenName() + '_Mst'; }
  GetWebService() { return AdmCompPrefService; }
  ...
  ExpandMst(mst, state, copy) {
    return {
      ...mst,
      key: Date.now(),
      CompPrefId1329: copy ? null : mst.CompPrefId1329,
    }
  }
...
export default new AdmCompPrefRedux()
