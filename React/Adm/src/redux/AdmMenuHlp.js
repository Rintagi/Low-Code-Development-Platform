...
class AdmMenuHlpRedux extends RintagiScreenRedux {
    ...
    constructor() {
      ...
      this.ScreenDdlDef = [
{ columnName: 'CultureId40', payloadDdlName:'CultureId40List', keyName:'CultureId40',labelName:'CultureId40Text', forMst: true, isAutoComplete:true, apiServiceName: 'GetCultureId40List', actionTypeName: 'GET_DDL_CultureId40' },
      ]
