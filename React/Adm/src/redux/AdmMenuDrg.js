...
class AdmMenuDrgRedux extends RintagiScreenRedux {
    allowTmpDtl = false;
    constructor() {
      super();
      this.ActionApiNameMapper = {
        'GET_SEARCH_LIST' : 'GetAdmMenuDrg121List',
        'GET_MST' : 'GetAdmMenuDrg121ById',
        'GET_DTL_LIST' : 'GetAdmMenuDrg121DtlById',
      }
      this.ScreenDdlDef = [
...
//        { columnName: 'TrxDetImg65', tableColumnName: 'TrxDetImg', forMst: false, apiServiceName: 'GetColumnContent', actionTypeName: 'GET_COLUMN_TRXDETIMG65' },
    ...
    GetScreenName(){return 'AdmMenuDrg'}
    ...
    GetWebService() {return AdmMenuDrgService}
...
//      || (state.ScreenCriteria.Posted30 ||{}).LastCriteria
  ...
  export default new AdmMenuDrgRedux()
