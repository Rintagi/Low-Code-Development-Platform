...
class AdmCronJobRedux extends RintagiScreenRedux {
    allowTmpDtl = false;
    constructor() {
      super();
      this.ActionApiNameMapper = {
        'GET_SEARCH_LIST' : 'GetAdmCronJob118List',
        'GET_MST' : 'GetAdmCronJob118ById',
        'GET_DTL_LIST' : 'GetAdmCronJob118DtlById',
      }
      this.ScreenDdlDef = [
...
//        { columnName: 'TrxDetImg65', tableColumnName: 'TrxDetImg', forMst: false, apiServiceName: 'GetColumnContent', actionTypeName: 'GET_COLUMN_TRXDETIMG65' },
    ...
    GetScreenName(){return 'AdmCronJob'}
    GetMstKeyColumnName(isUnderlining = false) {return isUnderlining ? 'CronJobId' :  'CronJobId264'}
    GetDtlKeyColumnName(isUnderlining = false) {return isUnderlining ? ''  :''}
    GetPersistDtlName() {return this.GetScreenName() + '_Dtl'}
    GetPersistMstName() {return this.GetScreenName() + '_Mst'}
    GetWebService() {return AdmCronJobService}
    ...
    ExpandMst(mst, state, copy) {
      return {
        ...mst,
		 key: Date.now(),
        CronJobId264: copy ? null : mst.CronJobId264,
...
//      || (state.ScreenCriteria.Posted30 ||{}).LastCriteria
  ...
  export default new AdmCronJobRedux()
