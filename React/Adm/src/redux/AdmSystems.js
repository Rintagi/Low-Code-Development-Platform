...
class AdmSystemsRedux extends RintagiScreenRedux {
    ...
    constructor() {
      ...
      this.ActionApiNameMapper = {
        'GET_SEARCH_LIST' : 'GetAdmSystems87List',
        'GET_MST' : 'GetAdmSystems87ById',
        'GET_DTL_LIST' : 'GetAdmSystems87DtlById',
      }
      this.ScreenDdlDef = [

      ]
      this.ScreenOnDemandDef = [
{ columnName: 'AddDbs', tableColumnName: 'AddDbs', forMst: false, apiServiceName: 'GetColumnContent', actionTypeName: 'GET_COLUMN_AddDbs' },
//        { columnName: 'TrxDetImg65', tableColumnName: 'TrxDetImg', forMst: false, apiServiceName: 'GetColumnContent', actionTypeName: 'GET_COLUMN_TRXDETIMG65' },
    ...
    GetScreenName(){return 'AdmSystems'}
    GetMstKeyColumnName(isUnderlining = false) {return isUnderlining ? 'SystemId' :  'SystemId45'}
    GetDtlKeyColumnName(isUnderlining = false) {return isUnderlining ? ''  :''}
    GetPersistDtlName() {return this.GetScreenName() + '_Dtl'}
    GetPersistMstName() {return this.GetScreenName() + '_Mst'}
    GetWebService() {return AdmSystemsService}
    ...
    ExpandMst(mst, state, copy) {
      return {
        ...mst,
		 key: Date.now(),
        SystemId45: copy ? null : mst.SystemId45,
...
//      || (state.ScreenCriteria.Posted30 ||{}).LastCriteria
  ...
  export default new AdmSystemsRedux()
