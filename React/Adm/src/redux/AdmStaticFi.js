...
class AdmStaticFiRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmStaticFi117List',
      'GET_MST': 'GetAdmStaticFi117ById',
      'GET_DTL_LIST': 'GetAdmStaticFi117DtlById',
    }
    this.ScreenDdlDef = [
  ...
  GetScreenName() { return 'AdmStaticFi' }
  GetMstKeyColumnName(isUnderlining = false) { return isUnderlining ? 'StaticFiId' : 'StaticFiId262'; }
  GetDtlKeyColumnName(isUnderlining = false) { return isUnderlining ? '' : ''; }
  GetPersistDtlName() { return this.GetScreenName() + '_Dtl'; }
  GetPersistMstName() { return this.GetScreenName() + '_Mst'; }
  GetWebService() { return AdmStaticFiService; }
  ...
  ExpandMst(mst, state, copy) {
    return {
      ...mst,
      key: Date.now(),
      StaticFiId262: copy ? null : mst.StaticFiId262,
    }
  }
...
export default new AdmStaticFiRedux()
