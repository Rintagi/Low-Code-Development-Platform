...
class AdmOvrideRedux extends RintagiScreenRedux {
    ...
    constructor() {
      ...
      this.ScreenDdlDef = [
{ columnName: 'UsrGroupId123', payloadDdlName:'UsrGroupId123List', keyName:'UsrGroupId123',labelName:'UsrGroupId123Text', forMst: true, isAutoComplete:false, apiServiceName: 'GetUsrGroupId123List', actionTypeName: 'GET_DDL_UsrGroupId123' },
      ]
