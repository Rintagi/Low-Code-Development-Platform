...
class AdmCtDisplayTypeRedux extends RintagiScreenRedux {
  allowTmpDtl = false;
  constructor() {
    super();
    this.ActionApiNameMapper = {
      'GET_SEARCH_LIST': 'GetAdmCtDisplayType32List',
      'GET_MST': 'GetAdmCtDisplayType32ById',
      'GET_DTL_LIST': 'GetAdmCtDisplayType32DtlById',
    }
    this.ScreenDdlDef = [
  ...
  GetScreenName() { return 'AdmCtDisplayType' }
  GetMstKeyColumnName(isUnderlining = false) { return isUnderlining ? 'TypeId' : 'TypeId18'; }
  GetDtlKeyColumnName(isUnderlining = false) { return isUnderlining ? '' : ''; }
  GetPersistDtlName() { return this.GetScreenName() + '_Dtl'; }
  GetPersistMstName() { return this.GetScreenName() + '_Mst'; }
  GetWebService() { return AdmCtDisplayTypeService; }
  ...
  ExpandMst(mst, state, copy) {
    return {
      ...mst,
      key: Date.now(),
      TypeId18: copy ? null : mst.TypeId18,
    }
  }
...
export default new AdmCtDisplayTypeRedux()
